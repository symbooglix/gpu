...
procedure {:source_name "Triad"} {:kernel} $Triad($s: bv32);
...
implementation {:source_name "Triad"} {:kernel} $Triad($s: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $0:
    ...
    havoc v1$1, v1$2;
    havoc v2$1, v2$2;
    call {:sourceloc} {:sourceloc_num 3} _LOG_WRITE_$$memC(true, v0$1, FADD32(FMUL32($s, v2$1), v1$1), $$memC[v0$1]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 3} _CHECK_WRITE_$$memC(true, v0$2, FADD32(FMUL32($s, v2$2), v1$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$memC"} true;
    $$memC[v0$1] := FADD32(FMUL32($s, v2$1), v1$1);
    $$memC[v0$2] := FADD32(FMUL32($s, v2$2), v1$2);
    return;
}
