...
procedure {:source_name "readConstantMemoryCoalesced"} {:kernel} $readConstantMemoryCoalesced($size: bv32);
...
implementation {:source_name "readConstantMemoryCoalesced"} {:kernel} $readConstantMemoryCoalesced($size: bv32)
{
  var $j.0: bv32;
  var $sum.0$1: bv32;
  var $sum.0$2: bv32;
