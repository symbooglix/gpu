...
procedure {:source_name "shiftArray"} {:kernel} $_Z10shiftArrayPfiiiii($pitch: bv32, $width: bv32, $height: bv32, $shiftX: bv32, $shiftY: bv32);
...
implementation {:source_name "shiftArray"} {:kernel} $_Z10shiftArrayPfiiiii($pitch: bv32, $width: bv32, $height: bv32, $shiftX: bv32, $shiftY: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
...
const _WATCHED_VALUE_$$texRefArray: bv8;

procedure {:inline 1} _LOG_READ_$$texRefArray(_P: bool, _offset: bv32, _value: bv8);
  modifies _READ_HAS_OCCURRED_$$texRefArray;



implementation {:inline 1} _LOG_READ_$$texRefArray(_P: bool, _offset: bv32, _value: bv8)
{
...
procedure _CHECK_READ_$$texRefArray(_P: bool, _offset: bv32, _value: bv8);
...
procedure {:inline 1} _LOG_WRITE_$$texRefArray(_P: bool, _offset: bv32, _value: bv8, _value_old: bv8);
  modifies _WRITE_HAS_OCCURRED_$$texRefArray, _WRITE_READ_BENIGN_FLAG_$$texRefArray;



implementation {:inline 1} _LOG_WRITE_$$texRefArray(_P: bool, _offset: bv32, _value: bv8, _value_old: bv8)
{
...
procedure _CHECK_WRITE_$$texRefArray(_P: bool, _offset: bv32, _value: bv8);
...
procedure {:inline 1} _LOG_ATOMIC_$$texRefArray(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$texRefArray;



implementation {:inline 1} _LOG_ATOMIC_$$texRefArray(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$texRefArray(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$texRefArray(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$texRefArray;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$texRefArray(_P: bool, _offset: bv32)
{
