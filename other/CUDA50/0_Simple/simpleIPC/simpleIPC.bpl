...
procedure {:source_name "simpleKernel"} {:kernel} $_Z12simpleKernelPiS_i($num: bv32);
...
implementation {:source_name "simpleKernel"} {:kernel} $_Z12simpleKernelPiS_i($num: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $0:
    ...
    havoc v1$1, v1$2;
    call {:sourceloc} {:sourceloc_num 2} _LOG_WRITE_$$dst(true, v0$1, BV32_SDIV(v1$1, $num), $$dst[v0$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$dst(true, v0$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 2} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 2} _CHECK_WRITE_$$dst(true, v0$2, BV32_SDIV(v1$2, $num));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$dst"} true;
    $$dst[v0$1] := BV32_SDIV(v1$1, $num);
    $$dst[v0$2] := BV32_SDIV(v1$2, $num);
    return;
}
