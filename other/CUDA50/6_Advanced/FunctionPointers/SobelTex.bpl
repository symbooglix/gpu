...
implementation {:source_name "SobelTex"} {:kernel} $_Z8SobelTexPhjiifiPFhhfE($Pitch: bv32, $w: bv32, $h: bv32, $fScale: bv32, $blockOperation: bv32, $pPointOperation: functionPtr)
{
  ...
  $1:
    ...
    assert {:block_sourceloc} {:sourceloc_num 40} p0$1 ==> true;
    v2$1 := (if p0$1 then BV32_SLT($i.0$1, $w) else v2$1);
    v2$2 := (if p0$2 then BV32_SLT($i.0$2, $w) else v2$2);
    p1$1 := false;
    p1$2 := false;
    p2$1 := false;
    p2$2 := false;
    ...
    $$0$0bv32$1 := (if p1$1 then v3$1 else $$0$0bv32$1);
    $$0$0bv32$2 := (if p1$2 then v3$2 else $$0$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v4$1 := (if p1$1 then _HAVOC_bv8$1 else v4$1);
    v4$2 := (if p1$2 then _HAVOC_bv8$2 else v4$2);
    $$0$1bv32$1 := (if p1$1 then v4$1 else $$0$1bv32$1);
    $$0$1bv32$2 := (if p1$2 then v4$2 else $$0$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v5$1 := (if p1$1 then _HAVOC_bv8$1 else v5$1);
    v5$2 := (if p1$2 then _HAVOC_bv8$2 else v5$2);
    $$0$2bv32$1 := (if p1$1 then v5$1 else $$0$2bv32$1);
    $$0$2bv32$2 := (if p1$2 then v5$2 else $$0$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v6$1 := (if p1$1 then _HAVOC_bv8$1 else v6$1);
    v6$2 := (if p1$2 then _HAVOC_bv8$2 else v6$2);
    $$0$3bv32$1 := (if p1$1 then v6$1 else $$0$3bv32$1);
    $$0$3bv32$2 := (if p1$2 then v6$2 else $$0$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v7$1 := (if p1$1 then _HAVOC_bv8$1 else v7$1);
    v7$2 := (if p1$2 then _HAVOC_bv8$2 else v7$2);
    $$0$4bv32$1 := (if p1$1 then v7$1 else $$0$4bv32$1);
    $$0$4bv32$2 := (if p1$2 then v7$2 else $$0$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v8$1 := (if p1$1 then _HAVOC_bv8$1 else v8$1);
    v8$2 := (if p1$2 then _HAVOC_bv8$2 else v8$2);
    $$0$5bv32$1 := (if p1$1 then v8$1 else $$0$5bv32$1);
    $$0$5bv32$2 := (if p1$2 then v8$2 else $$0$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v9$1 := (if p1$1 then _HAVOC_bv8$1 else v9$1);
    v9$2 := (if p1$2 then _HAVOC_bv8$2 else v9$2);
    $$0$6bv32$1 := (if p1$1 then v9$1 else $$0$6bv32$1);
    $$0$6bv32$2 := (if p1$2 then v9$2 else $$0$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v10$1 := (if p1$1 then _HAVOC_bv8$1 else v10$1);
    v10$2 := (if p1$2 then _HAVOC_bv8$2 else v10$2);
    $$0$7bv32$1 := (if p1$1 then v10$1 else $$0$7bv32$1);
    $$0$7bv32$2 := (if p1$2 then v10$2 else $$0$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v11$1 := (if p1$1 then _HAVOC_bv8$1 else v11$1);
    v11$2 := (if p1$2 then _HAVOC_bv8$2 else v11$2);
    $$0$8bv32$1 := (if p1$1 then v11$1 else $$0$8bv32$1);
    $$0$8bv32$2 := (if p1$2 then v11$2 else $$0$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v12$1 := (if p1$1 then _HAVOC_bv8$1 else v12$1);
    v12$2 := (if p1$2 then _HAVOC_bv8$2 else v12$2);
    $$0$9bv32$1 := (if p1$1 then v12$1 else $$0$9bv32$1);
    $$0$9bv32$2 := (if p1$2 then v12$2 else $$0$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v13$1 := (if p1$1 then _HAVOC_bv8$1 else v13$1);
    v13$2 := (if p1$2 then _HAVOC_bv8$2 else v13$2);
    $$0$10bv32$1 := (if p1$1 then v13$1 else $$0$10bv32$1);
    $$0$10bv32$2 := (if p1$2 then v13$2 else $$0$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v14$1 := (if p1$1 then _HAVOC_bv8$1 else v14$1);
    v14$2 := (if p1$2 then _HAVOC_bv8$2 else v14$2);
    $$0$11bv32$1 := (if p1$1 then v14$1 else $$0$11bv32$1);
    $$0$11bv32$2 := (if p1$2 then v14$2 else $$0$11bv32$2);
    v15$1 := (if p1$1 then $$0$0bv32$1 else v15$1);
    v15$2 := (if p1$2 then $$0$0bv32$2 else v15$2);
    v16$1 := (if p1$1 then $$0$4bv32$1 else v16$1);
    v16$2 := (if p1$2 then $$0$4bv32$2 else v16$2);
    v17$1 := (if p1$1 then $$0$5bv32$1 else v17$1);
    v17$2 := (if p1$2 then $$0$5bv32$2 else v17$2);
    v18$1 := (if p1$1 then $$0$6bv32$1 else v18$1);
    v18$2 := (if p1$2 then $$0$6bv32$2 else v18$2);
    v19$1 := (if p1$1 then $$0$7bv32$1 else v19$1);
    v19$2 := (if p1$2 then $$0$7bv32$2 else v19$2);
    v20$1 := (if p1$1 then $$0$8bv32$1 else v20$1);
    v20$2 := (if p1$2 then $$0$8bv32$2 else v20$2);
    v21$1 := (if p1$1 then $$0$9bv32$1 else v21$1);
    v21$2 := (if p1$2 then $$0$9bv32$2 else v21$2);
    v22$1 := (if p1$1 then $$0$10bv32$1 else v22$1);
    v22$2 := (if p1$2 then $$0$10bv32$2 else v22$2);
    v23$1 := (if p1$1 then $$0$11bv32$1 else v23$1);
    v23$2 := (if p1$2 then $$0$11bv32$2 else v23$2);
    call {:sourceloc_num 75} v24$1, v24$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v15$1, v19$1 ++ v18$1 ++ v17$1 ++ v16$1, v23$1 ++ v22$1 ++ v21$1 ++ v20$1, FSUB32(SI32_TO_FP32($i.0$1), 1065353216bv32), FSUB32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v15$2, v19$2 ++ v18$2 ++ v17$2 ++ v16$2, v23$2 ++ v22$2 ++ v21$2 ++ v20$2, FSUB32(SI32_TO_FP32($i.0$2), 1065353216bv32), FSUB32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    ...
    $$1$0bv32$1 := (if p1$1 then v25$1 else $$1$0bv32$1);
    $$1$0bv32$2 := (if p1$2 then v25$2 else $$1$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v26$1 := (if p1$1 then _HAVOC_bv8$1 else v26$1);
    v26$2 := (if p1$2 then _HAVOC_bv8$2 else v26$2);
    $$1$1bv32$1 := (if p1$1 then v26$1 else $$1$1bv32$1);
    $$1$1bv32$2 := (if p1$2 then v26$2 else $$1$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v27$1 := (if p1$1 then _HAVOC_bv8$1 else v27$1);
    v27$2 := (if p1$2 then _HAVOC_bv8$2 else v27$2);
    $$1$2bv32$1 := (if p1$1 then v27$1 else $$1$2bv32$1);
    $$1$2bv32$2 := (if p1$2 then v27$2 else $$1$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v28$1 := (if p1$1 then _HAVOC_bv8$1 else v28$1);
    v28$2 := (if p1$2 then _HAVOC_bv8$2 else v28$2);
    $$1$3bv32$1 := (if p1$1 then v28$1 else $$1$3bv32$1);
    $$1$3bv32$2 := (if p1$2 then v28$2 else $$1$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v29$1 := (if p1$1 then _HAVOC_bv8$1 else v29$1);
    v29$2 := (if p1$2 then _HAVOC_bv8$2 else v29$2);
    $$1$4bv32$1 := (if p1$1 then v29$1 else $$1$4bv32$1);
    $$1$4bv32$2 := (if p1$2 then v29$2 else $$1$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v30$1 := (if p1$1 then _HAVOC_bv8$1 else v30$1);
    v30$2 := (if p1$2 then _HAVOC_bv8$2 else v30$2);
    $$1$5bv32$1 := (if p1$1 then v30$1 else $$1$5bv32$1);
    $$1$5bv32$2 := (if p1$2 then v30$2 else $$1$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v31$1 := (if p1$1 then _HAVOC_bv8$1 else v31$1);
    v31$2 := (if p1$2 then _HAVOC_bv8$2 else v31$2);
    $$1$6bv32$1 := (if p1$1 then v31$1 else $$1$6bv32$1);
    $$1$6bv32$2 := (if p1$2 then v31$2 else $$1$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v32$1 := (if p1$1 then _HAVOC_bv8$1 else v32$1);
    v32$2 := (if p1$2 then _HAVOC_bv8$2 else v32$2);
    $$1$7bv32$1 := (if p1$1 then v32$1 else $$1$7bv32$1);
    $$1$7bv32$2 := (if p1$2 then v32$2 else $$1$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v33$1 := (if p1$1 then _HAVOC_bv8$1 else v33$1);
    v33$2 := (if p1$2 then _HAVOC_bv8$2 else v33$2);
    $$1$8bv32$1 := (if p1$1 then v33$1 else $$1$8bv32$1);
    $$1$8bv32$2 := (if p1$2 then v33$2 else $$1$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v34$1 := (if p1$1 then _HAVOC_bv8$1 else v34$1);
    v34$2 := (if p1$2 then _HAVOC_bv8$2 else v34$2);
    $$1$9bv32$1 := (if p1$1 then v34$1 else $$1$9bv32$1);
    $$1$9bv32$2 := (if p1$2 then v34$2 else $$1$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v35$1 := (if p1$1 then _HAVOC_bv8$1 else v35$1);
    v35$2 := (if p1$2 then _HAVOC_bv8$2 else v35$2);
    $$1$10bv32$1 := (if p1$1 then v35$1 else $$1$10bv32$1);
    $$1$10bv32$2 := (if p1$2 then v35$2 else $$1$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v36$1 := (if p1$1 then _HAVOC_bv8$1 else v36$1);
    v36$2 := (if p1$2 then _HAVOC_bv8$2 else v36$2);
    $$1$11bv32$1 := (if p1$1 then v36$1 else $$1$11bv32$1);
    $$1$11bv32$2 := (if p1$2 then v36$2 else $$1$11bv32$2);
    v37$1 := (if p1$1 then $$1$0bv32$1 else v37$1);
    v37$2 := (if p1$2 then $$1$0bv32$2 else v37$2);
    v38$1 := (if p1$1 then $$1$4bv32$1 else v38$1);
    v38$2 := (if p1$2 then $$1$4bv32$2 else v38$2);
    v39$1 := (if p1$1 then $$1$5bv32$1 else v39$1);
    v39$2 := (if p1$2 then $$1$5bv32$2 else v39$2);
    v40$1 := (if p1$1 then $$1$6bv32$1 else v40$1);
    v40$2 := (if p1$2 then $$1$6bv32$2 else v40$2);
    v41$1 := (if p1$1 then $$1$7bv32$1 else v41$1);
    v41$2 := (if p1$2 then $$1$7bv32$2 else v41$2);
    v42$1 := (if p1$1 then $$1$8bv32$1 else v42$1);
    v42$2 := (if p1$2 then $$1$8bv32$2 else v42$2);
    v43$1 := (if p1$1 then $$1$9bv32$1 else v43$1);
    v43$2 := (if p1$2 then $$1$9bv32$2 else v43$2);
    v44$1 := (if p1$1 then $$1$10bv32$1 else v44$1);
    v44$2 := (if p1$2 then $$1$10bv32$2 else v44$2);
    v45$1 := (if p1$1 then $$1$11bv32$1 else v45$1);
    v45$2 := (if p1$2 then $$1$11bv32$2 else v45$2);
    call {:sourceloc_num 109} v46$1, v46$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v37$1, v41$1 ++ v40$1 ++ v39$1 ++ v38$1, v45$1 ++ v44$1 ++ v43$1 ++ v42$1, FADD32(SI32_TO_FP32($i.0$1), 0bv32), FSUB32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v37$2, v41$2 ++ v40$2 ++ v39$2 ++ v38$2, v45$2 ++ v44$2 ++ v43$2 ++ v42$2, FADD32(SI32_TO_FP32($i.0$2), 0bv32), FSUB32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v47$1 := (if p1$1 then _HAVOC_bv8$1 else v47$1);
    v47$2 := (if p1$2 then _HAVOC_bv8$2 else v47$2);
    $$2$0bv32$1 := (if p1$1 then v47$1 else $$2$0bv32$1);
    $$2$0bv32$2 := (if p1$2 then v47$2 else $$2$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v48$1 := (if p1$1 then _HAVOC_bv8$1 else v48$1);
    v48$2 := (if p1$2 then _HAVOC_bv8$2 else v48$2);
    $$2$1bv32$1 := (if p1$1 then v48$1 else $$2$1bv32$1);
    $$2$1bv32$2 := (if p1$2 then v48$2 else $$2$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v49$1 := (if p1$1 then _HAVOC_bv8$1 else v49$1);
    v49$2 := (if p1$2 then _HAVOC_bv8$2 else v49$2);
    $$2$2bv32$1 := (if p1$1 then v49$1 else $$2$2bv32$1);
    $$2$2bv32$2 := (if p1$2 then v49$2 else $$2$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v50$1 := (if p1$1 then _HAVOC_bv8$1 else v50$1);
    v50$2 := (if p1$2 then _HAVOC_bv8$2 else v50$2);
    $$2$3bv32$1 := (if p1$1 then v50$1 else $$2$3bv32$1);
    $$2$3bv32$2 := (if p1$2 then v50$2 else $$2$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v51$1 := (if p1$1 then _HAVOC_bv8$1 else v51$1);
    v51$2 := (if p1$2 then _HAVOC_bv8$2 else v51$2);
    $$2$4bv32$1 := (if p1$1 then v51$1 else $$2$4bv32$1);
    $$2$4bv32$2 := (if p1$2 then v51$2 else $$2$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v52$1 := (if p1$1 then _HAVOC_bv8$1 else v52$1);
    v52$2 := (if p1$2 then _HAVOC_bv8$2 else v52$2);
    $$2$5bv32$1 := (if p1$1 then v52$1 else $$2$5bv32$1);
    $$2$5bv32$2 := (if p1$2 then v52$2 else $$2$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v53$1 := (if p1$1 then _HAVOC_bv8$1 else v53$1);
    v53$2 := (if p1$2 then _HAVOC_bv8$2 else v53$2);
    $$2$6bv32$1 := (if p1$1 then v53$1 else $$2$6bv32$1);
    $$2$6bv32$2 := (if p1$2 then v53$2 else $$2$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v54$1 := (if p1$1 then _HAVOC_bv8$1 else v54$1);
    v54$2 := (if p1$2 then _HAVOC_bv8$2 else v54$2);
    $$2$7bv32$1 := (if p1$1 then v54$1 else $$2$7bv32$1);
    $$2$7bv32$2 := (if p1$2 then v54$2 else $$2$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v55$1 := (if p1$1 then _HAVOC_bv8$1 else v55$1);
    v55$2 := (if p1$2 then _HAVOC_bv8$2 else v55$2);
    $$2$8bv32$1 := (if p1$1 then v55$1 else $$2$8bv32$1);
    $$2$8bv32$2 := (if p1$2 then v55$2 else $$2$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v56$1 := (if p1$1 then _HAVOC_bv8$1 else v56$1);
    v56$2 := (if p1$2 then _HAVOC_bv8$2 else v56$2);
    $$2$9bv32$1 := (if p1$1 then v56$1 else $$2$9bv32$1);
    $$2$9bv32$2 := (if p1$2 then v56$2 else $$2$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v57$1 := (if p1$1 then _HAVOC_bv8$1 else v57$1);
    v57$2 := (if p1$2 then _HAVOC_bv8$2 else v57$2);
    $$2$10bv32$1 := (if p1$1 then v57$1 else $$2$10bv32$1);
    $$2$10bv32$2 := (if p1$2 then v57$2 else $$2$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v58$1 := (if p1$1 then _HAVOC_bv8$1 else v58$1);
    v58$2 := (if p1$2 then _HAVOC_bv8$2 else v58$2);
    $$2$11bv32$1 := (if p1$1 then v58$1 else $$2$11bv32$1);
    $$2$11bv32$2 := (if p1$2 then v58$2 else $$2$11bv32$2);
    v59$1 := (if p1$1 then $$2$0bv32$1 else v59$1);
    v59$2 := (if p1$2 then $$2$0bv32$2 else v59$2);
    v60$1 := (if p1$1 then $$2$4bv32$1 else v60$1);
    v60$2 := (if p1$2 then $$2$4bv32$2 else v60$2);
    v61$1 := (if p1$1 then $$2$5bv32$1 else v61$1);
    v61$2 := (if p1$2 then $$2$5bv32$2 else v61$2);
    v62$1 := (if p1$1 then $$2$6bv32$1 else v62$1);
    v62$2 := (if p1$2 then $$2$6bv32$2 else v62$2);
    v63$1 := (if p1$1 then $$2$7bv32$1 else v63$1);
    v63$2 := (if p1$2 then $$2$7bv32$2 else v63$2);
    v64$1 := (if p1$1 then $$2$8bv32$1 else v64$1);
    v64$2 := (if p1$2 then $$2$8bv32$2 else v64$2);
    v65$1 := (if p1$1 then $$2$9bv32$1 else v65$1);
    v65$2 := (if p1$2 then $$2$9bv32$2 else v65$2);
    v66$1 := (if p1$1 then $$2$10bv32$1 else v66$1);
    v66$2 := (if p1$2 then $$2$10bv32$2 else v66$2);
    v67$1 := (if p1$1 then $$2$11bv32$1 else v67$1);
    v67$2 := (if p1$2 then $$2$11bv32$2 else v67$2);
    call {:sourceloc_num 143} v68$1, v68$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v59$1, v63$1 ++ v62$1 ++ v61$1 ++ v60$1, v67$1 ++ v66$1 ++ v65$1 ++ v64$1, FADD32(SI32_TO_FP32($i.0$1), 1065353216bv32), FSUB32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v59$2, v63$2 ++ v62$2 ++ v61$2 ++ v60$2, v67$2 ++ v66$2 ++ v65$2 ++ v64$2, FADD32(SI32_TO_FP32($i.0$2), 1065353216bv32), FSUB32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v69$1 := (if p1$1 then _HAVOC_bv8$1 else v69$1);
    v69$2 := (if p1$2 then _HAVOC_bv8$2 else v69$2);
    $$3$0bv32$1 := (if p1$1 then v69$1 else $$3$0bv32$1);
    $$3$0bv32$2 := (if p1$2 then v69$2 else $$3$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v70$1 := (if p1$1 then _HAVOC_bv8$1 else v70$1);
    v70$2 := (if p1$2 then _HAVOC_bv8$2 else v70$2);
    $$3$1bv32$1 := (if p1$1 then v70$1 else $$3$1bv32$1);
    $$3$1bv32$2 := (if p1$2 then v70$2 else $$3$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v71$1 := (if p1$1 then _HAVOC_bv8$1 else v71$1);
    v71$2 := (if p1$2 then _HAVOC_bv8$2 else v71$2);
    $$3$2bv32$1 := (if p1$1 then v71$1 else $$3$2bv32$1);
    $$3$2bv32$2 := (if p1$2 then v71$2 else $$3$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v72$1 := (if p1$1 then _HAVOC_bv8$1 else v72$1);
    v72$2 := (if p1$2 then _HAVOC_bv8$2 else v72$2);
    $$3$3bv32$1 := (if p1$1 then v72$1 else $$3$3bv32$1);
    $$3$3bv32$2 := (if p1$2 then v72$2 else $$3$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v73$1 := (if p1$1 then _HAVOC_bv8$1 else v73$1);
    v73$2 := (if p1$2 then _HAVOC_bv8$2 else v73$2);
    $$3$4bv32$1 := (if p1$1 then v73$1 else $$3$4bv32$1);
    $$3$4bv32$2 := (if p1$2 then v73$2 else $$3$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v74$1 := (if p1$1 then _HAVOC_bv8$1 else v74$1);
    v74$2 := (if p1$2 then _HAVOC_bv8$2 else v74$2);
    $$3$5bv32$1 := (if p1$1 then v74$1 else $$3$5bv32$1);
    $$3$5bv32$2 := (if p1$2 then v74$2 else $$3$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v75$1 := (if p1$1 then _HAVOC_bv8$1 else v75$1);
    v75$2 := (if p1$2 then _HAVOC_bv8$2 else v75$2);
    $$3$6bv32$1 := (if p1$1 then v75$1 else $$3$6bv32$1);
    $$3$6bv32$2 := (if p1$2 then v75$2 else $$3$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v76$1 := (if p1$1 then _HAVOC_bv8$1 else v76$1);
    v76$2 := (if p1$2 then _HAVOC_bv8$2 else v76$2);
    $$3$7bv32$1 := (if p1$1 then v76$1 else $$3$7bv32$1);
    $$3$7bv32$2 := (if p1$2 then v76$2 else $$3$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v77$1 := (if p1$1 then _HAVOC_bv8$1 else v77$1);
    v77$2 := (if p1$2 then _HAVOC_bv8$2 else v77$2);
    $$3$8bv32$1 := (if p1$1 then v77$1 else $$3$8bv32$1);
    $$3$8bv32$2 := (if p1$2 then v77$2 else $$3$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v78$1 := (if p1$1 then _HAVOC_bv8$1 else v78$1);
    v78$2 := (if p1$2 then _HAVOC_bv8$2 else v78$2);
    $$3$9bv32$1 := (if p1$1 then v78$1 else $$3$9bv32$1);
    $$3$9bv32$2 := (if p1$2 then v78$2 else $$3$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v79$1 := (if p1$1 then _HAVOC_bv8$1 else v79$1);
    v79$2 := (if p1$2 then _HAVOC_bv8$2 else v79$2);
    $$3$10bv32$1 := (if p1$1 then v79$1 else $$3$10bv32$1);
    $$3$10bv32$2 := (if p1$2 then v79$2 else $$3$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v80$1 := (if p1$1 then _HAVOC_bv8$1 else v80$1);
    v80$2 := (if p1$2 then _HAVOC_bv8$2 else v80$2);
    $$3$11bv32$1 := (if p1$1 then v80$1 else $$3$11bv32$1);
    $$3$11bv32$2 := (if p1$2 then v80$2 else $$3$11bv32$2);
    v81$1 := (if p1$1 then $$3$0bv32$1 else v81$1);
    v81$2 := (if p1$2 then $$3$0bv32$2 else v81$2);
    v82$1 := (if p1$1 then $$3$4bv32$1 else v82$1);
    v82$2 := (if p1$2 then $$3$4bv32$2 else v82$2);
    v83$1 := (if p1$1 then $$3$5bv32$1 else v83$1);
    v83$2 := (if p1$2 then $$3$5bv32$2 else v83$2);
    v84$1 := (if p1$1 then $$3$6bv32$1 else v84$1);
    v84$2 := (if p1$2 then $$3$6bv32$2 else v84$2);
    v85$1 := (if p1$1 then $$3$7bv32$1 else v85$1);
    v85$2 := (if p1$2 then $$3$7bv32$2 else v85$2);
    v86$1 := (if p1$1 then $$3$8bv32$1 else v86$1);
    v86$2 := (if p1$2 then $$3$8bv32$2 else v86$2);
    v87$1 := (if p1$1 then $$3$9bv32$1 else v87$1);
    v87$2 := (if p1$2 then $$3$9bv32$2 else v87$2);
    v88$1 := (if p1$1 then $$3$10bv32$1 else v88$1);
    v88$2 := (if p1$2 then $$3$10bv32$2 else v88$2);
    v89$1 := (if p1$1 then $$3$11bv32$1 else v89$1);
    v89$2 := (if p1$2 then $$3$11bv32$2 else v89$2);
    call {:sourceloc_num 177} v90$1, v90$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v81$1, v85$1 ++ v84$1 ++ v83$1 ++ v82$1, v89$1 ++ v88$1 ++ v87$1 ++ v86$1, FSUB32(SI32_TO_FP32($i.0$1), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$1), 0bv32), p1$2, v81$2, v85$2 ++ v84$2 ++ v83$2 ++ v82$2, v89$2 ++ v88$2 ++ v87$2 ++ v86$2, FSUB32(SI32_TO_FP32($i.0$2), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$2), 0bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v91$1 := (if p1$1 then _HAVOC_bv8$1 else v91$1);
    v91$2 := (if p1$2 then _HAVOC_bv8$2 else v91$2);
    $$4$0bv32$1 := (if p1$1 then v91$1 else $$4$0bv32$1);
    $$4$0bv32$2 := (if p1$2 then v91$2 else $$4$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v92$1 := (if p1$1 then _HAVOC_bv8$1 else v92$1);
    v92$2 := (if p1$2 then _HAVOC_bv8$2 else v92$2);
    $$4$1bv32$1 := (if p1$1 then v92$1 else $$4$1bv32$1);
    $$4$1bv32$2 := (if p1$2 then v92$2 else $$4$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v93$1 := (if p1$1 then _HAVOC_bv8$1 else v93$1);
    v93$2 := (if p1$2 then _HAVOC_bv8$2 else v93$2);
    $$4$2bv32$1 := (if p1$1 then v93$1 else $$4$2bv32$1);
    $$4$2bv32$2 := (if p1$2 then v93$2 else $$4$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v94$1 := (if p1$1 then _HAVOC_bv8$1 else v94$1);
    v94$2 := (if p1$2 then _HAVOC_bv8$2 else v94$2);
    $$4$3bv32$1 := (if p1$1 then v94$1 else $$4$3bv32$1);
    $$4$3bv32$2 := (if p1$2 then v94$2 else $$4$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v95$1 := (if p1$1 then _HAVOC_bv8$1 else v95$1);
    v95$2 := (if p1$2 then _HAVOC_bv8$2 else v95$2);
    $$4$4bv32$1 := (if p1$1 then v95$1 else $$4$4bv32$1);
    $$4$4bv32$2 := (if p1$2 then v95$2 else $$4$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v96$1 := (if p1$1 then _HAVOC_bv8$1 else v96$1);
    v96$2 := (if p1$2 then _HAVOC_bv8$2 else v96$2);
    $$4$5bv32$1 := (if p1$1 then v96$1 else $$4$5bv32$1);
    $$4$5bv32$2 := (if p1$2 then v96$2 else $$4$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v97$1 := (if p1$1 then _HAVOC_bv8$1 else v97$1);
    v97$2 := (if p1$2 then _HAVOC_bv8$2 else v97$2);
    $$4$6bv32$1 := (if p1$1 then v97$1 else $$4$6bv32$1);
    $$4$6bv32$2 := (if p1$2 then v97$2 else $$4$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v98$1 := (if p1$1 then _HAVOC_bv8$1 else v98$1);
    v98$2 := (if p1$2 then _HAVOC_bv8$2 else v98$2);
    $$4$7bv32$1 := (if p1$1 then v98$1 else $$4$7bv32$1);
    $$4$7bv32$2 := (if p1$2 then v98$2 else $$4$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v99$1 := (if p1$1 then _HAVOC_bv8$1 else v99$1);
    v99$2 := (if p1$2 then _HAVOC_bv8$2 else v99$2);
    $$4$8bv32$1 := (if p1$1 then v99$1 else $$4$8bv32$1);
    $$4$8bv32$2 := (if p1$2 then v99$2 else $$4$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v100$1 := (if p1$1 then _HAVOC_bv8$1 else v100$1);
    v100$2 := (if p1$2 then _HAVOC_bv8$2 else v100$2);
    $$4$9bv32$1 := (if p1$1 then v100$1 else $$4$9bv32$1);
    $$4$9bv32$2 := (if p1$2 then v100$2 else $$4$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v101$1 := (if p1$1 then _HAVOC_bv8$1 else v101$1);
    v101$2 := (if p1$2 then _HAVOC_bv8$2 else v101$2);
    $$4$10bv32$1 := (if p1$1 then v101$1 else $$4$10bv32$1);
    $$4$10bv32$2 := (if p1$2 then v101$2 else $$4$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v102$1 := (if p1$1 then _HAVOC_bv8$1 else v102$1);
    v102$2 := (if p1$2 then _HAVOC_bv8$2 else v102$2);
    $$4$11bv32$1 := (if p1$1 then v102$1 else $$4$11bv32$1);
    $$4$11bv32$2 := (if p1$2 then v102$2 else $$4$11bv32$2);
    v103$1 := (if p1$1 then $$4$0bv32$1 else v103$1);
    v103$2 := (if p1$2 then $$4$0bv32$2 else v103$2);
    v104$1 := (if p1$1 then $$4$4bv32$1 else v104$1);
    v104$2 := (if p1$2 then $$4$4bv32$2 else v104$2);
    v105$1 := (if p1$1 then $$4$5bv32$1 else v105$1);
    v105$2 := (if p1$2 then $$4$5bv32$2 else v105$2);
    v106$1 := (if p1$1 then $$4$6bv32$1 else v106$1);
    v106$2 := (if p1$2 then $$4$6bv32$2 else v106$2);
    v107$1 := (if p1$1 then $$4$7bv32$1 else v107$1);
    v107$2 := (if p1$2 then $$4$7bv32$2 else v107$2);
    v108$1 := (if p1$1 then $$4$8bv32$1 else v108$1);
    v108$2 := (if p1$2 then $$4$8bv32$2 else v108$2);
    v109$1 := (if p1$1 then $$4$9bv32$1 else v109$1);
    v109$2 := (if p1$2 then $$4$9bv32$2 else v109$2);
    v110$1 := (if p1$1 then $$4$10bv32$1 else v110$1);
    v110$2 := (if p1$2 then $$4$10bv32$2 else v110$2);
    v111$1 := (if p1$1 then $$4$11bv32$1 else v111$1);
    v111$2 := (if p1$2 then $$4$11bv32$2 else v111$2);
    call {:sourceloc_num 211} v112$1, v112$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v103$1, v107$1 ++ v106$1 ++ v105$1 ++ v104$1, v111$1 ++ v110$1 ++ v109$1 ++ v108$1, FADD32(SI32_TO_FP32($i.0$1), 0bv32), FADD32(UI32_TO_FP32(group_id_x$1), 0bv32), p1$2, v103$2, v107$2 ++ v106$2 ++ v105$2 ++ v104$2, v111$2 ++ v110$2 ++ v109$2 ++ v108$2, FADD32(SI32_TO_FP32($i.0$2), 0bv32), FADD32(UI32_TO_FP32(group_id_x$2), 0bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v113$1 := (if p1$1 then _HAVOC_bv8$1 else v113$1);
    v113$2 := (if p1$2 then _HAVOC_bv8$2 else v113$2);
    $$5$0bv32$1 := (if p1$1 then v113$1 else $$5$0bv32$1);
    $$5$0bv32$2 := (if p1$2 then v113$2 else $$5$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v114$1 := (if p1$1 then _HAVOC_bv8$1 else v114$1);
    v114$2 := (if p1$2 then _HAVOC_bv8$2 else v114$2);
    $$5$1bv32$1 := (if p1$1 then v114$1 else $$5$1bv32$1);
    $$5$1bv32$2 := (if p1$2 then v114$2 else $$5$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v115$1 := (if p1$1 then _HAVOC_bv8$1 else v115$1);
    v115$2 := (if p1$2 then _HAVOC_bv8$2 else v115$2);
    $$5$2bv32$1 := (if p1$1 then v115$1 else $$5$2bv32$1);
    $$5$2bv32$2 := (if p1$2 then v115$2 else $$5$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v116$1 := (if p1$1 then _HAVOC_bv8$1 else v116$1);
    v116$2 := (if p1$2 then _HAVOC_bv8$2 else v116$2);
    $$5$3bv32$1 := (if p1$1 then v116$1 else $$5$3bv32$1);
    $$5$3bv32$2 := (if p1$2 then v116$2 else $$5$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v117$1 := (if p1$1 then _HAVOC_bv8$1 else v117$1);
    v117$2 := (if p1$2 then _HAVOC_bv8$2 else v117$2);
    $$5$4bv32$1 := (if p1$1 then v117$1 else $$5$4bv32$1);
    $$5$4bv32$2 := (if p1$2 then v117$2 else $$5$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v118$1 := (if p1$1 then _HAVOC_bv8$1 else v118$1);
    v118$2 := (if p1$2 then _HAVOC_bv8$2 else v118$2);
    $$5$5bv32$1 := (if p1$1 then v118$1 else $$5$5bv32$1);
    $$5$5bv32$2 := (if p1$2 then v118$2 else $$5$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v119$1 := (if p1$1 then _HAVOC_bv8$1 else v119$1);
    v119$2 := (if p1$2 then _HAVOC_bv8$2 else v119$2);
    $$5$6bv32$1 := (if p1$1 then v119$1 else $$5$6bv32$1);
    $$5$6bv32$2 := (if p1$2 then v119$2 else $$5$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v120$1 := (if p1$1 then _HAVOC_bv8$1 else v120$1);
    v120$2 := (if p1$2 then _HAVOC_bv8$2 else v120$2);
    $$5$7bv32$1 := (if p1$1 then v120$1 else $$5$7bv32$1);
    $$5$7bv32$2 := (if p1$2 then v120$2 else $$5$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v121$1 := (if p1$1 then _HAVOC_bv8$1 else v121$1);
    v121$2 := (if p1$2 then _HAVOC_bv8$2 else v121$2);
    $$5$8bv32$1 := (if p1$1 then v121$1 else $$5$8bv32$1);
    $$5$8bv32$2 := (if p1$2 then v121$2 else $$5$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v122$1 := (if p1$1 then _HAVOC_bv8$1 else v122$1);
    v122$2 := (if p1$2 then _HAVOC_bv8$2 else v122$2);
    $$5$9bv32$1 := (if p1$1 then v122$1 else $$5$9bv32$1);
    $$5$9bv32$2 := (if p1$2 then v122$2 else $$5$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v123$1 := (if p1$1 then _HAVOC_bv8$1 else v123$1);
    v123$2 := (if p1$2 then _HAVOC_bv8$2 else v123$2);
    $$5$10bv32$1 := (if p1$1 then v123$1 else $$5$10bv32$1);
    $$5$10bv32$2 := (if p1$2 then v123$2 else $$5$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v124$1 := (if p1$1 then _HAVOC_bv8$1 else v124$1);
    v124$2 := (if p1$2 then _HAVOC_bv8$2 else v124$2);
    $$5$11bv32$1 := (if p1$1 then v124$1 else $$5$11bv32$1);
    $$5$11bv32$2 := (if p1$2 then v124$2 else $$5$11bv32$2);
    v125$1 := (if p1$1 then $$5$0bv32$1 else v125$1);
    v125$2 := (if p1$2 then $$5$0bv32$2 else v125$2);
    v126$1 := (if p1$1 then $$5$4bv32$1 else v126$1);
    v126$2 := (if p1$2 then $$5$4bv32$2 else v126$2);
    v127$1 := (if p1$1 then $$5$5bv32$1 else v127$1);
    v127$2 := (if p1$2 then $$5$5bv32$2 else v127$2);
    v128$1 := (if p1$1 then $$5$6bv32$1 else v128$1);
    v128$2 := (if p1$2 then $$5$6bv32$2 else v128$2);
    v129$1 := (if p1$1 then $$5$7bv32$1 else v129$1);
    v129$2 := (if p1$2 then $$5$7bv32$2 else v129$2);
    v130$1 := (if p1$1 then $$5$8bv32$1 else v130$1);
    v130$2 := (if p1$2 then $$5$8bv32$2 else v130$2);
    v131$1 := (if p1$1 then $$5$9bv32$1 else v131$1);
    v131$2 := (if p1$2 then $$5$9bv32$2 else v131$2);
    v132$1 := (if p1$1 then $$5$10bv32$1 else v132$1);
    v132$2 := (if p1$2 then $$5$10bv32$2 else v132$2);
    v133$1 := (if p1$1 then $$5$11bv32$1 else v133$1);
    v133$2 := (if p1$2 then $$5$11bv32$2 else v133$2);
    call {:sourceloc_num 245} v134$1, v134$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v125$1, v129$1 ++ v128$1 ++ v127$1 ++ v126$1, v133$1 ++ v132$1 ++ v131$1 ++ v130$1, FADD32(SI32_TO_FP32($i.0$1), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$1), 0bv32), p1$2, v125$2, v129$2 ++ v128$2 ++ v127$2 ++ v126$2, v133$2 ++ v132$2 ++ v131$2 ++ v130$2, FADD32(SI32_TO_FP32($i.0$2), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$2), 0bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v135$1 := (if p1$1 then _HAVOC_bv8$1 else v135$1);
    v135$2 := (if p1$2 then _HAVOC_bv8$2 else v135$2);
    $$6$0bv32$1 := (if p1$1 then v135$1 else $$6$0bv32$1);
    $$6$0bv32$2 := (if p1$2 then v135$2 else $$6$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v136$1 := (if p1$1 then _HAVOC_bv8$1 else v136$1);
    v136$2 := (if p1$2 then _HAVOC_bv8$2 else v136$2);
    $$6$1bv32$1 := (if p1$1 then v136$1 else $$6$1bv32$1);
    $$6$1bv32$2 := (if p1$2 then v136$2 else $$6$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v137$1 := (if p1$1 then _HAVOC_bv8$1 else v137$1);
    v137$2 := (if p1$2 then _HAVOC_bv8$2 else v137$2);
    $$6$2bv32$1 := (if p1$1 then v137$1 else $$6$2bv32$1);
    $$6$2bv32$2 := (if p1$2 then v137$2 else $$6$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v138$1 := (if p1$1 then _HAVOC_bv8$1 else v138$1);
    v138$2 := (if p1$2 then _HAVOC_bv8$2 else v138$2);
    $$6$3bv32$1 := (if p1$1 then v138$1 else $$6$3bv32$1);
    $$6$3bv32$2 := (if p1$2 then v138$2 else $$6$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v139$1 := (if p1$1 then _HAVOC_bv8$1 else v139$1);
    v139$2 := (if p1$2 then _HAVOC_bv8$2 else v139$2);
    $$6$4bv32$1 := (if p1$1 then v139$1 else $$6$4bv32$1);
    $$6$4bv32$2 := (if p1$2 then v139$2 else $$6$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v140$1 := (if p1$1 then _HAVOC_bv8$1 else v140$1);
    v140$2 := (if p1$2 then _HAVOC_bv8$2 else v140$2);
    $$6$5bv32$1 := (if p1$1 then v140$1 else $$6$5bv32$1);
    $$6$5bv32$2 := (if p1$2 then v140$2 else $$6$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v141$1 := (if p1$1 then _HAVOC_bv8$1 else v141$1);
    v141$2 := (if p1$2 then _HAVOC_bv8$2 else v141$2);
    $$6$6bv32$1 := (if p1$1 then v141$1 else $$6$6bv32$1);
    $$6$6bv32$2 := (if p1$2 then v141$2 else $$6$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v142$1 := (if p1$1 then _HAVOC_bv8$1 else v142$1);
    v142$2 := (if p1$2 then _HAVOC_bv8$2 else v142$2);
    $$6$7bv32$1 := (if p1$1 then v142$1 else $$6$7bv32$1);
    $$6$7bv32$2 := (if p1$2 then v142$2 else $$6$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v143$1 := (if p1$1 then _HAVOC_bv8$1 else v143$1);
    v143$2 := (if p1$2 then _HAVOC_bv8$2 else v143$2);
    $$6$8bv32$1 := (if p1$1 then v143$1 else $$6$8bv32$1);
    $$6$8bv32$2 := (if p1$2 then v143$2 else $$6$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v144$1 := (if p1$1 then _HAVOC_bv8$1 else v144$1);
    v144$2 := (if p1$2 then _HAVOC_bv8$2 else v144$2);
    $$6$9bv32$1 := (if p1$1 then v144$1 else $$6$9bv32$1);
    $$6$9bv32$2 := (if p1$2 then v144$2 else $$6$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v145$1 := (if p1$1 then _HAVOC_bv8$1 else v145$1);
    v145$2 := (if p1$2 then _HAVOC_bv8$2 else v145$2);
    $$6$10bv32$1 := (if p1$1 then v145$1 else $$6$10bv32$1);
    $$6$10bv32$2 := (if p1$2 then v145$2 else $$6$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v146$1 := (if p1$1 then _HAVOC_bv8$1 else v146$1);
    v146$2 := (if p1$2 then _HAVOC_bv8$2 else v146$2);
    $$6$11bv32$1 := (if p1$1 then v146$1 else $$6$11bv32$1);
    $$6$11bv32$2 := (if p1$2 then v146$2 else $$6$11bv32$2);
    v147$1 := (if p1$1 then $$6$0bv32$1 else v147$1);
    v147$2 := (if p1$2 then $$6$0bv32$2 else v147$2);
    v148$1 := (if p1$1 then $$6$4bv32$1 else v148$1);
    v148$2 := (if p1$2 then $$6$4bv32$2 else v148$2);
    v149$1 := (if p1$1 then $$6$5bv32$1 else v149$1);
    v149$2 := (if p1$2 then $$6$5bv32$2 else v149$2);
    v150$1 := (if p1$1 then $$6$6bv32$1 else v150$1);
    v150$2 := (if p1$2 then $$6$6bv32$2 else v150$2);
    v151$1 := (if p1$1 then $$6$7bv32$1 else v151$1);
    v151$2 := (if p1$2 then $$6$7bv32$2 else v151$2);
    v152$1 := (if p1$1 then $$6$8bv32$1 else v152$1);
    v152$2 := (if p1$2 then $$6$8bv32$2 else v152$2);
    v153$1 := (if p1$1 then $$6$9bv32$1 else v153$1);
    v153$2 := (if p1$2 then $$6$9bv32$2 else v153$2);
    v154$1 := (if p1$1 then $$6$10bv32$1 else v154$1);
    v154$2 := (if p1$2 then $$6$10bv32$2 else v154$2);
    v155$1 := (if p1$1 then $$6$11bv32$1 else v155$1);
    v155$2 := (if p1$2 then $$6$11bv32$2 else v155$2);
    call {:sourceloc_num 279} v156$1, v156$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v147$1, v151$1 ++ v150$1 ++ v149$1 ++ v148$1, v155$1 ++ v154$1 ++ v153$1 ++ v152$1, FSUB32(SI32_TO_FP32($i.0$1), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v147$2, v151$2 ++ v150$2 ++ v149$2 ++ v148$2, v155$2 ++ v154$2 ++ v153$2 ++ v152$2, FSUB32(SI32_TO_FP32($i.0$2), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v157$1 := (if p1$1 then _HAVOC_bv8$1 else v157$1);
    v157$2 := (if p1$2 then _HAVOC_bv8$2 else v157$2);
    $$7$0bv32$1 := (if p1$1 then v157$1 else $$7$0bv32$1);
    $$7$0bv32$2 := (if p1$2 then v157$2 else $$7$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v158$1 := (if p1$1 then _HAVOC_bv8$1 else v158$1);
    v158$2 := (if p1$2 then _HAVOC_bv8$2 else v158$2);
    $$7$1bv32$1 := (if p1$1 then v158$1 else $$7$1bv32$1);
    $$7$1bv32$2 := (if p1$2 then v158$2 else $$7$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v159$1 := (if p1$1 then _HAVOC_bv8$1 else v159$1);
    v159$2 := (if p1$2 then _HAVOC_bv8$2 else v159$2);
    $$7$2bv32$1 := (if p1$1 then v159$1 else $$7$2bv32$1);
    $$7$2bv32$2 := (if p1$2 then v159$2 else $$7$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v160$1 := (if p1$1 then _HAVOC_bv8$1 else v160$1);
    v160$2 := (if p1$2 then _HAVOC_bv8$2 else v160$2);
    $$7$3bv32$1 := (if p1$1 then v160$1 else $$7$3bv32$1);
    $$7$3bv32$2 := (if p1$2 then v160$2 else $$7$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v161$1 := (if p1$1 then _HAVOC_bv8$1 else v161$1);
    v161$2 := (if p1$2 then _HAVOC_bv8$2 else v161$2);
    $$7$4bv32$1 := (if p1$1 then v161$1 else $$7$4bv32$1);
    $$7$4bv32$2 := (if p1$2 then v161$2 else $$7$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v162$1 := (if p1$1 then _HAVOC_bv8$1 else v162$1);
    v162$2 := (if p1$2 then _HAVOC_bv8$2 else v162$2);
    $$7$5bv32$1 := (if p1$1 then v162$1 else $$7$5bv32$1);
    $$7$5bv32$2 := (if p1$2 then v162$2 else $$7$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v163$1 := (if p1$1 then _HAVOC_bv8$1 else v163$1);
    v163$2 := (if p1$2 then _HAVOC_bv8$2 else v163$2);
    $$7$6bv32$1 := (if p1$1 then v163$1 else $$7$6bv32$1);
    $$7$6bv32$2 := (if p1$2 then v163$2 else $$7$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v164$1 := (if p1$1 then _HAVOC_bv8$1 else v164$1);
    v164$2 := (if p1$2 then _HAVOC_bv8$2 else v164$2);
    $$7$7bv32$1 := (if p1$1 then v164$1 else $$7$7bv32$1);
    $$7$7bv32$2 := (if p1$2 then v164$2 else $$7$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v165$1 := (if p1$1 then _HAVOC_bv8$1 else v165$1);
    v165$2 := (if p1$2 then _HAVOC_bv8$2 else v165$2);
    $$7$8bv32$1 := (if p1$1 then v165$1 else $$7$8bv32$1);
    $$7$8bv32$2 := (if p1$2 then v165$2 else $$7$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v166$1 := (if p1$1 then _HAVOC_bv8$1 else v166$1);
    v166$2 := (if p1$2 then _HAVOC_bv8$2 else v166$2);
    $$7$9bv32$1 := (if p1$1 then v166$1 else $$7$9bv32$1);
    $$7$9bv32$2 := (if p1$2 then v166$2 else $$7$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v167$1 := (if p1$1 then _HAVOC_bv8$1 else v167$1);
    v167$2 := (if p1$2 then _HAVOC_bv8$2 else v167$2);
    $$7$10bv32$1 := (if p1$1 then v167$1 else $$7$10bv32$1);
    $$7$10bv32$2 := (if p1$2 then v167$2 else $$7$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v168$1 := (if p1$1 then _HAVOC_bv8$1 else v168$1);
    v168$2 := (if p1$2 then _HAVOC_bv8$2 else v168$2);
    $$7$11bv32$1 := (if p1$1 then v168$1 else $$7$11bv32$1);
    $$7$11bv32$2 := (if p1$2 then v168$2 else $$7$11bv32$2);
    v169$1 := (if p1$1 then $$7$0bv32$1 else v169$1);
    v169$2 := (if p1$2 then $$7$0bv32$2 else v169$2);
    v170$1 := (if p1$1 then $$7$4bv32$1 else v170$1);
    v170$2 := (if p1$2 then $$7$4bv32$2 else v170$2);
    v171$1 := (if p1$1 then $$7$5bv32$1 else v171$1);
    v171$2 := (if p1$2 then $$7$5bv32$2 else v171$2);
    v172$1 := (if p1$1 then $$7$6bv32$1 else v172$1);
    v172$2 := (if p1$2 then $$7$6bv32$2 else v172$2);
    v173$1 := (if p1$1 then $$7$7bv32$1 else v173$1);
    v173$2 := (if p1$2 then $$7$7bv32$2 else v173$2);
    v174$1 := (if p1$1 then $$7$8bv32$1 else v174$1);
    v174$2 := (if p1$2 then $$7$8bv32$2 else v174$2);
    v175$1 := (if p1$1 then $$7$9bv32$1 else v175$1);
    v175$2 := (if p1$2 then $$7$9bv32$2 else v175$2);
    v176$1 := (if p1$1 then $$7$10bv32$1 else v176$1);
    v176$2 := (if p1$2 then $$7$10bv32$2 else v176$2);
    v177$1 := (if p1$1 then $$7$11bv32$1 else v177$1);
    v177$2 := (if p1$2 then $$7$11bv32$2 else v177$2);
    call {:sourceloc_num 313} v178$1, v178$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v169$1, v173$1 ++ v172$1 ++ v171$1 ++ v170$1, v177$1 ++ v176$1 ++ v175$1 ++ v174$1, FADD32(SI32_TO_FP32($i.0$1), 0bv32), FADD32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v169$2, v173$2 ++ v172$2 ++ v171$2 ++ v170$2, v177$2 ++ v176$2 ++ v175$2 ++ v174$2, FADD32(SI32_TO_FP32($i.0$2), 0bv32), FADD32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v179$1 := (if p1$1 then _HAVOC_bv8$1 else v179$1);
    v179$2 := (if p1$2 then _HAVOC_bv8$2 else v179$2);
    $$8$0bv32$1 := (if p1$1 then v179$1 else $$8$0bv32$1);
    $$8$0bv32$2 := (if p1$2 then v179$2 else $$8$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v180$1 := (if p1$1 then _HAVOC_bv8$1 else v180$1);
    v180$2 := (if p1$2 then _HAVOC_bv8$2 else v180$2);
    $$8$1bv32$1 := (if p1$1 then v180$1 else $$8$1bv32$1);
    $$8$1bv32$2 := (if p1$2 then v180$2 else $$8$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v181$1 := (if p1$1 then _HAVOC_bv8$1 else v181$1);
    v181$2 := (if p1$2 then _HAVOC_bv8$2 else v181$2);
    $$8$2bv32$1 := (if p1$1 then v181$1 else $$8$2bv32$1);
    $$8$2bv32$2 := (if p1$2 then v181$2 else $$8$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v182$1 := (if p1$1 then _HAVOC_bv8$1 else v182$1);
    v182$2 := (if p1$2 then _HAVOC_bv8$2 else v182$2);
    $$8$3bv32$1 := (if p1$1 then v182$1 else $$8$3bv32$1);
    $$8$3bv32$2 := (if p1$2 then v182$2 else $$8$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v183$1 := (if p1$1 then _HAVOC_bv8$1 else v183$1);
    v183$2 := (if p1$2 then _HAVOC_bv8$2 else v183$2);
    $$8$4bv32$1 := (if p1$1 then v183$1 else $$8$4bv32$1);
    $$8$4bv32$2 := (if p1$2 then v183$2 else $$8$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v184$1 := (if p1$1 then _HAVOC_bv8$1 else v184$1);
    v184$2 := (if p1$2 then _HAVOC_bv8$2 else v184$2);
    $$8$5bv32$1 := (if p1$1 then v184$1 else $$8$5bv32$1);
    $$8$5bv32$2 := (if p1$2 then v184$2 else $$8$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v185$1 := (if p1$1 then _HAVOC_bv8$1 else v185$1);
    v185$2 := (if p1$2 then _HAVOC_bv8$2 else v185$2);
    $$8$6bv32$1 := (if p1$1 then v185$1 else $$8$6bv32$1);
    $$8$6bv32$2 := (if p1$2 then v185$2 else $$8$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v186$1 := (if p1$1 then _HAVOC_bv8$1 else v186$1);
    v186$2 := (if p1$2 then _HAVOC_bv8$2 else v186$2);
    $$8$7bv32$1 := (if p1$1 then v186$1 else $$8$7bv32$1);
    $$8$7bv32$2 := (if p1$2 then v186$2 else $$8$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v187$1 := (if p1$1 then _HAVOC_bv8$1 else v187$1);
    v187$2 := (if p1$2 then _HAVOC_bv8$2 else v187$2);
    $$8$8bv32$1 := (if p1$1 then v187$1 else $$8$8bv32$1);
    $$8$8bv32$2 := (if p1$2 then v187$2 else $$8$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v188$1 := (if p1$1 then _HAVOC_bv8$1 else v188$1);
    v188$2 := (if p1$2 then _HAVOC_bv8$2 else v188$2);
    $$8$9bv32$1 := (if p1$1 then v188$1 else $$8$9bv32$1);
    $$8$9bv32$2 := (if p1$2 then v188$2 else $$8$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v189$1 := (if p1$1 then _HAVOC_bv8$1 else v189$1);
    v189$2 := (if p1$2 then _HAVOC_bv8$2 else v189$2);
    $$8$10bv32$1 := (if p1$1 then v189$1 else $$8$10bv32$1);
    $$8$10bv32$2 := (if p1$2 then v189$2 else $$8$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v190$1 := (if p1$1 then _HAVOC_bv8$1 else v190$1);
    v190$2 := (if p1$2 then _HAVOC_bv8$2 else v190$2);
    $$8$11bv32$1 := (if p1$1 then v190$1 else $$8$11bv32$1);
    $$8$11bv32$2 := (if p1$2 then v190$2 else $$8$11bv32$2);
    v191$1 := (if p1$1 then $$8$0bv32$1 else v191$1);
    v191$2 := (if p1$2 then $$8$0bv32$2 else v191$2);
    v192$1 := (if p1$1 then $$8$4bv32$1 else v192$1);
    v192$2 := (if p1$2 then $$8$4bv32$2 else v192$2);
    v193$1 := (if p1$1 then $$8$5bv32$1 else v193$1);
    v193$2 := (if p1$2 then $$8$5bv32$2 else v193$2);
    v194$1 := (if p1$1 then $$8$6bv32$1 else v194$1);
    v194$2 := (if p1$2 then $$8$6bv32$2 else v194$2);
    v195$1 := (if p1$1 then $$8$7bv32$1 else v195$1);
    v195$2 := (if p1$2 then $$8$7bv32$2 else v195$2);
    v196$1 := (if p1$1 then $$8$8bv32$1 else v196$1);
    v196$2 := (if p1$2 then $$8$8bv32$2 else v196$2);
    v197$1 := (if p1$1 then $$8$9bv32$1 else v197$1);
    v197$2 := (if p1$2 then $$8$9bv32$2 else v197$2);
    v198$1 := (if p1$1 then $$8$10bv32$1 else v198$1);
    v198$2 := (if p1$2 then $$8$10bv32$2 else v198$2);
    v199$1 := (if p1$1 then $$8$11bv32$1 else v199$1);
    v199$2 := (if p1$2 then $$8$11bv32$2 else v199$2);
    call {:sourceloc_num 347} v200$1, v200$2 := $_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff(p1$1, v191$1, v195$1 ++ v194$1 ++ v193$1 ++ v192$1, v199$1 ++ v198$1 ++ v197$1 ++ v196$1, FADD32(SI32_TO_FP32($i.0$1), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$1), 1065353216bv32), p1$2, v191$2, v195$2 ++ v194$2 ++ v193$2 ++ v192$2, v199$2 ++ v198$2 ++ v197$2 ++ v196$2, FADD32(SI32_TO_FP32($i.0$2), 1065353216bv32), FADD32(UI32_TO_FP32(group_id_x$2), 1065353216bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z5tex2DIhET_7textureIS0_Li2EL19cudaTextureReadMode0EEff"} true;
    v201$1 := (if p1$1 then $$blockFunction_table[$blockOperation] else v201$1);
    v201$2 := (if p1$2 then $$blockFunction_table[$blockOperation] else v201$2);
    p2$1 := (if p1$1 && v201$1 == $functionId$$_Z12ComputeSobelhhhhhhhhhf then v201$1 == $functionId$$_Z12ComputeSobelhhhhhhhhhf else p2$1);
    p2$2 := (if p1$2 && v201$2 == $functionId$$_Z12ComputeSobelhhhhhhhhhf then v201$2 == $functionId$$_Z12ComputeSobelhhhhhhhhhf else p2$2);
    p3$1 := (if p1$1 && v201$1 != $functionId$$_Z12ComputeSobelhhhhhhhhhf then v201$1 != $functionId$$_Z12ComputeSobelhhhhhhhhhf else p3$1);
    p3$2 := (if p1$2 && v201$2 != $functionId$$_Z12ComputeSobelhhhhhhhhhf then v201$2 != $functionId$$_Z12ComputeSobelhhhhhhhhhf else p3$2);
    call {:sourceloc_num 349} v202$1, v202$2 := $_Z12ComputeSobelhhhhhhhhhf(p2$1, v24$1, v46$1, v68$1, v90$1, v112$1, v134$1, v156$1, v178$1, v200$1, $fScale, p2$2, v24$2, v46$2, v68$2, v90$2, v112$2, v134$2, v156$2, v178$2, v200$2, $fScale);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z12ComputeSobelhhhhhhhhhf"} true;
    p5$1 := (if p3$1 && v201$1 == $functionId$$_Z10ComputeBoxhhhhhhhhhf then v201$1 == $functionId$$_Z10ComputeBoxhhhhhhhhhf else p5$1);
    p5$2 := (if p3$2 && v201$2 == $functionId$$_Z10ComputeBoxhhhhhhhhhf then v201$2 == $functionId$$_Z10ComputeBoxhhhhhhhhhf else p5$2);
    p4$1 := (if p3$1 && v201$1 != $functionId$$_Z10ComputeBoxhhhhhhhhhf then v201$1 != $functionId$$_Z10ComputeBoxhhhhhhhhhf else p4$1);
    p4$2 := (if p3$2 && v201$2 != $functionId$$_Z10ComputeBoxhhhhhhhhhf then v201$2 != $functionId$$_Z10ComputeBoxhhhhhhhhhf else p4$2);
    assert {:bad_pointer_access} {:sourceloc_num 351} {:thread 1} p4$1 ==> false;
    assert {:bad_pointer_access} {:sourceloc_num 351} {:thread 2} p4$2 ==> false;
    call {:sourceloc_num 350} v202$1, v202$2 := $_Z10ComputeBoxhhhhhhhhhf(p5$1, v24$1, v46$1, v68$1, v90$1, v112$1, v134$1, v156$1, v178$1, v200$1, $fScale, p5$2, v24$2, v46$2, v68$2, v90$2, v112$2, v134$2, v156$2, v178$2, v200$2, $fScale);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10ComputeBoxhhhhhhhhhf"} true;
    v203$1 := (if p1$1 then $pPointOperation != $functionId$$null$ else v203$1);
    v203$2 := (if p1$2 then $pPointOperation != $functionId$$null$ else v203$2);
    p7$1 := (if p1$1 && v203$1 then v203$1 else p7$1);
    p7$2 := (if p1$2 && v203$2 then v203$2 else p7$2);
    p6$1 := (if p1$1 && !v203$1 then !v203$1 else p6$1);
    p6$2 := (if p1$2 && !v203$2 then !v203$2 else p6$2);
    $tmp.0$1 := (if p6$1 then v202$1 else $tmp.0$1);
    $tmp.0$2 := (if p6$2 then v202$2 else $tmp.0$2);
    ...
    assert {:bad_pointer_access} {:sourceloc_num 354} {:thread 1} p8$1 ==> false;
    assert {:bad_pointer_access} {:sourceloc_num 354} {:thread 2} p8$2 ==> false;
    call {:sourceloc_num 353} v204$1, v204$2 := $_Z9Thresholdhf(p9$1, v202$1, 1125515264bv32, p9$2, v202$2, 1125515264bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z9Thresholdhf"} true;
    $tmp.0$1 := (if p7$1 then v204$1 else $tmp.0$1);
    $tmp.0$2 := (if p7$2 then v204$2 else $tmp.0$2);
    call {:sourceloc} {:sourceloc_num 356} _LOG_WRITE_$$pSobelOriginal(p1$1, BV32_ADD(BV32_MUL(group_id_x$1, $Pitch), $i.0$1), $tmp.0$1, $$pSobelOriginal[BV32_ADD(BV32_MUL(group_id_x$1, $Pitch), $i.0$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$pSobelOriginal(p1$2, BV32_ADD(BV32_MUL(group_id_x$2, $Pitch), $i.0$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 356} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 356} _CHECK_WRITE_$$pSobelOriginal(p1$2, BV32_ADD(BV32_MUL(group_id_x$2, $Pitch), $i.0$2), $tmp.0$2);
