...
var {:source_name "array"} {:global} $$array: [bv32]bv32;
...
procedure {:source_name "addScalar"} {:kernel} $_Z9addScalarPjij($scalar: bv32, $size: bv32);
...
implementation {:source_name "addScalar"} {:kernel} $_Z9addScalarPjij($scalar: bv32, $size: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bool;
...
const _WATCHED_VALUE_$$array: bv32;

procedure {:inline 1} _LOG_READ_$$array(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$array;



implementation {:inline 1} _LOG_READ_$$array(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$array(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$array(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$array, _WRITE_READ_BENIGN_FLAG_$$array;



implementation {:inline 1} _LOG_WRITE_$$array(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$array(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$array(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$array;



implementation {:inline 1} _LOG_ATOMIC_$$array(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$array(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$array(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$array;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$array(_P: bool, _offset: bv32)
{
