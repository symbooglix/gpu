				   ...
				   int mb_height)
{
  ...
  for (int search_pos = get_local_id(0);
       __global_invariant(__read_implies(blk_sad,
                                                 ...
                                                 |
                                                 (
                                                      ((__read_offset_bytes(blk_sad) - __ptr_offset_bytes(bi))/sizeof(ushort2) - (2*MAX_POS_PADDED/2) >= get_local_id(0))
                                                   &  ((__read_offset_bytes(blk_sad) - __ptr_offset_bytes(bi))/sizeof(ushort2) - (2*MAX_POS_PADDED/2) < (MAX_POS+1)/2)
                                                   & (((__read_offset_bytes(blk_sad) - __ptr_offset_bytes(bi))/sizeof(ushort2) - (2*MAX_POS_PADDED/2))%32 == get_local_id(0))
                                                 )
                                                 |
                                                 (
                                                      ((__read_offset_bytes(blk_sad) - __ptr_offset_bytes(bi))/sizeof(ushort2) - (3*MAX_POS_PADDED/2) >= get_local_id(0))
                                                   &  ((__read_offset_bytes(blk_sad) - __ptr_offset_bytes(bi))/sizeof(ushort2) - (3*MAX_POS_PADDED/2) < (MAX_POS+1)/2)
                                                   & (((__read_offset_bytes(blk_sad) - __ptr_offset_bytes(bi))/sizeof(ushort2) - (3*MAX_POS_PADDED/2))%32 == get_local_id(0))
                                                 )
                                                 )),
       __global_invariant(__write_implies(blk_sad,
                                                 (
                                                      ((__write_offset_bytes(blk_sad) - __ptr_offset_bytes(bo_3))/sizeof(ushort2) >= get_local_id(0))
                                                   &  ((__write_offset_bytes(blk_sad) - __ptr_offset_bytes(bo_3))/sizeof(ushort2) < (MAX_POS+1)/2)
                                                   &  ((__write_offset_bytes(blk_sad) - __ptr_offset_bytes(bo_3))/sizeof(ushort2)%32 == get_local_id(0))
                                                 )
                                                 |
                                                 (
                                                      ((__write_offset_bytes(blk_sad) - __ptr_offset_bytes(bo_3))/sizeof(ushort2) - (MAX_POS_PADDED/2) >= get_local_id(0))
                                                 ...
                                                 |
                                                 (
                                                      ((__write_offset_bytes(blk_sad) - __ptr_offset_bytes(bo_2))/sizeof(ushort2) >= get_local_id(0))
                                                 ...
                                                 |
                                                 (
                                                      ((__write_offset_bytes(blk_sad) - __ptr_offset_bytes(bo_2))/sizeof(ushort2) - (MAX_POS_PADDED/2) >= get_local_id(0))
                                                 ...
                                                 |
                                                 (
                                                      ((__write_offset_bytes(blk_sad) - __ptr_offset_bytes(bo_1))/sizeof(ushort2) >= get_local_id(0))
