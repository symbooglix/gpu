...
procedure {:source_name "compress_kernel"} {:kernel} $compress_kernel($d_Ne: bv64);
...
implementation {:source_name "compress_kernel"} {:kernel} $compress_kernel($d_Ne: bv64)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bool;
  ...
  $0:
    ...
    call {:sourceloc} {:sourceloc_num 3} _LOG_WRITE_$$d_I(p0$1, v0$1, FMUL32(FMUL32(FLOG32(v2$1), 1060205080bv32), 1132396544bv32), $$d_I[v0$1]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 3} _CHECK_WRITE_$$d_I(p0$2, v0$2, FMUL32(FMUL32(FLOG32(v2$2), 1060205080bv32), 1132396544bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_I"} true;
    $$d_I[v0$1] := (if p0$1 then FMUL32(FMUL32(FLOG32(v2$1), 1060205080bv32), 1132396544bv32) else $$d_I[v0$1]);
    $$d_I[v0$2] := (if p0$2 then FMUL32(FMUL32(FLOG32(v2$2), 1060205080bv32), 1132396544bv32) else $$d_I[v0$2]);
    return;
}
