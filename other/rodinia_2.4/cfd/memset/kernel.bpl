...
implementation {:source_name "memset_kernel"} {:kernel} $memset_kernel($val: bv16, $number_bytes: bv32)
{
  ...
  $0:
    call {:sourceloc} {:sourceloc_num 1} _LOG_WRITE_$$mem_d(true, BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $val[8:0], $$mem_d[BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$mem_d(true, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 1} _CHECK_WRITE_$$mem_d(true, BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2), $val[8:0]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$mem_d"} true;
    $$mem_d[BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)] := $val[8:0];
    $$mem_d[BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2)] := $val[8:0];
    return;
}
...
axiom (if num_groups_x == 2024bv32 then 1bv1 else 0bv1) != 0bv1;
