...
procedure {:source_name "boxblur"} {:kernel} $_Z7boxblurPfS_ii($originX: bv32, $originY: bv32);
  ...
  modifies _WRITE_HAS_OCCURRED_$$blurimage, _WRITE_READ_BENIGN_FLAG_$$blurimage, _WRITE_READ_BENIGN_FLAG_$$blurimage, _READ_HAS_OCCURRED_$$blurimage;



implementation {:source_name "boxblur"} {:kernel} $_Z7boxblurPfS_ii($originX: bv32, $originY: bv32)
{
  var $r.0$1: bv32;
  var $r.0$2: bv32;
  var $samples.0: bv32;
  ...
  $falsebb:
    ...
    call {:sourceloc} {:sourceloc_num 11} _LOG_READ_$$blurimage(true, BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 17bv32), v0$1), 1bv32), $$blurimage[BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 17bv32), v0$1), 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 11} _CHECK_READ_$$blurimage(true, BV32_ADD(BV32_ADD(BV32_MUL(v1$2, 17bv32), v0$2), 1bv32), $$blurimage[BV32_ADD(BV32_ADD(BV32_MUL(v1$2, 17bv32), v0$2), 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$blurimage"} true;
    v5$1 := $$blurimage[BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 17bv32), v0$1), 1bv32)];
    v5$2 := $$blurimage[BV32_ADD(BV32_ADD(BV32_MUL(v1$2, 17bv32), v0$2), 1bv32)];
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$blurimage(true, BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 17bv32), v0$1), 1bv32), v5$1, $$blurimage[BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 17bv32), v0$1), 1bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$blurimage(true, BV32_ADD(BV32_ADD(BV32_MUL(v1$2, 17bv32), v0$2), 1bv32));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$blurimage(true, BV32_ADD(BV32_ADD(BV32_MUL(v1$2, 17bv32), v0$2), 1bv32), v5$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$blurimage"} true;
    $$blurimage[BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 17bv32), v0$1), 1bv32)] := v5$1;
    $$blurimage[BV32_ADD(BV32_ADD(BV32_MUL(v1$2, 17bv32), v0$2), 1bv32)] := v5$2;
    return;
