...
procedure {:source_name "calNumEigenValueInterval"} {:kernel} $calNumEigenValueInterval($width: bv32);
  ...
  modifies _WRITE_HAS_OCCURRED_$$numEigenIntervals, _WRITE_READ_BENIGN_FLAG_$$numEigenIntervals, _WRITE_READ_BENIGN_FLAG_$$numEigenIntervals;



implementation {:source_name "calNumEigenValueInterval"} {:kernel} $calNumEigenValueInterval($width: bv32)
{
  ...
  $falsebb:
    ...
    $prev_diff.i2.0$1, $count.i1.0$1, $i.i3.0 := v12$1, (if FLT32(v12$1, 0bv32) then 1bv32 else 0bv32), 1bv32;
    $prev_diff.i2.0$2, $count.i1.0$2 := v12$2, (if FLT32(v12$2, 0bv32) then 1bv32 else 0bv32);
  ...
  $falsebb0:
    ...
    call {:sourceloc} {:sourceloc_num 17} _LOG_WRITE_$$numEigenIntervals(true, v0$1, BV32_SUB(FP32_TO_UI32(UI32_TO_FP32($count.i1.0$1)), FP32_TO_UI32(UI32_TO_FP32($count.i.0$1))), $$numEigenIntervals[v0$1]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 17} _CHECK_WRITE_$$numEigenIntervals(true, v0$2, BV32_SUB(FP32_TO_UI32(UI32_TO_FP32($count.i1.0$2)), FP32_TO_UI32(UI32_TO_FP32($count.i.0$2))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$numEigenIntervals"} true;
    $$numEigenIntervals[v0$1] := BV32_SUB(FP32_TO_UI32(UI32_TO_FP32($count.i1.0$1)), FP32_TO_UI32(UI32_TO_FP32($count.i.0$1)));
    $$numEigenIntervals[v0$2] := BV32_SUB(FP32_TO_UI32(UI32_TO_FP32($count.i1.0$2)), FP32_TO_UI32(UI32_TO_FP32($count.i.0$2)));
    return;
  ...
  $truebb0:
    ...
    havoc v15$1, v15$2;
    havoc v16$1, v16$2;
    v17$1 := FSUB32(FSUB32(v14$1, v3$1), FDIV32(FMUL32(v15$1, v16$1), $prev_diff.i2.0$1));
    v17$2 := FSUB32(FSUB32(v14$2, v3$2), FDIV32(FMUL32(v15$2, v16$2), $prev_diff.i2.0$2));
    $prev_diff.i2.0$1, $count.i1.0$1, $i.i3.0 := v17$1, BV32_ADD($count.i1.0$1, (if FLT32(v17$1, 0bv32) then 1bv32 else 0bv32)), BV32_ADD($i.i3.0, 1bv32);
    $prev_diff.i2.0$2, $count.i1.0$2 := v17$2, BV32_ADD($count.i1.0$2, (if FLT32(v17$2, 0bv32) then 1bv32 else 0bv32));
