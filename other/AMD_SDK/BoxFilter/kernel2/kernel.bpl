...
procedure {:source_name "horizontalSAT0"} {:kernel} $horizontalSAT0($i: bv32, $r: bv32, $width: bv32);
...
implementation {:source_name "horizontalSAT0"} {:kernel} $horizontalSAT0($i: bv32, $r: bv32, $width: bv32)
{
  var $sum.0$1: bv128;
  var $sum.0$2: bv128;
  var $j.0$1: bv32;
  ...
  $1:
    ...
    v5$1 := (if p2$1 then _HAVOC_bv8$1 else v5$1);
    v5$2 := (if p2$2 then _HAVOC_bv8$2 else v5$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v6$1 := (if p2$1 then _HAVOC_bv8$1 else v6$1);
    v6$2 := (if p2$2 then _HAVOC_bv8$2 else v6$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v7$1 := (if p2$1 then _HAVOC_bv8$1 else v7$1);
    v7$2 := (if p2$2 then _HAVOC_bv8$2 else v7$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v8$1 := (if p2$1 then _HAVOC_bv8$1 else v8$1);
    v8$2 := (if p2$2 then _HAVOC_bv8$2 else v8$2);
    $sum.0$1, $j.0$1 := (if p2$1 then BV32_ADD($sum.0$1[128:96], BV8_ZEXT32(v8$1)) ++ BV32_ADD($sum.0$1[96:64], BV8_ZEXT32(v7$1)) ++ BV32_ADD($sum.0$1[64:32], BV8_ZEXT32(v6$1)) ++ BV32_ADD($sum.0$1[32:0], BV8_ZEXT32(v5$1)) else $sum.0$1), (if p2$1 then BV32_ADD($j.0$1, 1bv32) else $j.0$1);
    $sum.0$2, $j.0$2 := (if p2$2 then BV32_ADD($sum.0$2[128:96], BV8_ZEXT32(v8$2)) ++ BV32_ADD($sum.0$2[96:64], BV8_ZEXT32(v7$2)) ++ BV32_ADD($sum.0$2[64:32], BV8_ZEXT32(v6$2)) ++ BV32_ADD($sum.0$2[32:0], BV8_ZEXT32(v5$2)) else $sum.0$2), (if p2$2 then BV32_ADD($j.0$2, 1bv32) else $j.0$2);
