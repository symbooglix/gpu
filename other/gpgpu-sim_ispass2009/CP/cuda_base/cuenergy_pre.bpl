...
{
  var $atomid.0: bv32;
  var $energyval.0$1: bv32;
  var $energyval.0$2: bv32;
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  var v1$2: bv32;
  ...
  $0:
    ...
    v2$1 := BV32_ADD(BV32_MUL(BV32_MUL(num_groups_x, group_size_x), v1$1), v0$1);
    v2$2 := BV32_ADD(BV32_MUL(BV32_MUL(num_groups_x, group_size_x), v1$2), v0$2);
    $atomid.0, $energyval.0$1 := 0bv32, 0bv32;
    $energyval.0$2 := 0bv32;
  ...
  $falsebb:
    ...
    call {:sourceloc} {:sourceloc_num 9} _LOG_READ_$$energygrid(true, v2$1, $$energygrid[v2$1]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 9} _CHECK_READ_$$energygrid(true, v2$2, $$energygrid[v2$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$energygrid"} true;
    v10$1 := $$energygrid[v2$1];
    v10$2 := $$energygrid[v2$2];
    call {:sourceloc} {:sourceloc_num 10} _LOG_WRITE_$$energygrid(true, v2$1, FADD32(v10$1, $energyval.0$1), $$energygrid[v2$1]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 10} _CHECK_WRITE_$$energygrid(true, v2$2, FADD32(v10$2, $energyval.0$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$energygrid"} true;
    $$energygrid[v2$1] := FADD32(v10$1, $energyval.0$1);
    $$energygrid[v2$2] := FADD32(v10$2, $energyval.0$2);
    return;

  $truebb:
    assume {:partition} v3 && v3;
    v4$1 := $$atominfo$1[BV32_MUL($atomid.0, 4bv32)];
    v4$2 := $$atominfo$2[BV32_MUL($atomid.0, 4bv32)];
    v5$1 := FSUB32(FMUL32($gridspacing, UI32_TO_FP32(v0$1)), v4$1);
    v5$2 := FSUB32(FMUL32($gridspacing, UI32_TO_FP32(v0$2)), v4$2);
    v6$1 := $$atominfo$1[BV32_ADD(BV32_MUL($atomid.0, 4bv32), 1bv32)];
    v6$2 := $$atominfo$2[BV32_ADD(BV32_MUL($atomid.0, 4bv32), 1bv32)];
    v7$1 := FSUB32(FMUL32($gridspacing, UI32_TO_FP32(v1$1)), v6$1);
    v7$2 := FSUB32(FMUL32($gridspacing, UI32_TO_FP32(v1$2)), v6$2);
    v8$1 := $$atominfo$1[BV32_ADD(BV32_MUL($atomid.0, 4bv32), 2bv32)];
    v8$2 := $$atominfo$2[BV32_ADD(BV32_MUL($atomid.0, 4bv32), 2bv32)];
    v9$1 := $$atominfo$1[BV32_ADD(BV32_MUL($atomid.0, 4bv32), 3bv32)];
    v9$2 := $$atominfo$2[BV32_ADD(BV32_MUL($atomid.0, 4bv32), 3bv32)];
    $atomid.0, $energyval.0$1 := BV32_ADD($atomid.0, 1bv32), FADD32($energyval.0$1, FMUL32(v9$1, FDIV32(1065353216bv32, FSQRT32(FADD32(FADD32(FMUL32(v5$1, v5$1), FMUL32(v7$1, v7$1)), v8$1)))));
    $energyval.0$2 := FADD32($energyval.0$2, FMUL32(v9$2, FDIV32(1065353216bv32, FSQRT32(FADD32(FADD32(FMUL32(v5$2, v5$2), FMUL32(v7$2, v7$2)), v8$2)))));
