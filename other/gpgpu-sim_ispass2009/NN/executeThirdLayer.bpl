...
var {:source_name "Layer4_Neurons_GPU"} {:global} $$Layer4_Neurons_GPU: [bv32]bv32;
...
procedure {:source_name "executeThirdLayer"} {:kernel} $_Z17executeThirdLayerPfS_S_();
  ...
  requires !_READ_HAS_OCCURRED_$$Layer3_Weights_GPU && !_WRITE_HAS_OCCURRED_$$Layer3_Weights_GPU && !_ATOMIC_HAS_OCCURRED_$$Layer3_Weights_GPU;
  ...
  modifies _WRITE_HAS_OCCURRED_$$Layer4_Neurons_GPU, _WRITE_READ_BENIGN_FLAG_$$Layer4_Neurons_GPU, _WRITE_READ_BENIGN_FLAG_$$Layer4_Neurons_GPU;



implementation {:source_name "executeThirdLayer"} {:kernel} $_Z17executeThirdLayerPfS_S_()
{
  var $result.0$1: bv32;
  var $result.0$2: bv32;
  var $i.0: bv32;
  ...
  $0:
    v0$1 := BV32_MUL(group_id_x$1, 1251bv32);
    v0$2 := BV32_MUL(group_id_x$2, 1251bv32);
    havoc v1$1, v1$2;
  ...
  $falsebb:
    ...
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$Layer4_Neurons_GPU(true, BV32_ADD(group_id_x$1, BV32_MUL(100bv32, group_id_y$1)), FP64_CONV32(FMUL64(4610406545773251946bv64, FP32_CONV64(v5$1))), $$Layer4_Neurons_GPU[BV32_ADD(group_id_x$1, BV32_MUL(100bv32, group_id_y$1))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$Layer4_Neurons_GPU(true, BV32_ADD(group_id_x$2, BV32_MUL(100bv32, group_id_y$2)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$Layer4_Neurons_GPU(true, BV32_ADD(group_id_x$2, BV32_MUL(100bv32, group_id_y$2)), FP64_CONV32(FMUL64(4610406545773251946bv64, FP32_CONV64(v5$2))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$Layer4_Neurons_GPU"} true;
    $$Layer4_Neurons_GPU[BV32_ADD(group_id_x$1, BV32_MUL(100bv32, group_id_y$1))] := FP64_CONV32(FMUL64(4610406545773251946bv64, FP32_CONV64(v5$1)));
    $$Layer4_Neurons_GPU[BV32_ADD(group_id_x$2, BV32_MUL(100bv32, group_id_y$2))] := FP64_CONV32(FMUL64(4610406545773251946bv64, FP32_CONV64(v5$2)));
    return;
...
axiom (if num_groups_x == 100bv32 then 1bv1 else 0bv1) != 0bv1;
...
const _WATCHED_VALUE_$$Layer3_Weights_GPU: bv32;

procedure {:inline 1} _LOG_READ_$$Layer3_Weights_GPU(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$Layer3_Weights_GPU;



implementation {:inline 1} _LOG_READ_$$Layer3_Weights_GPU(_P: bool, _offset: bv32, _value: bv32)
{

  log_access_entry:
    _READ_HAS_OCCURRED_$$Layer3_Weights_GPU := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$Layer3_Weights_GPU == _value then true else _READ_HAS_OCCURRED_$$Layer3_Weights_GPU);
    return;
}



procedure _CHECK_READ_$$Layer3_Weights_GPU(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "Layer3_Weights_GPU"} {:array "$$Layer3_Weights_GPU"} {:race} {:write_read} !(_P && _WRITE_HAS_OCCURRED_$$Layer3_Weights_GPU && _WATCHED_OFFSET == _offset && _WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU);
  requires {:source_name "Layer3_Weights_GPU"} {:array "$$Layer3_Weights_GPU"} {:race} {:atomic_read} !(_P && _ATOMIC_HAS_OCCURRED_$$Layer3_Weights_GPU && _WATCHED_OFFSET == _offset);



var _WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU: bool;

procedure {:inline 1} _LOG_WRITE_$$Layer3_Weights_GPU(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$Layer3_Weights_GPU, _WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU;



implementation {:inline 1} _LOG_WRITE_$$Layer3_Weights_GPU(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{

  log_access_entry:
    _WRITE_HAS_OCCURRED_$$Layer3_Weights_GPU := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$Layer3_Weights_GPU == _value then true else _WRITE_HAS_OCCURRED_$$Layer3_Weights_GPU);
    _WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$Layer3_Weights_GPU == _value then _value != _value_old else _WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU);
    return;
}



procedure _CHECK_WRITE_$$Layer3_Weights_GPU(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "Layer3_Weights_GPU"} {:array "$$Layer3_Weights_GPU"} {:race} {:write_write} !(_P && _WRITE_HAS_OCCURRED_$$Layer3_Weights_GPU && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$Layer3_Weights_GPU != _value);
  requires {:source_name "Layer3_Weights_GPU"} {:array "$$Layer3_Weights_GPU"} {:race} {:read_write} !(_P && _READ_HAS_OCCURRED_$$Layer3_Weights_GPU && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$Layer3_Weights_GPU != _value);
  requires {:source_name "Layer3_Weights_GPU"} {:array "$$Layer3_Weights_GPU"} {:race} {:atomic_write} !(_P && _ATOMIC_HAS_OCCURRED_$$Layer3_Weights_GPU && _WATCHED_OFFSET == _offset);



procedure {:inline 1} _LOG_ATOMIC_$$Layer3_Weights_GPU(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$Layer3_Weights_GPU;



implementation {:inline 1} _LOG_ATOMIC_$$Layer3_Weights_GPU(_P: bool, _offset: bv32)
{

  log_access_entry:
    _ATOMIC_HAS_OCCURRED_$$Layer3_Weights_GPU := (if _P && _TRACKING && _WATCHED_OFFSET == _offset then true else _ATOMIC_HAS_OCCURRED_$$Layer3_Weights_GPU);
    return;
}



procedure _CHECK_ATOMIC_$$Layer3_Weights_GPU(_P: bool, _offset: bv32);
  requires {:source_name "Layer3_Weights_GPU"} {:array "$$Layer3_Weights_GPU"} {:race} {:write_atomic} !(_P && _WRITE_HAS_OCCURRED_$$Layer3_Weights_GPU && _WATCHED_OFFSET == _offset);
  requires {:source_name "Layer3_Weights_GPU"} {:array "$$Layer3_Weights_GPU"} {:race} {:read_atomic} !(_P && _READ_HAS_OCCURRED_$$Layer3_Weights_GPU && _WATCHED_OFFSET == _offset);



procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU(_P: bool, _offset: bv32)
{

  _UPDATE_BENIGN_FLAG:
    _WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU := (if _P && _WRITE_HAS_OCCURRED_$$Layer3_Weights_GPU && _WATCHED_OFFSET == _offset then false else _WRITE_READ_BENIGN_FLAG_$$Layer3_Weights_GPU);
    return;
}
