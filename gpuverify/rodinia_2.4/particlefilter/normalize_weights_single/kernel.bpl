...
implementation {:source_name "normalize_weights_kernel"} {:kernel} $normalize_weights_kernel($Nparticles: bv32)
{
  ...
  $6:
    ...
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p5$1 ==> _b10 ==> p5$1 ==> BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1) == 0bv32;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p5$2 ==> _b10 ==> p5$2 ==> BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2) == 0bv32;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b9 ==> BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1) == 0bv32 && BV32_SLT($x.i.0$1, $Nparticles) ==> p5$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b9 ==> BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2) == 0bv32 && BV32_SLT($x.i.0$2, $Nparticles) ==> p5$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b8 ==> v0$1 != 0bv32 ==> !_READ_HAS_OCCURRED_$$CDF;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b7 ==> v0$1 != 0bv32 ==> !_READ_HAS_OCCURRED_$$weights;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b6 ==> v0$1 != 0bv32 ==> !_WRITE_HAS_OCCURRED_$$CDF;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b5 ==> v0$1 != 0bv32 ==> !p5$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b5 ==> v0$2 != 0bv32 ==> !p5$2;
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b4 ==> BV32_UGE($x.i.0$1, 1bv32);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b4 ==> BV32_UGE($x.i.0$2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b3 ==> BV32_ULE($x.i.0$1, 1bv32);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b3 ==> BV32_ULE($x.i.0$2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b2 ==> BV32_SGE($x.i.0$1, 1bv32);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b2 ==> BV32_SGE($x.i.0$2, 1bv32);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b1 ==> BV32_SLE($x.i.0$1, 1bv32);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b1 ==> BV32_SLE($x.i.0$2, 1bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p5$1 ==> _b0 ==> BV32_SLE(0bv32, $x.i.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p5$2 ==> _b0 ==> BV32_SLE(0bv32, $x.i.0$2);
