...
{
  __requires(d_frame_no == 1);
  __assume(d_common.endoPoints == 20);
  __assume(d_common.no_frames == 104);
  __assume(d_common.in_rows == 51);
  __assume(d_common.in_elem == 2601);
  __assume(d_common.in2_elem == 6561);
  __assume(d_common.conv_elem == 17161);
  __assume(d_common.conv_rows == 131);
  __assume(d_common.joffset == 0);
  __assume(d_common.in2_cols == 81);
  __assume(d_common.in_cols == 51);
  __assume(d_common.ioffset == 0);
  __assume(d_common.in2_rows == 81);
  __assume(d_common.in2_pad_cumv_rows == 183);
  __assume(d_common.in2_pad_add_rows == 51);
  __assume(d_common.in2_pad_add_cols == 51);
  __assume(d_common.in2_pad_cumv_elem == 33489);
  __assume(d_common.in2_pad_cumv_cols == 183);
  __assume(d_common.in2_pad_cumv_sel_elem == 23973);
  __assume(d_common.in2_pad_cumv_sel_rows == 131);
  __assume(d_common.in2_pad_cumv_sel_rowlow == 52);
  __assume(d_common.in2_pad_cumv_sel_collow == 1);
  __assume(d_common.in2_sub_cumh_elem == 23973);
  __assume(d_common.in2_sub_cumh_rows == 131);
  __assume(d_common.in2_pad_cumv_sel2_rowlow == 1);
  __assume(d_common.in2_pad_cumv_sel2_collow == 1);
	...
	if(d_frame_no == 0){
		...
		ei_new = tx;
		while(
              __global_invariant(__implies(bx < d_common.endoPoints, !__write(d_epiT))),
              __global_invariant(__implies(bx >= d_common.endoPoints, !__write(d_endoT))),
              __global_invariant(__write_implies(d_in, ((__write_offset_bytes(d_in) - __ptr_offset_bytes(d_in))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_in, (__write_offset_bytes(d_in) - __ptr_offset_bytes(d_in))/sizeof(fp) < d_common.in_elem)),
	...
	if(d_frame_no != 0){
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(d_unique_d_in2, ((__write_offset_bytes(d_unique_d_in2) - __ptr_offset_bytes(d_unique_d_in2))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2, (__write_offset_bytes(d_unique_d_in2) - __ptr_offset_bytes(d_unique_d_in2))/sizeof(fp) < d_common.in2_elem)),
              ei_new < d_common.in2_elem){
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(d_in_mod_temp, ((__write_offset_bytes(d_in_mod_temp) - __ptr_offset_bytes(d_in_mod_temp))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_in_mod_temp, (__write_offset_bytes(d_in_mod_temp) - __ptr_offset_bytes(d_in_mod_temp))/sizeof(fp) < d_common.in_elem)),
              ei_new < d_common.in_elem){
		// while(ei_new < 1){
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(d_unique_d_conv, ((__write_offset_bytes(d_unique_d_conv) - __ptr_offset_bytes(d_unique_d_conv))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_conv, (__write_offset_bytes(d_unique_d_conv) - __ptr_offset_bytes(d_unique_d_conv))/sizeof(fp) < d_common.conv_elem)),
              ei_new < d_common.conv_elem){
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(d_unique_d_in2_pad_cumv, ((__write_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2_pad_cumv, (__write_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp) < d_common.in2_pad_cumv_elem)),
              ei_new < d_common.in2_pad_cumv_elem){
		...
		ei_new = tx;
		while(
              __global_invariant(__implies(__same_group & __write(d_unique_d_in2_pad_cumv), ((__write_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp)/d_common.in2_pad_cumv_rows - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__implies(__same_group & __write(d_unique_d_in2_pad_cumv), (__write_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp)/d_common.in2_pad_cumv_rows < d_common.in2_pad_cumv_cols)),
              __global_invariant(__implies(!__same_group & __write(d_unique_d_in2_pad_cumv), (__write_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp) < d_common.in2_pad_cumv_elem)),
              __global_invariant(__read_implies(d_unique_d_in2_pad_cumv, ((__read_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp)/d_common.in2_pad_cumv_rows - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__read_implies(d_unique_d_in2_pad_cumv, (__read_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp)/d_common.in2_pad_cumv_rows < d_common.in2_pad_cumv_cols)),
              ei_new < d_common.in2_pad_cumv_cols){
			...
			for(position = pos_ori;
                ...
                __global_invariant(__read_implies(d_unique_d_in2_pad_cumv, ((__read_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp)/d_common.in2_pad_cumv_rows - tx)%NUMBER_THREADS == 0)),
                __global_invariant(__read_implies(d_unique_d_in2_pad_cumv, (__read_offset_bytes(d_unique_d_in2_pad_cumv) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv))/sizeof(fp)/d_common.in2_pad_cumv_rows < d_common.in2_pad_cumv_cols)),
                position < pos_ori+d_common.in2_pad_cumv_rows; position = position + 1){
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(d_unique_d_in2_pad_cumv_sel, ((__write_offset_bytes(d_unique_d_in2_pad_cumv_sel) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv_sel))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2_pad_cumv_sel, (__write_offset_bytes(d_unique_d_in2_pad_cumv_sel) - __ptr_offset_bytes(d_unique_d_in2_pad_cumv_sel))/sizeof(fp) < d_common.in2_pad_cumv_sel_elem)),
              ei_new < d_common.in2_pad_cumv_sel_elem){
		...
		ei_new = tx;
		while(
              __global_invariant(__write_implies(d_unique_d_in2_sub_cumh, ((__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2_sub_cumh, (__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) < d_common.in2_sub_cumh_elem)),
              ei_new < d_common.in2_sub_cumh_elem){
		...
		while(
              __global_invariant(__write_implies(d_unique_d_in2_sub_cumh, ((__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__write_implies(d_unique_d_in2_sub_cumh, (__write_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) < d_common.in2_sub_cumh_elem)),
              __global_invariant(__read_implies(d_unique_d_in2_sub_cumh, ((__read_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) - tx)%NUMBER_THREADS == 0)),
              __global_invariant(__read_implies(d_unique_d_in2_sub_cumh, (__read_offset_bytes(d_unique_d_in2_sub_cumh) - __ptr_offset_bytes(d_unique_d_in2_sub_cumh))/sizeof(fp) < d_common.in2_sub_cumh_elem)),
              ei_new < d_common.in2_sub_cumh_elem){
