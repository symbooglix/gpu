...
implementation {:source_name "lud_internal"} {:kernel} $lud_internal($matrix_dim: bv32, $offset: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessBreak"} _b6 ==> _READ_HAS_OCCURRED_$$peri_col ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 16bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b5 ==> _READ_HAS_OCCURRED_$$peri_row ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 16bv32), local_id_x$1));
