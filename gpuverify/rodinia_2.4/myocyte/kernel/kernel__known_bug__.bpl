...
procedure {:source_name "kernel_gpu_opencl"} {:kernel} $kernel_gpu_opencl($timeinst: bv32);
  ...
  modifies _WRITE_HAS_OCCURRED_$$d_finavalu, _WRITE_READ_BENIGN_FLAG_$$d_finavalu, _WRITE_READ_BENIGN_FLAG_$$d_finavalu, _READ_HAS_OCCURRED_$$d_finavalu;
...
implementation {:source_name "kernel_gpu_opencl"} {:kernel} $kernel_gpu_opencl($timeinst: bv32)
{
  ...
  $0:
    ...
    call {:sourceloc} {:sourceloc_num 163} _LOG_WRITE_$$d_finavalu(p15$1, 0bv32, FP64_CONV32(FMUL64(4562254508917369340bv64, FP32_CONV64(FADD32(FMUL32(FMUL32(1073741824bv32, v113$1), FSUB32(v160$1, v156$1)), FSUB32(2147483648bv32, FMUL32(1073741824bv32, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v140$1, v141$1), v143$1), v144$1), v148$1), v149$1), v150$1))))))), $$d_finavalu[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_finavalu(p15$2, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_15"} {:captureState "check_state_15"} {:sourceloc} {:sourceloc_num 163} true;
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 163} _CHECK_WRITE_$$d_finavalu(p15$2, 0bv32, FP64_CONV32(FMUL64(4562254508917369340bv64, FP32_CONV64(FADD32(FMUL32(FMUL32(1073741824bv32, v113$2), FSUB32(v160$2, v156$2)), FSUB32(2147483648bv32, FMUL32(1073741824bv32, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v140$2, v141$2), v143$2), v144$2), v148$2), v149$2), v150$2))))))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_finavalu"} true;
    $$d_finavalu[0bv32] := (if p15$1 then FP64_CONV32(FMUL64(4562254508917369340bv64, FP32_CONV64(FADD32(FMUL32(FMUL32(1073741824bv32, v113$1), FSUB32(v160$1, v156$1)), FSUB32(2147483648bv32, FMUL32(1073741824bv32, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v140$1, v141$1), v143$1), v144$1), v148$1), v149$1), v150$1))))))) else $$d_finavalu[0bv32]);
    $$d_finavalu[0bv32] := (if p15$2 then FP64_CONV32(FMUL64(4562254508917369340bv64, FP32_CONV64(FADD32(FMUL32(FMUL32(1073741824bv32, v113$2), FSUB32(v160$2, v156$2)), FSUB32(2147483648bv32, FMUL32(1073741824bv32, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v140$2, v141$2), v143$2), v144$2), v148$2), v149$2), v150$2))))))) else $$d_finavalu[0bv32]);
    ...
    call {:sourceloc} {:sourceloc_num 204} _LOG_WRITE_$$d_finavalu(p15$1, 1bv32, FP64_CONV32(FMUL64(4562254508917369340bv64, FP32_CONV64(FADD32(FMUL32(FMUL32(1073741824bv32, v167$1), FSUB32(v214$1, v210$1)), FSUB32(2147483648bv32, FMUL32(1073741824bv32, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v194$1, v195$1), v197$1), v198$1), v202$1), v203$1), v204$1))))))), $$d_finavalu[1bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_finavalu(p15$2, 1bv32);
    assume {:do_not_predicate} {:check_id "check_state_31"} {:captureState "check_state_31"} {:sourceloc} {:sourceloc_num 204} true;
    call {:check_id "check_state_31"} {:sourceloc} {:sourceloc_num 204} _CHECK_WRITE_$$d_finavalu(p15$2, 1bv32, FP64_CONV32(FMUL64(4562254508917369340bv64, FP32_CONV64(FADD32(FMUL32(FMUL32(1073741824bv32, v167$2), FSUB32(v214$2, v210$2)), FSUB32(2147483648bv32, FMUL32(1073741824bv32, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v194$2, v195$2), v197$2), v198$2), v202$2), v203$2), v204$2))))))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_finavalu"} true;
    $$d_finavalu[1bv32] := (if p15$1 then FP64_CONV32(FMUL64(4562254508917369340bv64, FP32_CONV64(FADD32(FMUL32(FMUL32(1073741824bv32, v167$1), FSUB32(v214$1, v210$1)), FSUB32(2147483648bv32, FMUL32(1073741824bv32, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v194$1, v195$1), v197$1), v198$1), v202$1), v203$1), v204$1))))))) else $$d_finavalu[1bv32]);
    $$d_finavalu[1bv32] := (if p15$2 then FP64_CONV32(FMUL64(4562254508917369340bv64, FP32_CONV64(FADD32(FMUL32(FMUL32(1073741824bv32, v167$2), FSUB32(v214$2, v210$2)), FSUB32(2147483648bv32, FMUL32(1073741824bv32, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v194$2, v195$2), v197$2), v198$2), v202$2), v203$2), v204$2))))))) else $$d_finavalu[1bv32]);
    ...
    call {:sourceloc} {:sourceloc_num 245} _LOG_WRITE_$$d_finavalu(p15$1, 2bv32, FP64_CONV32(FMUL64(4562254508917369340bv64, FP32_CONV64(FADD32(FMUL32(FMUL32(1073741824bv32, v221$1), FSUB32(v268$1, v264$1)), FSUB32(2147483648bv32, FMUL32(1073741824bv32, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v248$1, v249$1), v251$1), v252$1), v256$1), v257$1), v258$1))))))), $$d_finavalu[2bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_finavalu(p15$2, 2bv32);
    assume {:do_not_predicate} {:check_id "check_state_47"} {:captureState "check_state_47"} {:sourceloc} {:sourceloc_num 245} true;
    call {:check_id "check_state_47"} {:sourceloc} {:sourceloc_num 245} _CHECK_WRITE_$$d_finavalu(p15$2, 2bv32, FP64_CONV32(FMUL64(4562254508917369340bv64, FP32_CONV64(FADD32(FMUL32(FMUL32(1073741824bv32, v221$2), FSUB32(v268$2, v264$2)), FSUB32(2147483648bv32, FMUL32(1073741824bv32, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v248$2, v249$2), v251$2), v252$2), v256$2), v257$2), v258$2))))))));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_finavalu"} true;
    $$d_finavalu[2bv32] := (if p15$1 then FP64_CONV32(FMUL64(4562254508917369340bv64, FP32_CONV64(FADD32(FMUL32(FMUL32(1073741824bv32, v221$1), FSUB32(v268$1, v264$1)), FSUB32(2147483648bv32, FMUL32(1073741824bv32, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v248$1, v249$1), v251$1), v252$1), v256$1), v257$1), v258$1))))))) else $$d_finavalu[2bv32]);
    $$d_finavalu[2bv32] := (if p15$2 then FP64_CONV32(FMUL64(4562254508917369340bv64, FP32_CONV64(FADD32(FMUL32(FMUL32(1073741824bv32, v221$2), FSUB32(v268$2, v264$2)), FSUB32(2147483648bv32, FMUL32(1073741824bv32, FADD32(FADD32(FADD32(FADD32(FADD32(FADD32(v248$2, v249$2), v251$2), v252$2), v256$2), v257$2), v258$2))))))) else $$d_finavalu[2bv32]);
    return;
}
