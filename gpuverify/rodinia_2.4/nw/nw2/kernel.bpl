...
implementation {:source_name "nw_kernel2"} {:kernel} $nw_kernel2($cols: bv32, $penalty: bv32, $blk: bv32, $block_width: bv32, $worksize: bv32, $offset_r: bv32, $offset_c: bv32)
{
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b21 ==> _WRITE_HAS_OCCURRED_$$reference_l ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 16bv32), local_id_x$1));
    ...
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_UGE($ty.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_UGE($ty.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($ty.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_ULE($ty.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($ty.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SGE($ty.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($ty.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SLE($ty.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b0 ==> BV32_SLE(0bv32, $ty.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b0 ==> BV32_SLE(0bv32, $ty.0);
  ...
  $7:
    ...
    assert {:tag "noread"} _b26 ==> !_READ_HAS_OCCURRED_$$reference_l;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b25 ==> _WRITE_HAS_OCCURRED_$$input_itemsets_l ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, 1bv32), 17bv32), BV32_ADD(local_id_x$1, 1bv32)));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b24 ==> _READ_HAS_OCCURRED_$$input_itemsets_l ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 17bv32), BV32_ADD(local_id_x$1, 1bv32)));
    assert {:tag "nowrite"} _b23 ==> !_WRITE_HAS_OCCURRED_$$input_itemsets_l;
    assert {:tag "noread"} _b22 ==> !_READ_HAS_OCCURRED_$$input_itemsets_l;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$reference_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$reference_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$reference_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_UGE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b9 ==> BV32_UGE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b8 ==> BV32_ULE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_SGE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_SLE($m.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b5 ==> BV32_SLE(0bv32, $m.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b5 ==> BV32_SLE(0bv32, $m.0);
  ...
  $18:
    ...
    assert {:tag "noread"} _b29 ==> !_READ_HAS_OCCURRED_$$reference_l;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b15 ==> BV32_UGE($m1.0, 14bv32);
    assert {:tag "loopBound"} {:thread 2} _b15 ==> BV32_UGE($m1.0, 14bv32);
    assert {:tag "loopBound"} {:thread 1} _b14 ==> BV32_ULE($m1.0, 14bv32);
    assert {:tag "loopBound"} {:thread 2} _b14 ==> BV32_ULE($m1.0, 14bv32);
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_SGE($m1.0, 14bv32);
    assert {:tag "loopBound"} {:thread 2} _b13 ==> BV32_SGE($m1.0, 14bv32);
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_SLE($m1.0, 14bv32);
    assert {:tag "loopBound"} {:thread 2} _b12 ==> BV32_SLE($m1.0, 14bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b11 ==> BV32_SLE(0bv32, $m1.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b11 ==> BV32_SLE(0bv32, $m1.0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b10 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $m1.0) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), 14bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b10 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $m1.0) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), 14bv32);
  ...
  $29:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b30 ==> _READ_HAS_OCCURRED_$$input_itemsets_l ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 17bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, 1bv32), 17bv32), BV32_ADD(local_id_x$1, 1bv32)));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$reference_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$reference_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$reference_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$input_itemsets_l ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b20 ==> BV32_UGE($ty4.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b20 ==> BV32_UGE($ty4.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b19 ==> BV32_ULE($ty4.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b19 ==> BV32_ULE($ty4.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b18 ==> BV32_SGE($ty4.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b18 ==> BV32_SGE($ty4.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b17 ==> BV32_SLE($ty4.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b17 ==> BV32_SLE($ty4.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b16 ==> BV32_SLE(0bv32, $ty4.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b16 ==> BV32_SLE(0bv32, $ty4.0);
    assert {:block_sourceloc} {:sourceloc_num 61} true;
    v40 := BV32_SLT($ty4.0, 16bv32);
    goto $truebb9, $falsebb9;

  $falsebb9:
    assume {:partition} !v40 && !v40;
    return;

  $truebb9:
    assume {:partition} v40 && v40;
    call {:sourceloc} {:sourceloc_num 63} _LOG_READ_$$input_itemsets_l(true, BV32_ADD(BV32_ADD(v1$1, 1bv32), BV32_MUL(BV32_ADD($ty4.0, 1bv32), 17bv32)), $$input_itemsets_l[1bv1][BV32_ADD(BV32_ADD(v1$1, 1bv32), BV32_MUL(BV32_ADD($ty4.0, 1bv32), 17bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 63} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 63} _CHECK_READ_$$input_itemsets_l(true, BV32_ADD(BV32_ADD(v1$2, 1bv32), BV32_MUL(BV32_ADD($ty4.0, 1bv32), 17bv32)), $$input_itemsets_l[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_ADD(v1$2, 1bv32), BV32_MUL(BV32_ADD($ty4.0, 1bv32), 17bv32))]);
    ...
    call {:sourceloc} {:sourceloc_num 64} _LOG_WRITE_$$input_itemsets_d(true, BV32_ADD(v5$1, BV32_MUL($ty4.0, $cols)), v41$1, $$input_itemsets_d[BV32_ADD(v5$1, BV32_MUL($ty4.0, $cols))]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 64} _CHECK_WRITE_$$input_itemsets_d(true, BV32_ADD(v5$2, BV32_MUL($ty4.0, $cols)), v41$2);
  ...
  __partitioned_block_$truebb5_0:
    ...
    call {:sourceloc} {:sourceloc_num 47} _LOG_READ_$$reference_l(p9$1, BV32_ADD(BV32_SUB(v29$1, 1bv32), BV32_MUL(BV32_SUB(v30$1, 1bv32), 16bv32)), $$reference_l[1bv1][BV32_ADD(BV32_SUB(v29$1, 1bv32), BV32_MUL(BV32_SUB(v30$1, 1bv32), 16bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 47} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 47} _CHECK_READ_$$reference_l(p9$2, BV32_ADD(BV32_SUB(v29$2, 1bv32), BV32_MUL(BV32_SUB(v30$2, 1bv32), 16bv32)), $$reference_l[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_SUB(v29$2, 1bv32), BV32_MUL(BV32_SUB(v30$2, 1bv32), 16bv32))]);
  ...
  __partitioned_block_$truebb1_0:
    ...
    call {:sourceloc} {:sourceloc_num 29} _LOG_READ_$$reference_l(p3$1, BV32_ADD(BV32_SUB(v16$1, 1bv32), BV32_MUL(BV32_SUB(v17$1, 1bv32), 16bv32)), $$reference_l[1bv1][BV32_ADD(BV32_SUB(v16$1, 1bv32), BV32_MUL(BV32_SUB(v17$1, 1bv32), 16bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_12"} {:captureState "check_state_12"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 29} _CHECK_READ_$$reference_l(p3$2, BV32_ADD(BV32_SUB(v16$2, 1bv32), BV32_MUL(BV32_SUB(v17$2, 1bv32), 16bv32)), $$reference_l[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_SUB(v16$2, 1bv32), BV32_MUL(BV32_SUB(v17$2, 1bv32), 16bv32))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$reference_l"} true;
