...
implementation {:source_name "opencl_cutoff_potential_lattice"} {:kernel} $opencl_cutoff_potential_lattice($binDim_x: bv32, $binDim_y: bv32, $offset: bv32, $h: bv32, $cutoff2: bv32, $inv_cutoff2: bv32, $zRegionIndex: bv32)
{
  ...
  $1:
    ...
    assert {:tag "nowrite"} _b100 ==> !_WRITE_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache;
    assert {:tag "noread"} _b99 ==> !_READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b98 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex ==> _WATCHED_OFFSET == 0bv32 || _WATCHED_OFFSET == 1bv32 || _WATCHED_OFFSET == 2bv32 || _WATCHED_OFFSET == 3bv32;
    assert {:tag "noread"} _b97 ==> !_READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex;
    assert {:tag "predicatedEquality"} _b96 ==> p0$1 && p0$2 ==> v65$1 == v65$2;
    assert {:tag "predicatedEquality"} _b95 ==> p0$1 && p0$2 ==> v64$1 == v64$2;
    assert {:tag "predicatedEquality"} _b94 ==> p0$1 && p0$2 ==> v63$1 == v63$2;
    assert {:tag "predicatedEquality"} _b93 ==> p0$1 && p0$2 ==> v62$1 == v62$2;
    assert {:tag "predicatedEquality"} _b92 ==> p0$1 && p0$2 ==> v61$1 == v61$2;
    assert {:tag "predicatedEquality"} _b91 ==> p0$1 && p0$2 ==> v60$1 == v60$2;
    assert {:tag "predicatedEquality"} _b90 ==> p0$1 && p0$2 ==> v59$1 == v59$2;
    assert {:tag "predicatedEquality"} _b89 ==> p0$1 && p0$2 ==> v58$1 == v58$2;
    assert {:tag "predicatedEquality"} _b88 ==> p0$1 && p0$2 ==> v57$1 == v57$2;
    assert {:tag "predicatedEquality"} _b87 ==> p0$1 && p0$2 ==> v56$1 == v56$2;
    assert {:tag "predicatedEquality"} _b86 ==> p0$1 && p0$2 ==> v55$1 == v55$2;
    assert {:tag "predicatedEquality"} _b85 ==> p0$1 && p0$2 ==> v54$1 == v54$2;
    assert {:tag "predicatedEquality"} _b84 ==> p0$1 && p0$2 ==> v53$1 == v53$2;
    assert {:tag "predicatedEquality"} _b83 ==> p0$1 && p0$2 ==> v52$1 == v52$2;
    assert {:tag "predicatedEquality"} _b82 ==> p0$1 && p0$2 ==> v51$1 == v51$2;
    assert {:tag "predicatedEquality"} _b81 ==> p0$1 && p0$2 ==> v50$1 == v50$2;
    assert {:tag "predicatedEquality"} _b80 ==> p0$1 && p0$2 ==> v49$1 == v49$2;
    assert {:tag "predicatedEquality"} _b79 ==> p0$1 && p0$2 ==> v48$1 == v48$2;
    assert {:tag "predicatedEquality"} _b78 ==> p0$1 && p0$2 ==> v47$1 == v47$2;
    assert {:tag "predicatedEquality"} _b77 ==> p0$1 && p0$2 ==> v45$1 == v45$2;
    assert {:tag "predicatedEquality"} _b76 ==> p0$1 && p0$2 ==> v44$1 == v44$2;
    assert {:tag "predicatedEquality"} _b75 ==> p0$1 && p0$2 ==> v43$1 == v43$2;
    assert {:tag "predicatedEquality"} _b74 ==> p0$1 && p0$2 ==> v42$1 == v42$2;
    assert {:tag "predicatedEquality"} _b73 ==> p0$1 && p0$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b72 ==> p0$1 && p0$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b71 ==> p0$1 && p0$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b70 ==> p0$1 && p0$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b69 ==> p0$1 && p0$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b68 ==> p0$1 && p0$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b67 ==> p0$1 && p0$2 ==> v46$1 == v46$2;
    assert {:tag "predicatedEquality"} _b66 ==> p0$1 && p0$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b65 ==> p0$1 && p0$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b64 ==> p0$1 && p0$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b63 ==> p0$1 && p0$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b62 ==> p0$1 && p0$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b61 ==> p0$1 && p0$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b60 ==> p0$1 && p0$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b59 ==> p0$1 && p0$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b58 ==> p0$1 && p0$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b57 ==> p0$1 && p0$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b56 ==> p0$1 && p0$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b55 ==> p0$1 && p0$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b54 ==> p0$1 && p0$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b53 ==> p0$1 && p0$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b52 ==> p0$1 && p0$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b51 ==> p0$1 && p0$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b50 ==> p0$1 && p0$2 ==> $energy.3$1 == $energy.3$2;
    assert {:tag "predicatedEquality"} _b49 ==> p0$1 && p0$2 ==> $i1.0$1 == $i1.0$2;
    assert {:tag "predicatedEquality"} _b48 ==> p0$1 && p0$2 ==> $energy.2$1 == $energy.2$2;
    assert {:tag "predicatedEquality"} _b47 ==> p0$1 && p0$2 ==> $bincnt.1$1 == $bincnt.1$2;
    assert {:tag "predicatedEquality"} _b46 ==> p0$1 && p0$2 ==> $energy.1$1 == $energy.1$2;
    assert {:tag "predicatedEquality"} _b45 ==> p0$1 && p0$2 ==> $numbins.1$1 == $numbins.1$2;
    assert {:tag "predicatedEquality"} _b44 ==> p0$1 && p0$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b43 ==> p0$1 && p0$2 ==> $bincnt.0$1 == $bincnt.0$2;
    assert {:tag "predicatedEquality"} _b42 ==> p0$1 && p0$2 ==> $nbrid.1$1 == $nbrid.1$2;
    assert {:tag "predicatedEquality"} _b41 ==> p0$1 && p0$2 ==> $energy.0$1 == $energy.0$2;
    assert {:tag "predicatedEquality"} _b40 ==> p0$1 && p0$2 ==> $numbins.0$1 == $numbins.0$2;
    assert {:tag "predicatedEquality"} _b39 ==> p0$1 && p0$2 ==> $totalbins.0$1 == $totalbins.0$2;
    assert {:tag "predicatedEquality"} _b38 ==> p0$1 && p0$2 ==> $nbrid.0$1 == $nbrid.0$2;
    assert {:tag "loopPredicateEquality"} _b37 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p0$1 == p0$2;
    assert {:tag "loopPredicateEquality"} _b36 ==> p0$1 == p0$2;
    assert {:tag "pow2NotZero"} _b35 ==> $nbrid.0$2 != 0bv32;
    assert {:tag "pow2"} _b34 ==> $nbrid.0$2 == 0bv32 || BV32_AND($nbrid.0$2, BV32_SUB($nbrid.0$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b33 ==> $nbrid.0$1 != 0bv32;
    assert {:tag "pow2"} _b32 ==> $nbrid.0$1 == 0bv32 || BV32_AND($nbrid.0$1, BV32_SUB($nbrid.0$1, 1bv32)) == 0bv32;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_SLT($totalbins.0$1, v20$1) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_SLT($totalbins.0$2, v20$2) ==> p0$2;
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b5 ==> BV32_UGE($totalbins.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b5 ==> BV32_UGE($totalbins.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b4 ==> BV32_ULE($totalbins.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b4 ==> BV32_ULE($totalbins.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b3 ==> BV32_SGE($totalbins.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b3 ==> BV32_SGE($totalbins.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b2 ==> BV32_SLE($totalbins.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b2 ==> BV32_SLE($totalbins.0$2, 0bv32);
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b101 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex ==> _WATCHED_OFFSET == 0bv32 || _WATCHED_OFFSET == 1bv32 || _WATCHED_OFFSET == 2bv32 || _WATCHED_OFFSET == 3bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b15 ==> _WRITE_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> BV32_SLT($totalbins.0$1, v20$1);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.myBinIndex ==> BV32_SLT($totalbins.0$1, v20$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p2$1 ==> _b13 ==> p2$1 ==> BV32_SLT($totalbins.0$1, v20$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p2$2 ==> _b13 ==> p2$2 ==> BV32_SLT($totalbins.0$2, v20$2);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b12 ==> BV32_SLT($totalbins.0$1, v20$1) && BV32_SLT($bincnt.0$1, 4bv32) ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b12 ==> BV32_SLT($totalbins.0$2, v20$2) && BV32_SLT($bincnt.0$2, 4bv32) ==> p2$2;
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b11 ==> BV32_UGE($bincnt.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b11 ==> BV32_UGE($bincnt.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b10 ==> BV32_ULE($bincnt.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b10 ==> BV32_ULE($bincnt.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b9 ==> BV32_SGE($bincnt.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b9 ==> BV32_SGE($bincnt.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b8 ==> BV32_SLE($bincnt.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b8 ==> BV32_SLE($bincnt.0$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p2$1 ==> _b7 ==> BV32_SLE(0bv32, $bincnt.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p2$2 ==> _b7 ==> BV32_SLE(0bv32, $bincnt.0$2);
  ...
  $11:
    ...
    assert p8$1 ==> p0$1;
    assert p8$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b23 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> BV32_SLT($totalbins.0$1, v20$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p8$1 ==> _b22 ==> p8$1 ==> BV32_SLT($totalbins.0$1, v20$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p8$2 ==> _b22 ==> p8$2 ==> BV32_SLT($totalbins.0$2, v20$2);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b21 ==> BV32_SLT($totalbins.0$1, v20$1) && BV32_SLT($bincnt.1$1, $numbins.1$1) ==> p8$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b21 ==> BV32_SLT($totalbins.0$2, v20$2) && BV32_SLT($bincnt.1$2, $numbins.1$2) ==> p8$2;
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b20 ==> BV32_UGE($bincnt.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b20 ==> BV32_UGE($bincnt.1$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b19 ==> BV32_ULE($bincnt.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b19 ==> BV32_ULE($bincnt.1$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b18 ==> BV32_SGE($bincnt.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b18 ==> BV32_SGE($bincnt.1$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b17 ==> BV32_SLE($bincnt.1$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b17 ==> BV32_SLE($bincnt.1$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p8$1 ==> _b16 ==> BV32_SLE(0bv32, $bincnt.1$1);
    assert {:tag "guardNonNeg"} {:thread 2} p8$2 ==> _b16 ==> BV32_SLE(0bv32, $bincnt.1$2);
  ...
  $13:
    ...
    assert p8$1 ==> p0$1;
    assert p8$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b31 ==> _READ_HAS_OCCURRED_$$opencl_cutoff_potential_lattice.AtomBinCache ==> BV32_SLT($totalbins.0$1, v20$1) && BV32_SLT($bincnt.1$1, $numbins.1$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p10$1 ==> _b30 ==> p10$1 ==> BV32_SLT($totalbins.0$1, v20$1) && BV32_SLT($bincnt.1$1, $numbins.1$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p10$2 ==> _b30 ==> p10$2 ==> BV32_SLT($totalbins.0$2, v20$2) && BV32_SLT($bincnt.1$2, $numbins.1$2);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b29 ==> BV32_SLT($totalbins.0$1, v20$1) && BV32_SLT($bincnt.1$1, $numbins.1$1) && BV32_SLT($i1.0$1, 8bv32) ==> p10$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b29 ==> BV32_SLT($totalbins.0$2, v20$2) && BV32_SLT($bincnt.1$2, $numbins.1$2) && BV32_SLT($i1.0$2, 8bv32) ==> p10$2;
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b28 ==> BV32_UGE($i1.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b28 ==> BV32_UGE($i1.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b27 ==> BV32_ULE($i1.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b27 ==> BV32_ULE($i1.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b26 ==> BV32_SGE($i1.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b26 ==> BV32_SGE($i1.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b25 ==> BV32_SLE($i1.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b25 ==> BV32_SLE($i1.0$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p10$1 ==> _b24 ==> BV32_SLE(0bv32, $i1.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p10$2 ==> _b24 ==> BV32_SLE(0bv32, $i1.0$2);
