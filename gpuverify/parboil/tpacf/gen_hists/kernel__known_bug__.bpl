...
implementation {:source_name "gen_hists"} {:kernel} $gen_hists($NUM_SETS: bv32, $NUM_ELEMENTS: bv32)
{
  ...
  $1:
    ...
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b30 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_WRITE_HAS_OCCURRED_$$gen_hists.warp_hists;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b29 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$gen_hists.warp_hists;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b28 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_WRITE_HAS_OCCURRED_$$all_x_data;
    ...
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_UGE($w.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_UGE($w.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($w.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_ULE($w.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($w.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SGE($w.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($w.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SLE($w.0, 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> BV32_AND(BV32_SUB(256bv32, 1bv32), $w.0) == BV32_AND(BV32_SUB(256bv32, 1bv32), 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> BV32_AND(BV32_SUB(256bv32, 1bv32), $w.0) == BV32_AND(BV32_SUB(256bv32, 1bv32), 0bv32);
  ...
  $10:
    ...
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b36 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_WRITE_HAS_OCCURRED_$$gen_hists.warp_hists;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b35 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$gen_hists.warp_hists;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_UGE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b9 ==> BV32_UGE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b8 ==> BV32_ULE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_SGE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_SLE($j.0, 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b5 ==> BV32_AND(BV32_SUB(256bv32, 1bv32), $j.0) == BV32_AND(BV32_SUB(256bv32, 1bv32), 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b5 ==> BV32_AND(BV32_SUB(256bv32, 1bv32), $j.0) == BV32_AND(BV32_SUB(256bv32, 1bv32), 0bv32);
  ...
  $37:
    ...
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b46 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_WRITE_HAS_OCCURRED_$$gen_hists.warp_hists;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b45 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$gen_hists.warp_hists;
    assert {:tag "nowrite"} _b44 ==> !_WRITE_HAS_OCCURRED_$$gen_hists.warp_hists;
    assert {:tag "noread"} _b43 ==> !_READ_HAS_OCCURRED_$$gen_hists.warp_hists;
    ...
    assert {:tag "pow2NotZero"} _b38 ==> $offset.0 != 0bv32;
    assert {:tag "pow2"} _b37 ==> $offset.0 == 0bv32 || BV32_AND($offset.0, BV32_SUB($offset.0, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_UGE($offset.0, 64bv32);
    assert {:tag "loopBound"} {:thread 2} _b13 ==> BV32_UGE($offset.0, 64bv32);
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_ULE($offset.0, 64bv32);
    assert {:tag "loopBound"} {:thread 2} _b12 ==> BV32_ULE($offset.0, 64bv32);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_SGE($offset.0, 64bv32);
    assert {:tag "loopBound"} {:thread 2} _b11 ==> BV32_SGE($offset.0, 64bv32);
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_SLE($offset.0, 64bv32);
    assert {:tag "loopBound"} {:thread 2} _b10 ==> BV32_SLE($offset.0, 64bv32);
  ...
  __partitioned_block_$falsebb14_1:
    call {:sourceloc_num 63} $bugle_barrier_duplicated_0(1bv1, 1bv1);
    ...
    call {:sourceloc} {:sourceloc_num 65} _LOG_READ_$$gen_hists.warp_hists(p32$1, BV32_MUL(v3$1, 128bv32), $$gen_hists.warp_hists[1bv1][BV32_MUL(v3$1, 128bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 65} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 65} _CHECK_READ_$$gen_hists.warp_hists(p32$2, BV32_MUL(v3$2, 128bv32), $$gen_hists.warp_hists[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_MUL(v3$2, 128bv32)]);
    ...
    call {:sourceloc} {:sourceloc_num 66} _LOG_WRITE_$$histograms(p32$1, BV32_ADD(v42$1, v3$1), BV32_ZEXT64(v44$1), $$histograms[BV32_ADD(v42$1, v3$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$histograms(p32$2, BV32_ADD(v42$2, v3$2));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 66} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 66} _CHECK_WRITE_$$histograms(p32$2, BV32_ADD(v42$2, v3$2), BV32_ZEXT64(v44$2));
  ...
  $39:
    ...
    assert {:tag "nowrite"} _b52 ==> !_WRITE_HAS_OCCURRED_$$gen_hists.warp_hists;
    assert {:tag "noread"} _b51 ==> !_READ_HAS_OCCURRED_$$gen_hists.warp_hists;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b50 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_WRITE_HAS_OCCURRED_$$all_x_data;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b49 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$all_x_data;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b18 ==> BV32_UGE($bin_base.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b18 ==> BV32_UGE($bin_base.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b17 ==> BV32_ULE($bin_base.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b17 ==> BV32_ULE($bin_base.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b16 ==> BV32_SGE($bin_base.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b16 ==> BV32_SGE($bin_base.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b15 ==> BV32_SLE($bin_base.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b15 ==> BV32_SLE($bin_base.0, 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b14 ==> BV32_AND(BV32_SUB(4bv32, 1bv32), $bin_base.0) == BV32_AND(BV32_SUB(4bv32, 1bv32), 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b14 ==> BV32_AND(BV32_SUB(4bv32, 1bv32), $bin_base.0) == BV32_AND(BV32_SUB(4bv32, 1bv32), 0bv32);
  ...
  __partitioned_block_$truebb15_1:
    call {:sourceloc_num 52} $bugle_barrier_duplicated_1(1bv1, 1bv1);
    ...
    call {:sourceloc} {:sourceloc_num 55} _LOG_READ_$$gen_hists.warp_hists(p31$1, BV32_ADD(BV32_MUL(BV32_ADD($bin_base.0, v35$1), 128bv32), v34$1), $$gen_hists.warp_hists[1bv1][BV32_ADD(BV32_MUL(BV32_ADD($bin_base.0, v35$1), 128bv32), v34$1)]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 55} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 55} _CHECK_READ_$$gen_hists.warp_hists(p31$2, BV32_ADD(BV32_MUL(BV32_ADD($bin_base.0, v35$2), 128bv32), v34$2), $$gen_hists.warp_hists[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(BV32_ADD($bin_base.0, v35$2), 128bv32), v34$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$gen_hists.warp_hists"} true;
    ...
    call _PRE_WARP_SYNC_$$gen_hists.warp_hists_READ(p31$1, p31$2);
    call {:sourceloc} {:sourceloc_num 56} _LOG_READ_$$gen_hists.warp_hists(p31$1, BV32_ADD(BV32_MUL(BV32_ADD($bin_base.0, v35$1), 128bv32), BV32_ADD(v34$1, $offset.0)), $$gen_hists.warp_hists[1bv1][BV32_ADD(BV32_MUL(BV32_ADD($bin_base.0, v35$1), 128bv32), BV32_ADD(v34$1, $offset.0))]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 56} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 56} _CHECK_READ_$$gen_hists.warp_hists(p31$2, BV32_ADD(BV32_MUL(BV32_ADD($bin_base.0, v35$2), 128bv32), BV32_ADD(v34$2, $offset.0)), $$gen_hists.warp_hists[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(BV32_ADD($bin_base.0, v35$2), 128bv32), BV32_ADD(v34$2, $offset.0))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$gen_hists.warp_hists"} true;
    call _POST_WARP_SYNC_$$gen_hists.warp_hists_READ(p31$1, p31$2);
    ...
    call {:sourceloc} {:sourceloc_num 57} _LOG_WRITE_$$gen_hists.warp_hists(p31$1, BV32_ADD(BV32_MUL(BV32_ADD($bin_base.0, v35$1), 128bv32), v34$1), BV32_ADD(v40$1, v41$1), $$gen_hists.warp_hists[1bv1][BV32_ADD(BV32_MUL(BV32_ADD($bin_base.0, v35$1), 128bv32), v34$1)]);
    ...
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 57} _CHECK_WRITE_$$gen_hists.warp_hists(p31$2, BV32_ADD(BV32_MUL(BV32_ADD($bin_base.0, v35$2), 128bv32), v34$2), BV32_ADD(v40$2, v41$2));
  ...
  $14:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$gen_hists.warp_hists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b24 ==> p6$1 ==> BV32_ULT($j.0, $NUM_ELEMENTS);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b24 ==> p6$2 ==> BV32_ULT($j.0, $NUM_ELEMENTS);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b23 ==> BV32_ULT($j.0, $NUM_ELEMENTS) && BV32_ULT($k.0$1, $NUM_ELEMENTS) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b23 ==> BV32_ULT($j.0, $NUM_ELEMENTS) && BV32_ULT($k.0$2, $NUM_ELEMENTS) ==> p6$2;
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b22 ==> BV32_UGE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b22 ==> BV32_UGE($k.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b21 ==> BV32_ULE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b21 ==> BV32_ULE($k.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b20 ==> BV32_SGE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b20 ==> BV32_SGE($k.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b19 ==> BV32_SLE($k.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b19 ==> BV32_SLE($k.0$2, 0bv32);
  ...
  $21.tail:
    ...
    call {:sourceloc} {:sourceloc_num 42} {:atomic} {:atomic_function "__bugle_atomic_inc_local_uint"} {:parts 1} {:part 1} _LOG_ATOMIC_$$gen_hists.warp_hists(p26$1, BV32_SDIV(BV32_ADD(BV32_MUL(BV32_SUB($max.0$1, 1bv32), 512bv32), BV32_MUL(BV32_UDIV(v3$1, 2bv32), 4bv32)), 4bv32));
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 42} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 42} {:atomic} {:atomic_function "__bugle_atomic_inc_local_uint"} {:parts 1} {:part 1} _CHECK_ATOMIC_$$gen_hists.warp_hists(p26$2, BV32_SDIV(BV32_ADD(BV32_MUL(BV32_SUB($max.0$2, 1bv32), 512bv32), BV32_MUL(BV32_UDIV(v3$2, 2bv32), 4bv32)), 4bv32));
