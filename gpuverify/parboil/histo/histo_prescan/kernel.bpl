...
implementation {:source_name "histo_prescan_kernel"} {:kernel} $histo_prescan_kernel($size: bv32)
{
  ...
  $7:
    ...
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b19 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$histo_prescan_kernel.StdDev;
    assert {:tag "nowrite"} _b18 ==> !_WRITE_HAS_OCCURRED_$$histo_prescan_kernel.StdDev;
    assert {:tag "noread"} _b17 ==> !_READ_HAS_OCCURRED_$$histo_prescan_kernel.StdDev;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b16 ==> _WRITE_HAS_OCCURRED_$$histo_prescan_kernel.Avg ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b15 ==> _READ_HAS_OCCURRED_$$histo_prescan_kernel.Avg ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b14 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_WRITE_HAS_OCCURRED_$$histo_prescan_kernel.Avg;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b13 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$histo_prescan_kernel.Avg;
    assert {:tag "nowrite"} _b12 ==> !_WRITE_HAS_OCCURRED_$$histo_prescan_kernel.Avg;
    assert {:tag "noread"} _b11 ==> !_READ_HAS_OCCURRED_$$histo_prescan_kernel.Avg;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b10 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_WRITE_HAS_OCCURRED_$$minmax;
    ...
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_UGE($stride1.0, 256bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($stride1.0, 256bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_ULE($stride1.0, 256bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($stride1.0, 256bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SGE($stride1.0, 256bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($stride1.0, 256bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SLE($stride1.0, 256bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b0 ==> BV32_SLE(0bv32, $stride1.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b0 ==> BV32_SLE(0bv32, $stride1.0);
