...
implementation {:source_name "histo_main_kernel"} {:kernel} $histo_main_kernel($num_elements: bv32, $sm_range_min: bv32, $sm_range_max: bv32, $histo_height: bv32, $histo_width: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b27 ==> _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1);
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_SLT($i.i.0$1, 6144bv32) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_SLT($i.i.0$2, 6144bv32) ==> p0$2;
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b5 ==> BV32_UGE($i.i.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b5 ==> BV32_UGE($i.i.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b4 ==> BV32_ULE($i.i.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b4 ==> BV32_ULE($i.i.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b3 ==> BV32_SGE($i.i.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b3 ==> BV32_SGE($i.i.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b2 ==> BV32_SLE($i.i.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b2 ==> BV32_SLE($i.i.0$2, local_id_x$2);
    assert {:tag "guardNonNeg"} {:thread 1} p0$1 ==> _b1 ==> BV32_SLE(0bv32, $i.i.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p0$2 ==> _b1 ==> BV32_SLE(0bv32, $i.i.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p0$1 ==> _b0 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.i.0$1) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p0$2 ==> _b0 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.i.0$2) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$2);
  ...
  $4:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p4$1 ==> _b26 ==> p4$1 ==> group_id_y$1 == 0bv32;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p4$2 ==> _b26 ==> p4$2 ==> group_id_y$2 == 0bv32;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b25 ==> group_id_y$1 == 0bv32 && BV32_ULT($local_scan_load.0$1, $num_elements) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b25 ==> group_id_y$2 == 0bv32 && BV32_ULT($local_scan_load.0$2, $num_elements) ==> p4$2;
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b24 ==> BV32_UGE($local_scan_load.0$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b24 ==> BV32_UGE($local_scan_load.0$2, v3$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b23 ==> BV32_ULE($local_scan_load.0$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b23 ==> BV32_ULE($local_scan_load.0$2, v3$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b22 ==> BV32_SGE($local_scan_load.0$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b22 ==> BV32_SGE($local_scan_load.0$2, v3$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b21 ==> BV32_SLE($local_scan_load.0$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b21 ==> BV32_SLE($local_scan_load.0$2, v3$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b20 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $local_scan_load.0$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b20 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $local_scan_load.0$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
  ...
  $36:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b12 ==> BV32_ULT($local_scan_load.1$1, $num_elements) ==> p42$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b12 ==> BV32_ULT($local_scan_load.1$2, $num_elements) ==> p42$2;
    assert {:tag "loopBound"} {:thread 1} p42$1 ==> _b11 ==> BV32_UGE($local_scan_load.1$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p42$2 ==> _b11 ==> BV32_UGE($local_scan_load.1$2, v3$2);
    assert {:tag "loopBound"} {:thread 1} p42$1 ==> _b10 ==> BV32_ULE($local_scan_load.1$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p42$2 ==> _b10 ==> BV32_ULE($local_scan_load.1$2, v3$2);
    assert {:tag "loopBound"} {:thread 1} p42$1 ==> _b9 ==> BV32_SGE($local_scan_load.1$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p42$2 ==> _b9 ==> BV32_SGE($local_scan_load.1$2, v3$2);
    assert {:tag "loopBound"} {:thread 1} p42$1 ==> _b8 ==> BV32_SLE($local_scan_load.1$1, v3$1);
    assert {:tag "loopBound"} {:thread 2} p42$2 ==> _b8 ==> BV32_SLE($local_scan_load.1$2, v3$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p42$1 ==> _b7 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $local_scan_load.1$1) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p42$2 ==> _b7 ==> BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), $local_scan_load.1$2) == BV32_AND(BV32_SUB(BV32_MUL(group_size_x, num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2));
  ...
  $64:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b28 ==> _READ_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1) || BV32_AND(BV32_SUB(group_size_x, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1) || BV32_AND(BV32_SUB(group_size_x, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1) || BV32_AND(BV32_SUB(group_size_x, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histo_main_kernel.sub_histo ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b19 ==> BV32_SLT($i.i28.0$1, 6144bv32) ==> p72$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b19 ==> BV32_SLT($i.i28.0$2, 6144bv32) ==> p72$2;
    assert {:tag "loopBound"} {:thread 1} p72$1 ==> _b18 ==> BV32_UGE($i.i28.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p72$2 ==> _b18 ==> BV32_UGE($i.i28.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p72$1 ==> _b17 ==> BV32_ULE($i.i28.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p72$2 ==> _b17 ==> BV32_ULE($i.i28.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p72$1 ==> _b16 ==> BV32_SGE($i.i28.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p72$2 ==> _b16 ==> BV32_SGE($i.i28.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p72$1 ==> _b15 ==> BV32_SLE($i.i28.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p72$2 ==> _b15 ==> BV32_SLE($i.i28.0$2, local_id_x$2);
    assert {:tag "guardNonNeg"} {:thread 1} p72$1 ==> _b14 ==> BV32_SLE(0bv32, $i.i28.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p72$2 ==> _b14 ==> BV32_SLE(0bv32, $i.i28.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p72$1 ==> _b13 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.i28.0$1) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p72$2 ==> _b13 ==> BV32_AND(BV32_SUB(group_size_x, 1bv32), $i.i28.0$2) == BV32_AND(BV32_SUB(group_size_x, 1bv32), local_id_x$2);
