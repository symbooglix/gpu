...
implementation {:source_name "scan_L1_kernel"} {:kernel} $scan_L1_kernel($n: bv32, $data_offset: bv32, $inter_offset: bv32)
{
  ...
  $7:
    ...
    assert {:tag "accessBreak"} _b49 ==> _WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0));
    assert {:tag "accessBreak"} _b48 ==> _WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0));
    assert {:tag "accessBreak"} _b47 ==> _WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0));
    assert {:tag "accessBreak"} _b46 ==> _WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> local_id_x$1 == BV32_SUB(BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $stride.0), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0)), BV32_DIV(BV32_MUL(local_id_x$1, $stride.0), $stride.0));
    assert {:tag "nowrite"} _b45 ==> !_WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data;
    assert {:tag "noread"} _b44 ==> !_READ_HAS_OCCURRED_$$scan_L1_kernel.s_data;
    assert {:tag "relationalPow2"} _b43 ==> ($d.0 == 0bv32 && $stride.0 == 2bv32) || BV32_MUL($stride.0, $d.0) == 1bv32;
    assert {:tag "relationalPow2"} _b42 ==> BV32_MUL($stride.0, $d.0) == 1bv32;
    assert {:tag "relationalPow2"} _b41 ==> ($d.0 == 0bv32 && $stride.0 == 4bv32) || BV32_MUL($stride.0, $d.0) == 2bv32;
    assert {:tag "relationalPow2"} _b40 ==> BV32_MUL($stride.0, $d.0) == 2bv32;
    assert {:tag "relationalPow2"} _b39 ==> ($d.0 == 0bv32 && $stride.0 == 8bv32) || BV32_MUL($stride.0, $d.0) == 4bv32;
    assert {:tag "relationalPow2"} _b38 ==> BV32_MUL($stride.0, $d.0) == 4bv32;
    assert {:tag "relationalPow2"} _b37 ==> ($d.0 == 0bv32 && $stride.0 == 16bv32) || BV32_MUL($stride.0, $d.0) == 8bv32;
    assert {:tag "relationalPow2"} _b36 ==> BV32_MUL($stride.0, $d.0) == 8bv32;
    assert {:tag "relationalPow2"} _b35 ==> ($d.0 == 0bv32 && $stride.0 == 32bv32) || BV32_MUL($stride.0, $d.0) == 16bv32;
    assert {:tag "relationalPow2"} _b34 ==> BV32_MUL($stride.0, $d.0) == 16bv32;
    assert {:tag "relationalPow2"} _b33 ==> ($d.0 == 0bv32 && $stride.0 == 64bv32) || BV32_MUL($stride.0, $d.0) == 32bv32;
    assert {:tag "relationalPow2"} _b32 ==> BV32_MUL($stride.0, $d.0) == 32bv32;
    assert {:tag "relationalPow2"} _b31 ==> ($d.0 == 0bv32 && $stride.0 == 128bv32) || BV32_MUL($stride.0, $d.0) == 64bv32;
    assert {:tag "relationalPow2"} _b30 ==> BV32_MUL($stride.0, $d.0) == 64bv32;
    assert {:tag "relationalPow2"} _b29 ==> ($d.0 == 0bv32 && $stride.0 == 256bv32) || BV32_MUL($stride.0, $d.0) == 128bv32;
    assert {:tag "relationalPow2"} _b28 ==> BV32_MUL($stride.0, $d.0) == 128bv32;
    assert {:tag "relationalPow2"} _b27 ==> ($d.0 == 0bv32 && $stride.0 == 512bv32) || BV32_MUL($stride.0, $d.0) == 256bv32;
    assert {:tag "relationalPow2"} _b26 ==> BV32_MUL($stride.0, $d.0) == 256bv32;
    assert {:tag "relationalPow2"} _b25 ==> ($d.0 == 0bv32 && $stride.0 == 1024bv32) || BV32_MUL($stride.0, $d.0) == 512bv32;
    assert {:tag "relationalPow2"} _b24 ==> BV32_MUL($stride.0, $d.0) == 512bv32;
    assert {:tag "relationalPow2"} _b23 ==> ($d.0 == 0bv32 && $stride.0 == 2048bv32) || BV32_MUL($stride.0, $d.0) == 1024bv32;
    assert {:tag "relationalPow2"} _b22 ==> BV32_MUL($stride.0, $d.0) == 1024bv32;
    assert {:tag "relationalPow2"} _b21 ==> ($d.0 == 0bv32 && $stride.0 == 4096bv32) || BV32_MUL($stride.0, $d.0) == 2048bv32;
    assert {:tag "relationalPow2"} _b20 ==> BV32_MUL($stride.0, $d.0) == 2048bv32;
    assert {:tag "relationalPow2"} _b19 ==> ($d.0 == 0bv32 && $stride.0 == 8192bv32) || BV32_MUL($stride.0, $d.0) == 4096bv32;
    assert {:tag "relationalPow2"} _b18 ==> BV32_MUL($stride.0, $d.0) == 4096bv32;
    assert {:tag "relationalPow2"} _b17 ==> ($d.0 == 0bv32 && $stride.0 == 16384bv32) || BV32_MUL($stride.0, $d.0) == 8192bv32;
    assert {:tag "relationalPow2"} _b16 ==> BV32_MUL($stride.0, $d.0) == 8192bv32;
    assert {:tag "relationalPow2"} _b15 ==> ($d.0 == 0bv32 && $stride.0 == 32768bv32) || BV32_MUL($stride.0, $d.0) == 16384bv32;
    assert {:tag "relationalPow2"} _b14 ==> BV32_MUL($stride.0, $d.0) == 16384bv32;
    assert {:tag "relationalPow2"} _b13 ==> ($d.0 == 0bv32 && $stride.0 == 65536bv32) || BV32_MUL($stride.0, $d.0) == 32768bv32;
    assert {:tag "relationalPow2"} _b12 ==> BV32_MUL($stride.0, $d.0) == 32768bv32;
    assert {:tag "pow2NotZero"} _b11 ==> $d.0 != 0bv32;
    assert {:tag "pow2"} _b10 ==> $d.0 == 0bv32 || BV32_AND($d.0, BV32_SUB($d.0, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b9 ==> $stride.0 != 0bv32;
    assert {:tag "pow2"} _b8 ==> $stride.0 == 0bv32 || BV32_AND($stride.0, BV32_SUB($stride.0, 1bv32)) == 0bv32;
  ...
  $15:
    ...
    assert {:tag "nowrite"} _b89 ==> !_WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data;
    assert {:tag "noread"} _b88 ==> !_READ_HAS_OCCURRED_$$scan_L1_kernel.s_data;
    assert {:tag "relationalPow2"} _b87 ==> ($stride.1 == 0bv32 && $d1.0 == 2bv32) || BV32_MUL($d1.0, $stride.1) == 1bv32;
    assert {:tag "relationalPow2"} _b86 ==> BV32_MUL($d1.0, $stride.1) == 1bv32;
    assert {:tag "relationalPow2"} _b85 ==> ($stride.1 == 0bv32 && $d1.0 == 4bv32) || BV32_MUL($d1.0, $stride.1) == 2bv32;
    assert {:tag "relationalPow2"} _b84 ==> BV32_MUL($d1.0, $stride.1) == 2bv32;
    assert {:tag "relationalPow2"} _b83 ==> ($stride.1 == 0bv32 && $d1.0 == 8bv32) || BV32_MUL($d1.0, $stride.1) == 4bv32;
    assert {:tag "relationalPow2"} _b82 ==> BV32_MUL($d1.0, $stride.1) == 4bv32;
    assert {:tag "relationalPow2"} _b81 ==> ($stride.1 == 0bv32 && $d1.0 == 16bv32) || BV32_MUL($d1.0, $stride.1) == 8bv32;
    assert {:tag "relationalPow2"} _b80 ==> BV32_MUL($d1.0, $stride.1) == 8bv32;
    assert {:tag "relationalPow2"} _b79 ==> ($stride.1 == 0bv32 && $d1.0 == 32bv32) || BV32_MUL($d1.0, $stride.1) == 16bv32;
    assert {:tag "relationalPow2"} _b78 ==> BV32_MUL($d1.0, $stride.1) == 16bv32;
    assert {:tag "relationalPow2"} _b77 ==> ($stride.1 == 0bv32 && $d1.0 == 64bv32) || BV32_MUL($d1.0, $stride.1) == 32bv32;
    assert {:tag "relationalPow2"} _b76 ==> BV32_MUL($d1.0, $stride.1) == 32bv32;
    assert {:tag "relationalPow2"} _b75 ==> ($stride.1 == 0bv32 && $d1.0 == 128bv32) || BV32_MUL($d1.0, $stride.1) == 64bv32;
    assert {:tag "relationalPow2"} _b74 ==> BV32_MUL($d1.0, $stride.1) == 64bv32;
    assert {:tag "relationalPow2"} _b73 ==> ($stride.1 == 0bv32 && $d1.0 == 256bv32) || BV32_MUL($d1.0, $stride.1) == 128bv32;
    assert {:tag "relationalPow2"} _b72 ==> BV32_MUL($d1.0, $stride.1) == 128bv32;
    assert {:tag "relationalPow2"} _b71 ==> ($stride.1 == 0bv32 && $d1.0 == 512bv32) || BV32_MUL($d1.0, $stride.1) == 256bv32;
    assert {:tag "relationalPow2"} _b70 ==> BV32_MUL($d1.0, $stride.1) == 256bv32;
    assert {:tag "relationalPow2"} _b69 ==> ($stride.1 == 0bv32 && $d1.0 == 1024bv32) || BV32_MUL($d1.0, $stride.1) == 512bv32;
    assert {:tag "relationalPow2"} _b68 ==> BV32_MUL($d1.0, $stride.1) == 512bv32;
    assert {:tag "relationalPow2"} _b67 ==> ($stride.1 == 0bv32 && $d1.0 == 2048bv32) || BV32_MUL($d1.0, $stride.1) == 1024bv32;
    assert {:tag "relationalPow2"} _b66 ==> BV32_MUL($d1.0, $stride.1) == 1024bv32;
    assert {:tag "relationalPow2"} _b65 ==> ($stride.1 == 0bv32 && $d1.0 == 4096bv32) || BV32_MUL($d1.0, $stride.1) == 2048bv32;
    assert {:tag "relationalPow2"} _b64 ==> BV32_MUL($d1.0, $stride.1) == 2048bv32;
    assert {:tag "relationalPow2"} _b63 ==> ($stride.1 == 0bv32 && $d1.0 == 8192bv32) || BV32_MUL($d1.0, $stride.1) == 4096bv32;
    assert {:tag "relationalPow2"} _b62 ==> BV32_MUL($d1.0, $stride.1) == 4096bv32;
    assert {:tag "relationalPow2"} _b61 ==> ($stride.1 == 0bv32 && $d1.0 == 16384bv32) || BV32_MUL($d1.0, $stride.1) == 8192bv32;
    assert {:tag "relationalPow2"} _b60 ==> BV32_MUL($d1.0, $stride.1) == 8192bv32;
    assert {:tag "relationalPow2"} _b59 ==> ($stride.1 == 0bv32 && $d1.0 == 32768bv32) || BV32_MUL($d1.0, $stride.1) == 16384bv32;
    assert {:tag "relationalPow2"} _b58 ==> BV32_MUL($d1.0, $stride.1) == 16384bv32;
    assert {:tag "relationalPow2"} _b57 ==> ($stride.1 == 0bv32 && $d1.0 == 65536bv32) || BV32_MUL($d1.0, $stride.1) == 32768bv32;
    assert {:tag "relationalPow2"} _b56 ==> BV32_MUL($d1.0, $stride.1) == 32768bv32;
    assert {:tag "pow2NotZero"} _b55 ==> v27 != 0bv32;
    assert {:tag "pow2"} _b54 ==> v27 == 0bv32 || BV32_AND(v27, BV32_SUB(v27, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b53 ==> $d1.0 != 0bv32;
    assert {:tag "pow2"} _b52 ==> $d1.0 == 0bv32 || BV32_AND($d1.0, BV32_SUB($d1.0, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b51 ==> $stride.1 != 0bv32;
    assert {:tag "pow2"} _b50 ==> $stride.1 == 0bv32 || BV32_AND($stride.1, BV32_SUB($stride.1, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$scan_L1_kernel.s_data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_UGE($d1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_UGE($d1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_ULE($d1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_ULE($d1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_SGE($d1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b5 ==> BV32_SGE($d1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_SLE($d1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_SLE($d1.0, 1bv32);
