...
implementation {:source_name "scan_inter2_kernel"} {:kernel} $scan_inter2_kernel($iter: bv32)
{
  ...
  $1:
    ...
    assert {:tag "relationalPow2"} _b41 ==> ($stride.0 == 0bv32 && $d.0 == 2bv32) || BV32_MUL($d.0, $stride.0) == 1bv32;
    assert {:tag "relationalPow2"} _b40 ==> BV32_MUL($d.0, $stride.0) == 1bv32;
    assert {:tag "relationalPow2"} _b39 ==> ($stride.0 == 0bv32 && $d.0 == 4bv32) || BV32_MUL($d.0, $stride.0) == 2bv32;
    assert {:tag "relationalPow2"} _b38 ==> BV32_MUL($d.0, $stride.0) == 2bv32;
    assert {:tag "relationalPow2"} _b37 ==> ($stride.0 == 0bv32 && $d.0 == 8bv32) || BV32_MUL($d.0, $stride.0) == 4bv32;
    assert {:tag "relationalPow2"} _b36 ==> BV32_MUL($d.0, $stride.0) == 4bv32;
    assert {:tag "relationalPow2"} _b35 ==> ($stride.0 == 0bv32 && $d.0 == 16bv32) || BV32_MUL($d.0, $stride.0) == 8bv32;
    assert {:tag "relationalPow2"} _b34 ==> BV32_MUL($d.0, $stride.0) == 8bv32;
    assert {:tag "relationalPow2"} _b33 ==> ($stride.0 == 0bv32 && $d.0 == 32bv32) || BV32_MUL($d.0, $stride.0) == 16bv32;
    assert {:tag "relationalPow2"} _b32 ==> BV32_MUL($d.0, $stride.0) == 16bv32;
    assert {:tag "relationalPow2"} _b31 ==> ($stride.0 == 0bv32 && $d.0 == 64bv32) || BV32_MUL($d.0, $stride.0) == 32bv32;
    assert {:tag "relationalPow2"} _b30 ==> BV32_MUL($d.0, $stride.0) == 32bv32;
    assert {:tag "relationalPow2"} _b29 ==> ($stride.0 == 0bv32 && $d.0 == 128bv32) || BV32_MUL($d.0, $stride.0) == 64bv32;
    assert {:tag "relationalPow2"} _b28 ==> BV32_MUL($d.0, $stride.0) == 64bv32;
    assert {:tag "relationalPow2"} _b27 ==> ($stride.0 == 0bv32 && $d.0 == 256bv32) || BV32_MUL($d.0, $stride.0) == 128bv32;
    assert {:tag "relationalPow2"} _b26 ==> BV32_MUL($d.0, $stride.0) == 128bv32;
    assert {:tag "relationalPow2"} _b25 ==> ($stride.0 == 0bv32 && $d.0 == 512bv32) || BV32_MUL($d.0, $stride.0) == 256bv32;
    assert {:tag "relationalPow2"} _b24 ==> BV32_MUL($d.0, $stride.0) == 256bv32;
    assert {:tag "relationalPow2"} _b23 ==> ($stride.0 == 0bv32 && $d.0 == 1024bv32) || BV32_MUL($d.0, $stride.0) == 512bv32;
    assert {:tag "relationalPow2"} _b22 ==> BV32_MUL($d.0, $stride.0) == 512bv32;
    assert {:tag "relationalPow2"} _b21 ==> ($stride.0 == 0bv32 && $d.0 == 2048bv32) || BV32_MUL($d.0, $stride.0) == 1024bv32;
    assert {:tag "relationalPow2"} _b20 ==> BV32_MUL($d.0, $stride.0) == 1024bv32;
    assert {:tag "relationalPow2"} _b19 ==> ($stride.0 == 0bv32 && $d.0 == 4096bv32) || BV32_MUL($d.0, $stride.0) == 2048bv32;
    assert {:tag "relationalPow2"} _b18 ==> BV32_MUL($d.0, $stride.0) == 2048bv32;
    assert {:tag "relationalPow2"} _b17 ==> ($stride.0 == 0bv32 && $d.0 == 8192bv32) || BV32_MUL($d.0, $stride.0) == 4096bv32;
    assert {:tag "relationalPow2"} _b16 ==> BV32_MUL($d.0, $stride.0) == 4096bv32;
    assert {:tag "relationalPow2"} _b15 ==> ($stride.0 == 0bv32 && $d.0 == 16384bv32) || BV32_MUL($d.0, $stride.0) == 8192bv32;
    assert {:tag "relationalPow2"} _b14 ==> BV32_MUL($d.0, $stride.0) == 8192bv32;
    assert {:tag "relationalPow2"} _b13 ==> ($stride.0 == 0bv32 && $d.0 == 32768bv32) || BV32_MUL($d.0, $stride.0) == 16384bv32;
    assert {:tag "relationalPow2"} _b12 ==> BV32_MUL($d.0, $stride.0) == 16384bv32;
    assert {:tag "relationalPow2"} _b11 ==> ($stride.0 == 0bv32 && $d.0 == 65536bv32) || BV32_MUL($d.0, $stride.0) == 32768bv32;
    assert {:tag "relationalPow2"} _b10 ==> BV32_MUL($d.0, $stride.0) == 32768bv32;
    assert {:tag "pow2NotZero"} _b9 ==> v13 != 0bv32;
    assert {:tag "pow2"} _b8 ==> v13 == 0bv32 || BV32_AND(v13, BV32_SUB(v13, 1bv32)) == 0bv32;
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($d.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_UGE($d.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($d.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_ULE($d.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($d.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SGE($d.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($d.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b0 ==> BV32_SLE($d.0, 1bv32);
