...
implementation {:source_name "larger_sad_calc_8"} {:kernel} $larger_sad_calc_8($mb_width: bv32, $mb_height: bv32)
{
  ...
  $3:
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_SLT($search_pos.0$2, 545bv32) ==> p2$2;
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b5 ==> BV32_UGE($search_pos.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b5 ==> BV32_UGE($search_pos.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b4 ==> BV32_ULE($search_pos.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b4 ==> BV32_ULE($search_pos.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b3 ==> BV32_SGE($search_pos.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b3 ==> BV32_SGE($search_pos.0$2, local_id_x$2);
    assert {:tag "loopBound"} {:thread 1} p2$1 ==> _b2 ==> BV32_SLE($search_pos.0$1, local_id_x$1);
    assert {:tag "loopBound"} {:thread 2} p2$2 ==> _b2 ==> BV32_SLE($search_pos.0$2, local_id_x$2);
    assert {:tag "guardNonNeg"} {:thread 1} p2$1 ==> _b1 ==> BV32_SLE(0bv32, $search_pos.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p2$2 ==> _b1 ==> BV32_SLE(0bv32, $search_pos.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p2$1 ==> _b0 ==> BV32_AND(BV32_SUB(32bv32, 1bv32), $search_pos.0$1) == BV32_AND(BV32_SUB(32bv32, 1bv32), local_id_x$1);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p2$2 ==> _b0 ==> BV32_AND(BV32_SUB(32bv32, 1bv32), $search_pos.0$2) == BV32_AND(BV32_SUB(32bv32, 1bv32), local_id_x$2);
