...
var {:source_name "g_partQ"} {:global} $$g_partQ: [bv32]bv32;
...
procedure {:source_name "partial_get_kernel3d"} {:kernel} $_Z20partial_get_kernel3diPiPf($Ntotal: bv32);
...
implementation {:source_name "partial_get_kernel3d"} {:kernel} $_Z20partial_get_kernel3diPiPf($Ntotal: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bool;
  ...
  $0:
    ...
    v14$1 := (if p0$1 then _HAVOC_bv32$1 else v14$1);
    v14$2 := (if p0$2 then _HAVOC_bv32$2 else v14$2);
    v15$1 := (if p0$1 then $$0$0bv32$1 else v15$1);
    v15$2 := (if p0$2 then $$0$0bv32$2 else v15$2);
    v16$1 := (if p0$1 then $$0$1bv32$1 else v16$1);
    v16$2 := (if p0$2 then $$0$1bv32$2 else v16$2);
    v17$1 := (if p0$1 then $$0$2bv32$1 else v17$1);
    v17$2 := (if p0$2 then $$0$2bv32$2 else v17$2);
    v18$1 := (if p0$1 then $$0$3bv32$1 else v18$1);
    v18$2 := (if p0$2 then $$0$3bv32$2 else v18$2);
    v19$1 := (if p0$1 then $$0$4bv32$1 else v19$1);
    v19$2 := (if p0$2 then $$0$4bv32$2 else v19$2);
    v20$1 := (if p0$1 then $$0$5bv32$1 else v20$1);
    v20$2 := (if p0$2 then $$0$5bv32$2 else v20$2);
    v21$1 := (if p0$1 then $$0$6bv32$1 else v21$1);
    v21$2 := (if p0$2 then $$0$6bv32$2 else v21$2);
    v22$1 := (if p0$1 then $$0$7bv32$1 else v22$1);
    v22$2 := (if p0$2 then $$0$7bv32$2 else v22$2);
    v23$1 := (if p0$1 then $$0$8bv32$1 else v23$1);
    v23$2 := (if p0$2 then $$0$8bv32$2 else v23$2);
    v24$1 := (if p0$1 then $$0$9bv32$1 else v24$1);
    v24$2 := (if p0$2 then $$0$9bv32$2 else v24$2);
    v25$1 := (if p0$1 then $$0$10bv32$1 else v25$1);
    v25$2 := (if p0$2 then $$0$10bv32$2 else v25$2);
    v26$1 := (if p0$1 then $$0$11bv32$1 else v26$1);
    v26$2 := (if p0$2 then $$0$11bv32$2 else v26$2);
    call {:sourceloc_num 39} v27$1, v27$2 := $_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(p0$1, v18$1 ++ v17$1 ++ v16$1 ++ v15$1, v22$1 ++ v21$1 ++ v20$1 ++ v19$1, v26$1 ++ v25$1 ++ v24$1 ++ v23$1, v14$1, p0$2, v18$2 ++ v17$2 ++ v16$2 ++ v15$2, v22$2 ++ v21$2 ++ v20$2 ++ v19$2, v26$2 ++ v25$2 ++ v24$2 ++ v23$2, v14$2);
...
const _WATCHED_VALUE_$$g_index: bv32;

procedure {:inline 1} _LOG_READ_$$g_index(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$g_index;



implementation {:inline 1} _LOG_READ_$$g_index(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$g_index(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$g_index(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$g_index, _WRITE_READ_BENIGN_FLAG_$$g_index;



implementation {:inline 1} _LOG_WRITE_$$g_index(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$g_index(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$g_index(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$g_index;



implementation {:inline 1} _LOG_ATOMIC_$$g_index(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$g_index(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$g_index(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$g_index;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$g_index(_P: bool, _offset: bv32)
{
...
const _WATCHED_VALUE_$$g_partQ: bv32;

procedure {:inline 1} _LOG_READ_$$g_partQ(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$g_partQ;



implementation {:inline 1} _LOG_READ_$$g_partQ(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$g_partQ(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$g_partQ(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$g_partQ, _WRITE_READ_BENIGN_FLAG_$$g_partQ;



implementation {:inline 1} _LOG_WRITE_$$g_partQ(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$g_partQ(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$g_partQ(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$g_partQ;



implementation {:inline 1} _LOG_ATOMIC_$$g_partQ(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$g_partQ(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$g_partQ(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$g_partQ;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$g_partQ(_P: bool, _offset: bv32)
{
