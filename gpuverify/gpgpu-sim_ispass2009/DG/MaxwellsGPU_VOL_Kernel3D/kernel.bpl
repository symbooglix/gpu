...
implementation {:source_name "MaxwellsGPU_VOL_Kernel3D"} {:kernel} $_Z24MaxwellsGPU_VOL_Kernel3DPf()
{
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b5 ==> _READ_HAS_OCCURRED_$$_ZZ24MaxwellsGPU_VOL_Kernel3DPfE3s_Q ==> BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), 0bv32) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 96bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 192bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 288bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 384bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 480bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 1bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 97bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 193bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 289bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 385bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 481bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 2bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 98bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 194bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 290bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 386bv32)) || BV32_AND(BV32_SUB(3bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(3bv32, 1bv32), BV32_ADD(0bv32, 482bv32));
    ...
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_UGE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_ULE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SGE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($m.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SLE($m.0, 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> BV32_AND(BV32_SUB(3bv32, 1bv32), $m.0) == BV32_AND(BV32_SUB(3bv32, 1bv32), 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> BV32_AND(BV32_SUB(3bv32, 1bv32), $m.0) == BV32_AND(BV32_SUB(3bv32, 1bv32), 0bv32);
