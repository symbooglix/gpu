...
var {:source_name "primary_block_buffer"} {:group_shared} $$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer: [bv1][bv32]bv32;
...
var {:source_name "curr_block_buffer"} {:group_shared} $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer: [bv1][bv32]bv32;
...
implementation {:source_name "transitive_closure_stage2_kernel"} {:kernel} $_Z32transitive_closure_stage2_kernelPji($passnum: bv32)
{
  ...
  $0:
    call {:sourceloc} {:sourceloc_num 1} _LOG_READ_$$graph(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL($passnum, 8bv32), local_id_y$1), 64bv32), BV32_ADD(BV32_MUL($passnum, 8bv32), local_id_x$1)), $$graph[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL($passnum, 8bv32), local_id_y$1), 64bv32), BV32_ADD(BV32_MUL($passnum, 8bv32), local_id_x$1))]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 1} _CHECK_READ_$$graph(true, BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL($passnum, 8bv32), local_id_y$2), 64bv32), BV32_ADD(BV32_MUL($passnum, 8bv32), local_id_x$2)), $$graph[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL($passnum, 8bv32), local_id_y$2), 64bv32), BV32_ADD(BV32_MUL($passnum, 8bv32), local_id_x$2))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$graph"} true;
    v0$1 := $$graph[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL($passnum, 8bv32), local_id_y$1), 64bv32), BV32_ADD(BV32_MUL($passnum, 8bv32), local_id_x$1))];
    v0$2 := $$graph[BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL($passnum, 8bv32), local_id_y$2), 64bv32), BV32_ADD(BV32_MUL($passnum, 8bv32), local_id_x$2))];
    call {:sourceloc} {:sourceloc_num 2} _LOG_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), v0$1, $$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 2} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 2} _CHECK_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2), v0$2);
    ...
    $$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)] := v0$1;
    $$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)] := v0$2;
    v1$1 := group_id_y$1 == 0bv32;
    v1$2 := group_id_y$2 == 0bv32;
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
    ...
    $group_id1.0$1 := (if p2$1 then BV32_ADD(group_id_x$1, 1bv32) else $group_id1.0$1);
    $group_id1.0$2 := (if p2$2 then BV32_ADD(group_id_x$2, 1bv32) else $group_id1.0$2);
    ...
    $group_id0.0$1 := (if p5$1 then BV32_ADD(group_id_x$1, 1bv32) else $group_id0.0$1);
    $group_id0.0$2 := (if p5$2 then BV32_ADD(group_id_x$2, 1bv32) else $group_id0.0$2);
    ...
    v4$1 := BV32_ADD(BV32_MUL($group_id0.1$1, 8bv32), local_id_y$1);
    v4$2 := BV32_ADD(BV32_MUL($group_id0.1$2, 8bv32), local_id_y$2);
    v5$1 := BV32_ADD(BV32_MUL($group_id1.1$1, 8bv32), local_id_x$1);
    v5$2 := BV32_ADD(BV32_MUL($group_id1.1$2, 8bv32), local_id_x$2);
    ...
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 11} _CHECK_READ_$$graph(true, BV32_ADD(BV32_MUL(v4$2, 64bv32), v5$2), $$graph[BV32_ADD(BV32_MUL(v4$2, 64bv32), v5$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$graph"} true;
    v6$1 := $$graph[BV32_ADD(BV32_MUL(v4$1, 64bv32), v5$1)];
    v6$2 := $$graph[BV32_ADD(BV32_MUL(v4$2, 64bv32), v5$2)];
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), v6$1, $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2), v6$2);
    ...
    $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)] := v6$1;
    $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)] := v6$2;
    $k.0 := 0bv32;
  ...
  $10:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b9 ==> _WRITE_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 8bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 8bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 8bv32), local_id_x$1));
    assert {:tag "nowrite"} _b7 ==> !_WRITE_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer;
    assert {:tag "noread"} _b6 ==> !_READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b5 ==> _READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 8bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 8bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 8bv32), local_id_x$1));
    assert {:tag "noread"} _b4 ==> !_READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer;
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_UGE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_ULE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SGE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b0 ==> BV32_SLE($k.0, 0bv32);
  ...
  $falsebb2:
    ...
    call {:sourceloc} {:sourceloc_num 35} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 35} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 35} _CHECK_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)]);
    ...
    v19$1 := $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)];
    v19$2 := $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)];
    call {:sourceloc} {:sourceloc_num 36} _LOG_WRITE_$$graph(true, BV32_ADD(BV32_MUL(v4$1, 64bv32), v5$1), v19$1, $$graph[BV32_ADD(BV32_MUL(v4$1, 64bv32), v5$1)]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 36} _CHECK_WRITE_$$graph(true, BV32_ADD(BV32_MUL(v4$2, 64bv32), v5$2), v19$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$graph"} true;
    $$graph[BV32_ADD(BV32_MUL(v4$1, 64bv32), v5$1)] := v19$1;
    $$graph[BV32_ADD(BV32_MUL(v4$2, 64bv32), v5$2)] := v19$2;
    return;

  __partitioned_block_$truebb2_0:
    assume {:partition} v7 && v7;
    call {:sourceloc} {:sourceloc_num 15} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 15} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 15} _CHECK_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer"} true;
    v8$1 := $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)];
    v8$2 := $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)];
    v9$1 := v8$1 == 0bv32;
    v9$2 := v8$2 == 0bv32;
    p7$1 := (if v9$1 then v9$1 else p7$1);
    p7$2 := (if v9$2 then v9$2 else p7$2);
    v10$1 := (if p7$1 then group_id_y$1 == 0bv32 else v10$1);
    v10$2 := (if p7$2 then group_id_y$2 == 0bv32 else v10$2);
    ...
    call {:sourceloc} {:sourceloc_num 18} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(p8$1, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), $k.0), $$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), $k.0)]);
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 18} true;
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 18} _CHECK_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(p8$2, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), $k.0), $$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), $k.0)]);
    ...
    v12$2 := (if p8$2 then v11$2 != 0bv32 else v12$2);
    p10$1 := (if p8$1 && v12$1 then v12$1 else p10$1);
    p10$2 := (if p8$2 && v12$2 then v12$2 else p10$2);
    call {:sourceloc} {:sourceloc_num 20} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p10$1, BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$1), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 20} true;
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 20} _CHECK_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p10$2, BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$2), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer"} true;
    v13$1 := (if p10$1 then $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$1)] else v13$1);
    v13$2 := (if p10$2 then $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$2)] else v13$2);
    v14$1 := (if p10$1 then v13$1 != 0bv32 else v14$1);
    v14$2 := (if p10$2 then v13$2 != 0bv32 else v14$2);
    p12$1 := (if p10$1 && v14$1 then v14$1 else p12$1);
    p12$2 := (if p10$2 && v14$2 then v14$2 else p12$2);
    call {:sourceloc} {:sourceloc_num 22} _LOG_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p12$1, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p12$2, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_12"} {:captureState "check_state_12"} {:sourceloc} {:sourceloc_num 22} true;
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 22} _CHECK_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p12$2, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2), BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer"} true;
    $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)] := (if p12$1 then BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32) else $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)] := (if p12$2 then BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32) else $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)]);
    call {:sourceloc} {:sourceloc_num 25} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p13$1, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), $k.0), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), $k.0)]);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 25} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 25} _CHECK_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p13$2, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), $k.0), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), $k.0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer"} true;
    v15$1 := (if p13$1 then $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), $k.0)] else v15$1);
    v15$2 := (if p13$2 then $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), $k.0)] else v15$2);
    v16$1 := (if p13$1 then v15$1 != 0bv32 else v16$1);
    ...
    call {:sourceloc} {:sourceloc_num 27} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(p15$1, BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$1), $$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer[1bv1][BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_8"} {:captureState "check_state_8"} {:sourceloc} {:sourceloc_num 27} true;
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 27} _CHECK_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(p15$2, BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$2), $$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer"} true;
    ...
    v18$2 := (if p15$2 then v17$2 != 0bv32 else v18$2);
    p17$1 := (if p15$1 && v18$1 then v18$1 else p17$1);
    p17$2 := (if p15$2 && v18$2 then v18$2 else p17$2);
    call {:sourceloc} {:sourceloc_num 29} _LOG_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p17$1, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p17$2, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 29} _CHECK_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p17$2, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2), BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer"} true;
    $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)] := (if p17$1 then BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32) else $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)] := (if p17$2 then BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32) else $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)]);
...
const _WATCHED_VALUE_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer: bv32;

procedure {:inline 1} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer;



implementation {:inline 1} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(_P: bool, _offset: bv32);
  requires {:source_name "primary_block_buffer"} {:array "$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer"} {:race} {:write_atomic} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "primary_block_buffer"} {:array "$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer"} {:race} {:read_atomic} !(_P && _READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);



procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer(_P: bool, _offset: bv32)
{
...
const _WATCHED_VALUE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer: bv32;

procedure {:inline 1} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer;



implementation {:inline 1} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(_P: bool, _offset: bv32, _value: bv32)
{
...
procedure _CHECK_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
...
procedure _CHECK_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(_P: bool, _offset: bv32, _value: bv32);
...
procedure {:inline 1} _LOG_ATOMIC_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(_P: bool, _offset: bv32)
{
...
procedure _CHECK_ATOMIC_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(_P: bool, _offset: bv32);
...
procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(_P: bool, _offset: bv32)
{
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon0:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer;
    assume $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer;
    assume $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE20primary_block_buffer;
    goto anon1;

  anon1:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer;
    assume $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer;
    assume $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer;
    goto anon2;
