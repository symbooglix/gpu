...
implementation {:source_name "transitive_closure_stage2_kernel"} {:kernel} $_Z32transitive_closure_stage2_kernelPji($passnum: bv32)
{
  ...
  __partitioned_block_$0_1:
    call {:sourceloc_num 13} $bugle_barrier_duplicated_0(1bv1, 1bv1);
    $k.0 := 0bv32;
  ...
  $falsebb2:
    ...
    call {:sourceloc} {:sourceloc_num 36} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    ...
    call {:sourceloc} {:sourceloc_num 37} _LOG_WRITE_$$graph(true, BV32_ADD(BV32_MUL(v4$1, 64bv32), v5$1), v19$1, $$graph[BV32_ADD(BV32_MUL(v4$1, 64bv32), v5$1)]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 37} _CHECK_WRITE_$$graph(true, BV32_ADD(BV32_MUL(v4$2, 64bv32), v5$2), v19$2);
  ...
  __partitioned_block_$truebb2_0:
    assume {:partition} v7 && v7;
    call {:sourceloc} {:sourceloc_num 16} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    ...
    call {:sourceloc} {:sourceloc_num 21} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p10$1, BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$1), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$1)]);
    ...
    call {:sourceloc} {:sourceloc_num 23} _LOG_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p12$1, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    ...
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 23} _CHECK_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p12$2, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2), BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer"} true;
    ...
    call {:sourceloc} {:sourceloc_num 26} _LOG_READ_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p13$1, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), $k.0), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), $k.0)]);
    ...
    call {:sourceloc} {:sourceloc_num 30} _LOG_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p17$1, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32), $$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    ...
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 30} _CHECK_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer(p17$2, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2), BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ32transitive_closure_stage2_kernelPjiE17curr_block_buffer"} true;
