...
implementation {:source_name "transitive_closure_stage3_kernel"} {:kernel} $_Z32transitive_closure_stage3_kernelPji($passnum: bv32)
{
  ...
  $7:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b11 ==> _WRITE_HAS_OCCURRED_$$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b10 ==> _READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1);
    assert {:tag "nowrite"} _b9 ==> !_WRITE_HAS_OCCURRED_$$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer;
    assert {:tag "noread"} _b8 ==> !_READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b7 ==> _READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage3_kernelPjiE9shBuffer2 ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 8bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 8bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 8bv32), local_id_x$1));
    assert {:tag "noread"} _b6 ==> !_READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage3_kernelPjiE9shBuffer2;
    assert {:tag "accessBreak"} _b5 ==> _READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage3_kernelPjiE9shbuffer1 ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 8bv32);
    assert {:tag "noread"} _b4 ==> !_READ_HAS_OCCURRED_$$_ZZ32transitive_closure_stage3_kernelPjiE9shbuffer1;
  ...
  $falsebb1:
    ...
    call {:sourceloc} {:sourceloc_num 28} _LOG_READ_$$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), $$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    ...
    call {:sourceloc} {:sourceloc_num 29} _LOG_WRITE_$$graph(true, BV32_ADD(BV32_MUL(v4$1, 64bv32), v5$1), v14$1, $$graph[BV32_ADD(BV32_MUL(v4$1, 64bv32), v5$1)]);
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 29} _CHECK_WRITE_$$graph(true, BV32_ADD(BV32_MUL(v4$2, 64bv32), v5$2), v14$2);
  ...
  __partitioned_block_$truebb1_0:
    assume {:partition} v7 && v7;
    call {:sourceloc} {:sourceloc_num 16} _LOG_READ_$$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1), $$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_8"} {:captureState "check_state_8"} {:sourceloc} {:sourceloc_num 16} true;
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 16} _CHECK_READ_$$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer(true, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2), $$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer"} true;
    ...
    call {:sourceloc} {:sourceloc_num 18} _LOG_READ_$$_ZZ32transitive_closure_stage3_kernelPjiE9shbuffer1(p5$1, BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), $k.0), $$_ZZ32transitive_closure_stage3_kernelPjiE9shbuffer1[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), $k.0)]);
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 18} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 18} _CHECK_READ_$$_ZZ32transitive_closure_stage3_kernelPjiE9shbuffer1(p5$2, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), $k.0), $$_ZZ32transitive_closure_stage3_kernelPjiE9shbuffer1[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), $k.0)]);
    ...
    call {:sourceloc} {:sourceloc_num 20} _LOG_READ_$$_ZZ32transitive_closure_stage3_kernelPjiE9shBuffer2(p7$1, BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$1), $$_ZZ32transitive_closure_stage3_kernelPjiE9shBuffer2[1bv1][BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 20} true;
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 20} _CHECK_READ_$$_ZZ32transitive_closure_stage3_kernelPjiE9shBuffer2(p7$2, BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$2), $$_ZZ32transitive_closure_stage3_kernelPjiE9shBuffer2[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL($k.0, 8bv32), local_id_x$2)]);
    ...
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 22} _CHECK_WRITE_$$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer(p9$2, BV32_ADD(BV32_MUL(local_id_y$2, 8bv32), local_id_x$2), BV32_ADD(BV32_ADD(BV32_MUL($passnum, 8bv32), $k.0), 2bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ32transitive_closure_stage3_kernelPjiE17curr_block_buffer"} true;
