...
implementation {:source_name "histo_merge_kernel"} {:kernel} $_Z18histo_merge_kernelPjS_()
{
  ...
  $5:
    ...
    assert {:tag "nowrite"} _b8 ==> !_WRITE_HAS_OCCURRED_$$_ZZ18histo_merge_kernelPjS_E6s_data;
    assert {:tag "noread"} _b7 ==> !_READ_HAS_OCCURRED_$$_ZZ18histo_merge_kernelPjS_E6s_data;
    assert {:tag "pow2NotZero"} _b6 ==> $stride.0 != 0bv32;
    assert {:tag "pow2"} _b5 ==> $stride.0 == 0bv32 || BV32_AND($stride.0, BV32_SUB($stride.0, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ18histo_merge_kernelPjS_E6s_data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ18histo_merge_kernelPjS_E6s_data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ18histo_merge_kernelPjS_E6s_data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_UGE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_UGE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_ULE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SGE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SLE($stride.0, 128bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b0 ==> BV32_SLE(0bv32, $stride.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b0 ==> BV32_SLE(0bv32, $stride.0);
  ...
  $falsebb0:
    ...
    call {:sourceloc} {:sourceloc_num 18} _LOG_READ_$$_ZZ18histo_merge_kernelPjS_E6s_data(p5$1, 0bv32, $$_ZZ18histo_merge_kernelPjS_E6s_data[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 18} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 18} _CHECK_READ_$$_ZZ18histo_merge_kernelPjS_E6s_data(p5$2, 0bv32, $$_ZZ18histo_merge_kernelPjS_E6s_data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon0:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$_ZZ18histo_merge_kernelPjS_E6s_data;
    assume $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$_ZZ18histo_merge_kernelPjS_E6s_data;
    assume $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ18histo_merge_kernelPjS_E6s_data;
    goto anon1;
  ...
  anon3:
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0bv1 ==> !_READ_HAS_OCCURRED_$$histogram_amp;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$histogram_amp;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> $1 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$histogram_amp;
    goto anon4;
