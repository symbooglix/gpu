...
implementation {:source_name "box_muller_kernel"} {:kernel} $_Z17box_muller_kernelPfS_i($n_per_RNG: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessBreak"} _b12 ==> _READ_HAS_OCCURRED_$$normalized_random_nums ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, group_size_x);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b11 ==> _WRITE_HAS_OCCURRED_$$normalized_random_nums ==> BV32_AND(BV32_SUB(BV32_MUL(2bv32, 4096bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(2bv32, 4096bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4096bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) || BV32_AND(BV32_SUB(BV32_MUL(2bv32, 4096bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(2bv32, 4096bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, 1bv32), 4096bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1))) || BV32_AND(BV32_SUB(BV32_MUL(2bv32, 4096bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(2bv32, 4096bv32), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(0bv32, 4096bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 1bv32));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b10 ==> _READ_HAS_OCCURRED_$$normalized_random_nums ==> BV32_AND(BV32_SUB(BV32_MUL(2bv32, 4096bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(2bv32, 4096bv32), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(0bv32, 4096bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 1bv32));
    ...
    assert {:tag "accessLowerBoundBlock"} _b8 ==> _WRITE_HAS_OCCURRED_$$normalized_random_nums ==> BV32_SLE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), _WATCHED_OFFSET);
    assert {:tag "accessUpperBoundBlock"} _b7 ==> _WRITE_HAS_OCCURRED_$$normalized_random_nums ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1));
    assert {:tag "accessLowerBoundBlock"} _b6 ==> _WRITE_HAS_OCCURRED_$$normalized_random_nums ==> BV32_SLE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), _WATCHED_OFFSET);
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_UGE($out.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b5 ==> BV32_UGE($out.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_ULE($out.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_ULE($out.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_SGE($out.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_SGE($out.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SLE($out.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SLE($out.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b1 ==> BV32_SLE(0bv32, $out.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b1 ==> BV32_SLE(0bv32, $out.0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> BV32_AND(BV32_SUB(2bv32, 1bv32), $out.0) == BV32_AND(BV32_SUB(2bv32, 1bv32), 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> BV32_AND(BV32_SUB(2bv32, 1bv32), $out.0) == BV32_AND(BV32_SUB(2bv32, 1bv32), 0bv32);
