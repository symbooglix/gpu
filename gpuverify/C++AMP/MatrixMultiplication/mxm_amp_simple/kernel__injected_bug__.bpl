...
procedure {:source_name "mxm_amp_simple"} {:kernel} $_Z14mxm_amp_simplePKfS0_Pf();
  ...
  modifies _WRITE_HAS_OCCURRED_$$vresult, _WRITE_READ_BENIGN_FLAG_$$vresult, _WRITE_READ_BENIGN_FLAG_$$vresult, _READ_HAS_OCCURRED_$$vresult;
...
implementation {:source_name "mxm_amp_simple"} {:kernel} $_Z14mxm_amp_simplePKfS0_Pf()
{
  ...
  $falsebb:
    ...
    call {:sourceloc} {:sourceloc_num 8} _LOG_READ_$$vresult(true, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 256bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 1bv32), $$vresult[BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 256bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 8} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 8} _CHECK_READ_$$vresult(true, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 256bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 1bv32), $$vresult[BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 256bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$vresult"} true;
    v3$1 := $$vresult[BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 256bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 1bv32)];
    v3$2 := $$vresult[BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 256bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 1bv32)];
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$vresult(true, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 256bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 1bv32), v3$1, $$vresult[BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 256bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 1bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$vresult(true, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 256bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 1bv32));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$vresult(true, BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 256bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 1bv32), v3$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$vresult"} true;
    $$vresult[BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1), 256bv32), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)), 1bv32)] := v3$1;
    $$vresult[BV32_ADD(BV32_ADD(BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$2, group_size_y), local_id_y$2), 256bv32), BV32_ADD(BV32_MUL(group_id_x$2, group_size_x), local_id_x$2)), 1bv32)] := v3$2;
    return;
