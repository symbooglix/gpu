...
procedure {:source_name "mxm_amp_tiled"} {:kernel} $_Z13mxm_amp_tiledPKfS0_Pf();
  ...
  modifies $$_ZZ13mxm_amp_tiledPKfS0_PfE6localA, $$_ZZ13mxm_amp_tiledPKfS0_PfE6localB, _WRITE_HAS_OCCURRED_$$vresult, _WRITE_READ_BENIGN_FLAG_$$vresult, _WRITE_READ_BENIGN_FLAG_$$vresult, _WRITE_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA, _WRITE_READ_BENIGN_FLAG_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA, _WRITE_READ_BENIGN_FLAG_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA, _WRITE_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB, _WRITE_READ_BENIGN_FLAG_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB, _WRITE_READ_BENIGN_FLAG_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB, $$vresult, _TRACKING, _READ_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA, _READ_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB;
...
implementation {:source_name "mxm_amp_tiled"} {:kernel} $_Z13mxm_amp_tiledPKfS0_Pf()
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b17 ==> _WRITE_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16bv32), local_id_x$1);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b16 ==> _READ_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 16bv32), local_id_x$1));
    assert {:tag "nowrite"} _b15 ==> !_WRITE_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB;
    assert {:tag "noread"} _b14 ==> !_READ_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB;
    assert {:tag "accessBreak"} _b13 ==> _READ_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 16bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b12 ==> _WRITE_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_y$1, 16bv32), local_id_x$1);
    assert {:tag "nowrite"} _b11 ==> !_WRITE_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA;
    assert {:tag "noread"} _b10 ==> !_READ_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA;
    ...
    assert {:tag "loopBound"} {:thread 2} _b5 ==> BV32_UGE($i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_ULE($i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_ULE($i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_SGE($i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_SGE($i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SLE($i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SLE($i.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b1 ==> BV32_SLE(0bv32, $i.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b1 ==> BV32_SLE(0bv32, $i.0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> BV32_AND(BV32_SUB(16bv32, 1bv32), $i.0) == BV32_AND(BV32_SUB(16bv32, 1bv32), 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> BV32_AND(BV32_SUB(16bv32, 1bv32), $i.0) == BV32_AND(BV32_SUB(16bv32, 1bv32), 0bv32);
  ...
  $falsebb:
    ...
    call {:sourceloc} {:sourceloc_num 16} _LOG_WRITE_$$vresult(true, BV32_ADD(BV32_MUL(v1$1, 256bv32), v0$1), $temp_c.0$1, $$vresult[BV32_ADD(BV32_MUL(v1$1, 256bv32), v0$1)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 16} _CHECK_WRITE_$$vresult(true, BV32_ADD(BV32_MUL(v1$2, 256bv32), v0$2), $temp_c.0$2);
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b19 ==> _READ_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 16bv32), local_id_x$1));
    assert {:tag "accessBreak"} _b18 ==> _READ_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 16bv32);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_UGE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b9 ==> BV32_UGE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b8 ==> BV32_ULE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_SGE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($k.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_SLE($k.0, 0bv32);
  ...
  $truebb0:
    assume {:partition} v5 && v5;
    call {:sourceloc} {:sourceloc_num 9} _LOG_READ_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA(true, BV32_ADD(BV32_MUL(local_id_y$1, 16bv32), $k.0), $$_ZZ13mxm_amp_tiledPKfS0_PfE6localA[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 16bv32), $k.0)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 9} _CHECK_READ_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA(true, BV32_ADD(BV32_MUL(local_id_y$2, 16bv32), $k.0), $$_ZZ13mxm_amp_tiledPKfS0_PfE6localA[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 16bv32), $k.0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localA"} true;
    ...
    call {:sourceloc} {:sourceloc_num 10} _LOG_READ_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB(true, BV32_ADD(BV32_MUL($k.0, 16bv32), local_id_x$1), $$_ZZ13mxm_amp_tiledPKfS0_PfE6localB[1bv1][BV32_ADD(BV32_MUL($k.0, 16bv32), local_id_x$1)]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 10} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 10} _CHECK_READ_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB(true, BV32_ADD(BV32_MUL($k.0, 16bv32), local_id_x$2), $$_ZZ13mxm_amp_tiledPKfS0_PfE6localB[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL($k.0, 16bv32), local_id_x$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ13mxm_amp_tiledPKfS0_PfE6localB"} true;
