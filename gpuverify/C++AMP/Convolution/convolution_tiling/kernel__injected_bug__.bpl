...
implementation {:source_name "convolution_tiling"} {:kernel} $_Z18convolution_tilingPKfS0_Pf()
{
  ...
  $12:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b10 ==> _READ_HAS_OCCURRED_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf ==> BV32_SGE(local_id_y$1, 7bv32) && BV32_SLT(local_id_y$1, 121bv32) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$1, 114bv32), local_id_y$1), 7bv32), 512bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p9$1 ==> _b9 ==> p9$1 ==> BV32_SGE(local_id_y$1, 7bv32) && BV32_SLT(local_id_y$1, 121bv32) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$1, 114bv32), local_id_y$1), 7bv32), 512bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p9$2 ==> _b9 ==> p9$2 ==> BV32_SGE(local_id_y$2, 7bv32) && BV32_SLT(local_id_y$2, 121bv32) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$2, 114bv32), local_id_y$2), 7bv32), 512bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b8 ==> BV32_SGE(local_id_y$1, 7bv32) && BV32_SLT(local_id_y$1, 121bv32) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$1, 114bv32), local_id_y$1), 7bv32), 512bv32) && BV32_SLE($k.0$1, 7bv32) ==> p9$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b8 ==> BV32_SGE(local_id_y$2, 7bv32) && BV32_SLT(local_id_y$2, 121bv32) && BV32_SLT(BV32_SUB(BV32_ADD(BV32_MUL(group_id_y$2, 114bv32), local_id_y$2), 7bv32), 512bv32) && BV32_SLE($k.0$2, 7bv32) ==> p9$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b7 ==> !BV32_SGE(local_id_y$1, 7bv32) || !BV32_SLT(local_id_y$1, 121bv32) || !BV32_SLT(v0$1, 512bv32) ==> !_READ_HAS_OCCURRED_$$filter;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b6 ==> !BV32_SGE(local_id_y$1, 7bv32) || !BV32_SLT(local_id_y$1, 121bv32) || !BV32_SLT(v0$1, 512bv32) ==> !_READ_HAS_OCCURRED_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b5 ==> !BV32_SGE(local_id_y$1, 7bv32) || !BV32_SLT(local_id_y$1, 121bv32) || !BV32_SLT(v0$1, 512bv32) ==> !p9$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b5 ==> !BV32_SGE(local_id_y$2, 7bv32) || !BV32_SLT(local_id_y$2, 121bv32) || !BV32_SLT(v0$2, 512bv32) ==> !p9$2;
    assert {:tag "loopBound"} {:thread 1} p9$1 ==> _b4 ==> BV32_UGE($k.0$1, 4294967289bv32);
    assert {:tag "loopBound"} {:thread 2} p9$2 ==> _b4 ==> BV32_UGE($k.0$2, 4294967289bv32);
    assert {:tag "loopBound"} {:thread 1} p9$1 ==> _b3 ==> BV32_ULE($k.0$1, 4294967289bv32);
    assert {:tag "loopBound"} {:thread 2} p9$2 ==> _b3 ==> BV32_ULE($k.0$2, 4294967289bv32);
    assert {:tag "loopBound"} {:thread 1} p9$1 ==> _b2 ==> BV32_SGE($k.0$1, 4294967289bv32);
    assert {:tag "loopBound"} {:thread 2} p9$2 ==> _b2 ==> BV32_SGE($k.0$2, 4294967289bv32);
    assert {:tag "loopBound"} {:thread 1} p9$1 ==> _b1 ==> BV32_SLE($k.0$1, 4294967289bv32);
    assert {:tag "loopBound"} {:thread 2} p9$2 ==> _b1 ==> BV32_SLE($k.0$2, 4294967289bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p9$1 ==> _b0 ==> BV32_SLE(0bv32, $k.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p9$2 ==> _b0 ==> BV32_SLE(0bv32, $k.0$2);
    assert {:block_sourceloc} {:sourceloc_num 14} p9$1 ==> true;
    ...
    call {:sourceloc} {:sourceloc_num 16} _LOG_READ_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf(p10$1, BV32_ADD(local_id_y$1, $k.0$1), $$_ZZ18convolution_tilingPKfS0_PfE9local_buf[1bv1][BV32_ADD(local_id_y$1, $k.0$1)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 16} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 16} _CHECK_READ_$$_ZZ18convolution_tilingPKfS0_PfE9local_buf(p10$2, BV32_ADD(local_id_y$2, $k.0$2), $$_ZZ18convolution_tilingPKfS0_PfE9local_buf[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_y$2, $k.0$2)]);
  ...
  $12.tail:
    assume !p9$1 && !p9$2;
    call {:sourceloc} {:sourceloc_num 20} _LOG_WRITE_$$result(p8$1, BV32_ADD(BV32_MUL($0$1, 512bv32), group_id_x$1), $sum.0$1, $$result[BV32_ADD(BV32_MUL($0$1, 512bv32), group_id_x$1)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 20} _CHECK_WRITE_$$result(p8$2, BV32_ADD(BV32_MUL($0$2, 512bv32), group_id_x$2), $sum.0$2);
