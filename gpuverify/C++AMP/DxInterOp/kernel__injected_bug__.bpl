...
implementation {:source_name "run"} {:kernel} $_Z3runPfS_()
{
  ...
  $0:
    ...
    call {:sourceloc} {:sourceloc_num 7} _LOG_READ_$$data_refX(true, BV32_ADD(v0$1, 1bv32), $$data_refX[BV32_ADD(v0$1, 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 7} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 7} _CHECK_READ_$$data_refX(true, BV32_ADD(v0$2, 1bv32), $$data_refX[BV32_ADD(v0$2, 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$data_refX"} true;
    v5$1 := $$data_refX[BV32_ADD(v0$1, 1bv32)];
    v5$2 := $$data_refX[BV32_ADD(v0$2, 1bv32)];
    call {:sourceloc} {:sourceloc_num 8} _LOG_WRITE_$$data_refX(true, BV32_ADD(v0$1, 1bv32), v5$1, $$data_refX[BV32_ADD(v0$1, 1bv32)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$data_refX(true, BV32_ADD(v0$2, 1bv32));
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 8} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 8} _CHECK_WRITE_$$data_refX(true, BV32_ADD(v0$2, 1bv32), v5$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$data_refX"} true;
    $$data_refX[BV32_ADD(v0$1, 1bv32)] := v5$1;
    $$data_refX[BV32_ADD(v0$2, 1bv32)] := v5$2;
    return;
}
