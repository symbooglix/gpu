...
implementation {:source_name "bitonic_sort_kernel"} {:kernel} $_Z19bitonic_sort_kernelPfjj($ulevel: bv32, $ulevelmask: bv32)
{
  ...
  $1:
    ...
    assert {:tag "pow2NotZero"} _b5 ==> $j.0 != 0bv32;
    assert {:tag "pow2"} _b4 ==> $j.0 == 0bv32 || BV32_AND($j.0, BV32_SUB($j.0, 1bv32)) == 0bv32;
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($j.0, BV32_LSHR($ulevel, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_UGE($j.0, BV32_LSHR($ulevel, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($j.0, BV32_LSHR($ulevel, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_ULE($j.0, BV32_LSHR($ulevel, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($j.0, BV32_LSHR($ulevel, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SGE($j.0, BV32_LSHR($ulevel, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($j.0, BV32_LSHR($ulevel, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b0 ==> BV32_SLE($j.0, BV32_LSHR($ulevel, 1bv32));
  ...
  __partitioned_block_$truebb_0:
    assume {:partition} v2 && v2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_READ_$$_ZZ19bitonic_sort_kernelPfjjE7sh_data(true, BV32_AND(local_id_x$1, BV32_XOR($j.0, 4294967295bv32)), $$_ZZ19bitonic_sort_kernelPfjjE7sh_data[1bv1][BV32_AND(local_id_x$1, BV32_XOR($j.0, 4294967295bv32))]);
