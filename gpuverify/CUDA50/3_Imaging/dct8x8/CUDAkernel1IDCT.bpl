...
implementation {:source_name "CUDAkernel1IDCT"} {:kernel} $_Z15CUDAkernel1IDCTPfiii($ImgWidth: bv32, $OffsetXBlocks: bv32, $OffsetYBlocks: bv32)
{
  ...
  $1:
    ...
    assert {:tag "pow2NotZero"} _b13 ==> $DCTv8matrixIndex.0$2 != 0bv32;
    assert {:tag "pow2"} _b12 ==> $DCTv8matrixIndex.0$2 == 0bv32 || BV32_AND($DCTv8matrixIndex.0$2, BV32_SUB($DCTv8matrixIndex.0$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b11 ==> $DCTv8matrixIndex.0$1 != 0bv32;
    assert {:tag "pow2"} _b10 ==> $DCTv8matrixIndex.0$1 == 0bv32 || BV32_AND($DCTv8matrixIndex.0$1, BV32_SUB($DCTv8matrixIndex.0$1, 1bv32)) == 0bv32;
  ...
  $5:
    ...
    assert {:tag "pow2NotZero"} _b21 ==> $CurBlockLocal2Index.0$2 != 0bv32;
    assert {:tag "pow2"} _b20 ==> $CurBlockLocal2Index.0$2 == 0bv32 || BV32_AND($CurBlockLocal2Index.0$2, BV32_SUB($CurBlockLocal2Index.0$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b19 ==> $CurBlockLocal2Index.0$1 != 0bv32;
    assert {:tag "pow2"} _b18 ==> $CurBlockLocal2Index.0$1 == 0bv32 || BV32_AND($CurBlockLocal2Index.0$1, BV32_SUB($CurBlockLocal2Index.0$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b17 ==> $DCTv8matrixIndex.1$2 != 0bv32;
    assert {:tag "pow2"} _b16 ==> $DCTv8matrixIndex.1$2 == 0bv32 || BV32_AND($DCTv8matrixIndex.1$2, BV32_SUB($DCTv8matrixIndex.1$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b15 ==> $DCTv8matrixIndex.1$1 != 0bv32;
    assert {:tag "pow2"} _b14 ==> $DCTv8matrixIndex.1$1 == 0bv32 || BV32_AND($DCTv8matrixIndex.1$1, BV32_SUB($DCTv8matrixIndex.1$1, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$CurBlockLocal1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
