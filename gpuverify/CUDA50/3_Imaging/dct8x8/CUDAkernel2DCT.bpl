...
implementation {:source_name "CUDAkernel2DCT"} {:kernel} $_Z14CUDAkernel2DCTPfS_i($ImgStride: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessBreak"} _b16 ==> _WRITE_HAS_OCCURRED_$$_ZZ14CUDAkernel2DCTPfS_iE5block ==> local_id_y$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 8bv32), BV32_MUL(local_id_z$1, 33bv32));
    assert {:tag "accessBreak"} _b15 ==> _WRITE_HAS_OCCURRED_$$_ZZ14CUDAkernel2DCTPfS_iE5block ==> local_id_z$1 == BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 8bv32), 33bv32), BV32_DIV(local_id_y$1, 33bv32));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b14 ==> _WRITE_HAS_OCCURRED_$$_ZZ14CUDAkernel2DCTPfS_iE5block ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 33bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 33bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 33bv32), BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, 8bv32), 33bv32), BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1))));
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b13 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_WRITE_HAS_OCCURRED_$$_ZZ14CUDAkernel2DCTPfS_iE5block;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b12 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$_ZZ14CUDAkernel2DCTPfS_iE5block;
  ...
  $5:
    ...
    assert {:tag "accessBreak"} _b30 ==> _READ_HAS_OCCURRED_$$_ZZ14CUDAkernel2DCTPfS_iE5block ==> local_id_y$1 == BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 8bv32), BV32_MUL(local_id_z$1, 33bv32));
    assert {:tag "accessBreak"} _b29 ==> _READ_HAS_OCCURRED_$$_ZZ14CUDAkernel2DCTPfS_iE5block ==> local_id_z$1 == BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 8bv32), 33bv32), BV32_DIV(local_id_y$1, 33bv32));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b28 ==> _READ_HAS_OCCURRED_$$_ZZ14CUDAkernel2DCTPfS_iE5block ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 33bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 33bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 33bv32), BV32_ADD(BV32_MUL(BV32_MUL(local_id_z$1, 8bv32), 33bv32), BV32_ADD(BV32_MUL(local_id_y$1, 8bv32), local_id_x$1))));
