...
implementation {:source_name "CUDAkernel1DCT"} {:kernel} $_Z14CUDAkernel1DCTPfiii($ImgWidth: bv32, $OffsetXBlocks: bv32, $OffsetYBlocks: bv32)
{
  ...
  $5:
    ...
    assert {:tag "pow2NotZero"} _b13 ==> $CurBlockLocal2Index.0$2 != 0bv32;
    assert {:tag "pow2"} _b12 ==> $CurBlockLocal2Index.0$2 == 0bv32 || BV32_AND($CurBlockLocal2Index.0$2, BV32_SUB($CurBlockLocal2Index.0$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b11 ==> $CurBlockLocal2Index.0$1 != 0bv32;
    assert {:tag "pow2"} _b10 ==> $CurBlockLocal2Index.0$1 == 0bv32 || BV32_AND($CurBlockLocal2Index.0$1, BV32_SUB($CurBlockLocal2Index.0$1, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$CurBlockLocal2 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$CurBlockLocal1 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $truebb0:
    ...
    $curelem.1$1, $DCTv8matrixIndex.1$1, $CurBlockLocal2Index.0$1, $i1.0 := FADD32($curelem.1$1, FMUL32(v31$1, v32$1)), BV32_ADD($DCTv8matrixIndex.1$1, 8bv32), BV32_ADD($CurBlockLocal2Index.0$1, 1bv32), BV32_ADD($i1.0, 1bv32);
    $curelem.1$2, $DCTv8matrixIndex.1$2, $CurBlockLocal2Index.0$2 := FADD32($curelem.1$2, FMUL32(v31$2, v32$2)), BV32_ADD($DCTv8matrixIndex.1$2, 8bv32), BV32_ADD($CurBlockLocal2Index.0$2, 1bv32);
  ...
  $truebb:
    ...
    $curelem.0$1, $DCTv8matrixIndex.0$1, $CurBlockLocal1Index.0$1, $i.0 := FADD32($curelem.0$1, FMUL32(v28$1, v29$1)), BV32_ADD($DCTv8matrixIndex.0$1, 8bv32), BV32_ADD($CurBlockLocal1Index.0$1, 8bv32), BV32_ADD($i.0, 1bv32);
    $curelem.0$2, $DCTv8matrixIndex.0$2, $CurBlockLocal1Index.0$2 := FADD32($curelem.0$2, FMUL32(v28$2, v29$2)), BV32_ADD($DCTv8matrixIndex.0$2, 8bv32), BV32_ADD($CurBlockLocal1Index.0$2, 8bv32);
