...
implementation {:source_name "NLM2"} {:kernel} $_Z4NLM2Pjiiff($imageW: bv32, $imageH: bv32, $Noise: bv32, $lerpC: bv32)
{
  ...
  $11:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b9 ==> _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $imageW) && BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$1), local_id_y$1), $imageH);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b8 ==> p6$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $imageW) && BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$1), local_id_y$1), $imageH);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b8 ==> p6$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2), $imageW) && BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$2), local_id_y$2), $imageH);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b7 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $imageW) && BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$1), local_id_y$1), $imageH) && (FEQ32($i.0$1, 1082130432bv32) || FLT32($i.0$1, 1082130432bv32)) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b7 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2), $imageW) && BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$2), local_id_y$2), $imageH) && (FEQ32($i.0$2, 1082130432bv32) || FLT32($i.0$2, 1082130432bv32)) ==> p6$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b6 ==> !BV32_SLT(v0$1, $imageW) || !BV32_SLT(v1$1, $imageH) ==> !_READ_HAS_OCCURRED_$$texImage;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b5 ==> !BV32_SLT(v0$1, $imageW) || !BV32_SLT(v1$1, $imageH) ==> !_READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b4 ==> !BV32_SLT(v0$1, $imageW) || !BV32_SLT(v1$1, $imageH) ==> !p6$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b4 ==> !BV32_SLT(v0$2, $imageW) || !BV32_SLT(v1$2, $imageH) ==> !p6$2;
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b3 ==> BV32_UGE($i.0$1, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b3 ==> BV32_UGE($i.0$2, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b2 ==> BV32_ULE($i.0$1, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b2 ==> BV32_ULE($i.0$2, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b1 ==> BV32_SGE($i.0$1, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b1 ==> BV32_SGE($i.0$2, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b0 ==> BV32_SLE($i.0$1, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b0 ==> BV32_SLE($i.0$2, 3225419776bv32);
  ...
  $13:
    ...
    assert p8$1 ==> p6$1;
    assert p8$2 ==> p6$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b19 ==> _READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $imageW) && BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$1), local_id_y$1), $imageH) && (FEQ32($i.0$1, 1082130432bv32) || FLT32($i.0$1, 1082130432bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p8$1 ==> _b18 ==> p8$1 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $imageW) && BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$1), local_id_y$1), $imageH) && (FEQ32($i.0$1, 1082130432bv32) || FLT32($i.0$1, 1082130432bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p8$2 ==> _b18 ==> p8$2 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2), $imageW) && BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$2), local_id_y$2), $imageH) && (FEQ32($i.0$2, 1082130432bv32) || FLT32($i.0$2, 1082130432bv32));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b17 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), $imageW) && BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$1), local_id_y$1), $imageH) && (FEQ32($i.0$1, 1082130432bv32) || FLT32($i.0$1, 1082130432bv32)) && (FEQ32($j.0$1, 1082130432bv32) || FLT32($j.0$1, 1082130432bv32)) ==> p8$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b17 ==> BV32_SLT(BV32_ADD(BV32_MUL(group_size_x, group_id_x$2), local_id_x$2), $imageW) && BV32_SLT(BV32_ADD(BV32_MUL(group_size_y, group_id_y$2), local_id_y$2), $imageH) && (FEQ32($i.0$2, 1082130432bv32) || FLT32($i.0$2, 1082130432bv32)) && (FEQ32($j.0$2, 1082130432bv32) || FLT32($j.0$2, 1082130432bv32)) ==> p8$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b16 ==> !BV32_SLT(v0$1, $imageW) || !BV32_SLT(v1$1, $imageH) ==> !_READ_HAS_OCCURRED_$$texImage;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b15 ==> !BV32_SLT(v0$1, $imageW) || !BV32_SLT(v1$1, $imageH) ==> !_READ_HAS_OCCURRED_$$_ZZ4NLM2PjiiffE8fWeights;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b14 ==> !BV32_SLT(v0$1, $imageW) || !BV32_SLT(v1$1, $imageH) ==> !p8$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b14 ==> !BV32_SLT(v0$2, $imageW) || !BV32_SLT(v1$2, $imageH) ==> !p8$2;
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b13 ==> BV32_UGE($j.0$1, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b13 ==> BV32_UGE($j.0$2, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b12 ==> BV32_ULE($j.0$1, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b12 ==> BV32_ULE($j.0$2, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b11 ==> BV32_SGE($j.0$1, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b11 ==> BV32_SGE($j.0$2, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 1} p8$1 ==> _b10 ==> BV32_SLE($j.0$1, 3225419776bv32);
    assert {:tag "loopBound"} {:thread 2} p8$2 ==> _b10 ==> BV32_SLE($j.0$2, 3225419776bv32);
