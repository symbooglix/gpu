...
procedure {:source_name "convolutionRowsKernel"} {:kernel} $_Z21convolutionRowsKernelPfS_iii($imageW: bv32, $imageH: bv32, $pitch: bv32);
  ...
  requires !_READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data && !_WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data && !_ATOMIC_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data;
  ...
  modifies $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data, $$d_Dst, _TRACKING, _WRITE_HAS_OCCURRED_$$d_Dst, _WRITE_READ_BENIGN_FLAG_$$d_Dst, _WRITE_READ_BENIGN_FLAG_$$d_Dst, _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data, _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data, _WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data, _WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data;
...
implementation {:source_name "convolutionRowsKernel"} {:kernel} $_Z21convolutionRowsKernelPfS_iii($imageW: bv32, $imageH: bv32, $pitch: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessBreak"} _b26 ==> _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 160bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b25 ==> _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 16bv32), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(0bv32, 16bv32), local_id_x$1), BV32_MUL(local_id_y$1, 160bv32)));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $5:
    ...
    assert {:tag "accessBreak"} _b28 ==> _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 160bv32);
  ...
  $12:
    ...
    assert {:tag "accessBreak"} _b30 ==> _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 160bv32);
  ...
  $19:
    ...
    assert {:tag "accessBreak"} _b31 ==> _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 160bv32);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $21:
    ...
    assert {:tag "accessBreak"} _b32 ==> _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 160bv32);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $falsebb5:
    ...
    call {:sourceloc} {:sourceloc_num 35} _LOG_WRITE_$$d_Dst(true, BV32_ADD(v3$1, BV32_MUL($i3.0, 16bv32)), $sum.0$1, $$d_Dst[BV32_ADD(v3$1, BV32_MUL($i3.0, 16bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Dst(true, BV32_ADD(v3$2, BV32_MUL($i3.0, 16bv32)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 35} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 35} _CHECK_WRITE_$$d_Dst(true, BV32_ADD(v3$2, BV32_MUL($i3.0, 16bv32)), $sum.0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_Dst"} true;
    $$d_Dst[BV32_ADD(v3$1, BV32_MUL($i3.0, 16bv32))] := $sum.0$1;
    $$d_Dst[BV32_ADD(v3$2, BV32_MUL($i3.0, 16bv32))] := $sum.0$2;
  ...
  $truebb5:
    ...
    call {:sourceloc} {:sourceloc_num 32} _LOG_READ_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(BV32_ADD(local_id_x$1, BV32_MUL($i3.0, 16bv32)), $j.0)), $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(BV32_ADD(local_id_x$1, BV32_MUL($i3.0, 16bv32)), $j.0))]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 32} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 32} _CHECK_READ_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(BV32_ADD(local_id_x$2, BV32_MUL($i3.0, 16bv32)), $j.0)), $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(BV32_ADD(local_id_x$2, BV32_MUL($i3.0, 16bv32)), $j.0))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} true;
    v15$1 := $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(BV32_ADD(local_id_x$1, BV32_MUL($i3.0, 16bv32)), $j.0))];
    v15$2 := $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(BV32_ADD(local_id_x$2, BV32_MUL($i3.0, 16bv32)), $j.0))];
  ...
  $truebb2:
    assume {:partition} v9 && v9;
    v10$1 := BV32_SGT(BV32_SUB($imageW, v0$1), BV32_MUL($i2.0, 16bv32));
    v10$2 := BV32_SGT(BV32_SUB($imageW, v0$2), BV32_MUL($i2.0, 16bv32));
    ...
    call {:sourceloc} {:sourceloc_num 23} _LOG_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i2.0, 16bv32))), $1$1, $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i2.0, 16bv32)))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i2.0, 16bv32))));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 23} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 23} _CHECK_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i2.0, 16bv32))), $1$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} true;
    $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i2.0, 16bv32)))] := $1$1;
    $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i2.0, 16bv32)))] := $1$2;
  ...
  $truebb0:
    assume {:partition} v6 && v6;
    v7$1 := BV32_SGE(v0$1, BV32_MUL(BV32_SUB(0bv32, $i1.0), 16bv32));
    v7$2 := BV32_SGE(v0$2, BV32_MUL(BV32_SUB(0bv32, $i1.0), 16bv32));
    ...
    call {:sourceloc} {:sourceloc_num 14} _LOG_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i1.0, 16bv32))), $0$1, $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i1.0, 16bv32)))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i1.0, 16bv32))));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 14} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 14} _CHECK_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i1.0, 16bv32))), $0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} true;
    $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i1.0, 16bv32)))] := $0$1;
    $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i1.0, 16bv32)))] := $0$2;
  ...
  $truebb:
    assume {:partition} v4 && v4;
    havoc v5$1, v5$2;
    call {:sourceloc} {:sourceloc_num 5} _LOG_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i.0, 16bv32))), v5$1, $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i.0, 16bv32)))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i.0, 16bv32))));
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 5} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 5} _CHECK_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(true, BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i.0, 16bv32))), v5$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} true;
    $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[1bv1][BV32_ADD(BV32_MUL(local_id_y$1, 160bv32), BV32_ADD(local_id_x$1, BV32_MUL($i.0, 16bv32)))] := v5$1;
    $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_y$2, 160bv32), BV32_ADD(local_id_x$2, BV32_MUL($i.0, 16bv32)))] := v5$2;
...
procedure {:inline 1} {:safe_barrier} {:source_name "bugle_barrier"} {:barrier} $bugle_barrier_duplicated_0($0: bv1, $1: bv1);
  requires $0 == 1bv1;
  requires $1 == 1bv1;
  modifies $$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data, $$d_Dst, _TRACKING;
...
implementation {:inline 1} _LOG_READ_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(_P: bool, _offset: bv32, _value: bv32)
{
  ...
  log_access_entry:
    _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data == _value then true else _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data);
    return;
}
...
procedure _CHECK_READ_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "s_Data"} {:array "$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} {:race} {:write_read} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data && _WATCHED_OFFSET == _offset && _WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "s_Data"} {:array "$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} {:race} {:atomic_read} !(_P && _ATOMIC_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
  ...
  log_access_entry:
    _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data == _value then true else _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data);
    _WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data == _value then _value != _value_old else _WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data);
    return;
}
...
procedure _CHECK_WRITE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "s_Data"} {:array "$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} {:race} {:write_write} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data != _value && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "s_Data"} {:array "$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} {:race} {:read_write} !(_P && _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data != _value && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "s_Data"} {:array "$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} {:race} {:atomic_write} !(_P && _ATOMIC_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
...
implementation {:inline 1} _LOG_ATOMIC_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(_P: bool, _offset: bv32)
{
  ...
  log_access_entry:
    _ATOMIC_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset then true else _ATOMIC_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data);
    return;
}
...
procedure _CHECK_ATOMIC_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(_P: bool, _offset: bv32);
  requires {:source_name "s_Data"} {:array "$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} {:race} {:write_atomic} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "s_Data"} {:array "$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data"} {:race} {:read_atomic} !(_P && _READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
...
implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data(_P: bool, _offset: bv32)
{
  ...
  _UPDATE_BENIGN_FLAG:
    _WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data := (if _P && _WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data && _WATCHED_OFFSET == _offset then false else _WRITE_READ_BENIGN_FLAG_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data);
    return;
}
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon0:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data;
    assume $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data;
    assume $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ21convolutionRowsKernelPfS_iiiE6s_Data;
    goto anon1;
