...
procedure {:source_name "mergeHistogram64Kernel"} {:kernel} $_Z22mergeHistogram64KernelPjS_j($histogramCount: bv32);
...
implementation {:source_name "mergeHistogram64Kernel"} {:kernel} $_Z22mergeHistogram64KernelPjS_j($histogramCount: bv32)
{
  var $sum.0$1: bv32;
  var $sum.0$2: bv32;
  var $i.0$1: bv32;
