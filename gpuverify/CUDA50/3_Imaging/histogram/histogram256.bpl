...
implementation {:source_name "histogram256Kernel"} {:kernel} $_Z18histogram256KernelPjS_j($dataCount: bv32)
{
  ...
  $11:
    ...
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p5$1 ==> _b21 ==> p5$1 ==> BV32_ULT($bin.0$1, 256bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p5$2 ==> _b21 ==> p5$2 ==> BV32_ULT($bin.0$2, 256bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b20 ==> BV32_ULT($bin.0$1, 256bv32) && BV32_ULT($i1.0$1, 6bv32) ==> p5$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b20 ==> BV32_ULT($bin.0$2, 256bv32) && BV32_ULT($i1.0$2, 6bv32) ==> p5$2;
