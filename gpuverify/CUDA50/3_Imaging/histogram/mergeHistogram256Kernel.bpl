...
procedure {:source_name "mergeHistogram256Kernel"} {:kernel} $_Z23mergeHistogram256KernelPjS_j($histogramCount: bv32);
  ...
  modifies $$_ZZ23mergeHistogram256KernelPjS_jE4data, _WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data, _WRITE_READ_BENIGN_FLAG_$$_ZZ23mergeHistogram256KernelPjS_jE4data, _WRITE_READ_BENIGN_FLAG_$$_ZZ23mergeHistogram256KernelPjS_jE4data, _READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data, _WRITE_HAS_OCCURRED_$$d_Histogram, _WRITE_READ_BENIGN_FLAG_$$d_Histogram, _WRITE_READ_BENIGN_FLAG_$$d_Histogram, $$d_Histogram, _TRACKING;
...
implementation {:source_name "mergeHistogram256Kernel"} {:kernel} $_Z23mergeHistogram256KernelPjS_j($histogramCount: bv32)
{
  ...
  $1:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $1.tail:
    assume !p0$1 && !p0$2;
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$_ZZ23mergeHistogram256KernelPjS_jE4data(true, local_id_x$1, $sum.0$1, $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][local_id_x$1]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$_ZZ23mergeHistogram256KernelPjS_jE4data(true, local_id_x$2, $sum.0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ23mergeHistogram256KernelPjS_jE4data"} true;
    $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][local_id_x$1] := $sum.0$1;
    $$_ZZ23mergeHistogram256KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := $sum.0$2;
    $stride.0 := 128bv32;
  ...
  $5:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b9 ==> _WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b7 ==> !_WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data;
    assert {:tag "noread"} _b6 ==> !_READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_UGE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_ULE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SGE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($stride.0, 128bv32);
    assert {:tag "loopBound"} {:thread 2} _b0 ==> BV32_SLE($stride.0, 128bv32);
  ...
  $falsebb0:
    ...
    call {:sourceloc} {:sourceloc_num 18} _LOG_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(p5$1, 0bv32, $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 18} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 18} _CHECK_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(p5$2, 0bv32, $$_ZZ23mergeHistogram256KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data"} true;
    v7$1 := (if p5$1 then $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][0bv32] else v7$1);
    v7$2 := (if p5$2 then $$_ZZ23mergeHistogram256KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] else v7$2);
  ...
  __partitioned_block_$truebb0_1:
    ...
    call {:sourceloc} {:sourceloc_num 11} _LOG_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(p4$1, BV32_ADD(local_id_x$1, $stride.0), $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][BV32_ADD(local_id_x$1, $stride.0)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 11} _CHECK_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(p4$2, BV32_ADD(local_id_x$2, $stride.0), $$_ZZ23mergeHistogram256KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, $stride.0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data"} true;
    v4$1 := (if p4$1 then $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][BV32_ADD(local_id_x$1, $stride.0)] else v4$1);
    v4$2 := (if p4$2 then $$_ZZ23mergeHistogram256KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, $stride.0)] else v4$2);
    call {:sourceloc} {:sourceloc_num 12} _LOG_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(p4$1, local_id_x$1, $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][local_id_x$1]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 12} _CHECK_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(p4$2, local_id_x$2, $$_ZZ23mergeHistogram256KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data"} true;
    v5$1 := (if p4$1 then $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][local_id_x$1] else v5$1);
    v5$2 := (if p4$2 then $$_ZZ23mergeHistogram256KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] else v5$2);
    call {:sourceloc} {:sourceloc_num 13} _LOG_WRITE_$$_ZZ23mergeHistogram256KernelPjS_jE4data(p4$1, local_id_x$1, BV32_ADD(v5$1, v4$1), $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][local_id_x$1]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 13} _CHECK_WRITE_$$_ZZ23mergeHistogram256KernelPjS_jE4data(p4$2, local_id_x$2, BV32_ADD(v5$2, v4$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ23mergeHistogram256KernelPjS_jE4data"} true;
    $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][local_id_x$1] := (if p4$1 then BV32_ADD(v5$1, v4$1) else $$_ZZ23mergeHistogram256KernelPjS_jE4data[1bv1][local_id_x$1]);
    $$_ZZ23mergeHistogram256KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p4$2 then BV32_ADD(v5$2, v4$2) else $$_ZZ23mergeHistogram256KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
...
procedure {:inline 1} {:safe_barrier} {:source_name "bugle_barrier"} {:barrier} $bugle_barrier_duplicated_0($0: bv1, $1: bv1);
  requires $0 == 1bv1;
  requires $1 == 1bv1;
  modifies $$_ZZ23mergeHistogram256KernelPjS_jE4data, $$d_Histogram, _TRACKING;
...
implementation {:inline 1} _LOG_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: bv32, _value: bv32)
{
  ...
  log_access_entry:
    _READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ23mergeHistogram256KernelPjS_jE4data == _value then true else _READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data);
    return;
}
...
procedure _CHECK_READ_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "data"} {:array "$$_ZZ23mergeHistogram256KernelPjS_jE4data"} {:race} {:write_read} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data && _WATCHED_OFFSET == _offset && _WRITE_READ_BENIGN_FLAG_$$_ZZ23mergeHistogram256KernelPjS_jE4data && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "data"} {:array "$$_ZZ23mergeHistogram256KernelPjS_jE4data"} {:race} {:atomic_read} !(_P && _ATOMIC_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
...
implementation {:inline 1} _LOG_WRITE_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{
  ...
  log_access_entry:
    _WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ23mergeHistogram256KernelPjS_jE4data == _value then true else _WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data);
    _WRITE_READ_BENIGN_FLAG_$$_ZZ23mergeHistogram256KernelPjS_jE4data := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ23mergeHistogram256KernelPjS_jE4data == _value then _value != _value_old else _WRITE_READ_BENIGN_FLAG_$$_ZZ23mergeHistogram256KernelPjS_jE4data);
    return;
}
...
procedure _CHECK_WRITE_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "data"} {:array "$$_ZZ23mergeHistogram256KernelPjS_jE4data"} {:race} {:write_write} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ23mergeHistogram256KernelPjS_jE4data != _value && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "data"} {:array "$$_ZZ23mergeHistogram256KernelPjS_jE4data"} {:race} {:read_write} !(_P && _READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ23mergeHistogram256KernelPjS_jE4data != _value && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "data"} {:array "$$_ZZ23mergeHistogram256KernelPjS_jE4data"} {:race} {:atomic_write} !(_P && _ATOMIC_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
...
implementation {:inline 1} _LOG_ATOMIC_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: bv32)
{
  ...
  log_access_entry:
    _ATOMIC_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset then true else _ATOMIC_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data);
    return;
}
...
procedure _CHECK_ATOMIC_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: bv32);
  requires {:source_name "data"} {:array "$$_ZZ23mergeHistogram256KernelPjS_jE4data"} {:race} {:write_atomic} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "data"} {:array "$$_ZZ23mergeHistogram256KernelPjS_jE4data"} {:race} {:read_atomic} !(_P && _READ_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
...
implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ23mergeHistogram256KernelPjS_jE4data(_P: bool, _offset: bv32)
{
  ...
  _UPDATE_BENIGN_FLAG:
    _WRITE_READ_BENIGN_FLAG_$$_ZZ23mergeHistogram256KernelPjS_jE4data := (if _P && _WRITE_HAS_OCCURRED_$$_ZZ23mergeHistogram256KernelPjS_jE4data && _WATCHED_OFFSET == _offset then false else _WRITE_READ_BENIGN_FLAG_$$_ZZ23mergeHistogram256KernelPjS_jE4data);
    return;
}
