...
implementation {:source_name "histogram64Kernel"} {:kernel} $_Z17histogram64KernelPjP5uint4j($dataCount: bv32)
{
  ...
  $10:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ17histogram64KernelPjP5uint4jE6s_Hist ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjP5uint4jE6s_Hist ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjP5uint4jE6s_Hist ==> BV32_ULT(local_id_x$1, 64bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p4$1 ==> _b17 ==> p4$1 ==> BV32_ULT(local_id_x$1, 64bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p4$2 ==> _b17 ==> p4$2 ==> BV32_ULT(local_id_x$2, 64bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b16 ==> BV32_ULT(local_id_x$1, 64bv32) && BV32_ULT($i2.0$1, 16bv32) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b16 ==> BV32_ULT(local_id_x$2, 64bv32) && BV32_ULT($i2.0$2, 16bv32) ==> p4$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b15 ==> !BV32_ULT(local_id_x$1, 64bv32) ==> !_READ_HAS_OCCURRED_$$_ZZ17histogram64KernelPjP5uint4jE6s_Hist;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b14 ==> !BV32_ULT(local_id_x$1, 64bv32) ==> !p4$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b14 ==> !BV32_ULT(local_id_x$2, 64bv32) ==> !p4$2;
