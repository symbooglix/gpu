...
procedure {:source_name "padKernel_kernel"} {:kernel} $_Z16padKernel_kernelPfS_iiiiii($fftH: bv32, $fftW: bv32, $kernelH: bv32, $kernelW: bv32, $kernelY: bv32, $kernelX: bv32);
...
implementation {:source_name "padKernel_kernel"} {:kernel} $_Z16padKernel_kernelPfS_iiiiii($fftH: bv32, $fftW: bv32, $kernelH: bv32, $kernelW: bv32, $kernelY: bv32, $kernelX: bv32)
{
  var $ky.0$1: bv32;
  var $ky.0$2: bv32;
  var $kx.0$1: bv32;
  ...
  $0:
    ...
    v2$1 := BV32_SLT(v0$1, $kernelH);
    v2$2 := BV32_SLT(v0$2, $kernelH);
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
    ...
    v3$1 := (if p0$1 then BV32_SLT(v1$1, $kernelW) else v3$1);
    v3$2 := (if p0$2 then BV32_SLT(v1$2, $kernelW) else v3$2);
    p1$1 := (if p0$1 && v3$1 then v3$1 else p1$1);
    p1$2 := (if p0$2 && v3$2 then v3$2 else p1$2);
    v4$1 := (if p1$1 then BV32_SUB(v0$1, $kernelY) else v4$1);
    v4$2 := (if p1$2 then BV32_SUB(v0$2, $kernelY) else v4$2);
    v5$1 := (if p1$1 then BV32_SLT(v4$1, 0bv32) else v5$1);
    v5$2 := (if p1$2 then BV32_SLT(v4$2, 0bv32) else v5$2);
    ...
    $ky.0$1 := (if p2$1 then BV32_ADD(v4$1, $fftH) else $ky.0$1);
    $ky.0$2 := (if p2$2 then BV32_ADD(v4$2, $fftH) else $ky.0$2);
    $ky.0$1 := (if p3$1 then v4$1 else $ky.0$1);
    $ky.0$2 := (if p3$2 then v4$2 else $ky.0$2);
    v6$1 := (if p1$1 then BV32_SUB(v1$1, $kernelX) else v6$1);
    v6$2 := (if p1$2 then BV32_SUB(v1$2, $kernelX) else v6$2);
    v7$1 := (if p1$1 then BV32_SLT(v6$1, 0bv32) else v7$1);
    v7$2 := (if p1$2 then BV32_SLT(v6$2, 0bv32) else v7$2);
    ...
    $kx.0$1 := (if p4$1 then BV32_ADD(v6$1, $fftW) else $kx.0$1);
    $kx.0$2 := (if p4$2 then BV32_ADD(v6$2, $fftW) else $kx.0$2);
    $kx.0$1 := (if p5$1 then v6$1 else $kx.0$1);
    $kx.0$2 := (if p5$2 then v6$2 else $kx.0$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v8$1 := (if p1$1 then _HAVOC_bv8$1 else v8$1);
    v8$2 := (if p1$2 then _HAVOC_bv8$2 else v8$2);
    $$0$0bv32$1 := (if p1$1 then v8$1 else $$0$0bv32$1);
    $$0$0bv32$2 := (if p1$2 then v8$2 else $$0$0bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v9$1 := (if p1$1 then _HAVOC_bv8$1 else v9$1);
    v9$2 := (if p1$2 then _HAVOC_bv8$2 else v9$2);
    $$0$1bv32$1 := (if p1$1 then v9$1 else $$0$1bv32$1);
    $$0$1bv32$2 := (if p1$2 then v9$2 else $$0$1bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v10$1 := (if p1$1 then _HAVOC_bv8$1 else v10$1);
    v10$2 := (if p1$2 then _HAVOC_bv8$2 else v10$2);
    $$0$2bv32$1 := (if p1$1 then v10$1 else $$0$2bv32$1);
    $$0$2bv32$2 := (if p1$2 then v10$2 else $$0$2bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v11$1 := (if p1$1 then _HAVOC_bv8$1 else v11$1);
    v11$2 := (if p1$2 then _HAVOC_bv8$2 else v11$2);
    $$0$3bv32$1 := (if p1$1 then v11$1 else $$0$3bv32$1);
    $$0$3bv32$2 := (if p1$2 then v11$2 else $$0$3bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v12$1 := (if p1$1 then _HAVOC_bv8$1 else v12$1);
    v12$2 := (if p1$2 then _HAVOC_bv8$2 else v12$2);
    $$0$4bv32$1 := (if p1$1 then v12$1 else $$0$4bv32$1);
    $$0$4bv32$2 := (if p1$2 then v12$2 else $$0$4bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v13$1 := (if p1$1 then _HAVOC_bv8$1 else v13$1);
    v13$2 := (if p1$2 then _HAVOC_bv8$2 else v13$2);
    $$0$5bv32$1 := (if p1$1 then v13$1 else $$0$5bv32$1);
    $$0$5bv32$2 := (if p1$2 then v13$2 else $$0$5bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v14$1 := (if p1$1 then _HAVOC_bv8$1 else v14$1);
    v14$2 := (if p1$2 then _HAVOC_bv8$2 else v14$2);
    $$0$6bv32$1 := (if p1$1 then v14$1 else $$0$6bv32$1);
    $$0$6bv32$2 := (if p1$2 then v14$2 else $$0$6bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v15$1 := (if p1$1 then _HAVOC_bv8$1 else v15$1);
    v15$2 := (if p1$2 then _HAVOC_bv8$2 else v15$2);
    $$0$7bv32$1 := (if p1$1 then v15$1 else $$0$7bv32$1);
    $$0$7bv32$2 := (if p1$2 then v15$2 else $$0$7bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v16$1 := (if p1$1 then _HAVOC_bv8$1 else v16$1);
    v16$2 := (if p1$2 then _HAVOC_bv8$2 else v16$2);
    $$0$8bv32$1 := (if p1$1 then v16$1 else $$0$8bv32$1);
    $$0$8bv32$2 := (if p1$2 then v16$2 else $$0$8bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v17$1 := (if p1$1 then _HAVOC_bv8$1 else v17$1);
    v17$2 := (if p1$2 then _HAVOC_bv8$2 else v17$2);
    $$0$9bv32$1 := (if p1$1 then v17$1 else $$0$9bv32$1);
    $$0$9bv32$2 := (if p1$2 then v17$2 else $$0$9bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v18$1 := (if p1$1 then _HAVOC_bv8$1 else v18$1);
    v18$2 := (if p1$2 then _HAVOC_bv8$2 else v18$2);
    $$0$10bv32$1 := (if p1$1 then v18$1 else $$0$10bv32$1);
    $$0$10bv32$2 := (if p1$2 then v18$2 else $$0$10bv32$2);
    havoc _HAVOC_bv8$1, _HAVOC_bv8$2;
    v19$1 := (if p1$1 then _HAVOC_bv8$1 else v19$1);
    v19$2 := (if p1$2 then _HAVOC_bv8$2 else v19$2);
    $$0$11bv32$1 := (if p1$1 then v19$1 else $$0$11bv32$1);
    $$0$11bv32$2 := (if p1$2 then v19$2 else $$0$11bv32$2);
    v20$1 := (if p1$1 then $$0$0bv32$1 else v20$1);
    v20$2 := (if p1$2 then $$0$0bv32$2 else v20$2);
    v21$1 := (if p1$1 then $$0$1bv32$1 else v21$1);
    v21$2 := (if p1$2 then $$0$1bv32$2 else v21$2);
    v22$1 := (if p1$1 then $$0$2bv32$1 else v22$1);
    v22$2 := (if p1$2 then $$0$2bv32$2 else v22$2);
    v23$1 := (if p1$1 then $$0$3bv32$1 else v23$1);
    v23$2 := (if p1$2 then $$0$3bv32$2 else v23$2);
    v24$1 := (if p1$1 then $$0$4bv32$1 else v24$1);
    v24$2 := (if p1$2 then $$0$4bv32$2 else v24$2);
    v25$1 := (if p1$1 then $$0$5bv32$1 else v25$1);
    v25$2 := (if p1$2 then $$0$5bv32$2 else v25$2);
    v26$1 := (if p1$1 then $$0$6bv32$1 else v26$1);
    v26$2 := (if p1$2 then $$0$6bv32$2 else v26$2);
    v27$1 := (if p1$1 then $$0$7bv32$1 else v27$1);
    v27$2 := (if p1$2 then $$0$7bv32$2 else v27$2);
    v28$1 := (if p1$1 then $$0$8bv32$1 else v28$1);
    v28$2 := (if p1$2 then $$0$8bv32$2 else v28$2);
    v29$1 := (if p1$1 then $$0$9bv32$1 else v29$1);
    v29$2 := (if p1$2 then $$0$9bv32$2 else v29$2);
    v30$1 := (if p1$1 then $$0$10bv32$1 else v30$1);
    v30$2 := (if p1$2 then $$0$10bv32$2 else v30$2);
    v31$1 := (if p1$1 then $$0$11bv32$1 else v31$1);
    v31$2 := (if p1$2 then $$0$11bv32$2 else v31$2);
    call {:sourceloc_num 45} v32$1, v32$2 := $_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi(p1$1, v23$1 ++ v22$1 ++ v21$1 ++ v20$1, v27$1 ++ v26$1 ++ v25$1 ++ v24$1, v31$1 ++ v30$1 ++ v29$1 ++ v28$1, BV32_ADD(BV32_MUL(v0$1, $kernelW), v1$1), p1$2, v23$2 ++ v22$2 ++ v21$2 ++ v20$2, v27$2 ++ v26$2 ++ v25$2 ++ v24$2, v31$2 ++ v30$2 ++ v29$2 ++ v28$2, BV32_ADD(BV32_MUL(v0$2, $kernelW), v1$2));
    assume {:captureState "call_return_state_0"} {:procedureName "$_Z10tex1DfetchIfET_7textureIS0_Li1EL19cudaTextureReadMode0EEi"} true;
    call {:sourceloc} {:sourceloc_num 46} _LOG_WRITE_$$d_Dst(p1$1, BV32_ADD(BV32_MUL($ky.0$1, $fftW), $kx.0$1), v32$1, $$d_Dst[BV32_ADD(BV32_MUL($ky.0$1, $fftW), $kx.0$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_Dst(p1$2, BV32_ADD(BV32_MUL($ky.0$2, $fftW), $kx.0$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 46} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 46} _CHECK_WRITE_$$d_Dst(p1$2, BV32_ADD(BV32_MUL($ky.0$2, $fftW), $kx.0$2), v32$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_Dst"} true;
    $$d_Dst[BV32_ADD(BV32_MUL($ky.0$1, $fftW), $kx.0$1)] := (if p1$1 then v32$1 else $$d_Dst[BV32_ADD(BV32_MUL($ky.0$1, $fftW), $kx.0$1)]);
    $$d_Dst[BV32_ADD(BV32_MUL($ky.0$2, $fftW), $kx.0$2)] := (if p1$2 then v32$2 else $$d_Dst[BV32_ADD(BV32_MUL($ky.0$2, $fftW), $kx.0$2)]);
    return;
}
