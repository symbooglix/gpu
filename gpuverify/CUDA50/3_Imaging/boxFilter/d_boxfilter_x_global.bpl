...
implementation {:source_name "d_boxfilter_x_global"} {:kernel} $_Z20d_boxfilter_x_globalPfS_iii($w: bv32, $h: bv32, $r: bv32)
{
  ...
  $4:
    ...
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_UGE($x1.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($x1.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_ULE($x1.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($x1.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SGE($x1.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($x1.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SLE($x1.i.0, 1bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b0 ==> BV32_SLE(0bv32, $x1.i.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b0 ==> BV32_SLE(0bv32, $x1.i.0);
  ...
  $7:
    ...
    assert {:tag "loopBound"} {:thread 2} _b9 ==> BV32_UGE($x2.i.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($x2.i.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b8 ==> BV32_ULE($x2.i.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($x2.i.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_SGE($x2.i.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($x2.i.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_SLE($x2.i.0, BV32_ADD($r, 1bv32));
    assert {:tag "guardNonNeg"} {:thread 1} _b5 ==> BV32_SLE(0bv32, $x2.i.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b5 ==> BV32_SLE(0bv32, $x2.i.0);
  ...
  $10:
    ...
    assert {:tag "loopBound"} {:thread 2} _b14 ==> BV32_UGE($x3.i.0, BV32_SUB($w, $r));
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_ULE($x3.i.0, BV32_SUB($w, $r));
    assert {:tag "loopBound"} {:thread 2} _b13 ==> BV32_ULE($x3.i.0, BV32_SUB($w, $r));
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_SGE($x3.i.0, BV32_SUB($w, $r));
    assert {:tag "loopBound"} {:thread 2} _b12 ==> BV32_SGE($x3.i.0, BV32_SUB($w, $r));
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_SLE($x3.i.0, BV32_SUB($w, $r));
    assert {:tag "loopBound"} {:thread 2} _b11 ==> BV32_SLE($x3.i.0, BV32_SUB($w, $r));
    assert {:tag "guardNonNeg"} {:thread 1} _b10 ==> BV32_SLE(0bv32, $x3.i.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b10 ==> BV32_SLE(0bv32, $x3.i.0);
