...
implementation {:source_name "d_boxfilter_y_tex"} {:kernel} $_Z17d_boxfilter_y_texPfiii($w: bv32, $h: bv32, $r: bv32)
{
  var $t.0$1: bv32;
  var $t.0$2: bv32;
  var $y.0: bv32;
  ...
  $0:
    ...
    $t.0$1, $y.0 := 0bv32, BV32_SUB(0bv32, $r);
    $t.0$2 := 0bv32;
  ...
  $5:
    ...
    assert {:tag "accessBreak"} _b8 ==> _WRITE_HAS_OCCURRED_$$od ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, group_size_x);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b7 ==> _WRITE_HAS_OCCURRED_$$od ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $w), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $w), 1bv32), BV32_ADD(BV32_MUL(0bv32, $w), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)));
    assert {:tag "accessUpperBoundBlock"} _b6 ==> _WRITE_HAS_OCCURRED_$$od ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), group_size_x), local_id_x$1));
    assert {:tag "accessLowerBoundBlock"} _b5 ==> _WRITE_HAS_OCCURRED_$$od ==> BV32_SLE(BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1), _WATCHED_OFFSET);
