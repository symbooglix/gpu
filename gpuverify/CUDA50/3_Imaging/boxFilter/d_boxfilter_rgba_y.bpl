...
implementation {:source_name "d_boxfilter_rgba_y"} {:kernel} $_Z18d_boxfilter_rgba_yPjS_iii($w: bv32, $h: bv32, $r: bv32)
{
  ...
  $5:
    ...
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_UGE($y1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_UGE($y1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($y1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_ULE($y1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($y1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SGE($y1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($y1.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SLE($y1.0, 1bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b0 ==> BV32_SLE(0bv32, $y1.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b0 ==> BV32_SLE(0bv32, $y1.0);
  ...
  $9:
    ...
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_UGE($y2.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b9 ==> BV32_UGE($y2.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($y2.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b8 ==> BV32_ULE($y2.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($y2.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_SGE($y2.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($y2.0, BV32_ADD($r, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_SLE($y2.0, BV32_ADD($r, 1bv32));
    assert {:tag "guardNonNeg"} {:thread 1} _b5 ==> BV32_SLE(0bv32, $y2.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b5 ==> BV32_SLE(0bv32, $y2.0);
  ...
  $13:
    ...
    assert {:tag "loopBound"} {:thread 1} _b14 ==> BV32_UGE($y3.0, BV32_SUB($h, $r));
    assert {:tag "loopBound"} {:thread 2} _b14 ==> BV32_UGE($y3.0, BV32_SUB($h, $r));
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_ULE($y3.0, BV32_SUB($h, $r));
    assert {:tag "loopBound"} {:thread 2} _b13 ==> BV32_ULE($y3.0, BV32_SUB($h, $r));
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_SGE($y3.0, BV32_SUB($h, $r));
    assert {:tag "loopBound"} {:thread 2} _b12 ==> BV32_SGE($y3.0, BV32_SUB($h, $r));
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_SLE($y3.0, BV32_SUB($h, $r));
    assert {:tag "loopBound"} {:thread 2} _b11 ==> BV32_SLE($y3.0, BV32_SUB($h, $r));
    assert {:tag "guardNonNeg"} {:thread 1} _b10 ==> BV32_SLE(0bv32, $y3.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b10 ==> BV32_SLE(0bv32, $y3.0);
