...
implementation {:source_name "dwtHaar1D"} {:kernel} $_Z9dwtHaar1DPfS_S_jji($dlevels: bv32, $slength_step_half: bv32, $bdim: bv32)
{
  ...
  $2:
    ...
    assert {:tag "accessBreak"} _b33 ==> _WRITE_HAS_OCCURRED_$$od ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $num_threads.0$1);
    assert {:tag "nowrite"} _b32 ==> !_WRITE_HAS_OCCURRED_$$od;
    assert {:tag "pow2NotZero"} _b31 ==> $idata0.1$2 != 0bv32;
    assert {:tag "pow2"} _b30 ==> $idata0.1$2 == 0bv32 || BV32_AND($idata0.1$2, BV32_SUB($idata0.1$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b29 ==> $idata0.1$1 != 0bv32;
    assert {:tag "pow2"} _b28 ==> $idata0.1$1 == 0bv32 || BV32_AND($idata0.1$1, BV32_SUB($idata0.1$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b27 ==> $num_threads.1$2 != 0bv32;
    assert {:tag "pow2"} _b26 ==> $num_threads.1$2 == 0bv32 || BV32_AND($num_threads.1$2, BV32_SUB($num_threads.1$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b25 ==> $num_threads.1$1 != 0bv32;
    assert {:tag "pow2"} _b24 ==> $num_threads.1$1 == 0bv32 || BV32_AND($num_threads.1$1, BV32_SUB($num_threads.1$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b23 ==> $offset_neighbor.1$2 != 0bv32;
    assert {:tag "pow2"} _b22 ==> $offset_neighbor.1$2 == 0bv32 || BV32_AND($offset_neighbor.1$2, BV32_SUB($offset_neighbor.1$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b21 ==> $offset_neighbor.1$1 != 0bv32;
    assert {:tag "pow2"} _b20 ==> $offset_neighbor.1$1 == 0bv32 || BV32_AND($offset_neighbor.1$1, BV32_SUB($offset_neighbor.1$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b19 ==> $idata0.0$2 != 0bv32;
    assert {:tag "pow2"} _b18 ==> $idata0.0$2 == 0bv32 || BV32_AND($idata0.0$2, BV32_SUB($idata0.0$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b17 ==> $idata0.0$1 != 0bv32;
    assert {:tag "pow2"} _b16 ==> $idata0.0$1 == 0bv32 || BV32_AND($idata0.0$1, BV32_SUB($idata0.0$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b15 ==> $num_threads.0$2 != 0bv32;
    assert {:tag "pow2"} _b14 ==> $num_threads.0$2 == 0bv32 || BV32_AND($num_threads.0$2, BV32_SUB($num_threads.0$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b13 ==> $num_threads.0$1 != 0bv32;
    assert {:tag "pow2"} _b12 ==> $num_threads.0$1 == 0bv32 || BV32_AND($num_threads.0$1, BV32_SUB($num_threads.0$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b11 ==> $offset_neighbor.0$2 != 0bv32;
    assert {:tag "pow2"} _b10 ==> $offset_neighbor.0$2 == 0bv32 || BV32_AND($offset_neighbor.0$2, BV32_SUB($offset_neighbor.0$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b9 ==> $offset_neighbor.0$1 != 0bv32;
    assert {:tag "pow2"} _b8 ==> $offset_neighbor.0$1 == 0bv32 || BV32_AND($offset_neighbor.0$1, BV32_SUB($offset_neighbor.0$1, 1bv32)) == 0bv32;
    ...
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_UGE($num_threads.0$1, BV32_ASHR($bdim, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_UGE($num_threads.0$2, BV32_ASHR($bdim, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_ULE($num_threads.0$1, BV32_ASHR($bdim, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_ULE($num_threads.0$2, BV32_ASHR($bdim, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_SGE($num_threads.0$1, BV32_ASHR($bdim, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b5 ==> BV32_SGE($num_threads.0$2, BV32_ASHR($bdim, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_SLE($num_threads.0$1, BV32_ASHR($bdim, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_SLE($num_threads.0$2, BV32_ASHR($bdim, 1bv32));
