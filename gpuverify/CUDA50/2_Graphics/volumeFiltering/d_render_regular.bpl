...
procedure {:source_name "d_render_regular"} {:kernel} $_Z16d_render_regularPjjjfffff($imageW: bv32, $imageH: bv32, $density: bv32, $brightness: bv32, $transferOffset: bv32, $transferScale: bv32, $transferWeight: bv32);
...
implementation {:source_name "d_render_regular"} {:kernel} $_Z16d_render_regularPjjjfffff($imageW: bv32, $imageH: bv32, $density: bv32, $brightness: bv32, $transferOffset: bv32, $transferScale: bv32, $transferWeight: bv32)
{
  ...
  $0:
    ...
    $$9$0bv32$1 := (if p5$1 then FMUL32(v415$1, 1008981770bv32) else $$9$0bv32$1);
    $$9$0bv32$2 := (if p5$2 then FMUL32(v415$2, 1008981770bv32) else $$9$0bv32$2);
    $$9$1bv32$1 := (if p5$1 then FMUL32(v416$1, 1008981770bv32) else $$9$1bv32$1);
    $$9$1bv32$2 := (if p5$2 then FMUL32(v416$2, 1008981770bv32) else $$9$1bv32$2);
    $$9$2bv32$1 := (if p5$1 then FMUL32(v417$1, 1008981770bv32) else $$9$2bv32$1);
    $$9$2bv32$2 := (if p5$2 then FMUL32(v417$2, 1008981770bv32) else $$9$2bv32$2);
    ...
    $t.i.0$1, $i.i.0$1 := (if p5$1 then $tnear.i.0$1 else $t.i.0$1), (if p5$1 then 0bv32 else $i.i.0$1);
    $t.i.0$2, $i.i.0$2 := (if p5$2 then $tnear.i.0$2 else $t.i.0$2), (if p5$2 then 0bv32 else $i.i.0$2);
  ...
  $8:
    ...
    call {:sourceloc_num 907} v505$1, v505$2 := $_Z5tex1DI6float4ET_7textureIS1_Li1EL19cudaTextureReadMode0EEf(p9$1, v496$1 ++ v495$1 ++ v494$1 ++ v493$1 ++ v492$1 ++ v491$1 ++ v490$1 ++ v489$1 ++ v488$1 ++ v487$1 ++ v486$1 ++ v485$1 ++ v484$1 ++ v483$1 ++ v482$1 ++ v481$1, v500$1 ++ v499$1 ++ v498$1 ++ v497$1, v504$1 ++ v503$1 ++ v502$1 ++ v501$1, v455$1, p9$2, v496$2 ++ v495$2 ++ v494$2 ++ v493$2 ++ v492$2 ++ v491$2 ++ v490$2 ++ v489$2 ++ v488$2 ++ v487$2 ++ v486$2 ++ v485$2 ++ v484$2 ++ v483$2 ++ v482$2 ++ v481$2, v500$2 ++ v499$2 ++ v498$2 ++ v497$2, v504$2 ++ v503$2 ++ v502$2 ++ v501$2, v455$2);
    ...
    $$col.i$3bv32$1 := (if p9$1 then FMUL32(v510$1, 0bv32) else $$col.i$3bv32$1);
    $$col.i$3bv32$2 := (if p9$2 then FMUL32(v510$2, 0bv32) else $$col.i$3bv32$2);
    ...
    v573$1 := (if p10$1 then FADD32($t.i.0$1, 1008981770bv32) else v573$1);
    v573$2 := (if p10$2 then FADD32($t.i.0$2, 1008981770bv32) else v573$2);
    ...
    $t.i.0$1, $i.i.0$1 := (if p11$1 then v573$1 else $t.i.0$1), (if p11$1 then BV32_ADD($i.i.0$1, 1bv32) else $i.i.0$1);
    $t.i.0$2, $i.i.0$2 := (if p11$2 then v573$2 else $t.i.0$2), (if p11$2 then BV32_ADD($i.i.0$2, 1bv32) else $i.i.0$2);
