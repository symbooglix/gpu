...
implementation {:source_name "advectVelocity_k"} {:kernel} $_Z16advectVelocity_kP6float2PfS1_iiifi($dx: bv32, $pdx: bv32, $dy: bv32, $dt: bv32, $lb: bv32)
{
  ...
  $2:
    ...
    assert {:tag "accessBreak"} _b18 ==> _WRITE_HAS_OCCURRED_$$vy ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, group_size_x), BV32_DIV(BV32_MUL(BV32_MUL(BV32_MUL(group_id_y$1, $pdx), $lb), group_size_y), group_size_x)), BV32_DIV(BV32_MUL(BV32_MUL(local_id_y$1, $pdx), $lb), group_size_x));
    assert {:tag "accessBreak"} _b17 ==> _WRITE_HAS_OCCURRED_$$vy ==> local_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $pdx), $lb), BV32_DIV(BV32_MUL(BV32_MUL(group_id_y$1, $lb), group_size_y), $lb)), BV32_DIV(BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $pdx), $lb));
    assert {:tag "accessBreak"} _b16 ==> _WRITE_HAS_OCCURRED_$$vy ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $pdx), $lb), group_size_y), BV32_DIV(BV32_DIV(BV32_MUL(local_id_y$1, $lb), $lb), group_size_y)), BV32_DIV(BV32_DIV(BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $pdx), $lb), group_size_y));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b15 ==> _WRITE_HAS_OCCURRED_$$vy ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $pdx), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $pdx), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, BV32_ADD(BV32_MUL(group_id_y$1, BV32_MUL($lb, group_size_y)), BV32_MUL(local_id_y$1, $lb))), $pdx), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)));
    assert {:tag "accessBreak"} _b14 ==> _WRITE_HAS_OCCURRED_$$vx ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, group_size_x), BV32_DIV(BV32_MUL(BV32_MUL(BV32_MUL(group_id_y$1, $pdx), $lb), group_size_y), group_size_x)), BV32_DIV(BV32_MUL(BV32_MUL(local_id_y$1, $pdx), $lb), group_size_x));
    assert {:tag "accessBreak"} _b13 ==> _WRITE_HAS_OCCURRED_$$vx ==> local_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $pdx), $lb), BV32_DIV(BV32_MUL(BV32_MUL(group_id_y$1, $lb), group_size_y), $lb)), BV32_DIV(BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $pdx), $lb));
    assert {:tag "accessBreak"} _b12 ==> _WRITE_HAS_OCCURRED_$$vx ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $pdx), $lb), group_size_y), BV32_DIV(BV32_DIV(BV32_MUL(local_id_y$1, $lb), $lb), group_size_y)), BV32_DIV(BV32_DIV(BV32_DIV(BV32_MUL(group_id_x$1, group_size_x), $pdx), $lb), group_size_y));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b11 ==> _WRITE_HAS_OCCURRED_$$vx ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $pdx), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $pdx), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, BV32_ADD(BV32_MUL(group_id_y$1, BV32_MUL($lb, group_size_y)), BV32_MUL(local_id_y$1, $lb))), $pdx), BV32_ADD(BV32_MUL(group_id_x$1, group_size_x), local_id_x$1)));
    ...
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b8 ==> !BV32_SLT(v0$1, $dx) ==> !_READ_HAS_OCCURRED_$$texref;
