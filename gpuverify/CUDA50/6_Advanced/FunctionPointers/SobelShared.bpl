...
procedure {:source_name "ComputeSobel"} $_Z12ComputeSobelhhhhhhhhhf(_P$1: bool, $ul$1: bv8, $um$1: bv8, $ur$1: bv8, $ml$1: bv8, $mm$1: bv8, $mr$1: bv8, $ll$1: bv8, $lm$1: bv8, $lr$1: bv8, $fScale$1: bv32, _P$2: bool, $ul$2: bv8, $um$2: bv8, $ur$2: bv8, $ml$2: bv8, $mm$2: bv8, $mr$2: bv8, $ll$2: bv8, $lm$2: bv8, $lr$2: bv8, $fScale$2: bv32) returns ($ret$1: bv8, $ret$2: bv8);
  ...
  requires _b23 ==> _P$1 == _P$2;
  requires _b24 ==> _P$1 && _P$2 ==> $ul$1 == $ul$2;
  requires _b25 ==> $ul$1 == $ul$2;
  requires _b26 ==> _P$1 && _P$2 ==> $um$1 == $um$2;
  requires _b27 ==> $um$1 == $um$2;
  requires _b28 ==> _P$1 && _P$2 ==> $ur$1 == $ur$2;
  requires _b29 ==> $ur$1 == $ur$2;
  requires _b30 ==> _P$1 && _P$2 ==> $ml$1 == $ml$2;
  requires _b31 ==> $ml$1 == $ml$2;
  requires _b32 ==> _P$1 && _P$2 ==> $mm$1 == $mm$2;
  requires _b33 ==> $mm$1 == $mm$2;
  requires _b34 ==> _P$1 && _P$2 ==> $mr$1 == $mr$2;
  requires _b35 ==> $mr$1 == $mr$2;
  requires _b36 ==> _P$1 && _P$2 ==> $ll$1 == $ll$2;
  requires _b37 ==> $ll$1 == $ll$2;
  requires _b38 ==> _P$1 && _P$2 ==> $lm$1 == $lm$2;
  requires _b39 ==> $lm$1 == $lm$2;
  requires _b40 ==> _P$1 && _P$2 ==> $lr$1 == $lr$2;
  requires _b41 ==> $lr$1 == $lr$2;
  requires _b42 ==> _P$1 && _P$2 ==> $fScale$1 == $fScale$2;
  requires _b43 ==> $fScale$1 == $fScale$2;
  requires _b44 ==> !_READ_HAS_OCCURRED_$$pSobelOriginal;
  requires _b45 ==> !_WRITE_HAS_OCCURRED_$$pSobelOriginal;
  requires _b46 ==> !_ATOMIC_HAS_OCCURRED_$$pSobelOriginal;
  requires _b47 ==> _READ_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b48 ==> _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b49 ==> _ATOMIC_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b50 ==> !_READ_HAS_OCCURRED_$$blockFunction_table;
  requires _b51 ==> !_WRITE_HAS_OCCURRED_$$blockFunction_table;
  requires _b52 ==> !_ATOMIC_HAS_OCCURRED_$$blockFunction_table;
  requires _b53 ==> _READ_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b54 ==> _WRITE_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b55 ==> _ATOMIC_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b56 ==> !_READ_HAS_OCCURRED_$$tex;
  requires _b57 ==> !_WRITE_HAS_OCCURRED_$$tex;
  requires _b58 ==> !_ATOMIC_HAS_OCCURRED_$$tex;
  requires _b59 ==> _READ_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b60 ==> _WRITE_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b61 ==> _ATOMIC_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b62 ==> !_READ_HAS_OCCURRED_$$blockFunction;
  requires _b63 ==> !_WRITE_HAS_OCCURRED_$$blockFunction;
  requires _b64 ==> !_ATOMIC_HAS_OCCURRED_$$blockFunction;
  requires _b65 ==> _READ_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b66 ==> _WRITE_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b67 ==> _ATOMIC_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b68 ==> !_READ_HAS_OCCURRED_$$LocalBlock;
  requires _b69 ==> !_WRITE_HAS_OCCURRED_$$LocalBlock;
  requires _b70 ==> !_ATOMIC_HAS_OCCURRED_$$LocalBlock;
  requires _b71 ==> _READ_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b72 ==> _WRITE_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b73 ==> _ATOMIC_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  ...
  ensures _b74 ==> $ret$1 == $ret$2;
  ensures _b75 ==> !_READ_HAS_OCCURRED_$$pSobelOriginal;
  ensures _b76 ==> !_WRITE_HAS_OCCURRED_$$pSobelOriginal;
  ensures _b77 ==> !_ATOMIC_HAS_OCCURRED_$$pSobelOriginal;
  ensures _b78 ==> _READ_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b79 ==> _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b80 ==> _ATOMIC_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b81 ==> !_READ_HAS_OCCURRED_$$blockFunction_table;
  ensures _b82 ==> !_WRITE_HAS_OCCURRED_$$blockFunction_table;
  ensures _b83 ==> !_ATOMIC_HAS_OCCURRED_$$blockFunction_table;
  ensures _b84 ==> _READ_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b85 ==> _WRITE_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b86 ==> _ATOMIC_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b87 ==> !_READ_HAS_OCCURRED_$$tex;
  ensures _b88 ==> !_WRITE_HAS_OCCURRED_$$tex;
  ensures _b89 ==> !_ATOMIC_HAS_OCCURRED_$$tex;
  ensures _b90 ==> _READ_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b91 ==> _WRITE_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b92 ==> _ATOMIC_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b93 ==> !_READ_HAS_OCCURRED_$$blockFunction;
  ensures _b94 ==> !_WRITE_HAS_OCCURRED_$$blockFunction;
  ensures _b95 ==> !_ATOMIC_HAS_OCCURRED_$$blockFunction;
  ensures _b96 ==> _READ_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b97 ==> _WRITE_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b98 ==> _ATOMIC_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b99 ==> !_READ_HAS_OCCURRED_$$LocalBlock;
  ensures _b100 ==> !_WRITE_HAS_OCCURRED_$$LocalBlock;
  ensures _b101 ==> !_ATOMIC_HAS_OCCURRED_$$LocalBlock;
  ensures _b102 ==> _READ_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b103 ==> _WRITE_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b104 ==> _ATOMIC_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
...
procedure {:source_name "ComputeBox"} $_Z10ComputeBoxhhhhhhhhhf(_P$1: bool, $ul$1: bv8, $um$1: bv8, $ur$1: bv8, $ml$1: bv8, $mm$1: bv8, $mr$1: bv8, $ll$1: bv8, $lm$1: bv8, $lr$1: bv8, $fscale$1: bv32, _P$2: bool, $ul$2: bv8, $um$2: bv8, $ur$2: bv8, $ml$2: bv8, $mm$2: bv8, $mr$2: bv8, $ll$2: bv8, $lm$2: bv8, $lr$2: bv8, $fscale$2: bv32) returns ($ret$1: bv8, $ret$2: bv8);
  ...
  requires BV32_SLT(local_id_z$2, group_size_z);
  requires group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> local_id_x$1 != local_id_x$2 || local_id_y$1 != local_id_y$2 || local_id_z$1 != local_id_z$2;
  requires _b105 ==> _P$1 == _P$2;
  requires _b106 ==> _P$1 && _P$2 ==> $ul$1 == $ul$2;
  requires _b107 ==> $ul$1 == $ul$2;
  requires _b108 ==> _P$1 && _P$2 ==> $um$1 == $um$2;
  requires _b109 ==> $um$1 == $um$2;
  requires _b110 ==> _P$1 && _P$2 ==> $ur$1 == $ur$2;
  requires _b111 ==> $ur$1 == $ur$2;
  requires _b112 ==> _P$1 && _P$2 ==> $ml$1 == $ml$2;
  requires _b113 ==> $ml$1 == $ml$2;
  requires _b114 ==> _P$1 && _P$2 ==> $mm$1 == $mm$2;
  requires _b115 ==> $mm$1 == $mm$2;
  requires _b116 ==> _P$1 && _P$2 ==> $mr$1 == $mr$2;
  requires _b117 ==> $mr$1 == $mr$2;
  requires _b118 ==> _P$1 && _P$2 ==> $ll$1 == $ll$2;
  requires _b119 ==> $ll$1 == $ll$2;
  requires _b120 ==> _P$1 && _P$2 ==> $lm$1 == $lm$2;
  requires _b121 ==> $lm$1 == $lm$2;
  requires _b122 ==> _P$1 && _P$2 ==> $lr$1 == $lr$2;
  requires _b123 ==> $lr$1 == $lr$2;
  requires _b124 ==> _P$1 && _P$2 ==> $fscale$1 == $fscale$2;
  requires _b125 ==> $fscale$1 == $fscale$2;
  requires _b126 ==> !_READ_HAS_OCCURRED_$$pSobelOriginal;
  requires _b127 ==> !_WRITE_HAS_OCCURRED_$$pSobelOriginal;
  requires _b128 ==> !_ATOMIC_HAS_OCCURRED_$$pSobelOriginal;
  requires _b129 ==> _READ_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b130 ==> _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b131 ==> _ATOMIC_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b132 ==> !_READ_HAS_OCCURRED_$$blockFunction_table;
  requires _b133 ==> !_WRITE_HAS_OCCURRED_$$blockFunction_table;
  requires _b134 ==> !_ATOMIC_HAS_OCCURRED_$$blockFunction_table;
  requires _b135 ==> _READ_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b136 ==> _WRITE_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b137 ==> _ATOMIC_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b138 ==> !_READ_HAS_OCCURRED_$$tex;
  requires _b139 ==> !_WRITE_HAS_OCCURRED_$$tex;
  requires _b140 ==> !_ATOMIC_HAS_OCCURRED_$$tex;
  requires _b141 ==> _READ_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b142 ==> _WRITE_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b143 ==> _ATOMIC_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b144 ==> !_READ_HAS_OCCURRED_$$blockFunction;
  requires _b145 ==> !_WRITE_HAS_OCCURRED_$$blockFunction;
  requires _b146 ==> !_ATOMIC_HAS_OCCURRED_$$blockFunction;
  requires _b147 ==> _READ_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b148 ==> _WRITE_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b149 ==> _ATOMIC_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b150 ==> !_READ_HAS_OCCURRED_$$LocalBlock;
  requires _b151 ==> !_WRITE_HAS_OCCURRED_$$LocalBlock;
  requires _b152 ==> !_ATOMIC_HAS_OCCURRED_$$LocalBlock;
  requires _b153 ==> _READ_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b154 ==> _WRITE_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b155 ==> _ATOMIC_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _READ_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _WRITE_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _ATOMIC_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _b156 ==> $ret$1 == $ret$2;
  ensures _b157 ==> !_READ_HAS_OCCURRED_$$pSobelOriginal;
  ensures _b158 ==> !_WRITE_HAS_OCCURRED_$$pSobelOriginal;
  ensures _b159 ==> !_ATOMIC_HAS_OCCURRED_$$pSobelOriginal;
  ensures _b160 ==> _READ_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b161 ==> _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b162 ==> _ATOMIC_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b163 ==> !_READ_HAS_OCCURRED_$$blockFunction_table;
  ensures _b164 ==> !_WRITE_HAS_OCCURRED_$$blockFunction_table;
  ensures _b165 ==> !_ATOMIC_HAS_OCCURRED_$$blockFunction_table;
  ensures _b166 ==> _READ_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b167 ==> _WRITE_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b168 ==> _ATOMIC_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b169 ==> !_READ_HAS_OCCURRED_$$tex;
  ensures _b170 ==> !_WRITE_HAS_OCCURRED_$$tex;
  ensures _b171 ==> !_ATOMIC_HAS_OCCURRED_$$tex;
  ensures _b172 ==> _READ_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b173 ==> _WRITE_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b174 ==> _ATOMIC_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b175 ==> !_READ_HAS_OCCURRED_$$blockFunction;
  ensures _b176 ==> !_WRITE_HAS_OCCURRED_$$blockFunction;
  ensures _b177 ==> !_ATOMIC_HAS_OCCURRED_$$blockFunction;
  ensures _b178 ==> _READ_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b179 ==> _WRITE_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b180 ==> _ATOMIC_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b181 ==> !_READ_HAS_OCCURRED_$$LocalBlock;
  ensures _b182 ==> !_WRITE_HAS_OCCURRED_$$LocalBlock;
  ensures _b183 ==> !_ATOMIC_HAS_OCCURRED_$$LocalBlock;
  ensures _b184 ==> _READ_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b185 ==> _WRITE_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b186 ==> _ATOMIC_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
...
procedure {:source_name "Threshold"} $_Z9Thresholdhf(_P$1: bool, $in$1: bv8, $thresh$1: bv32, _P$2: bool, $in$2: bv8, $thresh$2: bv32) returns ($ret$1: bv8, $ret$2: bv8);
  ...
  requires BV32_SLT(local_id_z$2, group_size_z);
  requires group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> local_id_x$1 != local_id_x$2 || local_id_y$1 != local_id_y$2 || local_id_z$1 != local_id_z$2;
  requires _b187 ==> _P$1 == _P$2;
  requires _b188 ==> _P$1 && _P$2 ==> $in$1 == $in$2;
  requires _b189 ==> $in$1 == $in$2;
  requires _b190 ==> _P$1 && _P$2 ==> $thresh$1 == $thresh$2;
  requires _b191 ==> $thresh$1 == $thresh$2;
  requires _b192 ==> !_READ_HAS_OCCURRED_$$pSobelOriginal;
  requires _b193 ==> !_WRITE_HAS_OCCURRED_$$pSobelOriginal;
  requires _b194 ==> !_ATOMIC_HAS_OCCURRED_$$pSobelOriginal;
  requires _b195 ==> _READ_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b196 ==> _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b197 ==> _ATOMIC_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b198 ==> !_READ_HAS_OCCURRED_$$blockFunction_table;
  requires _b199 ==> !_WRITE_HAS_OCCURRED_$$blockFunction_table;
  requires _b200 ==> !_ATOMIC_HAS_OCCURRED_$$blockFunction_table;
  requires _b201 ==> _READ_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b202 ==> _WRITE_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b203 ==> _ATOMIC_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b204 ==> !_READ_HAS_OCCURRED_$$tex;
  requires _b205 ==> !_WRITE_HAS_OCCURRED_$$tex;
  requires _b206 ==> !_ATOMIC_HAS_OCCURRED_$$tex;
  requires _b207 ==> _READ_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b208 ==> _WRITE_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b209 ==> _ATOMIC_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b210 ==> !_READ_HAS_OCCURRED_$$blockFunction;
  requires _b211 ==> !_WRITE_HAS_OCCURRED_$$blockFunction;
  requires _b212 ==> !_ATOMIC_HAS_OCCURRED_$$blockFunction;
  requires _b213 ==> _READ_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b214 ==> _WRITE_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b215 ==> _ATOMIC_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b216 ==> !_READ_HAS_OCCURRED_$$LocalBlock;
  requires _b217 ==> !_WRITE_HAS_OCCURRED_$$LocalBlock;
  requires _b218 ==> !_ATOMIC_HAS_OCCURRED_$$LocalBlock;
  requires _b219 ==> _READ_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b220 ==> _WRITE_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  requires _b221 ==> _ATOMIC_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _READ_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _WRITE_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _ATOMIC_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ensures _b222 ==> $ret$1 == $ret$2;
  ensures _b223 ==> !_READ_HAS_OCCURRED_$$pSobelOriginal;
  ensures _b224 ==> !_WRITE_HAS_OCCURRED_$$pSobelOriginal;
  ensures _b225 ==> !_ATOMIC_HAS_OCCURRED_$$pSobelOriginal;
  ensures _b226 ==> _READ_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b227 ==> _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b228 ==> _ATOMIC_HAS_OCCURRED_$$pSobelOriginal ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b229 ==> !_READ_HAS_OCCURRED_$$blockFunction_table;
  ensures _b230 ==> !_WRITE_HAS_OCCURRED_$$blockFunction_table;
  ensures _b231 ==> !_ATOMIC_HAS_OCCURRED_$$blockFunction_table;
  ensures _b232 ==> _READ_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b233 ==> _WRITE_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b234 ==> _ATOMIC_HAS_OCCURRED_$$blockFunction_table ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b235 ==> !_READ_HAS_OCCURRED_$$tex;
  ensures _b236 ==> !_WRITE_HAS_OCCURRED_$$tex;
  ensures _b237 ==> !_ATOMIC_HAS_OCCURRED_$$tex;
  ensures _b238 ==> _READ_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b239 ==> _WRITE_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b240 ==> _ATOMIC_HAS_OCCURRED_$$tex ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b241 ==> !_READ_HAS_OCCURRED_$$blockFunction;
  ensures _b242 ==> !_WRITE_HAS_OCCURRED_$$blockFunction;
  ensures _b243 ==> !_ATOMIC_HAS_OCCURRED_$$blockFunction;
  ensures _b244 ==> _READ_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b245 ==> _WRITE_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b246 ==> _ATOMIC_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b247 ==> !_READ_HAS_OCCURRED_$$LocalBlock;
  ensures _b248 ==> !_WRITE_HAS_OCCURRED_$$LocalBlock;
  ensures _b249 ==> !_ATOMIC_HAS_OCCURRED_$$LocalBlock;
  ensures _b250 ==> _READ_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b251 ==> _WRITE_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
  ensures _b252 ==> _ATOMIC_HAS_OCCURRED_$$LocalBlock ==> _WATCHED_OFFSET == local_id_x$1;
...
implementation {:source_name "SobelShared"} {:kernel} $_Z11SobelSharedP6uchar4tssssfiPFhhfE($SobelPitch: bv16, $BlockWidth: bv16, $SharedPitch: bv16, $w: bv16, $h: bv16, $fScale: bv32, $blockOperation: bv32, $pPointFunction: functionPtr)
{
  ...
  $6:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b22 ==> _WRITE_HAS_OCCURRED_$$LocalBlock ==> BV32_ULT(local_id_y$1, 2bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p4$1 ==> _b21 ==> p4$1 ==> BV32_ULT(local_id_y$1, 2bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p4$2 ==> _b21 ==> p4$2 ==> BV32_ULT(local_id_y$2, 2bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b20 ==> BV32_ULT(local_id_y$1, 2bv32) && BV32_SLT(BV16_SEXT32($ib.1$1), BV32_ADD(BV16_SEXT32($BlockWidth), 2bv32)) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b20 ==> BV32_ULT(local_id_y$2, 2bv32) && BV32_SLT(BV16_SEXT32($ib.1$2), BV32_ADD(BV16_SEXT32($BlockWidth), 2bv32)) ==> p4$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b19 ==> !BV32_ULT(local_id_y$1, 2bv32) ==> !_READ_HAS_OCCURRED_$$tex;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b18 ==> !BV32_ULT(local_id_y$1, 2bv32) ==> !_WRITE_HAS_OCCURRED_$$LocalBlock;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b17 ==> !BV32_ULT(local_id_y$1, 2bv32) ==> !p4$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b17 ==> !BV32_ULT(local_id_y$2, 2bv32) ==> !p4$2;
  ...
  $11:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b255 ==> _READ_HAS_OCCURRED_$$blockFunction ==> _WATCHED_OFFSET == 0bv32;
    assert {:tag "accessUpperBoundBlock"} _b254 ==> _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV16_SEXT32(BV32_ADD(BV32_MUL(BV32_ADD(group_id_y$1, 1bv32), group_size_y), local_id_y$1)[16:0]), BV16_ZEXT32($SobelPitch)));
    assert {:tag "accessLowerBoundBlock"} _b253 ==> _WRITE_HAS_OCCURRED_$$pSobelOriginal ==> BV32_SLE(BV32_MUL(BV16_SEXT32(BV32_ADD(BV32_MUL(group_id_y$1, group_size_y), local_id_y$1)[16:0]), BV16_ZEXT32($SobelPitch)), _WATCHED_OFFSET);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$LocalBlock ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
