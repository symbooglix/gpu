...
procedure {:source_name "copy"} {:kernel} $_Z4copyPfS_iii($width: bv32, $height: bv32, $nreps: bv32);
...
implementation {:source_name "copy"} {:kernel} $_Z4copyPfS_iii($width: bv32, $height: bv32, $nreps: bv32)
{
  var $r.0: bv32;
  var $i.0: bv32;
  var v0$1: bv32;
  ...
  $0:
    v0$1 := BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, 16bv32), local_id_x$1), BV32_MUL($width, BV32_ADD(BV32_MUL(group_id_y$1, 16bv32), local_id_y$1)));
    v0$2 := BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, 16bv32), local_id_x$2), BV32_MUL($width, BV32_ADD(BV32_MUL(group_id_y$2, 16bv32), local_id_y$2)));
    $r.0 := 0bv32;
  ...
  $1:
    ...
    assert {:tag "accessBreak"} _b14 ==> _WRITE_HAS_OCCURRED_$$odata ==> local_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $width), BV32_DIV(BV32_MUL(group_id_x$1, 16bv32), $width)), BV32_MUL(group_id_y$1, 16bv32));
    assert {:tag "accessBreak"} _b13 ==> _WRITE_HAS_OCCURRED_$$odata ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $width), 16bv32), BV32_DIV(group_id_x$1, $width)), BV32_DIV(local_id_y$1, 16bv32));
    assert {:tag "accessBreak"} _b12 ==> _WRITE_HAS_OCCURRED_$$odata ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 16bv32), BV32_MUL(group_id_y$1, $width)), BV32_DIV(BV32_MUL(local_id_y$1, $width), 16bv32));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b11 ==> _WRITE_HAS_OCCURRED_$$odata ==> BV32_AND(BV32_SUB(BV32_MUL(16bv32, $width), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(16bv32, $width), 1bv32), BV32_ADD(BV32_MUL(0bv32, $width), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, 16bv32), local_id_x$1), BV32_MUL($width, BV32_ADD(BV32_MUL(group_id_y$1, 16bv32), local_id_y$1)))));
  ...
  $3:
    ...
    assert {:tag "accessBreak"} _b18 ==> _WRITE_HAS_OCCURRED_$$odata ==> local_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $width), BV32_DIV(BV32_MUL(group_id_x$1, 16bv32), $width)), BV32_MUL(group_id_y$1, 16bv32));
    assert {:tag "accessBreak"} _b17 ==> _WRITE_HAS_OCCURRED_$$odata ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $width), 16bv32), BV32_DIV(group_id_x$1, $width)), BV32_DIV(local_id_y$1, 16bv32));
    assert {:tag "accessBreak"} _b16 ==> _WRITE_HAS_OCCURRED_$$odata ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 16bv32), BV32_MUL(group_id_y$1, $width)), BV32_DIV(BV32_MUL(local_id_y$1, $width), 16bv32));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b15 ==> _WRITE_HAS_OCCURRED_$$odata ==> BV32_AND(BV32_SUB(BV32_MUL(16bv32, $width), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(16bv32, $width), 1bv32), BV32_ADD(BV32_MUL(0bv32, $width), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, 16bv32), local_id_x$1), BV32_MUL($width, BV32_ADD(BV32_MUL(group_id_y$1, 16bv32), local_id_y$1)))));
  ...
  $truebb0:
    assume {:partition} v2 && v2;
    havoc v3$1, v3$2;
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$odata(true, BV32_ADD(v0$1, BV32_MUL($i.0, $width)), v3$1, $$odata[BV32_ADD(v0$1, BV32_MUL($i.0, $width))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$odata(true, BV32_ADD(v0$2, BV32_MUL($i.0, $width)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$odata(true, BV32_ADD(v0$2, BV32_MUL($i.0, $width)), v3$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$odata"} true;
    $$odata[BV32_ADD(v0$1, BV32_MUL($i.0, $width))] := v3$1;
    $$odata[BV32_ADD(v0$2, BV32_MUL($i.0, $width))] := v3$2;
