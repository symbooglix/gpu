...
implementation {:source_name "transposeFineGrained"} {:kernel} $_Z20transposeFineGrainedPfS_iii($width: bv32, $height: bv32, $nreps: bv32)
{
  ...
  $1:
    ...
    assert {:tag "nowrite"} _b22 ==> !_WRITE_HAS_OCCURRED_$$_ZZ20transposeFineGrainedPfS_iiiE5block;
    assert {:tag "accessBreak"} _b21 ==> _WRITE_HAS_OCCURRED_$$odata ==> local_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, $width), BV32_DIV(BV32_MUL(group_id_x$1, 16bv32), $width)), BV32_MUL(group_id_y$1, 16bv32));
    assert {:tag "accessBreak"} _b20 ==> _WRITE_HAS_OCCURRED_$$odata ==> group_id_y$1 == BV32_SUB(BV32_SUB(BV32_DIV(BV32_DIV(_WATCHED_OFFSET, $width), 16bv32), BV32_DIV(group_id_x$1, $width)), BV32_DIV(local_id_y$1, 16bv32));
    assert {:tag "accessBreak"} _b19 ==> _WRITE_HAS_OCCURRED_$$odata ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 16bv32), BV32_MUL(group_id_y$1, $width)), BV32_DIV(BV32_MUL(local_id_y$1, $width), 16bv32));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b18 ==> _WRITE_HAS_OCCURRED_$$odata ==> BV32_AND(BV32_SUB(BV32_MUL(16bv32, $height), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(16bv32, $height), 1bv32), BV32_ADD(BV32_MUL(0bv32, $height), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, 16bv32), local_id_x$1), BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, 16bv32), local_id_y$1), $width))));
  ...
  $7:
    ...
    assert {:tag "accessBreak"} _b28 ==> _WRITE_HAS_OCCURRED_$$odata ==> group_id_x$1 == BV32_SUB(BV32_SUB(BV32_DIV(_WATCHED_OFFSET, 16bv32), BV32_MUL(group_id_y$1, $width)), BV32_DIV(BV32_MUL(local_id_y$1, $width), 16bv32));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b27 ==> _WRITE_HAS_OCCURRED_$$odata ==> BV32_AND(BV32_SUB(BV32_MUL(16bv32, $height), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(16bv32, $height), 1bv32), BV32_ADD(BV32_MUL(0bv32, $height), BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, 16bv32), local_id_x$1), BV32_MUL(BV32_ADD(BV32_MUL(group_id_y$1, 16bv32), local_id_y$1), $width))));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ20transposeFineGrainedPfS_iiiE5block ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ20transposeFineGrainedPfS_iiiE5block ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ20transposeFineGrainedPfS_iiiE5block ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
