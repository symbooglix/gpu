...
var {:source_name "tile"} {:group_shared} $$_ZZ24transposeNoBankConflictsPfS_iiiE4tile: [bv1][bv32]bv32;
...
procedure {:source_name "transposeNoBankConflicts"} {:kernel} $_Z24transposeNoBankConflictsPfS_iii($width: bv32, $height: bv32, $nreps: bv32);
  ...
  requires !_READ_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile && !_WRITE_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile && !_ATOMIC_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile;
  ...
  modifies $$_ZZ24transposeNoBankConflictsPfS_iiiE4tile, $$odata, _TRACKING, _TRACKING, _READ_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile, _WRITE_HAS_OCCURRED_$$odata, _WRITE_READ_BENIGN_FLAG_$$odata, _WRITE_READ_BENIGN_FLAG_$$odata, _WRITE_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile, _WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile, _WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile;



implementation {:source_name "transposeNoBankConflicts"} {:kernel} $_Z24transposeNoBankConflictsPfS_iii($width: bv32, $height: bv32, $nreps: bv32)
{
  var $r.0: bv32;
  var $i.0: bv32;
  var $i1.0: bv32;
  ...
  $1:
    ...
    assert {:tag "nowrite"} _b22 ==> !_WRITE_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile;
  ...
  $truebb0:
    assume {:partition} v1 && v1;
    havoc v2$1, v2$2;
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(true, BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, $i.0), 17bv32), local_id_x$1), v2$1, $$_ZZ24transposeNoBankConflictsPfS_iiiE4tile[1bv1][BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, $i.0), 17bv32), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(true, BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$2, $i.0), 17bv32), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(true, BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$2, $i.0), 17bv32), local_id_x$2), v2$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile"} true;
    $$_ZZ24transposeNoBankConflictsPfS_iiiE4tile[1bv1][BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, $i.0), 17bv32), local_id_x$1)] := v2$1;
...
procedure {:inline 1} {:safe_barrier} {:source_name "bugle_barrier"} {:barrier} $bugle_barrier_duplicated_0($0: bv1, $1: bv1);
  requires $0 == 1bv1;
  requires $1 == 1bv1;
  modifies $$_ZZ24transposeNoBankConflictsPfS_iiiE4tile, $$odata, _TRACKING;
...
const _WATCHED_VALUE_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile: bv32;

procedure {:inline 1} _LOG_READ_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile;



implementation {:inline 1} _LOG_READ_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(_P: bool, _offset: bv32, _value: bv32)
{

  log_access_entry:
    _READ_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile == _value then true else _READ_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile);
    return;
}



procedure _CHECK_READ_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "tile"} {:array "$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile"} {:race} {:write_read} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile && _WATCHED_OFFSET == _offset && _WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "tile"} {:array "$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile"} {:race} {:atomic_read} !(_P && _ATOMIC_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);



var _WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile: bool;

procedure {:inline 1} _LOG_WRITE_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile, _WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile;



implementation {:inline 1} _LOG_WRITE_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{

  log_access_entry:
    _WRITE_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile == _value then true else _WRITE_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile);
    _WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile == _value then _value != _value_old else _WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile);
    return;
}



procedure _CHECK_WRITE_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "tile"} {:array "$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile"} {:race} {:write_write} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile != _value && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "tile"} {:array "$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile"} {:race} {:read_write} !(_P && _READ_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile != _value && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "tile"} {:array "$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile"} {:race} {:atomic_write} !(_P && _ATOMIC_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);



procedure {:inline 1} _LOG_ATOMIC_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(_P: bool, _offset: bv32)
{

  log_access_entry:
    _ATOMIC_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset then true else _ATOMIC_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile);
    return;
}



procedure _CHECK_ATOMIC_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(_P: bool, _offset: bv32);
  requires {:source_name "tile"} {:array "$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile"} {:race} {:write_atomic} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "tile"} {:array "$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile"} {:race} {:read_atomic} !(_P && _READ_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);



procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile(_P: bool, _offset: bv32)
{

  _UPDATE_BENIGN_FLAG:
    _WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile := (if _P && _WRITE_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile && _WATCHED_OFFSET == _offset then false else _WRITE_READ_BENIGN_FLAG_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile);
    return;
}
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon0:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile;
    assume $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile;
    assume $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ24transposeNoBankConflictsPfS_iiiE4tile;
    goto anon1;
  ...
  anon8_Then:
    assume {:partition} $0 != 0bv1 || $0 != 0bv1;
    havoc $$_ZZ24transposeNoBankConflictsPfS_iiiE4tile;
    goto anon3;
