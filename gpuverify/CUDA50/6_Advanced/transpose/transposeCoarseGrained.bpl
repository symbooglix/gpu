...
var {:source_name "block"} {:group_shared} $$_ZZ22transposeCoarseGrainedPfS_iiiE5block: [bv1][bv32]bv32;

axiom {:array_info "$$_ZZ22transposeCoarseGrainedPfS_iiiE5block"} {:group_shared} {:elem_width 32} {:source_name "block"} {:source_elem_width 32} {:source_dimensions "16,17"} true;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*,17"} _READ_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block: bool;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*,17"} _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block: bool;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*,17"} _ATOMIC_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block: bool;
...
procedure {:source_name "transposeCoarseGrained"} {:kernel} $_Z22transposeCoarseGrainedPfS_iii($width: bv32, $height: bv32, $nreps: bv32);
  ...
  requires !_READ_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block && !_WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block && !_ATOMIC_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block;
  ...
  modifies $$_ZZ22transposeCoarseGrainedPfS_iiiE5block, $$odata, _TRACKING, _TRACKING, _READ_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block, _WRITE_HAS_OCCURRED_$$odata, _WRITE_READ_BENIGN_FLAG_$$odata, _WRITE_READ_BENIGN_FLAG_$$odata, _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block, _WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block, _WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block;



implementation {:source_name "transposeCoarseGrained"} {:kernel} $_Z22transposeCoarseGrainedPfS_iii($width: bv32, $height: bv32, $nreps: bv32)
{
  var $r.0: bv32;
  var $i.0: bv32;
  var $i1.0: bv32;
  ...
  $1:
    ...
    assert {:tag "accessBreak"} _b24 ==> _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 17bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b23 ==> _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block ==> BV32_AND(BV32_SUB(BV32_MUL(16bv32, 17bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(16bv32, 17bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, local_id_y$1), 17bv32), local_id_x$1));
    assert {:tag "nowrite"} _b22 ==> !_WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $3:
    ...
    assert {:tag "accessBreak"} _b26 ==> _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block ==> local_id_y$1 == BV32_DIV(_WATCHED_OFFSET, 17bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b25 ==> _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block ==> BV32_AND(BV32_SUB(BV32_MUL(16bv32, 17bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(16bv32, 17bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_ADD(0bv32, local_id_y$1), 17bv32), local_id_x$1));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $truebb1:
    ...
    v4$1 := $$_ZZ22transposeCoarseGrainedPfS_iiiE5block[1bv1][BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, $i1.0), 17bv32), local_id_x$1)];
    v4$2 := $$_ZZ22transposeCoarseGrainedPfS_iiiE5block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$2, $i1.0), 17bv32), local_id_x$2)];
  ...
  $truebb0:
    assume {:partition} v1 && v1;
    havoc v2$1, v2$2;
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(true, BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, $i.0), 17bv32), local_id_x$1), v2$1, $$_ZZ22transposeCoarseGrainedPfS_iiiE5block[1bv1][BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, $i.0), 17bv32), local_id_x$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(true, BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$2, $i.0), 17bv32), local_id_x$2));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 9} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(true, BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$2, $i.0), 17bv32), local_id_x$2), v2$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block"} true;
    $$_ZZ22transposeCoarseGrainedPfS_iiiE5block[1bv1][BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$1, $i.0), 17bv32), local_id_x$1)] := v2$1;
    $$_ZZ22transposeCoarseGrainedPfS_iiiE5block[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(BV32_ADD(local_id_y$2, $i.0), 17bv32), local_id_x$2)] := v2$2;
...
procedure {:inline 1} {:safe_barrier} {:source_name "bugle_barrier"} {:barrier} $bugle_barrier_duplicated_0($0: bv1, $1: bv1);
  requires $0 == 1bv1;
  requires $1 == 1bv1;
  modifies $$_ZZ22transposeCoarseGrainedPfS_iiiE5block, $$odata, _TRACKING;
...
const _WATCHED_VALUE_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block: bv32;

procedure {:inline 1} _LOG_READ_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block;



implementation {:inline 1} _LOG_READ_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(_P: bool, _offset: bv32, _value: bv32)
{

  log_access_entry:
    _READ_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block == _value then true else _READ_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block);
    return;
}



procedure _CHECK_READ_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "block"} {:array "$$_ZZ22transposeCoarseGrainedPfS_iiiE5block"} {:race} {:write_read} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block && _WATCHED_OFFSET == _offset && _WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "block"} {:array "$$_ZZ22transposeCoarseGrainedPfS_iiiE5block"} {:race} {:atomic_read} !(_P && _ATOMIC_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);



var _WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block: bool;

procedure {:inline 1} _LOG_WRITE_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block, _WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block;



implementation {:inline 1} _LOG_WRITE_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{

  log_access_entry:
    _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block == _value then true else _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block);
    _WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block == _value then _value != _value_old else _WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block);
    return;
}



procedure _CHECK_WRITE_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "block"} {:array "$$_ZZ22transposeCoarseGrainedPfS_iiiE5block"} {:race} {:write_write} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block != _value && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "block"} {:array "$$_ZZ22transposeCoarseGrainedPfS_iiiE5block"} {:race} {:read_write} !(_P && _READ_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block != _value && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "block"} {:array "$$_ZZ22transposeCoarseGrainedPfS_iiiE5block"} {:race} {:atomic_write} !(_P && _ATOMIC_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);



procedure {:inline 1} _LOG_ATOMIC_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block;



implementation {:inline 1} _LOG_ATOMIC_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(_P: bool, _offset: bv32)
{

  log_access_entry:
    _ATOMIC_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset then true else _ATOMIC_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block);
    return;
}



procedure _CHECK_ATOMIC_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(_P: bool, _offset: bv32);
  requires {:source_name "block"} {:array "$$_ZZ22transposeCoarseGrainedPfS_iiiE5block"} {:race} {:write_atomic} !(_P && _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "block"} {:array "$$_ZZ22transposeCoarseGrainedPfS_iiiE5block"} {:race} {:read_atomic} !(_P && _READ_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);



procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block(_P: bool, _offset: bv32)
{

  _UPDATE_BENIGN_FLAG:
    _WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block := (if _P && _WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block && _WATCHED_OFFSET == _offset then false else _WRITE_READ_BENIGN_FLAG_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block);
    return;
}
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon0:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block;
    assume $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block;
    assume $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ22transposeCoarseGrainedPfS_iiiE5block;
    goto anon1;
  ...
  anon8_Then:
    assume {:partition} $0 != 0bv1 || $0 != 0bv1;
    havoc $$_ZZ22transposeCoarseGrainedPfS_iiiE5block;
    goto anon3;
