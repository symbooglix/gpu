...
implementation {:source_name "bitonicMergeElementaryIntervalsKernel<1>"} {:kernel} $_Z37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jj($stride: bv32, $N: bv32)
{
  ...
  $18:
    ...
    assert {:tag "nowrite"} _b11 ==> !_WRITE_HAS_OCCURRED_$$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_val;
    assert {:tag "noread"} _b10 ==> !_READ_HAS_OCCURRED_$$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_val;
    assert {:tag "nowrite"} _b9 ==> !_WRITE_HAS_OCCURRED_$$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key;
    assert {:tag "noread"} _b8 ==> !_READ_HAS_OCCURRED_$$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key;
    assert {:tag "nowrite"} _b7 ==> !_WRITE_HAS_OCCURRED_$$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_inf;
    assert {:tag "noread"} _b6 ==> !_READ_HAS_OCCURRED_$$_ZZ37bitonicMergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_inf;
    assert {:tag "pow2NotZero"} _b5 ==> $stride1.0 != 0bv32;
    assert {:tag "pow2"} _b4 ==> $stride1.0 == 0bv32 || BV32_AND($stride1.0, BV32_SUB($stride1.0, 1bv32)) == 0bv32;
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($stride1.0, 128bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_UGE($stride1.0, 128bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($stride1.0, 128bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_ULE($stride1.0, 128bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($stride1.0, 128bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SGE($stride1.0, 128bv32);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($stride1.0, 128bv32);
    assert {:tag "loopBound"} {:thread 2} _b0 ==> BV32_SLE($stride1.0, 128bv32);
