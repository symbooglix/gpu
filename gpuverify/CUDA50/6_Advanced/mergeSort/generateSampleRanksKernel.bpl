...
var {:source_name "d_RanksA"} {:global} $$d_RanksA: [bv32]bv32;
...
var {:source_name "d_RanksB"} {:global} $$d_RanksB: [bv32]bv32;
...
procedure {:source_name "generateSampleRanksKernel<1>"} {:kernel} $_Z25generateSampleRanksKernelILj1EEvPjS0_S0_jjj($stride: bv32, $N: bv32, $threadCount: bv32);
  ...
  requires !_READ_HAS_OCCURRED_$$d_RanksA && !_WRITE_HAS_OCCURRED_$$d_RanksA && !_ATOMIC_HAS_OCCURRED_$$d_RanksA;
  requires !_READ_HAS_OCCURRED_$$d_RanksB && !_WRITE_HAS_OCCURRED_$$d_RanksB && !_ATOMIC_HAS_OCCURRED_$$d_RanksB;
  ...
  modifies _WRITE_HAS_OCCURRED_$$d_RanksA, _WRITE_READ_BENIGN_FLAG_$$d_RanksA, _WRITE_READ_BENIGN_FLAG_$$d_RanksA, _WRITE_HAS_OCCURRED_$$d_RanksB, _WRITE_READ_BENIGN_FLAG_$$d_RanksB, _WRITE_READ_BENIGN_FLAG_$$d_RanksB;



implementation {:source_name "generateSampleRanksKernel<1>"} {:kernel} $_Z25generateSampleRanksKernelILj1EEvPjS0_S0_jjj($stride: bv32, $N: bv32, $threadCount: bv32)
{
  var $0$1: bv32;
  var $0$2: bv32;
  var $1$1: bv32;
  ...
  $0:
    ...
    v4$1 := (if p1$1 then BV32_UDIV(v3$1, 128bv32) else v4$1);
    v4$2 := (if p1$2 then BV32_UDIV(v3$2, 128bv32) else v4$2);
    v5$1 := (if p1$1 then BV32_UDIV(v3$1, 128bv32) else v5$1);
    v5$2 := (if p1$2 then BV32_UDIV(v3$2, 128bv32) else v5$2);
    ...
    call {:sourceloc} {:sourceloc_num 14} _LOG_WRITE_$$d_RanksA(p8$1, BV32_ADD(v4$1, v2$1), BV32_MUL(v2$1, 128bv32), $$d_RanksA[BV32_ADD(v4$1, v2$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_RanksA(p8$2, BV32_ADD(v4$2, v2$2));
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 14} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 14} _CHECK_WRITE_$$d_RanksA(p8$2, BV32_ADD(v4$2, v2$2), BV32_MUL(v2$2, 128bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_RanksA"} true;
    $$d_RanksA[BV32_ADD(v4$1, v2$1)] := (if p8$1 then BV32_MUL(v2$1, 128bv32) else $$d_RanksA[BV32_ADD(v4$1, v2$1)]);
    $$d_RanksA[BV32_ADD(v4$2, v2$2)] := (if p8$2 then BV32_MUL(v2$2, 128bv32) else $$d_RanksA[BV32_ADD(v4$2, v2$2)]);
    v10$1 := (if p8$1 then $$d_SrcKey[BV32_ADD(v3$1, BV32_MUL(v2$1, 128bv32))] else v10$1);
    v10$2 := (if p8$2 then $$d_SrcKey[BV32_ADD(v3$2, BV32_MUL(v2$2, 128bv32))] else v10$2);
    call v11$1, v11$2 := BV32_CTLZ(false, p8$1, BV32_SUB($0$1, 1bv32), p8$2, BV32_SUB($0$2, 1bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "BV32_CTLZ"} true;
    v12$1 := (if p8$1 then $0$1 == 0bv32 else v12$1);
    v12$2 := (if p8$2 then $0$2 == 0bv32 else v12$2);
    ...
    $pos.i2.0$1, $.01$1 := (if p10$1 then 0bv32 else $pos.i2.0$1), (if p10$1 then BV32_SHL(1bv32, BV32_SUB(32bv32, v11$1)) else $.01$1);
    $pos.i2.0$2, $.01$2 := (if p10$2 then 0bv32 else $pos.i2.0$2), (if p10$2 then BV32_SHL(1bv32, BV32_SUB(32bv32, v11$2)) else $.01$2);
  ...
  $13:
    ...
    v13$1 := (if p11$1 then BV32_UGT($.01$1, 0bv32) else v13$1);
    v13$2 := (if p11$2 then BV32_UGT($.01$2, 0bv32) else v13$2);
    p12$1 := false;
    p12$2 := false;
    p13$1 := false;
    p13$2 := false;
    ...
    v14$1 := (if p12$1 then BV32_ULT(BV32_ADD($pos.i2.0$1, $.01$1), $0$1) else v14$1);
    v14$2 := (if p12$2 then BV32_ULT(BV32_ADD($pos.i2.0$2, $.01$2), $0$2) else v14$2);
    ...
    $3$1 := (if p13$1 then $0$1 else $3$1);
    $3$2 := (if p13$2 then $0$2 else $3$2);
    $3$1 := (if p14$1 then BV32_ADD($pos.i2.0$1, $.01$1) else $3$1);
    $3$2 := (if p14$2 then BV32_ADD($pos.i2.0$2, $.01$2) else $3$2);
    v15$1 := (if p12$1 then $$d_SrcKey[BV32_ADD(BV32_ADD(v3$1, $stride), BV32_SUB($3$1, 1bv32))] else v15$1);
    v15$2 := (if p12$2 then $$d_SrcKey[BV32_ADD(BV32_ADD(v3$2, $stride), BV32_SUB($3$2, 1bv32))] else v15$2);
    ...
    $pos.i2.1$1 := (if p15$1 then $pos.i2.0$1 else $pos.i2.1$1);
    $pos.i2.1$2 := (if p15$2 then $pos.i2.0$2 else $pos.i2.1$2);
    $pos.i2.1$1 := (if p16$1 then $3$1 else $pos.i2.1$1);
    $pos.i2.1$2 := (if p16$2 then $3$2 else $pos.i2.1$2);
    $pos.i2.0$1, $.01$1 := (if p12$1 then $pos.i2.1$1 else $pos.i2.0$1), (if p12$1 then BV32_LSHR($.01$1, 1bv32) else $.01$1);
    $pos.i2.0$2, $.01$2 := (if p12$2 then $pos.i2.1$2 else $pos.i2.0$2), (if p12$2 then BV32_LSHR($.01$2, 1bv32) else $.01$2);
  ...
  $13.tail:
    assume !p11$1 && !p11$2;
    $.0$1 := (if p10$1 then $pos.i2.0$1 else $.0$1);
    $.0$2 := (if p10$2 then $pos.i2.0$2 else $.0$2);
    call {:sourceloc} {:sourceloc_num 28} _LOG_WRITE_$$d_RanksB(p8$1, BV32_ADD(v5$1, v2$1), $.0$1, $$d_RanksB[BV32_ADD(v5$1, v2$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_RanksB(p8$2, BV32_ADD(v5$2, v2$2));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 28} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 28} _CHECK_WRITE_$$d_RanksB(p8$2, BV32_ADD(v5$2, v2$2), $.0$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_RanksB"} true;
    $$d_RanksB[BV32_ADD(v5$1, v2$1)] := (if p8$1 then $.0$1 else $$d_RanksB[BV32_ADD(v5$1, v2$1)]);
    $$d_RanksB[BV32_ADD(v5$2, v2$2)] := (if p8$2 then $.0$2 else $$d_RanksB[BV32_ADD(v5$2, v2$2)]);
    v17$1 := (if p1$1 then BV32_ULT(v2$1, $2$1) else v17$1);
    v17$2 := (if p1$2 then BV32_ULT(v2$2, $2$2) else v17$2);
    p18$1 := (if p1$1 && v17$1 then v17$1 else p18$1);
    p18$2 := (if p1$2 && v17$2 then v17$2 else p18$2);
    call {:sourceloc} {:sourceloc_num 31} _LOG_WRITE_$$d_RanksB(p18$1, BV32_ADD(v5$1, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$1)), BV32_MUL(v2$1, 128bv32), $$d_RanksB[BV32_ADD(v5$1, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$1))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_RanksB(p18$2, BV32_ADD(v5$2, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$2)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 31} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 31} _CHECK_WRITE_$$d_RanksB(p18$2, BV32_ADD(v5$2, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$2)), BV32_MUL(v2$2, 128bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_RanksB"} true;
    $$d_RanksB[BV32_ADD(v5$1, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$1))] := (if p18$1 then BV32_MUL(v2$1, 128bv32) else $$d_RanksB[BV32_ADD(v5$1, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$1))]);
    $$d_RanksB[BV32_ADD(v5$2, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$2))] := (if p18$2 then BV32_MUL(v2$2, 128bv32) else $$d_RanksB[BV32_ADD(v5$2, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$2))]);
    v18$1 := (if p18$1 then $$d_SrcKey[BV32_ADD(v3$1, BV32_ADD($stride, BV32_MUL(v2$1, 128bv32)))] else v18$1);
    v18$2 := (if p18$2 then $$d_SrcKey[BV32_ADD(v3$2, BV32_ADD($stride, BV32_MUL(v2$2, 128bv32)))] else v18$2);
    call v19$1, v19$2 := BV32_CTLZ(false, p18$1, BV32_SUB($stride, 1bv32), p18$2, BV32_SUB($stride, 1bv32));
    assume {:captureState "call_return_state_0"} {:procedureName "BV32_CTLZ"} true;
    v20$1 := (if p18$1 then $stride == 0bv32 else v20$1);
    v20$2 := (if p18$2 then $stride == 0bv32 else v20$2);
    p19$1 := (if p18$1 && v20$1 then v20$1 else p19$1);
    p19$2 := (if p18$2 && v20$2 then v20$2 else p19$2);
    p20$1 := (if p18$1 && !v20$1 then !v20$1 else p20$1);
    p20$2 := (if p18$2 && !v20$2 then !v20$2 else p20$2);
    $.03$1 := (if p19$1 then 0bv32 else $.03$1);
    $.03$2 := (if p19$2 then 0bv32 else $.03$2);
    $.02$1, $pos.i.0$1 := (if p20$1 then BV32_SHL(1bv32, BV32_SUB(32bv32, v19$1)) else $.02$1), (if p20$1 then 0bv32 else $pos.i.0$1);
    $.02$2, $pos.i.0$2 := (if p20$2 then BV32_SHL(1bv32, BV32_SUB(32bv32, v19$2)) else $.02$2), (if p20$2 then 0bv32 else $pos.i.0$2);
  ...
  $25:
    ...
    v21$1 := (if p21$1 then BV32_UGT($.02$1, 0bv32) else v21$1);
    v21$2 := (if p21$2 then BV32_UGT($.02$2, 0bv32) else v21$2);
    p22$1 := false;
    p22$2 := false;
    p23$1 := false;
    p23$2 := false;
    ...
    p26$1 := false;
    p26$2 := false;
    p22$1 := (if p21$1 && v21$1 then v21$1 else p22$1);
    p22$2 := (if p21$2 && v21$2 then v21$2 else p22$2);
    p21$1 := (if p21$1 && !v21$1 then v21$1 else p21$1);
    p21$2 := (if p21$2 && !v21$2 then v21$2 else p21$2);
    v22$1 := (if p22$1 then BV32_ULT(BV32_ADD($pos.i.0$1, $.02$1), $stride) else v22$1);
    v22$2 := (if p22$2 then BV32_ULT(BV32_ADD($pos.i.0$2, $.02$2), $stride) else v22$2);
    p24$1 := (if p22$1 && v22$1 then v22$1 else p24$1);
    p24$2 := (if p22$2 && v22$2 then v22$2 else p24$2);
    p23$1 := (if p22$1 && !v22$1 then !v22$1 else p23$1);
    p23$2 := (if p22$2 && !v22$2 then !v22$2 else p23$2);
    $4$1 := (if p23$1 then $stride else $4$1);
    $4$2 := (if p23$2 then $stride else $4$2);
    $4$1 := (if p24$1 then BV32_ADD($pos.i.0$1, $.02$1) else $4$1);
    $4$2 := (if p24$2 then BV32_ADD($pos.i.0$2, $.02$2) else $4$2);
    v23$1 := (if p22$1 then $$d_SrcKey[BV32_ADD(v3$1, BV32_SUB($4$1, 1bv32))] else v23$1);
    v23$2 := (if p22$2 then $$d_SrcKey[BV32_ADD(v3$2, BV32_SUB($4$2, 1bv32))] else v23$2);
    v24$1 := (if p22$1 then BV32_ULE(v23$1, v18$1) else v24$1);
    v24$2 := (if p22$2 then BV32_ULE(v23$2, v18$2) else v24$2);
    p26$1 := (if p22$1 && v24$1 then v24$1 else p26$1);
    p26$2 := (if p22$2 && v24$2 then v24$2 else p26$2);
    p25$1 := (if p22$1 && !v24$1 then !v24$1 else p25$1);
    p25$2 := (if p22$2 && !v24$2 then !v24$2 else p25$2);
    ...
    $.02$1, $pos.i.0$1 := (if p22$1 then BV32_LSHR($.02$1, 1bv32) else $.02$1), (if p22$1 then $pos.i.1$1 else $pos.i.0$1);
    $.02$2, $pos.i.0$2 := (if p22$2 then BV32_LSHR($.02$2, 1bv32) else $.02$2), (if p22$2 then $pos.i.1$2 else $pos.i.0$2);
  ...
  $25.tail:
    ...
    call {:sourceloc} {:sourceloc_num 45} _LOG_WRITE_$$d_RanksA(p18$1, BV32_ADD(v4$1, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$1)), $.03$1, $$d_RanksA[BV32_ADD(v4$1, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$1))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_RanksA(p18$2, BV32_ADD(v4$2, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$2)));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 45} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 45} _CHECK_WRITE_$$d_RanksA(p18$2, BV32_ADD(v4$2, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$2)), $.03$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$d_RanksA"} true;
    $$d_RanksA[BV32_ADD(v4$1, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$1))] := (if p18$1 then $.03$1 else $$d_RanksA[BV32_ADD(v4$1, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$1))]);
    $$d_RanksA[BV32_ADD(v4$2, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$2))] := (if p18$2 then $.03$2 else $$d_RanksA[BV32_ADD(v4$2, BV32_ADD(BV32_UDIV($stride, 128bv32), v2$2))]);
    return;
...
const _WATCHED_VALUE_$$d_RanksA: bv32;

procedure {:inline 1} _LOG_READ_$$d_RanksA(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$d_RanksA;



implementation {:inline 1} _LOG_READ_$$d_RanksA(_P: bool, _offset: bv32, _value: bv32)
{

  log_access_entry:
    _READ_HAS_OCCURRED_$$d_RanksA := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$d_RanksA == _value then true else _READ_HAS_OCCURRED_$$d_RanksA);
    return;
}



procedure _CHECK_READ_$$d_RanksA(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "d_RanksA"} {:array "$$d_RanksA"} {:race} {:write_read} !(_P && _WRITE_HAS_OCCURRED_$$d_RanksA && _WATCHED_OFFSET == _offset && _WRITE_READ_BENIGN_FLAG_$$d_RanksA);
  requires {:source_name "d_RanksA"} {:array "$$d_RanksA"} {:race} {:atomic_read} !(_P && _ATOMIC_HAS_OCCURRED_$$d_RanksA && _WATCHED_OFFSET == _offset);



var _WRITE_READ_BENIGN_FLAG_$$d_RanksA: bool;

procedure {:inline 1} _LOG_WRITE_$$d_RanksA(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$d_RanksA, _WRITE_READ_BENIGN_FLAG_$$d_RanksA;



implementation {:inline 1} _LOG_WRITE_$$d_RanksA(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{

  log_access_entry:
    _WRITE_HAS_OCCURRED_$$d_RanksA := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$d_RanksA == _value then true else _WRITE_HAS_OCCURRED_$$d_RanksA);
    _WRITE_READ_BENIGN_FLAG_$$d_RanksA := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$d_RanksA == _value then _value != _value_old else _WRITE_READ_BENIGN_FLAG_$$d_RanksA);
    return;
}



procedure _CHECK_WRITE_$$d_RanksA(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "d_RanksA"} {:array "$$d_RanksA"} {:race} {:write_write} !(_P && _WRITE_HAS_OCCURRED_$$d_RanksA && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$d_RanksA != _value);
  requires {:source_name "d_RanksA"} {:array "$$d_RanksA"} {:race} {:read_write} !(_P && _READ_HAS_OCCURRED_$$d_RanksA && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$d_RanksA != _value);
  requires {:source_name "d_RanksA"} {:array "$$d_RanksA"} {:race} {:atomic_write} !(_P && _ATOMIC_HAS_OCCURRED_$$d_RanksA && _WATCHED_OFFSET == _offset);



procedure {:inline 1} _LOG_ATOMIC_$$d_RanksA(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$d_RanksA;



implementation {:inline 1} _LOG_ATOMIC_$$d_RanksA(_P: bool, _offset: bv32)
{

  log_access_entry:
    _ATOMIC_HAS_OCCURRED_$$d_RanksA := (if _P && _TRACKING && _WATCHED_OFFSET == _offset then true else _ATOMIC_HAS_OCCURRED_$$d_RanksA);
    return;
}



procedure _CHECK_ATOMIC_$$d_RanksA(_P: bool, _offset: bv32);
  requires {:source_name "d_RanksA"} {:array "$$d_RanksA"} {:race} {:write_atomic} !(_P && _WRITE_HAS_OCCURRED_$$d_RanksA && _WATCHED_OFFSET == _offset);
  requires {:source_name "d_RanksA"} {:array "$$d_RanksA"} {:race} {:read_atomic} !(_P && _READ_HAS_OCCURRED_$$d_RanksA && _WATCHED_OFFSET == _offset);



procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_RanksA(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$d_RanksA;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_RanksA(_P: bool, _offset: bv32)
{

  _UPDATE_BENIGN_FLAG:
    _WRITE_READ_BENIGN_FLAG_$$d_RanksA := (if _P && _WRITE_HAS_OCCURRED_$$d_RanksA && _WATCHED_OFFSET == _offset then false else _WRITE_READ_BENIGN_FLAG_$$d_RanksA);
    return;
}



const _WATCHED_VALUE_$$d_RanksB: bv32;

procedure {:inline 1} _LOG_READ_$$d_RanksB(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$d_RanksB;



implementation {:inline 1} _LOG_READ_$$d_RanksB(_P: bool, _offset: bv32, _value: bv32)
{

  log_access_entry:
    _READ_HAS_OCCURRED_$$d_RanksB := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$d_RanksB == _value then true else _READ_HAS_OCCURRED_$$d_RanksB);
    return;
}



procedure _CHECK_READ_$$d_RanksB(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "d_RanksB"} {:array "$$d_RanksB"} {:race} {:write_read} !(_P && _WRITE_HAS_OCCURRED_$$d_RanksB && _WATCHED_OFFSET == _offset && _WRITE_READ_BENIGN_FLAG_$$d_RanksB);
  requires {:source_name "d_RanksB"} {:array "$$d_RanksB"} {:race} {:atomic_read} !(_P && _ATOMIC_HAS_OCCURRED_$$d_RanksB && _WATCHED_OFFSET == _offset);



var _WRITE_READ_BENIGN_FLAG_$$d_RanksB: bool;

procedure {:inline 1} _LOG_WRITE_$$d_RanksB(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$d_RanksB, _WRITE_READ_BENIGN_FLAG_$$d_RanksB;



implementation {:inline 1} _LOG_WRITE_$$d_RanksB(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{

  log_access_entry:
    _WRITE_HAS_OCCURRED_$$d_RanksB := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$d_RanksB == _value then true else _WRITE_HAS_OCCURRED_$$d_RanksB);
    _WRITE_READ_BENIGN_FLAG_$$d_RanksB := (if _P && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$d_RanksB == _value then _value != _value_old else _WRITE_READ_BENIGN_FLAG_$$d_RanksB);
    return;
}



procedure _CHECK_WRITE_$$d_RanksB(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "d_RanksB"} {:array "$$d_RanksB"} {:race} {:write_write} !(_P && _WRITE_HAS_OCCURRED_$$d_RanksB && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$d_RanksB != _value);
  requires {:source_name "d_RanksB"} {:array "$$d_RanksB"} {:race} {:read_write} !(_P && _READ_HAS_OCCURRED_$$d_RanksB && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$d_RanksB != _value);
  requires {:source_name "d_RanksB"} {:array "$$d_RanksB"} {:race} {:atomic_write} !(_P && _ATOMIC_HAS_OCCURRED_$$d_RanksB && _WATCHED_OFFSET == _offset);



procedure {:inline 1} _LOG_ATOMIC_$$d_RanksB(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$d_RanksB;



implementation {:inline 1} _LOG_ATOMIC_$$d_RanksB(_P: bool, _offset: bv32)
{

  log_access_entry:
    _ATOMIC_HAS_OCCURRED_$$d_RanksB := (if _P && _TRACKING && _WATCHED_OFFSET == _offset then true else _ATOMIC_HAS_OCCURRED_$$d_RanksB);
    return;
}



procedure _CHECK_ATOMIC_$$d_RanksB(_P: bool, _offset: bv32);
  requires {:source_name "d_RanksB"} {:array "$$d_RanksB"} {:race} {:write_atomic} !(_P && _WRITE_HAS_OCCURRED_$$d_RanksB && _WATCHED_OFFSET == _offset);
  requires {:source_name "d_RanksB"} {:array "$$d_RanksB"} {:race} {:read_atomic} !(_P && _READ_HAS_OCCURRED_$$d_RanksB && _WATCHED_OFFSET == _offset);



procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_RanksB(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$d_RanksB;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$d_RanksB(_P: bool, _offset: bv32)
{

  _UPDATE_BENIGN_FLAG:
    _WRITE_READ_BENIGN_FLAG_$$d_RanksB := (if _P && _WRITE_HAS_OCCURRED_$$d_RanksB && _WATCHED_OFFSET == _offset then false else _WRITE_READ_BENIGN_FLAG_$$d_RanksB);
    return;
}
