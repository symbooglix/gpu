...
implementation {:source_name "mergeElementaryIntervalsKernel<1>"} {:kernel} $_Z30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jj($stride: bv32, $N: bv32)
{
  ...
  $23:
    ...
    assert {:tag "pow2NotZero"} _b29 ==> $.03$2 != 0bv32;
    assert {:tag "pow2"} _b28 ==> $.03$2 == 0bv32 || BV32_AND($.03$2, BV32_SUB($.03$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b27 ==> $.03$1 != 0bv32;
    assert {:tag "pow2"} _b26 ==> $.03$1 == 0bv32 || BV32_AND($.03$1, BV32_SUB($.03$1, 1bv32)) == 0bv32;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b25 ==> _READ_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key ==> BV32_ULT(local_id_x$1, v31$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p19$1 ==> _b24 ==> p19$1 ==> BV32_ULT(local_id_x$1, v31$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p19$2 ==> _b24 ==> p19$2 ==> BV32_ULT(local_id_x$2, v31$2);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b23 ==> BV32_ULT(local_id_x$1, v31$1) && BV32_UGT($.03$1, 0bv32) ==> p19$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b23 ==> BV32_ULT(local_id_x$2, v31$2) && BV32_UGT($.03$2, 0bv32) ==> p19$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b22 ==> !BV32_ULT(local_id_x$1, v31$1) ==> !_READ_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b21 ==> !BV32_ULT(local_id_x$1, v31$1) ==> !p19$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b21 ==> !BV32_ULT(local_id_x$2, v31$2) ==> !p19$2;
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b20 ==> BV32_UGE($pos.i.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b20 ==> BV32_UGE($pos.i.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b19 ==> BV32_ULE($pos.i.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b19 ==> BV32_ULE($pos.i.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b18 ==> BV32_SGE($pos.i.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b18 ==> BV32_SGE($pos.i.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b17 ==> BV32_SLE($pos.i.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b17 ==> BV32_SLE($pos.i.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b16 ==> BV32_UGE($.03$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b16 ==> BV32_UGE($.03$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b15 ==> BV32_ULE($.03$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b15 ==> BV32_ULE($.03$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b14 ==> BV32_SGE($.03$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b14 ==> BV32_SGE($.03$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p19$1 ==> _b13 ==> BV32_SLE($.03$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p19$2 ==> _b13 ==> BV32_SLE($.03$2, 128bv32);
  ...
  $35:
    ...
    assert {:tag "pow2NotZero"} _b33 ==> $.01$2 != 0bv32;
    assert {:tag "pow2"} _b32 ==> $.01$2 == 0bv32 || BV32_AND($.01$2, BV32_SUB($.01$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b31 ==> $.01$1 != 0bv32;
    assert {:tag "pow2"} _b30 ==> $.01$1 == 0bv32 || BV32_AND($.01$1, BV32_SUB($.01$1, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE9startSrcA ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE9startSrcA ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b12 ==> _READ_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key ==> BV32_ULT(local_id_x$1, v32$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p29$1 ==> _b11 ==> p29$1 ==> BV32_ULT(local_id_x$1, v32$1);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p29$2 ==> _b11 ==> p29$2 ==> BV32_ULT(local_id_x$2, v32$2);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b10 ==> BV32_ULT(local_id_x$1, v32$1) && BV32_UGT($.01$1, 0bv32) ==> p29$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b10 ==> BV32_ULT(local_id_x$2, v32$2) && BV32_UGT($.01$2, 0bv32) ==> p29$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b9 ==> !BV32_ULT(local_id_x$1, v32$1) ==> !_READ_HAS_OCCURRED_$$_ZZ30mergeElementaryIntervalsKernelILj1EEvPjS0_S0_S0_S0_S0_jjE5s_key;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b8 ==> !BV32_ULT(local_id_x$1, v32$1) ==> !p29$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b8 ==> !BV32_ULT(local_id_x$2, v32$2) ==> !p29$2;
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b7 ==> BV32_UGE($pos.i1.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b7 ==> BV32_UGE($pos.i1.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b6 ==> BV32_ULE($pos.i1.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b6 ==> BV32_ULE($pos.i1.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b5 ==> BV32_SGE($pos.i1.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b5 ==> BV32_SGE($pos.i1.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b4 ==> BV32_SLE($pos.i1.i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b4 ==> BV32_SLE($pos.i1.i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b3 ==> BV32_UGE($.01$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b3 ==> BV32_UGE($.01$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b2 ==> BV32_ULE($.01$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b2 ==> BV32_ULE($.01$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b1 ==> BV32_SGE($.01$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b1 ==> BV32_SGE($.01$2, 128bv32);
    assert {:tag "loopBound"} {:thread 1} p29$1 ==> _b0 ==> BV32_SLE($.01$1, 128bv32);
    assert {:tag "loopBound"} {:thread 2} p29$2 ==> _b0 ==> BV32_SLE($.01$2, 128bv32);
