...
implementation {:source_name "oddEvenMergeSortShared"} {:kernel} $_Z22oddEvenMergeSortSharedPjS_S_S_jj($arrayLength: bv32, $dir: bv32)
{
  ...
  $1:
    ...
    assert {:tag "relationalPow2"} _b45 ==> ($stride.0 == 0bv32 && $size.0 == 2bv32) || BV32_MUL($size.0, $stride.0) == 1bv32;
    assert {:tag "relationalPow2"} _b44 ==> BV32_MUL($size.0, $stride.0) == 1bv32;
    assert {:tag "relationalPow2"} _b43 ==> ($stride.0 == 0bv32 && $size.0 == 4bv32) || BV32_MUL($size.0, $stride.0) == 2bv32;
    assert {:tag "relationalPow2"} _b42 ==> BV32_MUL($size.0, $stride.0) == 2bv32;
    assert {:tag "relationalPow2"} _b41 ==> ($stride.0 == 0bv32 && $size.0 == 8bv32) || BV32_MUL($size.0, $stride.0) == 4bv32;
    assert {:tag "relationalPow2"} _b40 ==> BV32_MUL($size.0, $stride.0) == 4bv32;
    assert {:tag "relationalPow2"} _b39 ==> ($stride.0 == 0bv32 && $size.0 == 16bv32) || BV32_MUL($size.0, $stride.0) == 8bv32;
    assert {:tag "relationalPow2"} _b38 ==> BV32_MUL($size.0, $stride.0) == 8bv32;
    assert {:tag "relationalPow2"} _b37 ==> ($stride.0 == 0bv32 && $size.0 == 32bv32) || BV32_MUL($size.0, $stride.0) == 16bv32;
    assert {:tag "relationalPow2"} _b36 ==> BV32_MUL($size.0, $stride.0) == 16bv32;
    assert {:tag "relationalPow2"} _b35 ==> ($stride.0 == 0bv32 && $size.0 == 64bv32) || BV32_MUL($size.0, $stride.0) == 32bv32;
    assert {:tag "relationalPow2"} _b34 ==> BV32_MUL($size.0, $stride.0) == 32bv32;
    assert {:tag "relationalPow2"} _b33 ==> ($stride.0 == 0bv32 && $size.0 == 128bv32) || BV32_MUL($size.0, $stride.0) == 64bv32;
    assert {:tag "relationalPow2"} _b32 ==> BV32_MUL($size.0, $stride.0) == 64bv32;
    assert {:tag "relationalPow2"} _b31 ==> ($stride.0 == 0bv32 && $size.0 == 256bv32) || BV32_MUL($size.0, $stride.0) == 128bv32;
    assert {:tag "relationalPow2"} _b30 ==> BV32_MUL($size.0, $stride.0) == 128bv32;
    assert {:tag "relationalPow2"} _b29 ==> ($stride.0 == 0bv32 && $size.0 == 512bv32) || BV32_MUL($size.0, $stride.0) == 256bv32;
    assert {:tag "relationalPow2"} _b28 ==> BV32_MUL($size.0, $stride.0) == 256bv32;
    assert {:tag "relationalPow2"} _b27 ==> ($stride.0 == 0bv32 && $size.0 == 1024bv32) || BV32_MUL($size.0, $stride.0) == 512bv32;
    assert {:tag "relationalPow2"} _b26 ==> BV32_MUL($size.0, $stride.0) == 512bv32;
    assert {:tag "relationalPow2"} _b25 ==> ($stride.0 == 0bv32 && $size.0 == 2048bv32) || BV32_MUL($size.0, $stride.0) == 1024bv32;
    assert {:tag "relationalPow2"} _b24 ==> BV32_MUL($size.0, $stride.0) == 1024bv32;
    assert {:tag "relationalPow2"} _b23 ==> ($stride.0 == 0bv32 && $size.0 == 4096bv32) || BV32_MUL($size.0, $stride.0) == 2048bv32;
    assert {:tag "relationalPow2"} _b22 ==> BV32_MUL($size.0, $stride.0) == 2048bv32;
    assert {:tag "relationalPow2"} _b21 ==> ($stride.0 == 0bv32 && $size.0 == 8192bv32) || BV32_MUL($size.0, $stride.0) == 4096bv32;
    assert {:tag "relationalPow2"} _b20 ==> BV32_MUL($size.0, $stride.0) == 4096bv32;
    assert {:tag "relationalPow2"} _b19 ==> ($stride.0 == 0bv32 && $size.0 == 16384bv32) || BV32_MUL($size.0, $stride.0) == 8192bv32;
    assert {:tag "relationalPow2"} _b18 ==> BV32_MUL($size.0, $stride.0) == 8192bv32;
    assert {:tag "relationalPow2"} _b17 ==> ($stride.0 == 0bv32 && $size.0 == 32768bv32) || BV32_MUL($size.0, $stride.0) == 16384bv32;
    assert {:tag "relationalPow2"} _b16 ==> BV32_MUL($size.0, $stride.0) == 16384bv32;
    assert {:tag "relationalPow2"} _b15 ==> ($stride.0 == 0bv32 && $size.0 == 65536bv32) || BV32_MUL($size.0, $stride.0) == 32768bv32;
    assert {:tag "relationalPow2"} _b14 ==> BV32_MUL($size.0, $stride.0) == 32768bv32;
    assert {:tag "pow2NotZero"} _b13 ==> v9 != 0bv32;
    assert {:tag "pow2"} _b12 ==> v9 == 0bv32 || BV32_AND(v9, BV32_SUB(v9, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b11 ==> $stride.0 != 0bv32;
    assert {:tag "pow2"} _b10 ==> $stride.0 == 0bv32 || BV32_AND($stride.0, BV32_SUB($stride.0, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b9 ==> $size.0 != 0bv32;
    assert {:tag "pow2"} _b8 ==> $size.0 == 0bv32 || BV32_AND($size.0, BV32_SUB($size.0, 1bv32)) == 0bv32;
  ...
  __partitioned_block_$falsebb_1:
    ...
    $$d_DstVal[v3$1] := v33$1;
    $$d_DstVal[v3$2] := v33$2;
    call {:sourceloc} {:sourceloc_num 50} _LOG_READ_$$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_key(true, BV32_ADD(local_id_x$1, 512bv32), $$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_key[1bv1][BV32_ADD(local_id_x$1, 512bv32)]);
    ...
    call {:sourceloc} {:sourceloc_num 52} _LOG_READ_$$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_val(true, BV32_ADD(local_id_x$1, 512bv32), $$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_val[1bv1][BV32_ADD(local_id_x$1, 512bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 52} true;
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 52} _CHECK_READ_$$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_val(true, BV32_ADD(local_id_x$2, 512bv32), $$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_val[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 512bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_val"} true;
  ...
  $4:
    ...
    assert {:tag "nowrite"} _b53 ==> !_WRITE_HAS_OCCURRED_$$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_key;
    assert {:tag "noread"} _b52 ==> !_READ_HAS_OCCURRED_$$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_key;
    assert {:tag "pow2NotZero"} _b51 ==> $stride.0 != 0bv32;
    assert {:tag "pow2"} _b50 ==> $stride.0 == 0bv32 || BV32_AND($stride.0, BV32_SUB($stride.0, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_val ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_key ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_key ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ22oddEvenMergeSortSharedPjS_S_S_jjE5s_key ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_UGE($stride.0, BV32_LSHR(v9, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_UGE($stride.0, BV32_LSHR(v9, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_ULE($stride.0, BV32_LSHR(v9, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_ULE($stride.0, BV32_LSHR(v9, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_SGE($stride.0, BV32_LSHR(v9, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b5 ==> BV32_SGE($stride.0, BV32_LSHR(v9, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_SLE($stride.0, BV32_LSHR(v9, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_SLE($stride.0, BV32_LSHR(v9, 1bv32));
