...
implementation {:source_name "reduce0<int>"} {:kernel} $_Z7reduce0IiEvPT_S1_j($n: bv32)
{
  var $0$1: bv32;
  var $0$2: bv32;
  var $s.0: bv32;
  ...
  __partitioned_block_$truebb0_0:
    assume {:partition} v3 && v3;
    v4$1 := BV32_UREM(local_id_x$1, BV32_MUL(2bv32, $s.0)) == 0bv32;
    v4$2 := BV32_UREM(local_id_x$2, BV32_MUL(2bv32, $s.0)) == 0bv32;
