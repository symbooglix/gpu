...
procedure {:source_name "reduce4<int, 256>"} {:kernel} $_Z7reduce4IiLj256EEvPT_S1_j($n: bv32);
...
implementation {:source_name "reduce4<int, 256>"} {:kernel} $_Z7reduce4IiLj256EEvPT_S1_j($n: bv32)
{
  var $0$1: bv32;
  var $0$2: bv32;
  var $mySum.0$1: bv32;
  ...
  $6:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b14 ==> _WRITE_HAS_OCCURRED_$$__smem ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b13 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_WRITE_HAS_OCCURRED_$$__smem;
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b12 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$__smem;
    assert {:tag "nowrite"} _b11 ==> !_WRITE_HAS_OCCURRED_$$__smem;
    assert {:tag "noread"} _b10 ==> !_READ_HAS_OCCURRED_$$__smem;
    ...
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b8 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$g_odata;
    ...
    assert {:do_not_predicate} {:tag "sameWarpNoAccess"} _b6 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && BV32_DIV(BV32_ADD(local_id_x$1, BV32_ADD(BV32_MUL(local_id_y$1, group_size_x), BV32_MUL(local_id_z$1, BV32_MUL(group_size_x, group_size_y)))), 32bv32) == BV32_DIV(BV32_ADD(local_id_x$2, BV32_ADD(BV32_MUL(local_id_y$2, group_size_x), BV32_MUL(local_id_z$2, BV32_MUL(group_size_x, group_size_y)))), 32bv32) ==> !_READ_HAS_OCCURRED_$$g_idata;
  ...
  $falsebb1:
    ...
    v9$1 := BV32_ULT(local_id_x$1, 32bv32);
    v9$2 := BV32_ULT(local_id_x$2, 32bv32);
    p6$1 := (if v9$1 then v9$1 else p6$1);
    p6$2 := (if v9$2 then v9$2 else p6$2);
    call _PRE_WARP_SYNC_$$__smem_READ(p6$1, p6$2);
    call {:sourceloc} {:sourceloc_num 20} _LOG_READ_$$__smem(p6$1, BV32_ADD(local_id_x$1, 32bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 32bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 20} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 20} _CHECK_READ_$$__smem(p6$2, BV32_ADD(local_id_x$2, 32bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 32bv32)]);
    ...
    v10$1 := (if p6$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 32bv32)] else v10$1);
    v10$2 := (if p6$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 32bv32)] else v10$2);
    ...
    call _PRE_WARP_SYNC_$$__smem_READ(p6$1, p6$2);
    call {:sourceloc} {:sourceloc_num 22} _LOG_READ_$$__smem(p6$1, BV32_ADD(local_id_x$1, 16bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 16bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 22} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 22} _CHECK_READ_$$__smem(p6$2, BV32_ADD(local_id_x$2, 16bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 16bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p6$1, p6$2);
    v12$1 := (if p6$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 16bv32)] else v12$1);
    v12$2 := (if p6$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 16bv32)] else v12$2);
    ...
    call _PRE_WARP_SYNC_$$__smem_READ(p6$1, p6$2);
    call {:sourceloc} {:sourceloc_num 24} _LOG_READ_$$__smem(p6$1, BV32_ADD(local_id_x$1, 8bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 8bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 24} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 24} _CHECK_READ_$$__smem(p6$2, BV32_ADD(local_id_x$2, 8bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 8bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p6$1, p6$2);
    v14$1 := (if p6$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 8bv32)] else v14$1);
    v14$2 := (if p6$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 8bv32)] else v14$2);
    ...
    call _PRE_WARP_SYNC_$$__smem_READ(p6$1, p6$2);
    call {:sourceloc} {:sourceloc_num 26} _LOG_READ_$$__smem(p6$1, BV32_ADD(local_id_x$1, 4bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 4bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 26} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 26} _CHECK_READ_$$__smem(p6$2, BV32_ADD(local_id_x$2, 4bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 4bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p6$1, p6$2);
    v16$1 := (if p6$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 4bv32)] else v16$1);
    v16$2 := (if p6$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 4bv32)] else v16$2);
    ...
    call _PRE_WARP_SYNC_$$__smem_READ(p6$1, p6$2);
    call {:sourceloc} {:sourceloc_num 28} _LOG_READ_$$__smem(p6$1, BV32_ADD(local_id_x$1, 2bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 2bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 28} true;
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 28} _CHECK_READ_$$__smem(p6$2, BV32_ADD(local_id_x$2, 2bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 2bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p6$1, p6$2);
    v18$1 := (if p6$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 2bv32)] else v18$1);
    v18$2 := (if p6$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 2bv32)] else v18$2);
    ...
    call _PRE_WARP_SYNC_$$__smem_READ(p6$1, p6$2);
    call {:sourceloc} {:sourceloc_num 30} _LOG_READ_$$__smem(p6$1, BV32_ADD(local_id_x$1, 1bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_13"} {:captureState "check_state_13"} {:sourceloc} {:sourceloc_num 30} true;
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 30} _CHECK_READ_$$__smem(p6$2, BV32_ADD(local_id_x$2, 1bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p6$1, p6$2);
    v20$1 := (if p6$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 1bv32)] else v20$1);
    v20$2 := (if p6$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)] else v20$2);
    call _PRE_WARP_SYNC_$$__smem_WRITE(p6$1, p6$2);
    ...
    call {:sourceloc} {:sourceloc_num 34} _LOG_READ_$$__smem(p8$1, 0bv32, $$__smem[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 34} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 34} _CHECK_READ_$$__smem(p8$2, 0bv32, $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p8$1, p8$2);
    v22$1 := (if p8$1 then $$__smem[1bv1][0bv32] else v22$1);
    v22$2 := (if p8$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] else v22$2);
