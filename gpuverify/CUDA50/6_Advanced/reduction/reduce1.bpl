...
procedure {:source_name "reduce1<int>"} {:kernel} $_Z7reduce1IiEvPT_S1_j($n: bv32);
...
implementation {:source_name "reduce1<int>"} {:kernel} $_Z7reduce1IiEvPT_S1_j($n: bv32)
{
  var $0$1: bv32;
  var $0$2: bv32;
  var $s.0: bv32;
  ...
  $4:
    ...
    assert {:tag "accessBreak"} _b10 ==> _WRITE_HAS_OCCURRED_$$__smem ==> local_id_x$1 == BV32_DIV(BV32_DIV(_WATCHED_OFFSET, 2bv32), $s.0);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b9 ==> _WRITE_HAS_OCCURRED_$$__smem ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 2bv32), local_id_x$1), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 2bv32), local_id_x$1), 1bv32), BV32_MUL(BV32_MUL(0bv32, 2bv32), local_id_x$1));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _READ_HAS_OCCURRED_$$__smem ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 2bv32), local_id_x$1), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 2bv32), local_id_x$1), 1bv32), BV32_MUL(BV32_MUL(0bv32, 2bv32), local_id_x$1));
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($s.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_UGE($s.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($s.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_ULE($s.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($s.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SGE($s.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($s.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b0 ==> BV32_SLE($s.0, 1bv32);
  ...
  $falsebb0:
    ...
    v9$1 := (if p4$1 then $$__smem[1bv1][0bv32] else v9$1);
    v9$2 := (if p4$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] else v9$2);
    call {:sourceloc} {:sourceloc_num 19} _LOG_WRITE_$$g_odata(p4$1, group_id_x$1, v9$1, $$g_odata[group_id_x$1]);
    ...
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 19} _CHECK_WRITE_$$g_odata(p4$2, group_id_x$2, v9$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$g_odata"} true;
    $$g_odata[group_id_x$1] := (if p4$1 then v9$1 else $$g_odata[group_id_x$1]);
    $$g_odata[group_id_x$2] := (if p4$2 then v9$2 else $$g_odata[group_id_x$2]);
    return;

  __partitioned_block_$truebb0_0:
    assume {:partition} v3 && v3;
    v4$1 := BV32_MUL(BV32_MUL(2bv32, $s.0), local_id_x$1);
    v4$2 := BV32_MUL(BV32_MUL(2bv32, $s.0), local_id_x$2);
    v5$1 := BV32_ULT(v4$1, group_size_x);
    v5$2 := BV32_ULT(v4$2, group_size_x);
    p3$1 := (if v5$1 then v5$1 else p3$1);
    p3$2 := (if v5$2 then v5$2 else p3$2);
    call {:sourceloc} {:sourceloc_num 10} _LOG_READ_$$__smem(p3$1, BV32_ADD(v4$1, $s.0), $$__smem[1bv1][BV32_ADD(v4$1, $s.0)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 10} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 10} _CHECK_READ_$$__smem(p3$2, BV32_ADD(v4$2, $s.0), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v4$2, $s.0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    v6$1 := (if p3$1 then $$__smem[1bv1][BV32_ADD(v4$1, $s.0)] else v6$1);
    v6$2 := (if p3$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v4$2, $s.0)] else v6$2);
    call {:sourceloc} {:sourceloc_num 11} _LOG_READ_$$__smem(p3$1, v4$1, $$__smem[1bv1][v4$1]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 11} _CHECK_READ_$$__smem(p3$2, v4$2, $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v4$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    v7$1 := (if p3$1 then $$__smem[1bv1][v4$1] else v7$1);
    v7$2 := (if p3$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v4$2] else v7$2);
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$__smem(p3$1, v4$1, BV32_ADD(v7$1, v6$1), $$__smem[1bv1][v4$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$__smem(p3$2, v4$2);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$__smem(p3$2, v4$2, BV32_ADD(v7$2, v6$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$__smem"} true;
    $$__smem[1bv1][v4$1] := (if p3$1 then BV32_ADD(v7$1, v6$1) else $$__smem[1bv1][v4$1]);
    $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v4$2] := (if p3$2 then BV32_ADD(v7$2, v6$2) else $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v4$2]);
