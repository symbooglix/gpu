...
procedure {:source_name "reduce6<int, 256, false>"} {:kernel} $_Z7reduce6IiLj256ELb0EEvPT_S1_j($n: bv32);
...
implementation {:source_name "reduce6<int, 256, false>"} {:kernel} $_Z7reduce6IiLj256ELb0EEvPT_S1_j($n: bv32)
{
  var $i.0$1: bv32;
  var $i.0$2: bv32;
  var $mySum.0$1: bv32;
  ...
  $0:
    $i.0$1, $mySum.0$1 := BV32_ADD(BV32_MUL(BV32_MUL(group_id_x$1, 256bv32), 2bv32), local_id_x$1), 0bv32;
    $i.0$2, $mySum.0$2 := BV32_ADD(BV32_MUL(BV32_MUL(group_id_x$2, 256bv32), 2bv32), local_id_x$2), 0bv32;
    p0$1 := false;
    p0$2 := false;
    p0$1 := true;
    p0$2 := true;
  ...
  $1:
    ...
    v0$1 := (if p0$1 then BV32_ULT($i.0$1, $n) else v0$1);
    v0$2 := (if p0$2 then BV32_ULT($i.0$2, $n) else v0$2);
    p1$1 := false;
    p1$2 := false;
    p2$1 := false;
    p2$2 := false;
    ...
    v2$1 := (if p1$1 then BV32_ADD($mySum.0$1, v1$1) else v2$1);
    v2$2 := (if p1$2 then BV32_ADD($mySum.0$2, v1$2) else v2$2);
    v3$1 := (if p1$1 then BV32_ULT(BV32_ADD($i.0$1, 256bv32), $n) else v3$1);
    v3$2 := (if p1$2 then BV32_ULT(BV32_ADD($i.0$2, 256bv32), $n) else v3$2);
    ...
    $mySum.1$1 := (if p2$1 then v2$1 else $mySum.1$1);
    $mySum.1$2 := (if p2$2 then v2$2 else $mySum.1$2);
    havoc _HAVOC_bv32$1, _HAVOC_bv32$2;
    v4$1 := (if p3$1 then _HAVOC_bv32$1 else v4$1);
    v4$2 := (if p3$2 then _HAVOC_bv32$2 else v4$2);
    $mySum.1$1 := (if p3$1 then BV32_ADD(v2$1, v4$1) else $mySum.1$1);
    $mySum.1$2 := (if p3$2 then BV32_ADD(v2$2, v4$2) else $mySum.1$2);
    $i.0$1, $mySum.0$1 := (if p1$1 then BV32_ADD($i.0$1, BV32_MUL(512bv32, num_groups_x)) else $i.0$1), (if p1$1 then $mySum.1$1 else $mySum.0$1);
    $i.0$2, $mySum.0$2 := (if p1$2 then BV32_ADD($i.0$2, BV32_MUL(512bv32, num_groups_x)) else $i.0$2), (if p1$2 then $mySum.1$2 else $mySum.0$2);
  ...
  __partitioned_block_$1.tail_1:
    ...
    call {:sourceloc} {:sourceloc_num 11} _LOG_READ_$$__smem(p5$1, BV32_ADD(local_id_x$1, 128bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 128bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_17"} {:captureState "check_state_17"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_17"} {:sourceloc} {:sourceloc_num 11} _CHECK_READ_$$__smem(p5$2, BV32_ADD(local_id_x$2, 128bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 128bv32)]);
    ...
    v6$1 := (if p5$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 128bv32)] else v6$1);
    v6$2 := (if p5$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 128bv32)] else v6$2);
    v7$1 := (if p5$1 then BV32_ADD($mySum.0$1, v6$1) else v7$1);
    v7$2 := (if p5$2 then BV32_ADD($mySum.0$2, v6$2) else v7$2);
    call _PRE_WARP_SYNC_$$__smem_WRITE(p5$1, p5$2);
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$__smem(p5$1, local_id_x$1, v7$1, $$__smem[1bv1][local_id_x$1]);
    ...
    call {:check_id "check_state_18"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$__smem(p5$2, local_id_x$2, v7$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_WRITE(p5$1, p5$2);
    $$__smem[1bv1][local_id_x$1] := (if p5$1 then v7$1 else $$__smem[1bv1][local_id_x$1]);
    $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p5$2 then v7$2 else $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    $mySum.2$1 := (if p5$1 then v7$1 else $mySum.2$1);
    $mySum.2$2 := (if p5$2 then v7$2 else $mySum.2$2);
    $mySum.2$1 := (if p6$1 then $mySum.0$1 else $mySum.2$1);
    $mySum.2$2 := (if p6$2 then $mySum.0$2 else $mySum.2$2);
  ...
  __partitioned_block_$1.tail_2:
    ...
    call _PRE_WARP_SYNC_$$__smem_READ(p7$1, p7$2);
    call {:sourceloc} {:sourceloc_num 16} _LOG_READ_$$__smem(p7$1, BV32_ADD(local_id_x$1, 64bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 64bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_15"} {:captureState "check_state_15"} {:sourceloc} {:sourceloc_num 16} true;
    call {:check_id "check_state_15"} {:sourceloc} {:sourceloc_num 16} _CHECK_READ_$$__smem(p7$2, BV32_ADD(local_id_x$2, 64bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 64bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p7$1, p7$2);
    v9$1 := (if p7$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 64bv32)] else v9$1);
    v9$2 := (if p7$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 64bv32)] else v9$2);
    v10$1 := (if p7$1 then BV32_ADD($mySum.2$1, v9$1) else v10$1);
    v10$2 := (if p7$2 then BV32_ADD($mySum.2$2, v9$2) else v10$2);
    call _PRE_WARP_SYNC_$$__smem_WRITE(p7$1, p7$2);
    call {:sourceloc} {:sourceloc_num 17} _LOG_WRITE_$$__smem(p7$1, local_id_x$1, v10$1, $$__smem[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$__smem(p7$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_16"} {:captureState "check_state_16"} {:sourceloc} {:sourceloc_num 17} true;
    call {:check_id "check_state_16"} {:sourceloc} {:sourceloc_num 17} _CHECK_WRITE_$$__smem(p7$2, local_id_x$2, v10$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_WRITE(p7$1, p7$2);
    $$__smem[1bv1][local_id_x$1] := (if p7$1 then v10$1 else $$__smem[1bv1][local_id_x$1]);
    $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p7$2 then v10$2 else $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    $mySum.3$1 := (if p7$1 then v10$1 else $mySum.3$1);
    $mySum.3$2 := (if p7$2 then v10$2 else $mySum.3$2);
    $mySum.3$1 := (if p8$1 then $mySum.2$1 else $mySum.3$1);
    $mySum.3$2 := (if p8$2 then $mySum.2$2 else $mySum.3$2);
    goto __partitioned_block_$1.tail_3;

  __partitioned_block_$1.tail_3:
    ...
    call _PRE_WARP_SYNC_$$__smem_READ(p9$1, p9$2);
    call {:sourceloc} {:sourceloc_num 21} _LOG_READ_$$__smem(p9$1, BV32_ADD(local_id_x$1, 32bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 32bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 21} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 21} _CHECK_READ_$$__smem(p9$2, BV32_ADD(local_id_x$2, 32bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 32bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p9$1, p9$2);
    v12$1 := (if p9$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 32bv32)] else v12$1);
    v12$2 := (if p9$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 32bv32)] else v12$2);
    v13$1 := (if p9$1 then BV32_ADD($mySum.3$1, v12$1) else v13$1);
    v13$2 := (if p9$2 then BV32_ADD($mySum.3$2, v12$2) else v13$2);
    call _PRE_WARP_SYNC_$$__smem_WRITE(p9$1, p9$2);
    call {:sourceloc} {:sourceloc_num 22} _LOG_WRITE_$$__smem(p9$1, local_id_x$1, v13$1, $$__smem[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$__smem(p9$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 22} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 22} _CHECK_WRITE_$$__smem(p9$2, local_id_x$2, v13$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_WRITE(p9$1, p9$2);
    $$__smem[1bv1][local_id_x$1] := (if p9$1 then v13$1 else $$__smem[1bv1][local_id_x$1]);
    $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p9$2 then v13$2 else $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    call _PRE_WARP_SYNC_$$__smem_READ(p9$1, p9$2);
    call {:sourceloc} {:sourceloc_num 23} _LOG_READ_$$__smem(p9$1, BV32_ADD(local_id_x$1, 16bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 16bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 23} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 23} _CHECK_READ_$$__smem(p9$2, BV32_ADD(local_id_x$2, 16bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 16bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p9$1, p9$2);
    v14$1 := (if p9$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 16bv32)] else v14$1);
    v14$2 := (if p9$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 16bv32)] else v14$2);
    v15$1 := (if p9$1 then BV32_ADD(v13$1, v14$1) else v15$1);
    v15$2 := (if p9$2 then BV32_ADD(v13$2, v14$2) else v15$2);
    call _PRE_WARP_SYNC_$$__smem_WRITE(p9$1, p9$2);
    call {:sourceloc} {:sourceloc_num 24} _LOG_WRITE_$$__smem(p9$1, local_id_x$1, v15$1, $$__smem[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$__smem(p9$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 24} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 24} _CHECK_WRITE_$$__smem(p9$2, local_id_x$2, v15$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_WRITE(p9$1, p9$2);
    $$__smem[1bv1][local_id_x$1] := (if p9$1 then v15$1 else $$__smem[1bv1][local_id_x$1]);
    $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p9$2 then v15$2 else $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    call _PRE_WARP_SYNC_$$__smem_READ(p9$1, p9$2);
    call {:sourceloc} {:sourceloc_num 25} _LOG_READ_$$__smem(p9$1, BV32_ADD(local_id_x$1, 8bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 8bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 25} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 25} _CHECK_READ_$$__smem(p9$2, BV32_ADD(local_id_x$2, 8bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 8bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p9$1, p9$2);
    v16$1 := (if p9$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 8bv32)] else v16$1);
    v16$2 := (if p9$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 8bv32)] else v16$2);
    v17$1 := (if p9$1 then BV32_ADD(v15$1, v16$1) else v17$1);
    v17$2 := (if p9$2 then BV32_ADD(v15$2, v16$2) else v17$2);
    call _PRE_WARP_SYNC_$$__smem_WRITE(p9$1, p9$2);
    call {:sourceloc} {:sourceloc_num 26} _LOG_WRITE_$$__smem(p9$1, local_id_x$1, v17$1, $$__smem[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$__smem(p9$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_8"} {:captureState "check_state_8"} {:sourceloc} {:sourceloc_num 26} true;
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 26} _CHECK_WRITE_$$__smem(p9$2, local_id_x$2, v17$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_WRITE(p9$1, p9$2);
    $$__smem[1bv1][local_id_x$1] := (if p9$1 then v17$1 else $$__smem[1bv1][local_id_x$1]);
    $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p9$2 then v17$2 else $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    call _PRE_WARP_SYNC_$$__smem_READ(p9$1, p9$2);
    call {:sourceloc} {:sourceloc_num 27} _LOG_READ_$$__smem(p9$1, BV32_ADD(local_id_x$1, 4bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 4bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 27} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 27} _CHECK_READ_$$__smem(p9$2, BV32_ADD(local_id_x$2, 4bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 4bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p9$1, p9$2);
    v18$1 := (if p9$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 4bv32)] else v18$1);
    v18$2 := (if p9$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 4bv32)] else v18$2);
    v19$1 := (if p9$1 then BV32_ADD(v17$1, v18$1) else v19$1);
    v19$2 := (if p9$2 then BV32_ADD(v17$2, v18$2) else v19$2);
    call _PRE_WARP_SYNC_$$__smem_WRITE(p9$1, p9$2);
    call {:sourceloc} {:sourceloc_num 28} _LOG_WRITE_$$__smem(p9$1, local_id_x$1, v19$1, $$__smem[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$__smem(p9$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_10"} {:captureState "check_state_10"} {:sourceloc} {:sourceloc_num 28} true;
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 28} _CHECK_WRITE_$$__smem(p9$2, local_id_x$2, v19$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_WRITE(p9$1, p9$2);
    $$__smem[1bv1][local_id_x$1] := (if p9$1 then v19$1 else $$__smem[1bv1][local_id_x$1]);
    $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p9$2 then v19$2 else $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    call _PRE_WARP_SYNC_$$__smem_READ(p9$1, p9$2);
    call {:sourceloc} {:sourceloc_num 29} _LOG_READ_$$__smem(p9$1, BV32_ADD(local_id_x$1, 2bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 2bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_11"} {:captureState "check_state_11"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 29} _CHECK_READ_$$__smem(p9$2, BV32_ADD(local_id_x$2, 2bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 2bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p9$1, p9$2);
    v20$1 := (if p9$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 2bv32)] else v20$1);
    v20$2 := (if p9$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 2bv32)] else v20$2);
    v21$1 := (if p9$1 then BV32_ADD(v19$1, v20$1) else v21$1);
    v21$2 := (if p9$2 then BV32_ADD(v19$2, v20$2) else v21$2);
    call _PRE_WARP_SYNC_$$__smem_WRITE(p9$1, p9$2);
    call {:sourceloc} {:sourceloc_num 30} _LOG_WRITE_$$__smem(p9$1, local_id_x$1, v21$1, $$__smem[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$__smem(p9$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_12"} {:captureState "check_state_12"} {:sourceloc} {:sourceloc_num 30} true;
    call {:check_id "check_state_12"} {:sourceloc} {:sourceloc_num 30} _CHECK_WRITE_$$__smem(p9$2, local_id_x$2, v21$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_WRITE(p9$1, p9$2);
    $$__smem[1bv1][local_id_x$1] := (if p9$1 then v21$1 else $$__smem[1bv1][local_id_x$1]);
    $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p9$2 then v21$2 else $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    call _PRE_WARP_SYNC_$$__smem_READ(p9$1, p9$2);
    call {:sourceloc} {:sourceloc_num 31} _LOG_READ_$$__smem(p9$1, BV32_ADD(local_id_x$1, 1bv32), $$__smem[1bv1][BV32_ADD(local_id_x$1, 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_13"} {:captureState "check_state_13"} {:sourceloc} {:sourceloc_num 31} true;
    call {:check_id "check_state_13"} {:sourceloc} {:sourceloc_num 31} _CHECK_READ_$$__smem(p9$2, BV32_ADD(local_id_x$2, 1bv32), $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p9$1, p9$2);
    v22$1 := (if p9$1 then $$__smem[1bv1][BV32_ADD(local_id_x$1, 1bv32)] else v22$1);
    v22$2 := (if p9$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, 1bv32)] else v22$2);
    call _PRE_WARP_SYNC_$$__smem_WRITE(p9$1, p9$2);
    call {:sourceloc} {:sourceloc_num 32} _LOG_WRITE_$$__smem(p9$1, local_id_x$1, BV32_ADD(v21$1, v22$1), $$__smem[1bv1][local_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$__smem(p9$2, local_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_14"} {:captureState "check_state_14"} {:sourceloc} {:sourceloc_num 32} true;
    call {:check_id "check_state_14"} {:sourceloc} {:sourceloc_num 32} _CHECK_WRITE_$$__smem(p9$2, local_id_x$2, BV32_ADD(v21$2, v22$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_WRITE(p9$1, p9$2);
    $$__smem[1bv1][local_id_x$1] := (if p9$1 then BV32_ADD(v21$1, v22$1) else $$__smem[1bv1][local_id_x$1]);
    $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2] := (if p9$2 then BV32_ADD(v21$2, v22$2) else $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    v23$1 := local_id_x$1 == 0bv32;
    v23$2 := local_id_x$2 == 0bv32;
    p11$1 := (if v23$1 then v23$1 else p11$1);
    p11$2 := (if v23$2 then v23$2 else p11$2);
    call _PRE_WARP_SYNC_$$__smem_READ(p11$1, p11$2);
    call {:sourceloc} {:sourceloc_num 35} _LOG_READ_$$__smem(p11$1, 0bv32, $$__smem[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 35} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 35} _CHECK_READ_$$__smem(p11$2, 0bv32, $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$__smem"} true;
    call _POST_WARP_SYNC_$$__smem_READ(p11$1, p11$2);
    v24$1 := (if p11$1 then $$__smem[1bv1][0bv32] else v24$1);
    v24$2 := (if p11$2 then $$__smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] else v24$2);
    call _PRE_WARP_SYNC_$$g_odata_WRITE(p11$1, p11$2);
    call {:sourceloc} {:sourceloc_num 36} _LOG_WRITE_$$g_odata(p11$1, group_id_x$1, v24$1, $$g_odata[group_id_x$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$g_odata(p11$2, group_id_x$2);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 36} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 36} _CHECK_WRITE_$$g_odata(p11$2, group_id_x$2, v24$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$g_odata"} true;
    call _POST_WARP_SYNC_$$g_odata_WRITE(p11$1, p11$2);
    $$g_odata[group_id_x$1] := (if p11$1 then v24$1 else $$g_odata[group_id_x$1]);
    $$g_odata[group_id_x$2] := (if p11$2 then v24$2 else $$g_odata[group_id_x$2]);
    return;
