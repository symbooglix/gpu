...
implementation {:source_name "scanExclusiveShared"} {:kernel} $_Z19scanExclusiveSharedP5uint4S0_j($size: bv32)
{
  ...
  $1:
    ...
    assert {:tag "pow2NotZero"} _b5 ==> $offset.i.i.i.i.0 != 0bv32;
    assert {:tag "pow2"} _b4 ==> $offset.i.i.i.i.0 == 0bv32 || BV32_AND($offset.i.i.i.i.0, BV32_SUB($offset.i.i.i.i.0, 1bv32)) == 0bv32;
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($offset.i.i.i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_UGE($offset.i.i.i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($offset.i.i.i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_ULE($offset.i.i.i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($offset.i.i.i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SGE($offset.i.i.i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($offset.i.i.i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b0 ==> BV32_SLE($offset.i.i.i.i.0, 1bv32);
