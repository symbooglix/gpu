...
procedure {:source_name "increment_kernel"} {:kernel} $_Z16increment_kernelPii($inc_value: bv32);
...
implementation {:source_name "increment_kernel"} {:kernel} $_Z16increment_kernelPii($inc_value: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $0:
    ...
    call {:sourceloc} {:sourceloc_num 1} _LOG_READ_$$g_data(true, v0$1, $$g_data[v0$1]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 1} _CHECK_READ_$$g_data(true, v0$2, $$g_data[v0$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$g_data"} true;
    v1$1 := $$g_data[v0$1];
    v1$2 := $$g_data[v0$2];
    call {:sourceloc} {:sourceloc_num 2} _LOG_WRITE_$$g_data(true, v0$1, BV32_ADD(v1$1, $inc_value), $$g_data[v0$1]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 2} _CHECK_WRITE_$$g_data(true, v0$2, BV32_ADD(v1$2, $inc_value));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$g_data"} true;
    $$g_data[v0$1] := BV32_ADD(v1$1, $inc_value);
    $$g_data[v0$2] := BV32_ADD(v1$2, $inc_value);
    return;
}
