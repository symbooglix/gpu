...
procedure {:source_name "vectorAdd"} {:kernel} $_Z9vectorAddPKfS0_Pfi($numElements: bv32);
...
implementation {:source_name "vectorAdd"} {:kernel} $_Z9vectorAddPKfS0_Pfi($numElements: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bool;
  ...
  $0:
    ...
    v1$1 := BV32_SLT(v0$1, $numElements);
    v1$2 := BV32_SLT(v0$2, $numElements);
    p0$1 := false;
    p0$2 := false;
    p1$1 := false;
    p1$2 := false;
...
axiom (if num_groups_x == 196bv32 then 1bv1 else 0bv1) != 0bv1;
