...
implementation {:source_name "dwtHaar1D"} {:kernel} $dwtHaar1D($tLevels: bv32, $signalLength: bv32, $levelsDone: bv32, $mLevels: bv32)
{
  ...
  $6:
    ...
    assert {:tag "nowrite"} _b20 ==> !_WRITE_HAS_OCCURRED_$$sharedArray;
    assert {:tag "noread"} _b19 ==> !_READ_HAS_OCCURRED_$$sharedArray;
    assert {:tag "nowrite"} _b18 ==> !_WRITE_HAS_OCCURRED_$$coefsSignal;
    assert {:tag "pow2NotZero"} _b17 ==> $midOutPos.1$2 != 0bv32;
    assert {:tag "pow2"} _b16 ==> $midOutPos.1$2 == 0bv32 || BV32_AND($midOutPos.1$2, BV32_SUB($midOutPos.1$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b15 ==> $midOutPos.1$1 != 0bv32;
    assert {:tag "pow2"} _b14 ==> $midOutPos.1$1 == 0bv32 || BV32_AND($midOutPos.1$1, BV32_SUB($midOutPos.1$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b13 ==> $midOutPos.0$2 != 0bv32;
    assert {:tag "pow2"} _b12 ==> $midOutPos.0$2 == 0bv32 || BV32_AND($midOutPos.0$2, BV32_SUB($midOutPos.0$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b11 ==> $midOutPos.0$1 != 0bv32;
    assert {:tag "pow2"} _b10 ==> $midOutPos.0$1 == 0bv32 || BV32_AND($midOutPos.0$1, BV32_SUB($midOutPos.0$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b9 ==> $activeThreads.0 != 0bv32;
    assert {:tag "pow2"} _b8 ==> $activeThreads.0 == 0bv32 || BV32_AND($activeThreads.0, BV32_SUB($activeThreads.0, 1bv32)) == 0bv32;
    ...
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_UGE($activeThreads.0, BV32_SDIV(BV32_SHL(1bv32, BV32_AND($0, 31bv32)), 2bv32));
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_ULE($activeThreads.0, BV32_SDIV(BV32_SHL(1bv32, BV32_AND($0, 31bv32)), 2bv32));
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_ULE($activeThreads.0, BV32_SDIV(BV32_SHL(1bv32, BV32_AND($0, 31bv32)), 2bv32));
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_SGE($activeThreads.0, BV32_SDIV(BV32_SHL(1bv32, BV32_AND($0, 31bv32)), 2bv32));
    assert {:tag "loopBound"} {:thread 2} _b5 ==> BV32_SGE($activeThreads.0, BV32_SDIV(BV32_SHL(1bv32, BV32_AND($0, 31bv32)), 2bv32));
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_SLE($activeThreads.0, BV32_SDIV(BV32_SHL(1bv32, BV32_AND($0, 31bv32)), 2bv32));
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_SLE($activeThreads.0, BV32_SDIV(BV32_SHL(1bv32, BV32_AND($0, 31bv32)), 2bv32));
  ...
  $falsebb1:
    ...
    call {:sourceloc} {:sourceloc_num 29} _LOG_READ_$$sharedArray(p4$1, 0bv32, $$sharedArray[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 29} _CHECK_READ_$$sharedArray(p4$2, 0bv32, $$sharedArray[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    ...
    call {:sourceloc} {:sourceloc_num 30} _LOG_WRITE_$$AverageSignal(p4$1, v1$1, v17$1, $$AverageSignal[v1$1]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 30} _CHECK_WRITE_$$AverageSignal(p4$2, v1$2, v17$2);
  ...
  __partitioned_block_$truebb1_0:
    ...
    call {:sourceloc} {:sourceloc_num 17} _LOG_READ_$$sharedArray(p1$1, BV32_MUL(2bv32, v0$1), $$sharedArray[1bv1][BV32_MUL(2bv32, v0$1)]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 17} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 17} _CHECK_READ_$$sharedArray(p1$2, BV32_MUL(2bv32, v0$2), $$sharedArray[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_MUL(2bv32, v0$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$sharedArray"} true;
    ...
    call {:sourceloc} {:sourceloc_num 18} _LOG_READ_$$sharedArray(p1$1, BV32_ADD(BV32_MUL(2bv32, v0$1), 1bv32), $$sharedArray[1bv1][BV32_ADD(BV32_MUL(2bv32, v0$1), 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 18} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 18} _CHECK_READ_$$sharedArray(p1$2, BV32_ADD(BV32_MUL(2bv32, v0$2), 1bv32), $$sharedArray[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(2bv32, v0$2), 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$sharedArray"} true;
  ...
  __partitioned_block_$truebb1_1:
    call {:sourceloc_num 20} $bugle_barrier_duplicated_1(1bv1, 0bv1);
    ...
    call {:sourceloc} {:sourceloc_num 22} _LOG_WRITE_$$sharedArray(p3$1, v0$1, FMUL32(FADD32($data0.1$1, $data1.1$1), v8), $$sharedArray[1bv1][v0$1]);
    ...
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 22} _CHECK_WRITE_$$sharedArray(p3$2, v0$2, FMUL32(FADD32($data0.1$2, $data1.1$2), v8));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$sharedArray"} true;
    ...
    call {:sourceloc} {:sourceloc_num 23} _LOG_WRITE_$$coefsSignal(p3$1, BV32_ADD(BV32_ADD($midOutPos.0$1, BV32_MUL(v1$1, $activeThreads.0)), v0$1), FMUL32(FSUB32($data0.1$1, $data1.1$1), v8), $$coefsSignal[BV32_ADD(BV32_ADD($midOutPos.0$1, BV32_MUL(v1$1, $activeThreads.0)), v0$1)]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 23} _CHECK_WRITE_$$coefsSignal(p3$2, BV32_ADD(BV32_ADD($midOutPos.0$2, BV32_MUL(v1$2, $activeThreads.0)), v0$2), FMUL32(FSUB32($data0.1$2, $data1.1$2), v8));
  ...
  __partitioned_block_$truebb1_2:
    call {:sourceloc_num 25} $bugle_barrier_duplicated_2(1bv1, 0bv1);
