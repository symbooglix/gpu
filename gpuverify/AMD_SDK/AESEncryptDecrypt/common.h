...
static __attribute__((always_inline)) uchar4
                                ...
                                
{
	...
	//__assert(__distinct_int(localIndex));
	...
	**/
	...
	//Rounds
        for (int i = 1; __invariant(__read_implies(block0, __read_offset_bytes(block0)/sizeof(uchar4) == localIndex)), i < rounds; i++)
	{
		//1. subytes
