...
procedure {:source_name "templateKernel"} {:kernel} $templateKernel($multiplier: bv32);
...
implementation {:source_name "templateKernel"} {:kernel} $templateKernel($multiplier: bv32)
{
  var v0$1: bv32;
  var v0$2: bv32;
  var v1$1: bv32;
  ...
  $0:
    ...
    havoc v1$1, v1$2;
    call {:sourceloc} {:sourceloc_num 2} _LOG_WRITE_$$output(true, v0$1, BV32_MUL(v1$1, $multiplier), $$output[v0$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$output(true, v0$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 2} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 2} _CHECK_WRITE_$$output(true, v0$2, BV32_MUL(v1$2, $multiplier));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$output"} true;
    $$output[v0$1] := BV32_MUL(v1$1, $multiplier);
    $$output[v0$2] := BV32_MUL(v1$2, $multiplier);
    return;
}
