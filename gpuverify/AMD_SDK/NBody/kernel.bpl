...
procedure {:source_name "nbody_sim"} {:kernel} $nbody_sim($numBodies: bv32, $deltaTime: bv32, $epsSqr: bv32);
...
implementation {:source_name "nbody_sim"} {:kernel} $nbody_sim($numBodies: bv32, $deltaTime: bv32, $epsSqr: bv32)
{
  var $acc.0$1: bv128;
  var $acc.0$2: bv128;
  var $i.0: bv32;
  ...
  $falsebb:
    ...
    havoc v28$1, v28$2;
    havoc v29$1, v29$2;
    call {:sourceloc} {:sourceloc_num 35} _LOG_WRITE_$$newPosition(true, BV32_MUL(v1$1, 4bv32), FADD32(FMUL32(FMUL32(FMUL32($acc.0$1[32:0], 1056964608bv32), $deltaTime), $deltaTime), FADD32(FMUL32(v26$1, $deltaTime), v3$1)), $$newPosition[BV32_MUL(v1$1, 4bv32)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 35} _CHECK_WRITE_$$newPosition(true, BV32_MUL(v1$2, 4bv32), FADD32(FMUL32(FMUL32(FMUL32($acc.0$2[32:0], 1056964608bv32), $deltaTime), $deltaTime), FADD32(FMUL32(v26$2, $deltaTime), v3$2)));
    ...
    call {:sourceloc} {:sourceloc_num 36} _LOG_WRITE_$$newPosition(true, BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32), FADD32(FMUL32(FMUL32(FMUL32($acc.0$1[64:32], 1056964608bv32), $deltaTime), $deltaTime), FADD32(FMUL32(v27$1, $deltaTime), v4$1)), $$newPosition[BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32)]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 36} _CHECK_WRITE_$$newPosition(true, BV32_ADD(BV32_MUL(v1$2, 4bv32), 1bv32), FADD32(FMUL32(FMUL32(FMUL32($acc.0$2[64:32], 1056964608bv32), $deltaTime), $deltaTime), FADD32(FMUL32(v27$2, $deltaTime), v4$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$newPosition"} true;
    ...
    call {:sourceloc} {:sourceloc_num 37} _LOG_WRITE_$$newPosition(true, BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32), FADD32(FMUL32(FMUL32(FMUL32($acc.0$1[96:64], 1056964608bv32), $deltaTime), $deltaTime), FADD32(FMUL32(v28$1, $deltaTime), v5$1)), $$newPosition[BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32)]);
    ...
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 37} _CHECK_WRITE_$$newPosition(true, BV32_ADD(BV32_MUL(v1$2, 4bv32), 2bv32), FADD32(FMUL32(FMUL32(FMUL32($acc.0$2[96:64], 1056964608bv32), $deltaTime), $deltaTime), FADD32(FMUL32(v28$2, $deltaTime), v5$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$newPosition"} true;
    ...
    call {:sourceloc} {:sourceloc_num 38} _LOG_WRITE_$$newPosition(true, BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32), v6$1, $$newPosition[BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32)]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 38} _CHECK_WRITE_$$newPosition(true, BV32_ADD(BV32_MUL(v1$2, 4bv32), 3bv32), v6$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$newPosition"} true;
    $$newPosition[BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32)] := v6$1;
    $$newPosition[BV32_ADD(BV32_MUL(v1$2, 4bv32), 3bv32)] := v6$2;
    call {:sourceloc} {:sourceloc_num 39} _LOG_WRITE_$$newVelocity(true, BV32_MUL(v1$1, 4bv32), FADD32(FMUL32($acc.0$1[32:0], $deltaTime), v26$1), $$newVelocity[BV32_MUL(v1$1, 4bv32)]);
    ...
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 39} _CHECK_WRITE_$$newVelocity(true, BV32_MUL(v1$2, 4bv32), FADD32(FMUL32($acc.0$2[32:0], $deltaTime), v26$2));
    ...
    call {:sourceloc} {:sourceloc_num 40} _LOG_WRITE_$$newVelocity(true, BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32), FADD32(FMUL32($acc.0$1[64:32], $deltaTime), v27$1), $$newVelocity[BV32_ADD(BV32_MUL(v1$1, 4bv32), 1bv32)]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 40} _CHECK_WRITE_$$newVelocity(true, BV32_ADD(BV32_MUL(v1$2, 4bv32), 1bv32), FADD32(FMUL32($acc.0$2[64:32], $deltaTime), v27$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$newVelocity"} true;
    ...
    call {:sourceloc} {:sourceloc_num 41} _LOG_WRITE_$$newVelocity(true, BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32), FADD32(FMUL32($acc.0$1[96:64], $deltaTime), v28$1), $$newVelocity[BV32_ADD(BV32_MUL(v1$1, 4bv32), 2bv32)]);
    ...
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 41} _CHECK_WRITE_$$newVelocity(true, BV32_ADD(BV32_MUL(v1$2, 4bv32), 2bv32), FADD32(FMUL32($acc.0$2[96:64], $deltaTime), v28$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$newVelocity"} true;
    ...
    call {:sourceloc} {:sourceloc_num 42} _LOG_WRITE_$$newVelocity(true, BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32), FADD32(FMUL32($acc.0$1[128:96], $deltaTime), v29$1), $$newVelocity[BV32_ADD(BV32_MUL(v1$1, 4bv32), 3bv32)]);
    ...
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 42} _CHECK_WRITE_$$newVelocity(true, BV32_ADD(BV32_MUL(v1$2, 4bv32), 3bv32), FADD32(FMUL32($acc.0$2[128:96], $deltaTime), v29$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$newVelocity"} true;
  ...
  __partitioned_block_$truebb_0:
    ...
    havoc v10$1, v10$2;
    havoc v11$1, v11$2;
    call {:sourceloc} {:sourceloc_num 11} _LOG_WRITE_$$localPos(true, BV32_MUL(v0$1, 4bv32), v8$1, $$localPos[1bv1][BV32_MUL(v0$1, 4bv32)]);
    ...
    call {:check_id "check_state_8"} {:sourceloc} {:sourceloc_num 11} _CHECK_WRITE_$$localPos(true, BV32_MUL(v0$2, 4bv32), v8$2);
    ...
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$localPos(true, BV32_ADD(BV32_MUL(v0$1, 4bv32), 1bv32), v9$1, $$localPos[1bv1][BV32_ADD(BV32_MUL(v0$1, 4bv32), 1bv32)]);
    ...
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$localPos(true, BV32_ADD(BV32_MUL(v0$2, 4bv32), 1bv32), v9$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$localPos"} true;
    ...
    call {:sourceloc} {:sourceloc_num 13} _LOG_WRITE_$$localPos(true, BV32_ADD(BV32_MUL(v0$1, 4bv32), 2bv32), v10$1, $$localPos[1bv1][BV32_ADD(BV32_MUL(v0$1, 4bv32), 2bv32)]);
    ...
    call {:check_id "check_state_10"} {:sourceloc} {:sourceloc_num 13} _CHECK_WRITE_$$localPos(true, BV32_ADD(BV32_MUL(v0$2, 4bv32), 2bv32), v10$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$localPos"} true;
    ...
    call {:sourceloc} {:sourceloc_num 14} _LOG_WRITE_$$localPos(true, BV32_ADD(BV32_MUL(v0$1, 4bv32), 3bv32), v11$1, $$localPos[1bv1][BV32_ADD(BV32_MUL(v0$1, 4bv32), 3bv32)]);
    ...
    call {:check_id "check_state_11"} {:sourceloc} {:sourceloc_num 14} _CHECK_WRITE_$$localPos(true, BV32_ADD(BV32_MUL(v0$2, 4bv32), 3bv32), v11$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$localPos"} true;
  ...
  $3:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$localPos ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$localPos ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_UGE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_UGE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_ULE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_ULE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_SGE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b5 ==> BV32_SGE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_SLE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_SLE($j.0, 0bv32);
