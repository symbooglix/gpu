...
implementation {:source_name "write_kernel"} {:kernel} $write_kernel($ni: bv32, $val: bv32, $nk: bv32)
{
  ...
  $7:
    ...
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_UGE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b11 ==> BV32_UGE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_ULE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b10 ==> BV32_ULE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_SGE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b9 ==> BV32_SGE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_SLE($i.1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b8 ==> BV32_SLE($i.1, 0bv32);
  ...
  $falsebb2:
    ...
    $i.0, $idx.0$1 := BV32_ADD($i.1, 1bv32), BV32_ADD($idx.0$1, BV32_MUL(group_size_x, num_groups_x));
  ...
  $truebb2:
    assume {:partition} v3 && v3;
    call {:sourceloc} {:sourceloc_num 9} _LOG_WRITE_$$out(true, BV32_MUL($idx.0$1, 4bv32), $val, $$out[BV32_MUL($idx.0$1, 4bv32)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 9} _CHECK_WRITE_$$out(true, BV32_MUL($idx.0$2, 4bv32), $val);
    ...
    call {:sourceloc} {:sourceloc_num 10} _LOG_WRITE_$$out(true, BV32_ADD(BV32_MUL($idx.0$1, 4bv32), 1bv32), $val, $$out[BV32_ADD(BV32_MUL($idx.0$1, 4bv32), 1bv32)]);
    ...
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 10} _CHECK_WRITE_$$out(true, BV32_ADD(BV32_MUL($idx.0$2, 4bv32), 1bv32), $val);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_ADD(BV32_MUL($idx.0$1, 4bv32), 1bv32)] := $val;
    $$out[BV32_ADD(BV32_MUL($idx.0$2, 4bv32), 1bv32)] := $val;
    call {:sourceloc} {:sourceloc_num 11} _LOG_WRITE_$$out(true, BV32_ADD(BV32_MUL($idx.0$1, 4bv32), 2bv32), $val, $$out[BV32_ADD(BV32_MUL($idx.0$1, 4bv32), 2bv32)]);
    ...
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 11} _CHECK_WRITE_$$out(true, BV32_ADD(BV32_MUL($idx.0$2, 4bv32), 2bv32), $val);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
    $$out[BV32_ADD(BV32_MUL($idx.0$1, 4bv32), 2bv32)] := $val;
    $$out[BV32_ADD(BV32_MUL($idx.0$2, 4bv32), 2bv32)] := $val;
    call {:sourceloc} {:sourceloc_num 12} _LOG_WRITE_$$out(true, BV32_ADD(BV32_MUL($idx.0$1, 4bv32), 3bv32), $val, $$out[BV32_ADD(BV32_MUL($idx.0$1, 4bv32), 3bv32)]);
    ...
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 12} _CHECK_WRITE_$$out(true, BV32_ADD(BV32_MUL($idx.0$2, 4bv32), 3bv32), $val);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$out"} true;
