...
implementation {:source_name "histogramKernel"} {:kernel} $histogramKernel($n4VectorsPerThread: bv32)
{
  ...
  $11:
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b21 ==> _WRITE_HAS_OCCURRED_$$histogramKernel.subhists ==> BV32_ULT(local_id_x$1, $2);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p1$1 ==> _b20 ==> p1$1 ==> BV32_ULT(local_id_x$1, $2);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p1$2 ==> _b20 ==> p1$2 ==> BV32_ULT(local_id_x$2, $2);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b19 ==> BV32_ULT(local_id_x$1, $2) && BV32_ULT($i.0$1, BV32_UDIV(BV32_UDIV(4096bv32, $2), 4bv32)) ==> p1$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b19 ==> BV32_ULT(local_id_x$2, $2) && BV32_ULT($i.0$2, BV32_UDIV(BV32_UDIV(4096bv32, $2), 4bv32)) ==> p1$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b18 ==> !BV32_ULT(v0$1, $2) ==> !_WRITE_HAS_OCCURRED_$$histogramKernel.subhists;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b17 ==> !BV32_ULT(v0$1, $2) ==> !p1$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b17 ==> !BV32_ULT(v0$2, $2) ==> !p1$2;
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b16 ==> BV32_UGE($i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b16 ==> BV32_UGE($i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b15 ==> BV32_ULE($i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b15 ==> BV32_ULE($i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b14 ==> BV32_SGE($i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b14 ==> BV32_SGE($i.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p1$1 ==> _b13 ==> BV32_SLE($i.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p1$2 ==> _b13 ==> BV32_SLE($i.0$2, 0bv32);
  ...
  $16:
    ...
    assert {:tag "pow2NotZero"} _b69 ==> v28$2 != 0bv32;
    assert {:tag "pow2"} _b68 ==> v28$2 == 0bv32 || BV32_AND(v28$2, BV32_SUB(v28$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b67 ==> v28$1 != 0bv32;
    assert {:tag "pow2"} _b66 ==> v28$1 == 0bv32 || BV32_AND(v28$1, BV32_SUB(v28$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b65 ==> v27$2 != 0bv32;
    assert {:tag "pow2"} _b64 ==> v27$2 == 0bv32 || BV32_AND(v27$2, BV32_SUB(v27$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b63 ==> v27$1 != 0bv32;
    assert {:tag "pow2"} _b62 ==> v27$1 == 0bv32 || BV32_AND(v27$1, BV32_SUB(v27$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b61 ==> v26$2 != 0bv32;
    assert {:tag "pow2"} _b60 ==> v26$2 == 0bv32 || BV32_AND(v26$2, BV32_SUB(v26$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b59 ==> v26$1 != 0bv32;
    assert {:tag "pow2"} _b58 ==> v26$1 == 0bv32 || BV32_AND(v26$1, BV32_SUB(v26$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b57 ==> v20$2 != 0bv32;
    assert {:tag "pow2"} _b56 ==> v20$2 == 0bv32 || BV32_AND(v20$2, BV32_SUB(v20$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b55 ==> v20$1 != 0bv32;
    assert {:tag "pow2"} _b54 ==> v20$1 == 0bv32 || BV32_AND(v20$1, BV32_SUB(v20$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b53 ==> v19$2 != 0bv32;
    assert {:tag "pow2"} _b52 ==> v19$2 == 0bv32 || BV32_AND(v19$2, BV32_SUB(v19$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b51 ==> v19$1 != 0bv32;
    assert {:tag "pow2"} _b50 ==> v19$1 == 0bv32 || BV32_AND(v19$1, BV32_SUB(v19$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b49 ==> v17$2 != 0bv32;
    assert {:tag "pow2"} _b48 ==> v17$2 == 0bv32 || BV32_AND(v17$2, BV32_SUB(v17$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b47 ==> v17$1 != 0bv32;
    assert {:tag "pow2"} _b46 ==> v17$1 == 0bv32 || BV32_AND(v17$1, BV32_SUB(v17$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b45 ==> v18$2 != 0bv32;
    assert {:tag "pow2"} _b44 ==> v18$2 == 0bv32 || BV32_AND(v18$2, BV32_SUB(v18$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b43 ==> v18$1 != 0bv32;
    assert {:tag "pow2"} _b42 ==> v18$1 == 0bv32 || BV32_AND(v18$1, BV32_SUB(v18$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b41 ==> v25$2 != 0bv32;
    assert {:tag "pow2"} _b40 ==> v25$2 == 0bv32 || BV32_AND(v25$2, BV32_SUB(v25$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b39 ==> v25$1 != 0bv32;
    assert {:tag "pow2"} _b38 ==> v25$1 == 0bv32 || BV32_AND(v25$1, BV32_SUB(v25$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b37 ==> v12$2 != 0bv32;
    assert {:tag "pow2"} _b36 ==> v12$2 == 0bv32 || BV32_AND(v12$2, BV32_SUB(v12$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b35 ==> v12$1 != 0bv32;
    assert {:tag "pow2"} _b34 ==> v12$1 == 0bv32 || BV32_AND(v12$1, BV32_SUB(v12$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b33 ==> v11$2 != 0bv32;
    assert {:tag "pow2"} _b32 ==> v11$2 == 0bv32 || BV32_AND(v11$2, BV32_SUB(v11$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b31 ==> v11$1 != 0bv32;
    assert {:tag "pow2"} _b30 ==> v11$1 == 0bv32 || BV32_AND(v11$1, BV32_SUB(v11$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b29 ==> v10$2 != 0bv32;
    assert {:tag "pow2"} _b28 ==> v10$2 == 0bv32 || BV32_AND(v10$2, BV32_SUB(v10$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b27 ==> v10$1 != 0bv32;
    assert {:tag "pow2"} _b26 ==> v10$1 == 0bv32 || BV32_AND(v10$1, BV32_SUB(v10$1, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b25 ==> v9$2 != 0bv32;
    assert {:tag "pow2"} _b24 ==> v9$2 == 0bv32 || BV32_AND(v9$2, BV32_SUB(v9$2, 1bv32)) == 0bv32;
    assert {:tag "pow2NotZero"} _b23 ==> v9$1 != 0bv32;
    assert {:tag "pow2"} _b22 ==> v9$1 == 0bv32 || BV32_AND(v9$1, BV32_SUB(v9$1, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$histogramKernel.subhists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histogramKernel.subhists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histogramKernel.subhists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $21:
    ...
    assert {:tag "accessBreak"} _b70 ==> _READ_HAS_OCCURRED_$$histogramKernel.subhists ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 16bv32);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$histogramKernel.subhists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$histogramKernel.subhists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$histogramKernel.subhists ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b12 ==> _READ_HAS_OCCURRED_$$histogramKernel.subhists ==> BV32_ULT(local_id_x$1, 256bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p5$1 ==> _b11 ==> p5$1 ==> BV32_ULT(local_id_x$1, 256bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p5$2 ==> _b11 ==> p5$2 ==> BV32_ULT(local_id_x$2, 256bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b10 ==> BV32_ULT(local_id_x$1, 256bv32) && BV32_ULT($i.2$1, 16bv32) ==> p5$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b10 ==> BV32_ULT(local_id_x$2, 256bv32) && BV32_ULT($i.2$2, 16bv32) ==> p5$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b9 ==> !BV32_ULT(v0$1, 256bv32) ==> !_READ_HAS_OCCURRED_$$histogramKernel.subhists;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b8 ==> !BV32_ULT(v0$1, 256bv32) ==> !p5$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b8 ==> !BV32_ULT(v0$2, 256bv32) ==> !p5$2;
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b7 ==> BV32_UGE($i.2$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b7 ==> BV32_UGE($i.2$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b6 ==> BV32_ULE($i.2$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b6 ==> BV32_ULE($i.2$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b5 ==> BV32_SGE($i.2$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b5 ==> BV32_SGE($i.2$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b4 ==> BV32_SLE($i.2$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b4 ==> BV32_SLE($i.2$2, 0bv32);
