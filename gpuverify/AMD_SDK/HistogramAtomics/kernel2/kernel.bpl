...
implementation {:source_name "reduceKernel"} {:kernel} $reduceKernel($nSubHists: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessBreak"} _b7 ==> _READ_HAS_OCCURRED_$$Histogram ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, group_size_x);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b6 ==> _READ_HAS_OCCURRED_$$Histogram ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 256bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 256bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 256bv32), BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)));
    assert {:tag "accessUpperBoundBlock"} _b5 ==> _READ_HAS_OCCURRED_$$Histogram ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(group_size_x, BV32_ADD(group_id_x$1, 1bv32)), local_id_x$1));
    assert {:tag "accessLowerBoundBlock"} _b4 ==> _READ_HAS_OCCURRED_$$Histogram ==> BV32_SLE(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), _WATCHED_OFFSET);
