...
implementation {:source_name "histogram256"} {:kernel} $histogram256()
{
  ...
  $1:
    ...
    assert {:tag "accessBreak"} _b19 ==> _WRITE_HAS_OCCURRED_$$sharedArray ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 256bv32);
    assert {:tag "accessedOffsetInRangeCTimesLid"} _b18 ==> _WRITE_HAS_OCCURRED_$$sharedArray ==> BV32_SLE(BV32_MUL(256bv32, local_id_x$1), _WATCHED_OFFSET) && BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(256bv32, local_id_x$1), 256bv32));
  ...
  $5:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b21 ==> _WRITE_HAS_OCCURRED_$$sharedArray ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 256bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b20 ==> _READ_HAS_OCCURRED_$$sharedArray ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 256bv32);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$sharedArray ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$sharedArray ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$sharedArray ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
  ...
  $9:
    ...
    assert {:tag "accessBreak"} _b23 ==> _WRITE_HAS_OCCURRED_$$binResult ==> group_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 256bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b22 ==> _WRITE_HAS_OCCURRED_$$binResult ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, group_size_x), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, group_size_x), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(0bv32, group_size_x), BV32_MUL(group_id_x$1, 256bv32)), local_id_x$1));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$sharedArray ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$sharedArray ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$sharedArray ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_UGE($i2.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b13 ==> BV32_UGE($i2.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_ULE($i2.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b12 ==> BV32_ULE($i2.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_SGE($i2.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b11 ==> BV32_SGE($i2.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b10 ==> BV32_SLE($i2.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b10 ==> BV32_SLE($i2.0, 0bv32);
  ...
  $11:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$sharedArray ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$sharedArray ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b17 ==> BV32_UGE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b17 ==> BV32_UGE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b16 ==> BV32_ULE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b16 ==> BV32_ULE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b15 ==> BV32_SGE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b15 ==> BV32_SGE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b14 ==> BV32_SLE($j.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b14 ==> BV32_SLE($j.0, 0bv32);
