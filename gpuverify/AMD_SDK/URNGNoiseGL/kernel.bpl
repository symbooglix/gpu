...
implementation {:source_name "noise_uniform"} {:kernel} $noise_uniform($factor: bv32)
{
  ...
  $1:
    ...
    assert {:tag "loopBound"} {:thread 2} _b5 ==> BV32_UGE($j.i.0, 4bv32);
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_ULE($j.i.0, 4bv32);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_ULE($j.i.0, 4bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_SGE($j.i.0, 4bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_SGE($j.i.0, 4bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SLE($j.i.0, 4bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SLE($j.i.0, 4bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b1 ==> BV32_SLE(0bv32, $j.i.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b1 ==> BV32_SLE(0bv32, $j.i.0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $j.i.0) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), 4bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $j.i.0) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), 4bv32);
  ...
  $falsebb:
    ...
    call {:sourceloc} {:sourceloc_num 13} _LOG_READ_$$noise_uniform.iv(true, BV32_MUL(4bv32, v8$1), $$noise_uniform.iv[1bv1][BV32_MUL(4bv32, v8$1)]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 13} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 13} _CHECK_READ_$$noise_uniform.iv(true, BV32_MUL(4bv32, v8$2), $$noise_uniform.iv[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_MUL(4bv32, v8$2)]);
    ...
    v18$2 := BV32_SDIV(v14$2, 536870912bv32);
    ...
    call {:sourceloc} {:sourceloc_num 16} _LOG_READ_$$noise_uniform.iv(true, BV32_ADD(BV32_MUL(4bv32, v8$1), v18$1), $$noise_uniform.iv[1bv1][BV32_ADD(BV32_MUL(4bv32, v8$1), v18$1)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 16} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 16} _CHECK_READ_$$noise_uniform.iv(true, BV32_ADD(BV32_MUL(4bv32, v8$2), v18$2), $$noise_uniform.iv[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(4bv32, v8$2), v18$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$noise_uniform.iv"} true;
    v19$1 := $$noise_uniform.iv[1bv1][BV32_ADD(BV32_MUL(4bv32, v8$1), v18$1)];
    v19$2 := $$noise_uniform.iv[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(4bv32, v8$2), v18$2)];
    v20$1 := FMUL32(FSUB32(FMUL32(805306368bv32, SI32_TO_FP32(v19$1)), 1056964608bv32), SI32_TO_FP32($factor));
    v20$2 := FMUL32(FSUB32(FMUL32(805306368bv32, SI32_TO_FP32(v19$2)), 1056964608bv32), SI32_TO_FP32($factor));
