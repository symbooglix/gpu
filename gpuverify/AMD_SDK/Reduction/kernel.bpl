...
implementation {:source_name "reduce"} {:kernel} $reduce()
{
  ...
  $1:
    ...
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($s.0, BV32_LSHR(group_size_x, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_UGE($s.0, BV32_LSHR(group_size_x, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($s.0, BV32_LSHR(group_size_x, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_ULE($s.0, BV32_LSHR(group_size_x, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($s.0, BV32_LSHR(group_size_x, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SGE($s.0, BV32_LSHR(group_size_x, 1bv32));
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($s.0, BV32_LSHR(group_size_x, 1bv32));
    assert {:tag "loopBound"} {:thread 2} _b0 ==> BV32_SLE($s.0, BV32_LSHR(group_size_x, 1bv32));
