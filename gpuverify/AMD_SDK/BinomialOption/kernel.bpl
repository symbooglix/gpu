...
implementation {:source_name "binomial_options"} {:kernel} $binomial_options($numSteps: bv32)
{
  ...
  $13:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _WRITE_HAS_OCCURRED_$$callA ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 4bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 1bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 2bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 3bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b7 ==> _READ_HAS_OCCURRED_$$callA ==> _WATCHED_OFFSET == BV32_MUL(local_id_x$1, 4bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 1bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 2bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(local_id_x$1, 4bv32), 3bv32) || _WATCHED_OFFSET == BV32_MUL(BV32_ADD(local_id_x$1, 1bv32), 4bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_x$1, 1bv32), 4bv32), 1bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_x$1, 1bv32), 4bv32), 2bv32) || _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(local_id_x$1, 1bv32), 4bv32), 3bv32);
    assert {:tag "nowrite"} _b6 ==> !_WRITE_HAS_OCCURRED_$$callA;
    assert {:tag "noread"} _b5 ==> !_READ_HAS_OCCURRED_$$callA;
    ...
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_UGE($j.0, $numSteps);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_UGE($j.0, $numSteps);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($j.0, $numSteps);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_ULE($j.0, $numSteps);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($j.0, $numSteps);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SGE($j.0, $numSteps);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($j.0, $numSteps);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SLE($j.0, $numSteps);
