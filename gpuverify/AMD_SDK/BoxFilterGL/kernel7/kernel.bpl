...
implementation {:source_name "box_filter_horizontal_local"} {:kernel} $box_filter_horizontal_local($filterWidth: bv32)
{
  ...
  $6:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _READ_HAS_OCCURRED_$$lds ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_MUL(0bv32, 4bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 1bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 2bv32)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 4bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 4bv32), 3bv32));
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b7 ==> BV32_SLE($X.0$1, BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32)) ==> p7$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b7 ==> BV32_SLE($X.0$2, BV32_SDIV(BV32_SUB($filterWidth, 1bv32), 2bv32)) ==> p7$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b6 ==> BV32_SLT(v0$1, v2) || BV32_SGE(v0$1, BV32_SUB(v1, v2)) ==> !_READ_HAS_OCCURRED_$$lds;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b5 ==> BV32_SLT(v0$1, v2) || BV32_SGE(v0$1, BV32_SUB(v1, v2)) ==> !p7$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b5 ==> BV32_SLT(v0$2, v2) || BV32_SGE(v0$2, BV32_SUB(v1, v2)) ==> !p7$2;
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b4 ==> BV32_UGE($X.0$1, BV32_SUB(0bv32, v2));
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b4 ==> BV32_UGE($X.0$2, BV32_SUB(0bv32, v2));
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b3 ==> BV32_ULE($X.0$1, BV32_SUB(0bv32, v2));
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b3 ==> BV32_ULE($X.0$2, BV32_SUB(0bv32, v2));
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b2 ==> BV32_SGE($X.0$1, BV32_SUB(0bv32, v2));
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b2 ==> BV32_SGE($X.0$2, BV32_SUB(0bv32, v2));
    assert {:tag "loopBound"} {:thread 1} p7$1 ==> _b1 ==> BV32_SLE($X.0$1, BV32_SUB(0bv32, v2));
    assert {:tag "loopBound"} {:thread 2} p7$2 ==> _b1 ==> BV32_SLE($X.0$2, BV32_SUB(0bv32, v2));
    assert {:tag "guardNonNeg"} {:thread 1} p7$1 ==> _b0 ==> BV32_SLE(0bv32, $X.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p7$2 ==> _b0 ==> BV32_SLE(0bv32, $X.0$2);
