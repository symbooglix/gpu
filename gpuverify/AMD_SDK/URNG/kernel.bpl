...
implementation {:source_name "noise_uniform"} {:kernel} $noise_uniform($factor: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessBreak"} _b11 ==> _WRITE_HAS_OCCURRED_$$noise_uniform.iv ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 16bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b10 ==> _WRITE_HAS_OCCURRED_$$noise_uniform.iv ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), BV32_ADD(16bv32, BV32_MUL(16bv32, local_id_x$1)));
    ...
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_UGE($j.i.0, 16bv32);
    assert {:tag "loopBound"} {:thread 2} _b5 ==> BV32_UGE($j.i.0, 16bv32);
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_ULE($j.i.0, 16bv32);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_ULE($j.i.0, 16bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_SGE($j.i.0, 16bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_SGE($j.i.0, 16bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SLE($j.i.0, 16bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SLE($j.i.0, 16bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b1 ==> BV32_SLE(0bv32, $j.i.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b1 ==> BV32_SLE(0bv32, $j.i.0);
    assert {:tag "loopCounterIsStrided"} {:thread 1} _b0 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $j.i.0) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), 16bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 2} _b0 ==> BV32_AND(BV32_SUB(4294967295bv32, 1bv32), $j.i.0) == BV32_AND(BV32_SUB(4294967295bv32, 1bv32), 16bv32);
