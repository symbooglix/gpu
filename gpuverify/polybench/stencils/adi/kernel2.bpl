...
procedure {:source_name "kernel2"} {:kernel} $kernel2($n: bv32, $tsteps: bv32, $h0: bv32);
  ...
  modifies $$kernel2.shared_A, _WRITE_HAS_OCCURRED_$$kernel2.shared_A, _WRITE_READ_BENIGN_FLAG_$$kernel2.shared_A, _WRITE_READ_BENIGN_FLAG_$$kernel2.shared_A, $$X, _TRACKING, _READ_HAS_OCCURRED_$$X, _READ_HAS_OCCURRED_$$kernel2.shared_A, _WRITE_HAS_OCCURRED_$$X, _WRITE_READ_BENIGN_FLAG_$$X, _WRITE_READ_BENIGN_FLAG_$$X, _TRACKING;



implementation {:source_name "kernel2"} {:kernel} $kernel2($n: bv32, $tsteps: bv32, $h0: bv32)
{
  var $g1.0$1: bv32;
  var $g1.0$2: bv32;
  var $g5.0$1: bv32;
  ...
  $1:
    ...
    assert {:tag "accessBreak"} _b68 ==> _READ_HAS_OCCURRED_$$kernel2.shared_A ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b67 ==> _WRITE_HAS_OCCURRED_$$kernel2.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1));
    assert {:tag "nowrite"} _b66 ==> !_WRITE_HAS_OCCURRED_$$kernel2.shared_A;
    assert {:tag "noread"} _b65 ==> !_READ_HAS_OCCURRED_$$kernel2.shared_A;
    assert {:tag "accessBreak"} _b64 ==> _WRITE_HAS_OCCURRED_$$X ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $n);
    assert {:tag "nowrite"} _b63 ==> !_WRITE_HAS_OCCURRED_$$X;
    assert {:tag "noread"} _b62 ==> !_READ_HAS_OCCURRED_$$X;
    ...
    assert {:tag "predicatedEquality"} _b48 ==> p0$1 && p0$2 ==> $1$1 == $1$2;
  ...
  $3:
    ...
    assert {:tag "accessBreak"} _b94 ==> _READ_HAS_OCCURRED_$$kernel2.shared_A ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b93 ==> _WRITE_HAS_OCCURRED_$$kernel2.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1));
    assert {:tag "nowrite"} _b92 ==> !_WRITE_HAS_OCCURRED_$$kernel2.shared_A;
    assert {:tag "noread"} _b91 ==> !_READ_HAS_OCCURRED_$$kernel2.shared_A;
    assert {:tag "accessBreak"} _b90 ==> _WRITE_HAS_OCCURRED_$$X ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $n);
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _WRITE_HAS_OCCURRED_$$kernel2.shared_A ==> BV32_SLT($g1.0$1, $n);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _READ_HAS_OCCURRED_$$kernel2.shared_A ==> BV32_SLT($g1.0$1, $n);
    ...
    v3$1 := (if p3$1 then BV32_SGE(BV32_ADD($n, v0$1), BV32_ADD($g5.0$1, 34bv32)) else v3$1);
    v3$2 := (if p3$2 then BV32_SGE(BV32_ADD($n, v0$2), BV32_ADD($g5.0$2, 34bv32)) else v3$2);
  ...
  $6:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b95 ==> _WRITE_HAS_OCCURRED_$$kernel2.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel2.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel2.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel2.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert p6$1 ==> p2$1;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b40 ==> _WRITE_HAS_OCCURRED_$$kernel2.shared_A ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g5.0$1, BV32_SUB($n, 2bv32)) && BV32_SGE(BV32_ADD($n, local_id_x$1), BV32_ADD($g5.0$1, 34bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b39 ==> p6$1 ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g5.0$1, BV32_SUB($n, 2bv32)) && BV32_SGE(BV32_ADD($n, local_id_x$1), BV32_ADD($g5.0$1, 34bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b39 ==> p6$2 ==> BV32_SLT($g1.0$2, $n) && BV32_SLT($g5.0$2, BV32_SUB($n, 2bv32)) && BV32_SGE(BV32_ADD($n, local_id_x$2), BV32_ADD($g5.0$2, 34bv32));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b38 ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g5.0$1, BV32_SUB($n, 2bv32)) && BV32_SGE(BV32_ADD($n, local_id_x$1), BV32_ADD($g5.0$1, 34bv32)) && BV32_SLT(BV32_SUB(BV32_SUB($n, $g1.0$1), 1bv32), 31bv32) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b38 ==> BV32_SLT($g1.0$2, $n) && BV32_SLT($g5.0$2, BV32_SUB($n, 2bv32)) && BV32_SGE(BV32_ADD($n, local_id_x$2), BV32_ADD($g5.0$2, 34bv32)) && BV32_SLT(BV32_SUB(BV32_SUB($n, $g1.0$2), 1bv32), 31bv32) ==> p6$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b37 ==> !BV32_SGE(BV32_ADD($n, v0$1), BV32_ADD($g5.0$1, 34bv32)) ==> !_READ_HAS_OCCURRED_$$A;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b36 ==> !BV32_SGE(BV32_ADD($n, v0$1), BV32_ADD($g5.0$1, 34bv32)) ==> !_WRITE_HAS_OCCURRED_$$kernel2.shared_A;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b35 ==> !BV32_SGE(BV32_ADD($n, v0$1), BV32_ADD($g5.0$1, 34bv32)) ==> !p6$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b35 ==> !BV32_SGE(BV32_ADD($n, v0$2), BV32_ADD($g5.0$2, 34bv32)) ==> !p6$2;
    ...
    v4$1 := (if p6$1 then BV32_SLT(BV32_SUB(BV32_SUB($n, $g1.0$1), 1bv32), 31bv32) else v4$1);
    v4$2 := (if p6$2 then BV32_SLT(BV32_SUB(BV32_SUB($n, $g1.0$2), 1bv32), 31bv32) else v4$2);
    p7$1 := false;
    p7$2 := false;
    p8$1 := false;
    p8$2 := false;
    ...
    $0$1 := (if p8$1 then BV32_SUB(BV32_SUB($n, $g1.0$1), 1bv32) else $0$1);
    $0$2 := (if p8$2 then BV32_SUB(BV32_SUB($n, $g1.0$2), 1bv32) else $0$2);
    ...
    call {:sourceloc} {:sourceloc_num 14} _LOG_WRITE_$$kernel2.shared_A(p9$1, BV32_ADD(BV32_MUL($c0.0$1, 32bv32), v0$1), v6$1, $$kernel2.shared_A[1bv1][BV32_ADD(BV32_MUL($c0.0$1, 32bv32), v0$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel2.shared_A(p9$2, BV32_ADD(BV32_MUL($c0.0$2, 32bv32), v0$2));
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 14} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 14} _CHECK_WRITE_$$kernel2.shared_A(p9$2, BV32_ADD(BV32_MUL($c0.0$2, 32bv32), v0$2), v6$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$kernel2.shared_A"} true;
    $$kernel2.shared_A[1bv1][BV32_ADD(BV32_MUL($c0.0$1, 32bv32), v0$1)] := (if p9$1 then v6$1 else $$kernel2.shared_A[1bv1][BV32_ADD(BV32_MUL($c0.0$1, 32bv32), v0$1)]);
    $$kernel2.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL($c0.0$2, 32bv32), v0$2)] := (if p9$2 then v6$2 else $$kernel2.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL($c0.0$2, 32bv32), v0$2)]);
  ...
  $15:
    ...
    assert {:tag "accessBreak"} _b97 ==> _READ_HAS_OCCURRED_$$kernel2.shared_A ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, 32bv32);
    assert {:tag "accessBreak"} _b96 ==> _WRITE_HAS_OCCURRED_$$X ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $n);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel2.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel2.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel2.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert p12$1 ==> p2$1;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _READ_HAS_OCCURRED_$$kernel2.shared_A ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g5.0$1, BV32_SUB($n, 2bv32)) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32));
    ...
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b26 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 1bv32)) ==> !_READ_HAS_OCCURRED_$$kernel2.shared_A;
    ...
    call {:sourceloc} {:sourceloc_num 25} _LOG_READ_$$X(p15$1, BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$1), $c2.0$1), 2bv32)), $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$1), $c2.0$1), 2bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 25} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 25} _CHECK_READ_$$X(p15$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$2), $c2.0$2), 2bv32)), $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$2), $c2.0$2), 2bv32))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$X"} true;
    v10$1 := (if p15$1 then $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$1), $c2.0$1), 2bv32))] else v10$1);
    v10$2 := (if p15$2 then $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$2), $c2.0$2), 2bv32))] else v10$2);
    call {:sourceloc} {:sourceloc_num 26} _LOG_READ_$$X(p15$1, BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$1), $c2.0$1), 3bv32)), $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$1), $c2.0$1), 3bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 26} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 26} _CHECK_READ_$$X(p15$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$2), $c2.0$2), 3bv32)), $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$2), $c2.0$2), 3bv32))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$X"} true;
    v11$1 := (if p15$1 then $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$1), $c2.0$1), 3bv32))] else v11$1);
    v11$2 := (if p15$2 then $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$2), $c2.0$2), 3bv32))] else v11$2);
    call {:sourceloc} {:sourceloc_num 27} _LOG_READ_$$kernel2.shared_A(p15$1, BV32_ADD(BV32_MUL(v0$1, 32bv32), BV32_ADD(BV32_SUB(0bv32, $c2.0$1), 31bv32)), $$kernel2.shared_A[1bv1][BV32_ADD(BV32_MUL(v0$1, 32bv32), BV32_ADD(BV32_SUB(0bv32, $c2.0$1), 31bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 27} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 27} _CHECK_READ_$$kernel2.shared_A(p15$2, BV32_ADD(BV32_MUL(v0$2, 32bv32), BV32_ADD(BV32_SUB(0bv32, $c2.0$2), 31bv32)), $$kernel2.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v0$2, 32bv32), BV32_ADD(BV32_SUB(0bv32, $c2.0$2), 31bv32))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$kernel2.shared_A"} true;
    v12$1 := (if p15$1 then $$kernel2.shared_A[1bv1][BV32_ADD(BV32_MUL(v0$1, 32bv32), BV32_ADD(BV32_SUB(0bv32, $c2.0$1), 31bv32))] else v12$1);
    v12$2 := (if p15$2 then $$kernel2.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v0$2, 32bv32), BV32_ADD(BV32_SUB(0bv32, $c2.0$2), 31bv32))] else v12$2);
    havoc _HAVOC_bv64$1, _HAVOC_bv64$2;
    v13$1 := (if p15$1 then _HAVOC_bv64$1 else v13$1);
    v13$2 := (if p15$2 then _HAVOC_bv64$2 else v13$2);
    call {:sourceloc} {:sourceloc_num 29} _LOG_WRITE_$$X(p15$1, BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$1), $c2.0$1), 2bv32)), FDIV64(FADD64(FMUL64(FSUB64(9223372036854775808bv64, v11$1), v12$1), v10$1), v13$1), $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$1), $c2.0$1), 2bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$X(p15$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$2), $c2.0$2), 2bv32)));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 29} _CHECK_WRITE_$$X(p15$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$2), $c2.0$2), 2bv32)), FDIV64(FADD64(FMUL64(FSUB64(9223372036854775808bv64, v11$2), v12$2), v10$2), v13$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$X"} true;
    $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$1), $c2.0$1), 2bv32))] := (if p15$1 then FDIV64(FADD64(FMUL64(FSUB64(9223372036854775808bv64, v11$1), v12$1), v10$1), v13$1) else $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$1), $c2.0$1), 2bv32))]);
    $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$2), $c2.0$2), 2bv32))] := (if p15$2 then FDIV64(FADD64(FMUL64(FSUB64(9223372036854775808bv64, v11$2), v12$2), v10$2), v13$2) else $$X[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_SUB(BV32_SUB($n, $g5.0$2), $c2.0$2), 2bv32))]);
...
procedure {:inline 1} {:safe_barrier} {:source_name "bugle_barrier"} {:barrier} $bugle_barrier_duplicated_0($0: bv1, $1: bv1, _P$1: bool, _P$2: bool);
  ...
  modifies $$kernel2.shared_A, $$X, _TRACKING;
