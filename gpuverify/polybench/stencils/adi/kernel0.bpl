...
implementation {:source_name "kernel0"} {:kernel} $kernel0($n: bv32, $tsteps: bv32, $h0: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b68 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1));
    assert {:tag "nowrite"} _b67 ==> !_WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "noread"} _b66 ==> !_READ_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "accessBreak"} _b65 ==> _WRITE_HAS_OCCURRED_$$B ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $n);
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b95 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1));
    assert {:tag "nowrite"} _b94 ==> !_WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "noread"} _b93 ==> !_READ_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "accessBreak"} _b92 ==> _WRITE_HAS_OCCURRED_$$B ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $n);
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_SLT($g1.0$1, $n);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_SLT($g1.0$1, $n);
  ...
  $6:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b96 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel0.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel0.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert p6$1 ==> p2$1;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b39 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g5.0$1, $n) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$1, $g5.0$1), 1bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b38 ==> p6$1 ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g5.0$1, $n) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$1, $g5.0$1), 1bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b38 ==> p6$2 ==> BV32_SLT($g1.0$2, $n) && BV32_SLT($g5.0$2, $n) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$2, $g5.0$2), 1bv32));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b37 ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g5.0$1, $n) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$1, $g5.0$1), 1bv32)) && BV32_SLT(31bv32, BV32_SUB(BV32_SUB($n, $g1.0$1), 1bv32)) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b37 ==> BV32_SLT($g1.0$2, $n) && BV32_SLT($g5.0$2, $n) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$2, $g5.0$2), 1bv32)) && BV32_SLT(31bv32, BV32_SUB(BV32_SUB($n, $g1.0$2), 1bv32)) ==> p6$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b36 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v0$1, $g5.0$1), 1bv32)) ==> !_READ_HAS_OCCURRED_$$A;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b35 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v0$1, $g5.0$1), 1bv32)) ==> !_WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b34 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v0$1, $g5.0$1), 1bv32)) ==> !p6$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b34 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v0$2, $g5.0$2), 1bv32)) ==> !p6$2;
    ...
    call {:sourceloc} {:sourceloc_num 14} _LOG_WRITE_$$kernel0.shared_A(p9$1, BV32_ADD(BV32_MUL($c0.0$1, 32bv32), v0$1), v6$1, $$kernel0.shared_A[1bv1][BV32_ADD(BV32_MUL($c0.0$1, 32bv32), v0$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel0.shared_A(p9$2, BV32_ADD(BV32_MUL($c0.0$2, 32bv32), v0$2));
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 14} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 14} _CHECK_WRITE_$$kernel0.shared_A(p9$2, BV32_ADD(BV32_MUL($c0.0$2, 32bv32), v0$2), v6$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$kernel0.shared_A"} true;
    $$kernel0.shared_A[1bv1][BV32_ADD(BV32_MUL($c0.0$1, 32bv32), v0$1)] := (if p9$1 then v6$1 else $$kernel0.shared_A[1bv1][BV32_ADD(BV32_MUL($c0.0$1, 32bv32), v0$1)]);
    $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL($c0.0$2, 32bv32), v0$2)] := (if p9$2 then v6$2 else $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL($c0.0$2, 32bv32), v0$2)]);
  ...
  $18:
    ...
    assert {:tag "accessBreak"} _b97 ==> _WRITE_HAS_OCCURRED_$$B ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $n);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel0.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel0.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert p14$1 ==> p2$1;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b29 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g5.0$1, $n) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32));
    ...
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b26 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 1bv32)) ==> !_READ_HAS_OCCURRED_$$kernel0.shared_A;
    ...
    call {:sourceloc} {:sourceloc_num 28} _LOG_READ_$$B(p17$1, BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_ADD($g5.0$1, $c2.0$1)), $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_ADD($g5.0$1, $c2.0$1))]);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 28} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 28} _CHECK_READ_$$B(p17$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_ADD($g5.0$2, $c2.0$2)), $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_ADD($g5.0$2, $c2.0$2))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$B"} true;
    v11$1 := (if p17$1 then $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_ADD($g5.0$1, $c2.0$1))] else v11$1);
    v11$2 := (if p17$2 then $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_ADD($g5.0$2, $c2.0$2))] else v11$2);
    call {:sourceloc} {:sourceloc_num 29} _LOG_READ_$$kernel0.shared_A(p17$1, BV32_ADD(BV32_MUL(v0$1, 32bv32), $c2.0$1), $$kernel0.shared_A[1bv1][BV32_ADD(BV32_MUL(v0$1, 32bv32), $c2.0$1)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 29} _CHECK_READ_$$kernel0.shared_A(p17$2, BV32_ADD(BV32_MUL(v0$2, 32bv32), $c2.0$2), $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v0$2, 32bv32), $c2.0$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$kernel0.shared_A"} true;
    v12$1 := (if p17$1 then $$kernel0.shared_A[1bv1][BV32_ADD(BV32_MUL(v0$1, 32bv32), $c2.0$1)] else v12$1);
    v12$2 := (if p17$2 then $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v0$2, 32bv32), $c2.0$2)] else v12$2);
    call {:sourceloc} {:sourceloc_num 30} _LOG_READ_$$kernel0.shared_A(p17$1, BV32_ADD(BV32_MUL(v0$1, 32bv32), $c2.0$1), $$kernel0.shared_A[1bv1][BV32_ADD(BV32_MUL(v0$1, 32bv32), $c2.0$1)]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 30} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 30} _CHECK_READ_$$kernel0.shared_A(p17$2, BV32_ADD(BV32_MUL(v0$2, 32bv32), $c2.0$2), $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v0$2, 32bv32), $c2.0$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$kernel0.shared_A"} true;
    v13$1 := (if p17$1 then $$kernel0.shared_A[1bv1][BV32_ADD(BV32_MUL(v0$1, 32bv32), $c2.0$1)] else v13$1);
    v13$2 := (if p17$2 then $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(v0$2, 32bv32), $c2.0$2)] else v13$2);
    call {:sourceloc} {:sourceloc_num 31} _LOG_READ_$$B(p17$1, BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_ADD($g5.0$1, $c2.0$1), 1bv32)), $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_ADD($g5.0$1, $c2.0$1), 1bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 31} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 31} _CHECK_READ_$$B(p17$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_ADD($g5.0$2, $c2.0$2), 1bv32)), $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_ADD($g5.0$2, $c2.0$2), 1bv32))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$B"} true;
    v14$1 := (if p17$1 then $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_SUB(BV32_ADD($g5.0$1, $c2.0$1), 1bv32))] else v14$1);
    v14$2 := (if p17$2 then $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_SUB(BV32_ADD($g5.0$2, $c2.0$2), 1bv32))] else v14$2);
    call {:sourceloc} {:sourceloc_num 32} _LOG_WRITE_$$B(p17$1, BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_ADD($g5.0$1, $c2.0$1)), FSUB64(v11$1, FDIV64(FMUL64(v12$1, v13$1), v14$1)), $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_ADD($g5.0$1, $c2.0$1))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$B(p17$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_ADD($g5.0$2, $c2.0$2)));
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 32} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 32} _CHECK_WRITE_$$B(p17$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_ADD($g5.0$2, $c2.0$2)), FSUB64(v11$2, FDIV64(FMUL64(v12$2, v13$2), v14$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$B"} true;
    $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_ADD($g5.0$1, $c2.0$1))] := (if p17$1 then FSUB64(v11$1, FDIV64(FMUL64(v12$1, v13$1), v14$1)) else $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $n), BV32_ADD($g5.0$1, $c2.0$1))]);
    $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_ADD($g5.0$2, $c2.0$2))] := (if p17$2 then FSUB64(v11$2, FDIV64(FMUL64(v12$2, v13$2), v14$2)) else $$B[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $n), BV32_ADD($g5.0$2, $c2.0$2))]);
