...
axiom {:array_info "$$private_B"} {:elem_width 64} {:source_name "private_B"} {:source_elem_width 64} {:source_dimensions "1"} true;

var {:source_name "shared_A"} {:group_shared} $$kernel0.shared_A: [bv1][bv32]bv64;

axiom {:array_info "$$kernel0.shared_A"} {:group_shared} {:elem_width 64} {:source_name "shared_A"} {:source_elem_width 64} {:source_dimensions "34"} true;

var {:race_checking} {:group_shared} {:elem_width 64} {:source_elem_width 64} {:source_dimensions "*"} _READ_HAS_OCCURRED_$$kernel0.shared_A: bool;

var {:race_checking} {:group_shared} {:elem_width 64} {:source_elem_width 64} {:source_dimensions "*"} _WRITE_HAS_OCCURRED_$$kernel0.shared_A: bool;

var {:race_checking} {:group_shared} {:elem_width 64} {:source_elem_width 64} {:source_dimensions "*"} _ATOMIC_HAS_OCCURRED_$$kernel0.shared_A: bool;
...
procedure {:source_name "kernel0"} {:kernel} $kernel0($tsteps: bv32, $n: bv32, $h0: bv32);
  requires {:sourceloc_num 0} {:thread 1} (if $tsteps == 128bv32 then 1bv1 else 0bv1) != 0bv1;
  ...
  modifies $$kernel0.shared_A, _WRITE_HAS_OCCURRED_$$kernel0.shared_A, _WRITE_READ_BENIGN_FLAG_$$kernel0.shared_A, _WRITE_READ_BENIGN_FLAG_$$kernel0.shared_A, $$B, _TRACKING, _READ_HAS_OCCURRED_$$kernel0.shared_A, _TRACKING, _WRITE_HAS_OCCURRED_$$B, _WRITE_READ_BENIGN_FLAG_$$B, _WRITE_READ_BENIGN_FLAG_$$B, _TRACKING;



implementation {:source_name "kernel0"} {:kernel} $kernel0($tsteps: bv32, $n: bv32, $h0: bv32)
{
  var $g1.0$1: bv32;
  var $g1.0$2: bv32;
  var $0$1: bv32;
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b38 ==> _READ_HAS_OCCURRED_$$kernel0.shared_A ==> _WATCHED_OFFSET == local_id_x$1 || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, 1bv32) || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, 2bv32);
    assert {:tag "nowrite"} _b37 ==> !_WRITE_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "noread"} _b36 ==> !_READ_HAS_OCCURRED_$$kernel0.shared_A;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b35 ==> _WRITE_HAS_OCCURRED_$$B ==> BV32_AND(BV32_SUB(1048576bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1048576bv32, 1bv32), BV32_ADD(BV32_MUL(32bv32, group_id_x$1), local_id_x$1));
    assert {:tag "nowrite"} _b34 ==> !_WRITE_HAS_OCCURRED_$$B;
    assert {:tag "predicatedEquality"} _b33 ==> p0$1 && p0$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b32 ==> p0$1 && p0$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b31 ==> p0$1 && p0$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b30 ==> p0$1 && p0$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b29 ==> p0$1 && p0$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b28 ==> p0$1 && p0$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b27 ==> p0$1 && p0$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b26 ==> p0$1 && p0$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b25 ==> p0$1 && p0$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b24 ==> p0$1 && p0$2 ==> v4$1 == v4$2;
    assert {:tag "predicatedEquality"} _b23 ==> p0$1 && p0$2 ==> v3$1 == v3$2;
    assert {:tag "predicatedEquality"} _b22 ==> p0$1 && p0$2 ==> v2$1 == v2$2;
    assert {:tag "predicatedEquality"} _b21 ==> p0$1 && p0$2 ==> v1$1 == v1$2;
    assert {:tag "predicatedEquality"} _b20 ==> p0$1 && p0$2 ==> $1$1 == $1$2;
    assert {:tag "predicatedEquality"} _b19 ==> p0$1 && p0$2 ==> $c0.0$1 == $c0.0$2;
    assert {:tag "predicatedEquality"} _b18 ==> p0$1 && p0$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b17 ==> p0$1 && p0$2 ==> $g1.0$1 == $g1.0$2;
    assert {:tag "loopPredicateEquality"} _b16 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p0$1 == p0$2;
    assert {:tag "loopPredicateEquality"} _b15 ==> p0$1 == p0$2;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b7 ==> BV32_SLT($g1.0$1, BV32_SUB($n, 1bv32)) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b7 ==> BV32_SLT($g1.0$2, BV32_SUB($n, 1bv32)) ==> p0$2;
    ...
    v1$1 := (if p0$1 then BV32_SLT($g1.0$1, BV32_SUB($n, 1bv32)) else v1$1);
    v1$2 := (if p0$2 then BV32_SLT($g1.0$2, BV32_SUB($n, 1bv32)) else v1$2);
    p1$1 := false;
    p1$2 := false;
    p2$1 := false;
    p2$2 := false;
    ...
    v2$1 := (if p1$1 then BV32_SGT(BV32_ADD(BV32_SUB(BV32_SREM(BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 31bv32), 32bv32), $g1.0$1), 1bv32), v0$1) else v2$1);
    v2$2 := (if p1$2 then BV32_SGT(BV32_ADD(BV32_SUB(BV32_SREM(BV32_ADD(BV32_ADD(v0$2, $g1.0$2), 31bv32), 32bv32), $g1.0$2), 1bv32), v0$2) else v2$2);
    ...
    $0$1 := (if p2$1 then v0$1 else $0$1);
    $0$2 := (if p2$2 then v0$2 else $0$2);
    $0$1 := (if p3$1 then BV32_ADD(BV32_SUB(BV32_SREM(BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 31bv32), 32bv32), $g1.0$1), 1bv32) else $0$1);
    $0$2 := (if p3$2 then BV32_ADD(BV32_SUB(BV32_SREM(BV32_ADD(BV32_ADD(v0$2, $g1.0$2), 31bv32), 32bv32), $g1.0$2), 1bv32) else $0$2);
    $c0.0$1 := (if p1$1 then $0$1 else $c0.0$1);
    $c0.0$2 := (if p1$2 then $0$2 else $c0.0$2);
  ...
  $6:
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b14 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_A ==> BV32_SLT($g1.0$1, BV32_SUB($n, 1bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p4$1 ==> _b13 ==> p4$1 ==> BV32_SLT($g1.0$1, BV32_SUB($n, 1bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p4$2 ==> _b13 ==> p4$2 ==> BV32_SLT($g1.0$2, BV32_SUB($n, 1bv32));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b12 ==> BV32_SLT($g1.0$1, BV32_SUB($n, 1bv32)) && BV32_SLT(33bv32, BV32_SUB($n, $g1.0$1)) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b12 ==> BV32_SLT($g1.0$2, BV32_SUB($n, 1bv32)) && BV32_SLT(33bv32, BV32_SUB($n, $g1.0$2)) ==> p4$2;
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b11 ==> BV32_UGE($c0.0$1, $0$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b11 ==> BV32_UGE($c0.0$2, $0$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b10 ==> BV32_ULE($c0.0$1, $0$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b10 ==> BV32_ULE($c0.0$2, $0$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b9 ==> BV32_SGE($c0.0$1, $0$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b9 ==> BV32_SGE($c0.0$2, $0$2);
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b8 ==> BV32_SLE($c0.0$1, $0$1);
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b8 ==> BV32_SLE($c0.0$2, $0$2);
    assert {:block_sourceloc} {:sourceloc_num 8} p4$1 ==> true;
    v3$1 := (if p4$1 then BV32_SLT(33bv32, BV32_SUB($n, $g1.0$1)) else v3$1);
    v3$2 := (if p4$2 then BV32_SLT(33bv32, BV32_SUB($n, $g1.0$2)) else v3$2);
    p5$1 := false;
    p5$2 := false;
    p6$1 := false;
    p6$2 := false;
    ...
    p15$1 := false;
    p15$2 := false;
    p6$1 := (if p4$1 && v3$1 then v3$1 else p6$1);
    p6$2 := (if p4$2 && v3$2 then v3$2 else p6$2);
    p5$1 := (if p4$1 && !v3$1 then !v3$1 else p5$1);
    p5$2 := (if p4$2 && !v3$2 then !v3$2 else p5$2);
    $1$1 := (if p5$1 then BV32_SUB($n, $g1.0$1) else $1$1);
    $1$2 := (if p5$2 then BV32_SUB($n, $g1.0$2) else $1$2);
    $1$1 := (if p6$1 then 33bv32 else $1$1);
    $1$2 := (if p6$2 then 33bv32 else $1$2);
    v4$1 := (if p4$1 then BV32_SLE($c0.0$1, $1$1) else v4$1);
    v4$2 := (if p4$2 then BV32_SLE($c0.0$2, $1$2) else v4$2);
    p7$1 := (if p4$1 && v4$1 then v4$1 else p7$1);
    p7$2 := (if p4$2 && v4$2 then v4$2 else p7$2);
    p4$1 := (if p4$1 && !v4$1 then v4$1 else p4$1);
    p4$2 := (if p4$2 && !v4$2 then v4$2 else p4$2);
    havoc _HAVOC_bv64$1, _HAVOC_bv64$2;
    v5$1 := (if p7$1 then _HAVOC_bv64$1 else v5$1);
    v5$2 := (if p7$2 then _HAVOC_bv64$2 else v5$2);
    call {:sourceloc} {:sourceloc_num 14} _LOG_WRITE_$$kernel0.shared_A(p7$1, $c0.0$1, v5$1, $$kernel0.shared_A[1bv1][$c0.0$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$kernel0.shared_A(p7$2, $c0.0$2);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 14} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 14} _CHECK_WRITE_$$kernel0.shared_A(p7$2, $c0.0$2, v5$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$kernel0.shared_A"} true;
    $$kernel0.shared_A[1bv1][$c0.0$1] := (if p7$1 then v5$1 else $$kernel0.shared_A[1bv1][$c0.0$1]);
    $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][$c0.0$2] := (if p7$2 then v5$2 else $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][$c0.0$2]);
    $c0.0$1 := (if p7$1 then BV32_ADD($c0.0$1, 32bv32) else $c0.0$1);
    $c0.0$2 := (if p7$2 then BV32_ADD($c0.0$2, 32bv32) else $c0.0$2);
  ...
  __partitioned_block_$6.tail_1:
    call {:sourceloc_num 17} $bugle_barrier_duplicated_0(1bv1, 1bv1, p1$1, p1$2);
    v6$1 := (if p1$1 then BV32_SGE(BV32_ADD(v0$1, $g1.0$1), 1bv32) else v6$1);
    v6$2 := (if p1$2 then BV32_SGE(BV32_ADD(v0$2, $g1.0$2), 1bv32) else v6$2);
    p9$1 := (if p1$1 && v6$1 then v6$1 else p9$1);
    p9$2 := (if p1$2 && v6$2 then v6$2 else p9$2);
    v7$1 := (if p9$1 then BV32_SGE($n, BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 2bv32)) else v7$1);
    v7$2 := (if p9$2 then BV32_SGE($n, BV32_ADD(BV32_ADD(v0$2, $g1.0$2), 2bv32)) else v7$2);
    p11$1 := (if p9$1 && v7$1 then v7$1 else p11$1);
    p11$2 := (if p9$2 && v7$2 then v7$2 else p11$2);
    call {:sourceloc} {:sourceloc_num 20} _LOG_READ_$$kernel0.shared_A(p11$1, v0$1, $$kernel0.shared_A[1bv1][v0$1]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 20} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 20} _CHECK_READ_$$kernel0.shared_A(p11$2, v0$2, $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v0$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$kernel0.shared_A"} true;
    v8$1 := (if p11$1 then $$kernel0.shared_A[1bv1][v0$1] else v8$1);
    v8$2 := (if p11$2 then $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v0$2] else v8$2);
    call {:sourceloc} {:sourceloc_num 21} _LOG_READ_$$kernel0.shared_A(p11$1, BV32_ADD(v0$1, 1bv32), $$kernel0.shared_A[1bv1][BV32_ADD(v0$1, 1bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 21} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 21} _CHECK_READ_$$kernel0.shared_A(p11$2, BV32_ADD(v0$2, 1bv32), $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v0$2, 1bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$kernel0.shared_A"} true;
    v9$1 := (if p11$1 then $$kernel0.shared_A[1bv1][BV32_ADD(v0$1, 1bv32)] else v9$1);
    v9$2 := (if p11$2 then $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v0$2, 1bv32)] else v9$2);
    call {:sourceloc} {:sourceloc_num 22} _LOG_READ_$$kernel0.shared_A(p11$1, BV32_ADD(v0$1, 2bv32), $$kernel0.shared_A[1bv1][BV32_ADD(v0$1, 2bv32)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 22} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 22} _CHECK_READ_$$kernel0.shared_A(p11$2, BV32_ADD(v0$2, 2bv32), $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v0$2, 2bv32)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$kernel0.shared_A"} true;
    v10$1 := (if p11$1 then $$kernel0.shared_A[1bv1][BV32_ADD(v0$1, 2bv32)] else v10$1);
    v10$2 := (if p11$2 then $$kernel0.shared_A[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v0$2, 2bv32)] else v10$2);
    $$private_B$0bv32$1 := (if p11$1 then FMUL64(4599676359373071550bv64, FADD64(FADD64(v8$1, v9$1), v10$1)) else $$private_B$0bv32$1);
    $$private_B$0bv32$2 := (if p11$2 then FMUL64(4599676359373071550bv64, FADD64(FADD64(v8$2, v9$2), v10$2)) else $$private_B$0bv32$2);
    goto __partitioned_block_$6.tail_2;

  __partitioned_block_$6.tail_2:
    call {:sourceloc_num 25} $bugle_barrier_duplicated_1(1bv1, 1bv1, p1$1, p1$2);
    v11$1 := (if p1$1 then BV32_SGE(BV32_ADD(v0$1, $g1.0$1), 1bv32) else v11$1);
    v11$2 := (if p1$2 then BV32_SGE(BV32_ADD(v0$2, $g1.0$2), 1bv32) else v11$2);
    p13$1 := (if p1$1 && v11$1 then v11$1 else p13$1);
    p13$2 := (if p1$2 && v11$2 then v11$2 else p13$2);
    v12$1 := (if p13$1 then BV32_SGE($n, BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 2bv32)) else v12$1);
    v12$2 := (if p13$2 then BV32_SGE($n, BV32_ADD(BV32_ADD(v0$2, $g1.0$2), 2bv32)) else v12$2);
    p15$1 := (if p13$1 && v12$1 then v12$1 else p15$1);
    p15$2 := (if p13$2 && v12$2 then v12$2 else p15$2);
    v13$1 := (if p15$1 then $$private_B$0bv32$1 else v13$1);
    v13$2 := (if p15$2 then $$private_B$0bv32$2 else v13$2);
    call {:sourceloc} {:sourceloc_num 29} _LOG_WRITE_$$B(p15$1, BV32_ADD(v0$1, $g1.0$1), v13$1, $$B[BV32_ADD(v0$1, $g1.0$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$B(p15$2, BV32_ADD(v0$2, $g1.0$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 29} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 29} _CHECK_WRITE_$$B(p15$2, BV32_ADD(v0$2, $g1.0$2), v13$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$B"} true;
    $$B[BV32_ADD(v0$1, $g1.0$1)] := (if p15$1 then v13$1 else $$B[BV32_ADD(v0$1, $g1.0$1)]);
    $$B[BV32_ADD(v0$2, $g1.0$2)] := (if p15$2 then v13$2 else $$B[BV32_ADD(v0$2, $g1.0$2)]);
    goto __partitioned_block_$6.tail_3;

  __partitioned_block_$6.tail_3:
    call {:sourceloc_num 31} $bugle_barrier_duplicated_2(1bv1, 1bv1, p1$1, p1$2);
