...
axiom {:array_info "$$private_ey"} {:elem_width 64} {:source_name "private_ey"} {:source_elem_width 64} {:source_dimensions "1,2"} true;
...
procedure {:source_name "kernel1"} {:kernel} $kernel1($ny: bv32, $tmax: bv32, $nx: bv32, $h0: bv32);
  ...
  modifies _READ_HAS_OCCURRED_$$ey, $$ey, _TRACKING, _WRITE_HAS_OCCURRED_$$ey, _WRITE_READ_BENIGN_FLAG_$$ey, _WRITE_READ_BENIGN_FLAG_$$ey, _TRACKING;



implementation {:source_name "kernel1"} {:kernel} $kernel1($ny: bv32, $tmax: bv32, $nx: bv32, $h0: bv32)
{
  var $g1.0$1: bv32;
  var $g1.0$2: bv32;
  var $g3.0$1: bv32;
  ...
  $1:
    ...
    assert {:tag "nowrite"} _b46 ==> !_WRITE_HAS_OCCURRED_$$ey;
    assert {:tag "noread"} _b45 ==> !_READ_HAS_OCCURRED_$$ey;
  ...
  __partitioned_block_$3_0:
    ...
    assert {:tag "nowrite"} _b74 ==> !_WRITE_HAS_OCCURRED_$$ey;
    assert {:tag "noread"} _b73 ==> !_READ_HAS_OCCURRED_$$ey;
    ...
    v5$1 := (if p5$1 then BV32_SGE(BV32_ADD(v0$1, $g1.0$1), 1bv32) else v5$1);
    v5$2 := (if p5$2 then BV32_SGE(BV32_ADD(v0$2, $g1.0$2), 1bv32) else v5$2);
    p7$1 := (if p5$1 && v5$1 then v5$1 else p7$1);
    p7$2 := (if p5$2 && v5$2 then v5$2 else p7$2);
    v6$1 := (if p7$1 then BV32_SGE($ny, BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 1bv32)) else v6$1);
    v6$2 := (if p7$2 then BV32_SGE($ny, BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 1bv32)) else v6$2);
    p9$1 := (if p7$1 && v6$1 then v6$1 else p9$1);
    p9$2 := (if p7$2 && v6$2 then v6$2 else p9$2);
    call {:sourceloc} {:sourceloc_num 11} _LOG_READ_$$ey(p9$1, BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(v1$1, $g3.0$1)), $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(v1$1, $g3.0$1))]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 11} _CHECK_READ_$$ey(p9$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(v1$2, $g3.0$2)), $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(v1$2, $g3.0$2))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$ey"} true;
    v7$1 := (if p9$1 then $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(v1$1, $g3.0$1))] else v7$1);
    v7$2 := (if p9$2 then $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(v1$2, $g3.0$2))] else v7$2);
    $$private_ey$0bv32$1 := (if p9$1 then v7$1 else $$private_ey$0bv32$1);
    $$private_ey$0bv32$2 := (if p9$2 then v7$2 else $$private_ey$0bv32$2);
    v8$1 := (if p9$1 then BV32_SGE($ny, BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 17bv32)) else v8$1);
    v8$2 := (if p9$2 then BV32_SGE($ny, BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 17bv32)) else v8$2);
    p11$1 := (if p9$1 && v8$1 then v8$1 else p11$1);
    p11$2 := (if p9$2 && v8$2 then v8$2 else p11$2);
    call {:sourceloc} {:sourceloc_num 14} _LOG_READ_$$ey(p11$1, BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 16bv32)), $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 16bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 14} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 14} _CHECK_READ_$$ey(p11$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 16bv32)), $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 16bv32))]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$ey"} true;
    v9$1 := (if p11$1 then $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 16bv32))] else v9$1);
    v9$2 := (if p11$2 then $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 16bv32))] else v9$2);
    $$private_ey$1bv32$1 := (if p11$1 then v9$1 else $$private_ey$1bv32$1);
    $$private_ey$1bv32$2 := (if p11$2 then v9$2 else $$private_ey$1bv32$2);
    ...
    v11$1 := (if p13$1 then BV32_SGE(BV32_ADD(v0$1, $g1.0$1), 1bv32) else v11$1);
    v11$2 := (if p13$2 then BV32_SGE(BV32_ADD(v0$2, $g1.0$2), 1bv32) else v11$2);
    p15$1 := (if p13$1 && v11$1 then v11$1 else p15$1);
    p15$2 := (if p13$2 && v11$2 then v11$2 else p15$2);
    v12$1 := (if p15$1 then BV32_SGE($ny, BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 1bv32)) else v12$1);
    v12$2 := (if p15$2 then BV32_SGE($ny, BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 1bv32)) else v12$2);
    p17$1 := (if p15$1 && v12$1 then v12$1 else p17$1);
    p17$2 := (if p15$2 && v12$2 then v12$2 else p17$2);
    v13$1 := (if p17$1 then $$private_ey$0bv32$1 else v13$1);
    v13$2 := (if p17$2 then $$private_ey$0bv32$2 else v13$2);
    ...
    $$private_ey$0bv32$1 := (if p17$1 then FADD64(FMUL64(13826050856027422720bv64, FSUB64(v14$1, v15$1)), v13$1) else $$private_ey$0bv32$1);
    $$private_ey$0bv32$2 := (if p17$2 then FADD64(FMUL64(13826050856027422720bv64, FSUB64(v14$2, v15$2)), v13$2) else $$private_ey$0bv32$2);
    v16$1 := (if p17$1 then BV32_SGE($ny, BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 17bv32)) else v16$1);
    v16$2 := (if p17$2 then BV32_SGE($ny, BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 17bv32)) else v16$2);
    p19$1 := (if p17$1 && v16$1 then v16$1 else p19$1);
    p19$2 := (if p17$2 && v16$2 then v16$2 else p19$2);
    v17$1 := (if p19$1 then $$private_ey$1bv32$1 else v17$1);
    v17$2 := (if p19$2 then $$private_ey$1bv32$2 else v17$2);
    havoc _HAVOC_bv64$1, _HAVOC_bv64$2;
    ...
    $$private_ey$1bv32$1 := (if p19$1 then FADD64(FMUL64(13826050856027422720bv64, FSUB64(v18$1, v19$1)), v17$1) else $$private_ey$1bv32$1);
    $$private_ey$1bv32$2 := (if p19$2 then FADD64(FMUL64(13826050856027422720bv64, FSUB64(v18$2, v19$2)), v17$2) else $$private_ey$1bv32$2);
    goto __partitioned_block_$3_1;

  __partitioned_block_$3_1:
    call {:sourceloc_num 32} $bugle_barrier_duplicated_0(1bv1, 1bv1, p3$1, p3$2);
    ...
    v21$1 := (if p21$1 then BV32_SGE(BV32_ADD(v0$1, $g1.0$1), 1bv32) else v21$1);
    v21$2 := (if p21$2 then BV32_SGE(BV32_ADD(v0$2, $g1.0$2), 1bv32) else v21$2);
    p23$1 := (if p21$1 && v21$1 then v21$1 else p23$1);
    p23$2 := (if p21$2 && v21$2 then v21$2 else p23$2);
    v22$1 := (if p23$1 then BV32_SGE($ny, BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 1bv32)) else v22$1);
    v22$2 := (if p23$2 then BV32_SGE($ny, BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 1bv32)) else v22$2);
    p25$1 := (if p23$1 && v22$1 then v22$1 else p25$1);
    p25$2 := (if p23$2 && v22$2 then v22$2 else p25$2);
    v23$1 := (if p25$1 then $$private_ey$0bv32$1 else v23$1);
    v23$2 := (if p25$2 then $$private_ey$0bv32$2 else v23$2);
    call {:sourceloc} {:sourceloc_num 37} _LOG_WRITE_$$ey(p25$1, BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(v1$1, $g3.0$1)), v23$1, $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(v1$1, $g3.0$1))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$ey(p25$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(v1$2, $g3.0$2)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 37} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 37} _CHECK_WRITE_$$ey(p25$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(v1$2, $g3.0$2)), v23$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$ey"} true;
    $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(v1$1, $g3.0$1))] := (if p25$1 then v23$1 else $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(v1$1, $g3.0$1))]);
    $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(v1$2, $g3.0$2))] := (if p25$2 then v23$2 else $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(v1$2, $g3.0$2))]);
    v24$1 := (if p25$1 then BV32_SGE($ny, BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 17bv32)) else v24$1);
    v24$2 := (if p25$2 then BV32_SGE($ny, BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 17bv32)) else v24$2);
    p27$1 := (if p25$1 && v24$1 then v24$1 else p27$1);
    p27$2 := (if p25$2 && v24$2 then v24$2 else p27$2);
    v25$1 := (if p27$1 then $$private_ey$1bv32$1 else v25$1);
    v25$2 := (if p27$2 then $$private_ey$1bv32$2 else v25$2);
    call {:sourceloc} {:sourceloc_num 40} _LOG_WRITE_$$ey(p27$1, BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 16bv32)), v25$1, $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 16bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$ey(p27$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 16bv32)));
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 40} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 40} _CHECK_WRITE_$$ey(p27$2, BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 16bv32)), v25$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$ey"} true;
    $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 16bv32))] := (if p27$1 then v25$1 else $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$1, $g1.0$1), $ny), BV32_ADD(BV32_ADD(v1$1, $g3.0$1), 16bv32))]);
    $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 16bv32))] := (if p27$2 then v25$2 else $$ey[BV32_ADD(BV32_MUL(BV32_ADD(v0$2, $g1.0$2), $ny), BV32_ADD(BV32_ADD(v1$2, $g3.0$2), 16bv32))]);
    goto __partitioned_block_$3_2;

  __partitioned_block_$3_2:
    call {:sourceloc_num 43} $bugle_barrier_duplicated_1(1bv1, 1bv1, p3$1, p3$2);
...
var $$private_ey$1bv32$1: bv64;

var $$private_ey$1bv32$2: bv64;
