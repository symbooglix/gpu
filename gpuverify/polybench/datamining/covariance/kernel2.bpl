...
procedure {:source_name "kernel2"} {:kernel} $kernel2($m: bv32, $n: bv32);
...
implementation {:source_name "kernel2"} {:kernel} $kernel2($m: bv32, $n: bv32)
{
  var $g1.0$1: bv32;
  var $g1.0$2: bv32;
  var $0$1: bv32;
  ...
  $1:
    ...
    assert {:tag "accessBreak"} _b41 ==> _WRITE_HAS_OCCURRED_$$symmat ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $m);
    assert {:tag "nowrite"} _b40 ==> !_WRITE_HAS_OCCURRED_$$symmat;
    ...
    v3$1 := (if p0$1 then BV32_SLT($g1.0$1, $m) else v3$1);
    v3$2 := (if p0$2 then BV32_SLT($g1.0$2, $m) else v3$2);
    p1$1 := false;
    p1$2 := false;
    p2$1 := false;
    p2$2 := false;
  ...
  $6:
    ...
    assert {:tag "accessBreak"} _b57 ==> _WRITE_HAS_OCCURRED_$$symmat ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $m);
    assert {:tag "nowrite"} _b56 ==> !_WRITE_HAS_OCCURRED_$$symmat;
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p4$1 ==> _b15 ==> p4$1 ==> BV32_SLT($g1.0$1, $m);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p4$2 ==> _b15 ==> p4$2 ==> BV32_SLT($g1.0$2, $m);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b14 ==> BV32_SLT($g1.0$1, $m) && BV32_SLT($g3.0$1, $m) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b14 ==> BV32_SLT($g1.0$2, $m) && BV32_SLT($g3.0$2, $m) ==> p4$2;
    ...
    v6$1 := (if p5$1 then BV32_SLT(BV32_SUB(BV32_SUB(BV32_ADD(BV32_SUB(v1$1, v2$1), $g1.0$1), $g3.0$1), 1bv32), 0bv32) else v6$1);
    v6$2 := (if p5$2 then BV32_SLT(BV32_SUB(BV32_SUB(BV32_ADD(BV32_SUB(v1$2, v2$2), $g1.0$2), $g3.0$2), 1bv32), 0bv32) else v6$2);
    ...
    $1$1 := (if p6$1 then BV32_SDIV(BV32_SUB(BV32_SUB(BV32_ADD(BV32_SUB(v1$1, v2$1), $g1.0$1), $g3.0$1), 1bv32), 16bv32) else $1$1);
    $1$2 := (if p6$2 then BV32_SDIV(BV32_SUB(BV32_SUB(BV32_ADD(BV32_SUB(v1$2, v2$2), $g1.0$2), $g3.0$2), 1bv32), 16bv32) else $1$2);
    $1$1 := (if p7$1 then BV32_SUB(0bv32, BV32_SDIV(BV32_SUB(BV32_ADD(BV32_SUB(0bv32, BV32_SUB(BV32_SUB(BV32_ADD(BV32_SUB(v1$1, v2$1), $g1.0$1), $g3.0$1), 1bv32)), 16bv32), 1bv32), 16bv32)) else $1$1);
    $1$2 := (if p7$2 then BV32_SUB(0bv32, BV32_SDIV(BV32_SUB(BV32_ADD(BV32_SUB(0bv32, BV32_SUB(BV32_SUB(BV32_ADD(BV32_SUB(v1$2, v2$2), $g1.0$2), $g3.0$2), 1bv32)), 16bv32), 1bv32), 16bv32)) else $1$2);
    ...
    v8$1 := (if p9$1 then BV32_SLT(BV32_SUB(BV32_SUB(BV32_ADD(BV32_SUB(v1$1, v2$1), $g1.0$1), $g3.0$1), 1bv32), 0bv32) else v8$1);
    v8$2 := (if p9$2 then BV32_SLT(BV32_SUB(BV32_SUB(BV32_ADD(BV32_SUB(v1$2, v2$2), $g1.0$2), $g3.0$2), 1bv32), 0bv32) else v8$2);
    ...
    $2$1 := (if p10$1 then BV32_SDIV(BV32_SUB(BV32_SUB(BV32_ADD(BV32_SUB(v1$1, v2$1), $g1.0$1), $g3.0$1), 1bv32), 16bv32) else $2$1);
    $2$2 := (if p10$2 then BV32_SDIV(BV32_SUB(BV32_SUB(BV32_ADD(BV32_SUB(v1$2, v2$2), $g1.0$2), $g3.0$2), 1bv32), 16bv32) else $2$2);
    $2$1 := (if p11$1 then BV32_SUB(0bv32, BV32_SDIV(BV32_SUB(BV32_ADD(BV32_SUB(0bv32, BV32_SUB(BV32_SUB(BV32_ADD(BV32_SUB(v1$1, v2$1), $g1.0$1), $g3.0$1), 1bv32)), 16bv32), 1bv32), 16bv32)) else $2$1);
    $2$2 := (if p11$2 then BV32_SUB(0bv32, BV32_SDIV(BV32_SUB(BV32_ADD(BV32_SUB(0bv32, BV32_SUB(BV32_SUB(BV32_ADD(BV32_SUB(v1$2, v2$2), $g1.0$2), $g3.0$2), 1bv32)), 16bv32), 1bv32), 16bv32)) else $2$2);
  ...
  $17:
    ...
    assert {:tag "accessBreak"} _b58 ==> _WRITE_HAS_OCCURRED_$$symmat ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $m);
    assert p12$1 ==> p4$1;
    assert p12$2 ==> p4$2;
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p12$1 ==> _b21 ==> p12$1 ==> BV32_SLT($g1.0$1, $m) && BV32_SLT($g3.0$1, $m);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p12$2 ==> _b21 ==> p12$2 ==> BV32_SLT($g1.0$2, $m) && BV32_SLT($g3.0$2, $m);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b20 ==> BV32_SLT($g1.0$1, $m) && BV32_SLT($g3.0$1, $m) && BV32_SLT(BV32_SUB(BV32_SUB($m, $g3.0$1), 1bv32), 31bv32) ==> p12$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b20 ==> BV32_SLT($g1.0$2, $m) && BV32_SLT($g3.0$2, $m) && BV32_SLT(BV32_SUB(BV32_SUB($m, $g3.0$2), 1bv32), 31bv32) ==> p12$2;
    ...
    v9$1 := (if p12$1 then BV32_SLT(BV32_SUB(BV32_SUB($m, $g3.0$1), 1bv32), 31bv32) else v9$1);
    v9$2 := (if p12$2 then BV32_SLT(BV32_SUB(BV32_SUB($m, $g3.0$2), 1bv32), 31bv32) else v9$2);
    p13$1 := false;
    p13$2 := false;
    p14$1 := false;
    p14$2 := false;
    ...
    $4$1 := (if p13$1 then 31bv32 else $4$1);
    $4$2 := (if p13$2 then 31bv32 else $4$2);
    $4$1 := (if p14$1 then BV32_SUB(BV32_SUB($m, $g3.0$1), 1bv32) else $4$1);
    $4$2 := (if p14$2 then BV32_SUB(BV32_SUB($m, $g3.0$2), 1bv32) else $4$2);
