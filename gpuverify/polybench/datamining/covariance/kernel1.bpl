...
implementation {:source_name "kernel1"} {:kernel} $kernel1($float_n: bv64, $m: bv32, $n: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b57 ==> _WRITE_HAS_OCCURRED_$$mean ==> BV32_AND(BV32_SUB(1048576bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1048576bv32, 1bv32), BV32_ADD(BV32_MUL(32bv32, group_id_x$1), local_id_x$1));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b56 ==> _READ_HAS_OCCURRED_$$mean ==> BV32_AND(BV32_SUB(1048576bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1048576bv32, 1bv32), BV32_ADD(BV32_MUL(32bv32, group_id_x$1), local_id_x$1));
    assert {:tag "nowrite"} _b55 ==> !_WRITE_HAS_OCCURRED_$$mean;
    assert {:tag "noread"} _b54 ==> !_READ_HAS_OCCURRED_$$mean;
    assert {:tag "nowrite"} _b53 ==> !_WRITE_HAS_OCCURRED_$$data;
    assert {:tag "noread"} _b52 ==> !_READ_HAS_OCCURRED_$$data;
    assert {:tag "predicatedEquality"} _b51 ==> p0$1 && p0$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b50 ==> p0$1 && p0$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b49 ==> p0$1 && p0$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b48 ==> p0$1 && p0$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b47 ==> p0$1 && p0$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b46 ==> p0$1 && p0$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b45 ==> p0$1 && p0$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b44 ==> p0$1 && p0$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b43 ==> p0$1 && p0$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b42 ==> p0$1 && p0$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b41 ==> p0$1 && p0$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b40 ==> p0$1 && p0$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b39 ==> p0$1 && p0$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b38 ==> p0$1 && p0$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b37 ==> p0$1 && p0$2 ==> v6$1 == v6$2;
    ...
    assert {:tag "predicatedEquality"} _b31 ==> p0$1 && p0$2 ==> $2$1 == $2$2;
    assert {:tag "predicatedEquality"} _b30 ==> p0$1 && p0$2 ==> $c2.0$1 == $c2.0$2;
    assert {:tag "predicatedEquality"} _b29 ==> p0$1 && p0$2 ==> $1$1 == $1$2;
    assert {:tag "predicatedEquality"} _b28 ==> p0$1 && p0$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b27 ==> p0$1 && p0$2 ==> $g5.0$1 == $g5.0$2;
    assert {:tag "predicatedEquality"} _b26 ==> p0$1 && p0$2 ==> $g1.0$1 == $g1.0$2;
    assert {:tag "loopPredicateEquality"} _b25 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p0$1 == p0$2;
    assert {:tag "loopPredicateEquality"} _b24 ==> p0$1 == p0$2;
  ...
  $5:
    ...
    assert {:tag "nowrite"} _b81 ==> !_WRITE_HAS_OCCURRED_$$data;
    assert {:tag "noread"} _b80 ==> !_READ_HAS_OCCURRED_$$data;
    assert {:tag "predicatedEquality"} _b79 ==> p4$1 && p4$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b78 ==> p4$1 && p4$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b77 ==> p4$1 && p4$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b76 ==> p4$1 && p4$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b75 ==> p4$1 && p4$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b74 ==> p4$1 && p4$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b73 ==> p4$1 && p4$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b72 ==> p4$1 && p4$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b71 ==> p4$1 && p4$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b70 ==> p4$1 && p4$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b69 ==> p4$1 && p4$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b68 ==> p4$1 && p4$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b67 ==> p4$1 && p4$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b66 ==> p4$1 && p4$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b65 ==> p4$1 && p4$2 ==> v4$1 == v4$2;
    assert {:tag "predicatedEquality"} _b64 ==> p4$1 && p4$2 ==> $2$1 == $2$2;
    assert {:tag "predicatedEquality"} _b63 ==> p4$1 && p4$2 ==> $c2.0$1 == $c2.0$2;
    assert {:tag "predicatedEquality"} _b62 ==> p4$1 && p4$2 ==> $1$1 == $1$2;
    assert {:tag "predicatedEquality"} _b61 ==> p4$1 && p4$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b60 ==> p4$1 && p4$2 ==> $g5.0$1 == $g5.0$2;
    assert {:tag "loopPredicateEquality"} _b59 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p4$1 == p4$2;
    assert {:tag "loopPredicateEquality"} _b58 ==> p4$1 == p4$2;
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p4$1 ==> _b14 ==> p4$1 ==> BV32_SLT($g1.0$1, $m);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p4$2 ==> _b14 ==> p4$2 ==> BV32_SLT($g1.0$2, $m);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b13 ==> BV32_SLT($g1.0$1, $m) && BV32_SGE($n, 1bv32) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b13 ==> BV32_SLT($g1.0$2, $m) && BV32_SGE($n, 1bv32) ==> p4$2;
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b12 ==> BV32_UGE($g5.0$1, BV32_SUB(BV32_SUB(BV32_SREM(BV32_ADD($n, 31bv32), 32bv32), $n), 31bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b12 ==> BV32_UGE($g5.0$2, BV32_SUB(BV32_SUB(BV32_SREM(BV32_ADD($n, 31bv32), 32bv32), $n), 31bv32));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b11 ==> BV32_ULE($g5.0$1, BV32_SUB(BV32_SUB(BV32_SREM(BV32_ADD($n, 31bv32), 32bv32), $n), 31bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b11 ==> BV32_ULE($g5.0$2, BV32_SUB(BV32_SUB(BV32_SREM(BV32_ADD($n, 31bv32), 32bv32), $n), 31bv32));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b10 ==> BV32_SGE($g5.0$1, BV32_SUB(BV32_SUB(BV32_SREM(BV32_ADD($n, 31bv32), 32bv32), $n), 31bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b10 ==> BV32_SGE($g5.0$2, BV32_SUB(BV32_SUB(BV32_SREM(BV32_ADD($n, 31bv32), 32bv32), $n), 31bv32));
    assert {:tag "loopBound"} {:thread 1} p4$1 ==> _b9 ==> BV32_SLE($g5.0$1, BV32_SUB(BV32_SUB(BV32_SREM(BV32_ADD($n, 31bv32), 32bv32), $n), 31bv32));
    assert {:tag "loopBound"} {:thread 2} p4$2 ==> _b9 ==> BV32_SLE($g5.0$2, BV32_SUB(BV32_SUB(BV32_SREM(BV32_ADD($n, 31bv32), 32bv32), $n), 31bv32));
    assert {:tag "loopCounterIsStrided"} {:thread 1} p4$1 ==> _b8 ==> BV32_AND(BV32_SUB(32bv32, 1bv32), $g5.0$1) == BV32_AND(BV32_SUB(32bv32, 1bv32), BV32_SUB(BV32_SUB(BV32_SREM(BV32_ADD($n, 31bv32), 32bv32), $n), 31bv32));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p4$2 ==> _b8 ==> BV32_AND(BV32_SUB(32bv32, 1bv32), $g5.0$2) == BV32_AND(BV32_SUB(32bv32, 1bv32), BV32_SUB(BV32_SUB(BV32_SREM(BV32_ADD($n, 31bv32), 32bv32), $n), 31bv32));
  ...
  $17:
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p16$1 ==> _b23 ==> p16$1 ==> BV32_SLT($g1.0$1, $m) && BV32_SLE($g5.0$1, $0$1) && BV32_SGE($m, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p16$2 ==> _b23 ==> p16$2 ==> BV32_SLT($g1.0$2, $m) && BV32_SLE($g5.0$2, $0$2) && BV32_SGE($m, BV32_ADD(BV32_ADD(local_id_x$2, $g1.0$2), 1bv32));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b22 ==> BV32_SLT($g1.0$1, $m) && BV32_SLE($g5.0$1, $0$1) && BV32_SGE($m, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32)) && BV32_SLT(BV32_SUB(BV32_SUB($n, $g5.0$1), 1bv32), 31bv32) ==> p16$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b22 ==> BV32_SLT($g1.0$2, $m) && BV32_SLE($g5.0$2, $0$2) && BV32_SGE($m, BV32_ADD(BV32_ADD(local_id_x$2, $g1.0$2), 1bv32)) && BV32_SLT(BV32_SUB(BV32_SUB($n, $g5.0$2), 1bv32), 31bv32) ==> p16$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b21 ==> !BV32_SGE($m, BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 1bv32)) ==> !_READ_HAS_OCCURRED_$$data;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b20 ==> !BV32_SGE($m, BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 1bv32)) ==> !_WRITE_HAS_OCCURRED_$$data;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b19 ==> !BV32_SGE($m, BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 1bv32)) ==> !p16$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b19 ==> !BV32_SGE($m, BV32_ADD(BV32_ADD(v0$2, $g1.0$2), 1bv32)) ==> !p16$2;
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b18 ==> BV32_UGE($c2.0$1, $1$1);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b18 ==> BV32_UGE($c2.0$2, $1$2);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b17 ==> BV32_ULE($c2.0$1, $1$1);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b17 ==> BV32_ULE($c2.0$2, $1$2);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b16 ==> BV32_SGE($c2.0$1, $1$1);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b16 ==> BV32_SGE($c2.0$2, $1$2);
    assert {:tag "loopBound"} {:thread 1} p16$1 ==> _b15 ==> BV32_SLE($c2.0$1, $1$1);
    assert {:tag "loopBound"} {:thread 2} p16$2 ==> _b15 ==> BV32_SLE($c2.0$2, $1$2);
