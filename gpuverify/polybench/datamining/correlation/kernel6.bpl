...
implementation {:source_name "kernel6"} {:kernel} $kernel6($m: bv32, $n: bv32)
{
  ...
  $17:
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p12$1 ==> _b21 ==> p12$1 ==> BV32_SLT($g1.0$1, BV32_SUB($m, 1bv32)) && BV32_SLT($g3.0$1, $m);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p12$2 ==> _b21 ==> p12$2 ==> BV32_SLT($g1.0$2, BV32_SUB($m, 1bv32)) && BV32_SLT($g3.0$2, $m);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b20 ==> BV32_SLT($g1.0$1, BV32_SUB($m, 1bv32)) && BV32_SLT($g3.0$1, $m) && BV32_SLT(31bv32, BV32_SUB(BV32_SUB($m, $g3.0$1), 1bv32)) ==> p12$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b20 ==> BV32_SLT($g1.0$2, BV32_SUB($m, 1bv32)) && BV32_SLT($g3.0$2, $m) && BV32_SLT(31bv32, BV32_SUB(BV32_SUB($m, $g3.0$2), 1bv32)) ==> p12$2;
