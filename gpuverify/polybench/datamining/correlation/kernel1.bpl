...
procedure {:source_name "kernel1"} {:kernel} $kernel1($m: bv32, $n: bv32);
...
implementation {:source_name "kernel1"} {:kernel} $kernel1($m: bv32, $n: bv32)
{
  var $g1.0$1: bv32;
  var $g1.0$2: bv32;
  var v0$1: bv32;
  ...
  __partitioned_block_$1_0:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b14 ==> _WRITE_HAS_OCCURRED_$$mean ==> BV32_AND(BV32_SUB(1048576bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1048576bv32, 1bv32), BV32_ADD(BV32_MUL(32bv32, group_id_x$1), local_id_x$1));
    assert {:tag "nowrite"} _b13 ==> !_WRITE_HAS_OCCURRED_$$mean;
    ...
    call {:sourceloc} {:sourceloc_num 6} _LOG_WRITE_$$mean(p3$1, BV32_ADD(v0$1, $g1.0$1), 0bv64, $$mean[BV32_ADD(v0$1, $g1.0$1)]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$mean(p3$2, BV32_ADD(v0$2, $g1.0$2));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 6} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 6} _CHECK_WRITE_$$mean(p3$2, BV32_ADD(v0$2, $g1.0$2), 0bv64);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$mean"} true;
    $$mean[BV32_ADD(v0$1, $g1.0$1)] := (if p3$1 then 0bv64 else $$mean[BV32_ADD(v0$1, $g1.0$1)]);
    $$mean[BV32_ADD(v0$2, $g1.0$2)] := (if p3$2 then 0bv64 else $$mean[BV32_ADD(v0$2, $g1.0$2)]);
