...
implementation {:source_name "kernel3"} {:kernel} $kernel3($m: bv32, $n: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b69 ==> _WRITE_HAS_OCCURRED_$$kernel3.shared_mean ==> BV32_AND(BV32_SUB(16bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(16bv32, 1bv32), local_id_y$1);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b68 ==> _READ_HAS_OCCURRED_$$kernel3.shared_mean ==> BV32_AND(BV32_SUB(16bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(16bv32, 1bv32), local_id_y$1);
    assert {:tag "nowrite"} _b67 ==> !_WRITE_HAS_OCCURRED_$$kernel3.shared_mean;
    assert {:tag "noread"} _b66 ==> !_READ_HAS_OCCURRED_$$kernel3.shared_mean;
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b95 ==> _WRITE_HAS_OCCURRED_$$kernel3.shared_mean ==> BV32_AND(BV32_SUB(16bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(16bv32, 1bv32), local_id_y$1);
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b94 ==> _READ_HAS_OCCURRED_$$kernel3.shared_mean ==> BV32_AND(BV32_SUB(16bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(16bv32, 1bv32), local_id_y$1);
    assert {:tag "nowrite"} _b93 ==> !_WRITE_HAS_OCCURRED_$$kernel3.shared_mean;
    assert {:tag "noread"} _b92 ==> !_READ_HAS_OCCURRED_$$kernel3.shared_mean;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _WRITE_HAS_OCCURRED_$$kernel3.shared_mean ==> BV32_SLT($g1.0$1, $n);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _READ_HAS_OCCURRED_$$kernel3.shared_mean ==> BV32_SLT($g1.0$1, $n);
  ...
  $6:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b96 ==> _WRITE_HAS_OCCURRED_$$kernel3.shared_mean ==> BV32_AND(BV32_SUB(16bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(16bv32, 1bv32), local_id_y$1);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel3.shared_mean ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel3.shared_mean ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel3.shared_mean ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert p6$1 ==> p2$1;
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b41 ==> _WRITE_HAS_OCCURRED_$$kernel3.shared_mean ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g3.0$1, $m) && local_id_x$1 == 0bv32;
    ...
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b38 ==> v0$1 != 0bv32 ==> !_READ_HAS_OCCURRED_$$mean;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b37 ==> v0$1 != 0bv32 ==> !_WRITE_HAS_OCCURRED_$$kernel3.shared_mean;
  ...
  $15:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b99 ==> _READ_HAS_OCCURRED_$$kernel3.shared_mean ==> BV32_AND(BV32_SUB(16bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(16bv32, 1bv32), local_id_y$1);
    ...
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _READ_HAS_OCCURRED_$$kernel3.shared_mean ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g3.0$1, $m) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32));
    ...
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b26 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 1bv32)) ==> !_READ_HAS_OCCURRED_$$kernel3.shared_mean;
