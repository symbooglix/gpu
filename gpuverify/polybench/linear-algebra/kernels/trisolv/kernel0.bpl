...
implementation {:source_name "kernel0"} {:kernel} $kernel0($n: bv32)
{
  ...
  __partitioned_block_$1_0:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b15 ==> _WRITE_HAS_OCCURRED_$$x ==> BV32_AND(BV32_SUB(1048576bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1048576bv32, 1bv32), BV32_ADD(BV32_MUL(32bv32, group_id_x$1), local_id_x$1));
    assert {:tag "nowrite"} _b14 ==> !_WRITE_HAS_OCCURRED_$$x;
