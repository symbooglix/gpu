...
implementation {:source_name "kernel1"} {:kernel} $kernel1($n: bv32, $h1: bv32)
{
  ...
  $10:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b48 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b47 ==> _READ_HAS_OCCURRED_$$kernel1.shared_A ==> _WATCHED_OFFSET == BV32_ADD(BV32_MUL(BV32_ADD(BV32_SUB(0bv32, local_id_x$1), 31bv32), 32bv32), local_id_x$1);
    assert {:tag "nowrite"} _b46 ==> !_WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "noread"} _b45 ==> !_READ_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:tag "nowrite"} _b44 ==> !_WRITE_HAS_OCCURRED_$$x;
    assert {:tag "noread"} _b43 ==> !_READ_HAS_OCCURRED_$$x;
    assert {:tag "predicatedEquality"} _b42 ==> p6$1 && p6$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b41 ==> p6$1 && p6$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b40 ==> p6$1 && p6$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b39 ==> p6$1 && p6$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b38 ==> p6$1 && p6$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b37 ==> p6$1 && p6$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b36 ==> p6$1 && p6$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b35 ==> p6$1 && p6$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b34 ==> p6$1 && p6$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b33 ==> p6$1 && p6$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b32 ==> p6$1 && p6$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b31 ==> p6$1 && p6$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b30 ==> p6$1 && p6$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b29 ==> p6$1 && p6$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b28 ==> p6$1 && p6$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b27 ==> p6$1 && p6$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b26 ==> p6$1 && p6$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b25 ==> p6$1 && p6$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b24 ==> p6$1 && p6$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b23 ==> p6$1 && p6$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b22 ==> p6$1 && p6$2 ==> $4$1 == $4$2;
    assert {:tag "predicatedEquality"} _b21 ==> p6$1 && p6$2 ==> $c0.0$1 == $c0.0$2;
    assert {:tag "predicatedEquality"} _b20 ==> p6$1 && p6$2 ==> $3$1 == $3$2;
    assert {:tag "predicatedEquality"} _b19 ==> p6$1 && p6$2 ==> $g1.0$1 == $g1.0$2;
    assert {:tag "loopPredicateEquality"} _b18 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p6$1 == p6$2;
    assert {:tag "loopPredicateEquality"} _b17 ==> p6$1 == p6$2;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD($h1, 1bv32), 2bv32)) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_SLT($g1.0$2, BV32_SDIV(BV32_ADD($h1, 1bv32), 2bv32)) ==> p6$2;
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b5 ==> BV32_UGE($g1.0$1, $2$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b5 ==> BV32_UGE($g1.0$2, $2$2);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b4 ==> BV32_ULE($g1.0$1, $2$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b4 ==> BV32_ULE($g1.0$2, $2$2);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b3 ==> BV32_SGE($g1.0$1, $2$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b3 ==> BV32_SGE($g1.0$2, $2$2);
    assert {:tag "loopBound"} {:thread 1} p6$1 ==> _b2 ==> BV32_SLE($g1.0$1, $2$1);
    assert {:tag "loopBound"} {:thread 2} p6$2 ==> _b2 ==> BV32_SLE($g1.0$2, $2$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p6$1 ==> _b1 ==> BV32_SUB($g1.0$1, $2$1) == BV32_SUB($g1.0$2, $2$2);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p6$2 ==> _b1 ==> BV32_SUB($g1.0$2, $2$2) == BV32_SUB($g1.0$1, $2$1);
    assert {:tag "guardNonNeg"} {:thread 1} p6$1 ==> _b0 ==> BV32_SLE(0bv32, $g1.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p6$2 ==> _b0 ==> BV32_SLE(0bv32, $g1.0$2);
  ...
  $22:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b49 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel1.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert p20$1 ==> p6$1;
    assert p20$2 ==> p6$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b16 ==> _WRITE_HAS_OCCURRED_$$kernel1.shared_A ==> BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD($h1, 1bv32), 2bv32)) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p20$1 ==> _b15 ==> p20$1 ==> BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD($h1, 1bv32), 2bv32)) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p20$2 ==> _b15 ==> p20$2 ==> BV32_SLT($g1.0$2, BV32_SDIV(BV32_ADD($h1, 1bv32), 2bv32)) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$2, $g1.0$2), 1bv32));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b14 ==> BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD($h1, 1bv32), 2bv32)) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32)) && BV32_SLT(BV32_ADD(BV32_ADD(BV32_SUB($n, $h1), $g1.0$1), 30bv32), 31bv32) ==> p20$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b14 ==> BV32_SLT($g1.0$2, BV32_SDIV(BV32_ADD($h1, 1bv32), 2bv32)) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$2, $g1.0$2), 1bv32)) && BV32_SLT(BV32_ADD(BV32_ADD(BV32_SUB($n, $h1), $g1.0$2), 30bv32), 31bv32) ==> p20$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b13 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v1$1, $g1.0$1), 1bv32)) ==> !_READ_HAS_OCCURRED_$$A;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b12 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v1$1, $g1.0$1), 1bv32)) ==> !_WRITE_HAS_OCCURRED_$$kernel1.shared_A;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b11 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v1$1, $g1.0$1), 1bv32)) ==> !p20$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b11 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v1$2, $g1.0$2), 1bv32)) ==> !p20$2;
    assert {:tag "loopBound"} {:thread 1} p20$1 ==> _b10 ==> BV32_UGE($c0.0$1, $3$1);
    assert {:tag "loopBound"} {:thread 2} p20$2 ==> _b10 ==> BV32_UGE($c0.0$2, $3$2);
    assert {:tag "loopBound"} {:thread 1} p20$1 ==> _b9 ==> BV32_ULE($c0.0$1, $3$1);
    assert {:tag "loopBound"} {:thread 2} p20$2 ==> _b9 ==> BV32_ULE($c0.0$2, $3$2);
    assert {:tag "loopBound"} {:thread 1} p20$1 ==> _b8 ==> BV32_SGE($c0.0$1, $3$1);
    assert {:tag "loopBound"} {:thread 2} p20$2 ==> _b8 ==> BV32_SGE($c0.0$2, $3$2);
    assert {:tag "loopBound"} {:thread 1} p20$1 ==> _b7 ==> BV32_SLE($c0.0$1, $3$1);
    assert {:tag "loopBound"} {:thread 2} p20$2 ==> _b7 ==> BV32_SLE($c0.0$2, $3$2);
