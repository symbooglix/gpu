...
implementation {:source_name "kernel0"} {:kernel} $kernel0($n: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b55 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_y_2 ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b54 ==> !_WRITE_HAS_OCCURRED_$$kernel0.shared_y_2;
    assert {:tag "noread"} _b53 ==> !_READ_HAS_OCCURRED_$$kernel0.shared_y_2;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b52 ==> _WRITE_HAS_OCCURRED_$$x2 ==> BV32_AND(BV32_SUB(1048576bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1048576bv32, 1bv32), BV32_ADD(BV32_MUL(32bv32, group_id_x$1), local_id_x$1));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b51 ==> _READ_HAS_OCCURRED_$$x2 ==> BV32_AND(BV32_SUB(1048576bv32, 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(1048576bv32, 1bv32), BV32_ADD(BV32_MUL(32bv32, group_id_x$1), local_id_x$1));
    assert {:tag "nowrite"} _b50 ==> !_WRITE_HAS_OCCURRED_$$x2;
    assert {:tag "noread"} _b49 ==> !_READ_HAS_OCCURRED_$$x2;
    assert {:tag "predicatedEquality"} _b48 ==> p0$1 && p0$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b47 ==> p0$1 && p0$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b46 ==> p0$1 && p0$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b45 ==> p0$1 && p0$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b44 ==> p0$1 && p0$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b43 ==> p0$1 && p0$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b42 ==> p0$1 && p0$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b41 ==> p0$1 && p0$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b40 ==> p0$1 && p0$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b39 ==> p0$1 && p0$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b38 ==> p0$1 && p0$2 ==> v4$1 == v4$2;
    assert {:tag "predicatedEquality"} _b37 ==> p0$1 && p0$2 ==> v3$1 == v3$2;
    assert {:tag "predicatedEquality"} _b36 ==> p0$1 && p0$2 ==> v2$1 == v2$2;
    assert {:tag "predicatedEquality"} _b35 ==> p0$1 && p0$2 ==> v1$1 == v1$2;
    assert {:tag "predicatedEquality"} _b34 ==> p0$1 && p0$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b33 ==> p0$1 && p0$2 ==> $c2.0$1 == $c2.0$2;
    assert {:tag "predicatedEquality"} _b32 ==> p0$1 && p0$2 ==> $g5.0$1 == $g5.0$2;
    assert {:tag "predicatedEquality"} _b31 ==> p0$1 && p0$2 ==> $g1.0$1 == $g1.0$2;
    assert {:tag "loopPredicateEquality"} _b30 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p0$1 == p0$2;
    assert {:tag "loopPredicateEquality"} _b29 ==> p0$1 == p0$2;
  ...
  __partitioned_block_$5_0:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b72 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_y_2 ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b71 ==> !_WRITE_HAS_OCCURRED_$$kernel0.shared_y_2;
    assert {:tag "noread"} _b70 ==> !_READ_HAS_OCCURRED_$$kernel0.shared_y_2;
    assert {:tag "predicatedEquality"} _b69 ==> p4$1 && p4$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b68 ==> p4$1 && p4$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b67 ==> p4$1 && p4$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b66 ==> p4$1 && p4$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b65 ==> p4$1 && p4$2 ==> v8$1 == v8$2;
    assert {:tag "predicatedEquality"} _b64 ==> p4$1 && p4$2 ==> v7$1 == v7$2;
    assert {:tag "predicatedEquality"} _b63 ==> p4$1 && p4$2 ==> v6$1 == v6$2;
    assert {:tag "predicatedEquality"} _b62 ==> p4$1 && p4$2 ==> v5$1 == v5$2;
    assert {:tag "predicatedEquality"} _b61 ==> p4$1 && p4$2 ==> v4$1 == v4$2;
    assert {:tag "predicatedEquality"} _b60 ==> p4$1 && p4$2 ==> $0$1 == $0$2;
    assert {:tag "predicatedEquality"} _b59 ==> p4$1 && p4$2 ==> $c2.0$1 == $c2.0$2;
    assert {:tag "predicatedEquality"} _b58 ==> p4$1 && p4$2 ==> $g5.0$1 == $g5.0$2;
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b18 ==> _WRITE_HAS_OCCURRED_$$kernel0.shared_y_2 ==> BV32_SLT($g1.0$1, $n);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b17 ==> _READ_HAS_OCCURRED_$$kernel0.shared_y_2 ==> BV32_SLT($g1.0$1, $n);
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b15 ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g5.0$1, $n) ==> p4$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b15 ==> BV32_SLT($g1.0$2, $n) && BV32_SLT($g5.0$2, $n) ==> p4$2;
  ...
  $10:
    ...
    assert p4$1 ==> p0$1;
    assert p4$2 ==> p0$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b28 ==> _READ_HAS_OCCURRED_$$kernel0.shared_y_2 ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g5.0$1, $n) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p10$1 ==> _b27 ==> p10$1 ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g5.0$1, $n) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p10$2 ==> _b27 ==> p10$2 ==> BV32_SLT($g1.0$2, $n) && BV32_SLT($g5.0$2, $n) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$2, $g1.0$2), 1bv32));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b26 ==> BV32_SLT($g1.0$1, $n) && BV32_SLT($g5.0$1, $n) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32)) && BV32_SLT(BV32_SUB(BV32_SUB($n, $g5.0$1), 1bv32), 31bv32) ==> p10$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b26 ==> BV32_SLT($g1.0$2, $n) && BV32_SLT($g5.0$2, $n) && BV32_SGE($n, BV32_ADD(BV32_ADD(local_id_x$2, $g1.0$2), 1bv32)) && BV32_SLT(BV32_SUB(BV32_SUB($n, $g5.0$2), 1bv32), 31bv32) ==> p10$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b25 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 1bv32)) ==> !_READ_HAS_OCCURRED_$$kernel0.shared_y_2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b24 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 1bv32)) ==> !_READ_HAS_OCCURRED_$$A;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b23 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 1bv32)) ==> !p10$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b23 ==> !BV32_SGE($n, BV32_ADD(BV32_ADD(v0$2, $g1.0$2), 1bv32)) ==> !p10$2;
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b22 ==> BV32_UGE($c2.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b22 ==> BV32_UGE($c2.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b21 ==> BV32_ULE($c2.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b21 ==> BV32_ULE($c2.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b20 ==> BV32_SGE($c2.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b20 ==> BV32_SGE($c2.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p10$1 ==> _b19 ==> BV32_SLE($c2.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p10$2 ==> _b19 ==> BV32_SLE($c2.0$2, 0bv32);
