...
implementation {:source_name "kernel0"} {:kernel} $kernel0($nl: bv32, $nm: bv32, $nj: bv32, $nk: bv32, $ni: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessBreak"} _b38 ==> _WRITE_HAS_OCCURRED_$$G ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $nl);
    assert {:tag "nowrite"} _b37 ==> !_WRITE_HAS_OCCURRED_$$G;
  ...
  $3:
    ...
    assert {:tag "accessBreak"} _b49 ==> _WRITE_HAS_OCCURRED_$$G ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $nl);
    assert {:tag "nowrite"} _b48 ==> !_WRITE_HAS_OCCURRED_$$G;
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b15 ==> BV32_SLT($g1.0$1, $ni) && BV32_SLT($g3.0$1, $nl) ==> p2$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b15 ==> BV32_SLT($g1.0$2, $ni) && BV32_SLT($g3.0$2, $nl) ==> p2$2;
  ...
  $6:
    ...
    assert {:tag "accessBreak"} _b50 ==> _WRITE_HAS_OCCURRED_$$G ==> local_id_x$1 == BV32_DIV(_WATCHED_OFFSET, $nl);
    assert p6$1 ==> p2$1;
    assert p6$2 ==> p2$2;
    assert p2$1 ==> p0$1;
    assert p2$2 ==> p0$2;
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p6$1 ==> _b25 ==> p6$1 ==> BV32_SLT($g1.0$1, $ni) && BV32_SLT($g3.0$1, $nl) && BV32_SGE($ni, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p6$2 ==> _b25 ==> p6$2 ==> BV32_SLT($g1.0$2, $ni) && BV32_SLT($g3.0$2, $nl) && BV32_SGE($ni, BV32_ADD(BV32_ADD(local_id_x$2, $g1.0$2), 1bv32));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b24 ==> BV32_SLT($g1.0$1, $ni) && BV32_SLT($g3.0$1, $nl) && BV32_SGE($ni, BV32_ADD(BV32_ADD(local_id_x$1, $g1.0$1), 1bv32)) && BV32_SLT(31bv32, BV32_SUB(BV32_SUB($nl, $g3.0$1), 1bv32)) ==> p6$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b24 ==> BV32_SLT($g1.0$2, $ni) && BV32_SLT($g3.0$2, $nl) && BV32_SGE($ni, BV32_ADD(BV32_ADD(local_id_x$2, $g1.0$2), 1bv32)) && BV32_SLT(31bv32, BV32_SUB(BV32_SUB($nl, $g3.0$2), 1bv32)) ==> p6$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b23 ==> !BV32_SGE($ni, BV32_ADD(BV32_ADD(v0$1, $g1.0$1), 1bv32)) ==> !_WRITE_HAS_OCCURRED_$$G;
