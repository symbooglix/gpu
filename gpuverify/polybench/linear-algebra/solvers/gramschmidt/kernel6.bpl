...
implementation {:source_name "kernel6"} {:kernel} $kernel6($nj: bv32, $ni: bv32, $h0: bv32)
{
  ...
  $18:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b83 ==> _WRITE_HAS_OCCURRED_$$kernel6.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1));
    assert {:tag "nowrite"} _b82 ==> !_WRITE_HAS_OCCURRED_$$kernel6.shared_A;
    assert {:tag "noread"} _b81 ==> !_READ_HAS_OCCURRED_$$kernel6.shared_A;
    assert {:tag "nowrite"} _b80 ==> !_WRITE_HAS_OCCURRED_$$R;
    assert {:tag "noread"} _b79 ==> !_READ_HAS_OCCURRED_$$R;
    assert {:tag "predicatedEquality"} _b78 ==> p10$1 && p10$2 ==> v41$1 == v41$2;
    assert {:tag "predicatedEquality"} _b77 ==> p10$1 && p10$2 ==> v40$1 == v40$2;
    assert {:tag "predicatedEquality"} _b76 ==> p10$1 && p10$2 ==> v39$1 == v39$2;
    assert {:tag "predicatedEquality"} _b75 ==> p10$1 && p10$2 ==> v38$1 == v38$2;
    assert {:tag "predicatedEquality"} _b74 ==> p10$1 && p10$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b73 ==> p10$1 && p10$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b72 ==> p10$1 && p10$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b71 ==> p10$1 && p10$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b70 ==> p10$1 && p10$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b69 ==> p10$1 && p10$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b68 ==> p10$1 && p10$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b67 ==> p10$1 && p10$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b66 ==> p10$1 && p10$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b65 ==> p10$1 && p10$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b64 ==> p10$1 && p10$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b63 ==> p10$1 && p10$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b62 ==> p10$1 && p10$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b61 ==> p10$1 && p10$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b60 ==> p10$1 && p10$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b59 ==> p10$1 && p10$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b58 ==> p10$1 && p10$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b57 ==> p10$1 && p10$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b56 ==> p10$1 && p10$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b55 ==> p10$1 && p10$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b54 ==> p10$1 && p10$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b53 ==> p10$1 && p10$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b52 ==> p10$1 && p10$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b51 ==> p10$1 && p10$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b50 ==> p10$1 && p10$2 ==> v13$1 == v13$2;
    assert {:tag "predicatedEquality"} _b49 ==> p10$1 && p10$2 ==> v12$1 == v12$2;
    assert {:tag "predicatedEquality"} _b48 ==> p10$1 && p10$2 ==> v11$1 == v11$2;
    assert {:tag "predicatedEquality"} _b47 ==> p10$1 && p10$2 ==> v10$1 == v10$2;
    assert {:tag "predicatedEquality"} _b46 ==> p10$1 && p10$2 ==> v9$1 == v9$2;
    assert {:tag "predicatedEquality"} _b45 ==> p10$1 && p10$2 ==> $6$1 == $6$2;
    assert {:tag "predicatedEquality"} _b44 ==> p10$1 && p10$2 ==> $c2.0$1 == $c2.0$2;
    assert {:tag "predicatedEquality"} _b43 ==> p10$1 && p10$2 ==> $5$1 == $5$2;
    assert {:tag "predicatedEquality"} _b42 ==> p10$1 && p10$2 ==> $c0.0$1 == $c0.0$2;
    assert {:tag "predicatedEquality"} _b41 ==> p10$1 && p10$2 ==> $g5.0$1 == $g5.0$2;
    assert {:tag "predicatedEquality"} _b40 ==> p10$1 && p10$2 ==> $g1.0$1 == $g1.0$2;
    assert {:tag "loopPredicateEquality"} _b39 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p10$1 == p10$2;
    assert {:tag "loopPredicateEquality"} _b38 ==> p10$1 == p10$2;
    ...
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b9 ==> _WRITE_HAS_OCCURRED_$$kernel6.shared_A ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32);
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b8 ==> _READ_HAS_OCCURRED_$$kernel6.shared_A ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p10$1 ==> _b7 ==> p10$1 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p10$2 ==> _b7 ==> p10$2 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b6 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) ==> p10$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b6 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$2, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) ==> p10$2;
  ...
  $24:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b117 ==> _WRITE_HAS_OCCURRED_$$kernel6.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1));
    assert {:tag "nowrite"} _b116 ==> !_WRITE_HAS_OCCURRED_$$kernel6.shared_A;
    assert {:tag "noread"} _b115 ==> !_READ_HAS_OCCURRED_$$kernel6.shared_A;
    assert {:tag "predicatedEquality"} _b114 ==> p18$1 && p18$2 ==> v37$1 == v37$2;
    assert {:tag "predicatedEquality"} _b113 ==> p18$1 && p18$2 ==> v36$1 == v36$2;
    assert {:tag "predicatedEquality"} _b112 ==> p18$1 && p18$2 ==> v35$1 == v35$2;
    assert {:tag "predicatedEquality"} _b111 ==> p18$1 && p18$2 ==> v34$1 == v34$2;
    assert {:tag "predicatedEquality"} _b110 ==> p18$1 && p18$2 ==> v33$1 == v33$2;
    assert {:tag "predicatedEquality"} _b109 ==> p18$1 && p18$2 ==> v32$1 == v32$2;
    assert {:tag "predicatedEquality"} _b108 ==> p18$1 && p18$2 ==> v31$1 == v31$2;
    assert {:tag "predicatedEquality"} _b107 ==> p18$1 && p18$2 ==> v30$1 == v30$2;
    assert {:tag "predicatedEquality"} _b106 ==> p18$1 && p18$2 ==> v29$1 == v29$2;
    assert {:tag "predicatedEquality"} _b105 ==> p18$1 && p18$2 ==> v28$1 == v28$2;
    assert {:tag "predicatedEquality"} _b104 ==> p18$1 && p18$2 ==> v27$1 == v27$2;
    assert {:tag "predicatedEquality"} _b103 ==> p18$1 && p18$2 ==> v26$1 == v26$2;
    assert {:tag "predicatedEquality"} _b102 ==> p18$1 && p18$2 ==> v25$1 == v25$2;
    assert {:tag "predicatedEquality"} _b101 ==> p18$1 && p18$2 ==> v24$1 == v24$2;
    assert {:tag "predicatedEquality"} _b100 ==> p18$1 && p18$2 ==> v23$1 == v23$2;
    assert {:tag "predicatedEquality"} _b99 ==> p18$1 && p18$2 ==> v22$1 == v22$2;
    assert {:tag "predicatedEquality"} _b98 ==> p18$1 && p18$2 ==> v21$1 == v21$2;
    assert {:tag "predicatedEquality"} _b97 ==> p18$1 && p18$2 ==> v20$1 == v20$2;
    assert {:tag "predicatedEquality"} _b96 ==> p18$1 && p18$2 ==> v19$1 == v19$2;
    assert {:tag "predicatedEquality"} _b95 ==> p18$1 && p18$2 ==> v18$1 == v18$2;
    assert {:tag "predicatedEquality"} _b94 ==> p18$1 && p18$2 ==> v17$1 == v17$2;
    assert {:tag "predicatedEquality"} _b93 ==> p18$1 && p18$2 ==> v16$1 == v16$2;
    assert {:tag "predicatedEquality"} _b92 ==> p18$1 && p18$2 ==> v15$1 == v15$2;
    assert {:tag "predicatedEquality"} _b91 ==> p18$1 && p18$2 ==> v14$1 == v14$2;
    assert {:tag "predicatedEquality"} _b90 ==> p18$1 && p18$2 ==> $6$1 == $6$2;
    assert {:tag "predicatedEquality"} _b89 ==> p18$1 && p18$2 ==> $c2.0$1 == $c2.0$2;
    assert {:tag "predicatedEquality"} _b88 ==> p18$1 && p18$2 ==> $5$1 == $5$2;
    assert {:tag "predicatedEquality"} _b87 ==> p18$1 && p18$2 ==> $c0.0$1 == $c0.0$2;
    assert {:tag "predicatedEquality"} _b86 ==> p18$1 && p18$2 ==> $g5.0$1 == $g5.0$2;
    assert {:tag "loopPredicateEquality"} _b85 ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> p18$1 == p18$2;
    assert {:tag "loopPredicateEquality"} _b84 ==> p18$1 == p18$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel6.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel6.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel6.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert p18$1 ==> p10$1;
    assert p18$2 ==> p10$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b20 ==> _WRITE_HAS_OCCURRED_$$kernel6.shared_A ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32));
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b19 ==> _READ_HAS_OCCURRED_$$kernel6.shared_A ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p18$1 ==> _b18 ==> p18$1 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32));
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p18$2 ==> _b18 ==> p18$2 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$2, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32));
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b17 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) && BV32_SLT($g5.0$1, $ni) ==> p18$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b17 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$2, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) && BV32_SLT($g5.0$2, $ni) ==> p18$2;
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b16 ==> BV32_UGE($g5.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b16 ==> BV32_UGE($g5.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b15 ==> BV32_ULE($g5.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b15 ==> BV32_ULE($g5.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b14 ==> BV32_SGE($g5.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b14 ==> BV32_SGE($g5.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p18$1 ==> _b13 ==> BV32_SLE($g5.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p18$2 ==> _b13 ==> BV32_SLE($g5.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 1} p18$1 ==> _b12 ==> BV32_SUB($g5.0$1, 0bv32) == BV32_SUB($g5.0$2, 0bv32);
    assert {:tag "guardMinusInitialIsUniform"} {:thread 2} p18$2 ==> _b12 ==> BV32_SUB($g5.0$2, 0bv32) == BV32_SUB($g5.0$1, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p18$1 ==> _b11 ==> BV32_SLE(0bv32, $g5.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p18$2 ==> _b11 ==> BV32_SLE(0bv32, $g5.0$2);
    assert {:tag "loopCounterIsStrided"} {:thread 1} p18$1 ==> _b10 ==> BV32_AND(BV32_SUB(32bv32, 1bv32), $g5.0$1) == BV32_AND(BV32_SUB(32bv32, 1bv32), 0bv32);
    assert {:tag "loopCounterIsStrided"} {:thread 2} p18$2 ==> _b10 ==> BV32_AND(BV32_SUB(32bv32, 1bv32), $g5.0$2) == BV32_AND(BV32_SUB(32bv32, 1bv32), 0bv32);
  ...
  $38:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b118 ==> _WRITE_HAS_OCCURRED_$$kernel6.shared_A ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 32bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 32bv32), local_id_x$1));
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$kernel6.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$kernel6.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$kernel6.shared_A ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert p47$1 ==> p18$1;
    ...
    assert p18$1 ==> p10$1;
    assert p18$2 ==> p10$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b37 ==> _WRITE_HAS_OCCURRED_$$kernel6.shared_A ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) && BV32_SLT($g5.0$1, $ni);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p47$1 ==> _b36 ==> p47$1 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) && BV32_SLT($g5.0$1, $ni);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p47$2 ==> _b36 ==> p47$2 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$2, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) && BV32_SLT($g5.0$2, $ni);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b35 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) && BV32_SLT($g5.0$1, $ni) && BV32_SLT(31bv32, BV32_SUB(BV32_SUB($ni, $g5.0$1), 1bv32)) ==> p47$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b35 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$2, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) && BV32_SLT($g5.0$2, $ni) && BV32_SLT(31bv32, BV32_SUB(BV32_SUB($ni, $g5.0$2), 1bv32)) ==> p47$2;
    assert {:tag "loopBound"} {:thread 1} p47$1 ==> _b34 ==> BV32_UGE($c0.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p47$2 ==> _b34 ==> BV32_UGE($c0.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p47$1 ==> _b33 ==> BV32_ULE($c0.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p47$2 ==> _b33 ==> BV32_ULE($c0.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p47$1 ==> _b32 ==> BV32_SGE($c0.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p47$2 ==> _b32 ==> BV32_SGE($c0.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p47$1 ==> _b31 ==> BV32_SLE($c0.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p47$2 ==> _b31 ==> BV32_SLE($c0.0$2, 0bv32);
  ...
  $49:
    ...
    assert p18$1 ==> p10$1;
    assert p18$2 ==> p10$2;
    assert {:do_not_predicate} {:tag "accessOnlyIfEnabledInEnclosingScopes"} {:thread 1} _b30 ==> _READ_HAS_OCCURRED_$$kernel6.shared_A ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) && BV32_SLT($g5.0$1, $ni) && BV32_SGE(BV32_ADD(BV32_ADD(BV32_MUL(3bv32, local_id_x$1), BV32_MUL(3bv32, $g1.0$1)), 1bv32), $h0) && BV32_SGE(BV32_MUL(2bv32, $h0), BV32_ADD(BV32_ADD(BV32_MUL(5bv32, local_id_x$1), BV32_MUL(5bv32, $g1.0$1)), 3bv32)) && BV32_SGE(BV32_ADD(BV32_ADD($nj, BV32_MUL(2bv32, local_id_x$1)), BV32_MUL(2bv32, $g1.0$1)), $h0);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 1} p57$1 ==> _b29 ==> p57$1 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) && BV32_SLT($g5.0$1, $ni) && BV32_SGE(BV32_ADD(BV32_ADD(BV32_MUL(3bv32, local_id_x$1), BV32_MUL(3bv32, $g1.0$1)), 1bv32), $h0) && BV32_SGE(BV32_MUL(2bv32, $h0), BV32_ADD(BV32_ADD(BV32_MUL(5bv32, local_id_x$1), BV32_MUL(5bv32, $g1.0$1)), 3bv32)) && BV32_SGE(BV32_ADD(BV32_ADD($nj, BV32_MUL(2bv32, local_id_x$1)), BV32_MUL(2bv32, $g1.0$1)), $h0);
    assert {:tag "conditionsImpliedByEnabledness"} {:thread 2} p57$2 ==> _b29 ==> p57$2 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$2, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) && BV32_SLT($g5.0$2, $ni) && BV32_SGE(BV32_ADD(BV32_ADD(BV32_MUL(3bv32, local_id_x$2), BV32_MUL(3bv32, $g1.0$2)), 1bv32), $h0) && BV32_SGE(BV32_MUL(2bv32, $h0), BV32_ADD(BV32_ADD(BV32_MUL(5bv32, local_id_x$2), BV32_MUL(5bv32, $g1.0$2)), 3bv32)) && BV32_SGE(BV32_ADD(BV32_ADD($nj, BV32_MUL(2bv32, local_id_x$2)), BV32_MUL(2bv32, $g1.0$2)), $h0);
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b28 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$1, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) && BV32_SLT($g5.0$1, $ni) && BV32_SGE(BV32_ADD(BV32_ADD(BV32_MUL(3bv32, local_id_x$1), BV32_MUL(3bv32, $g1.0$1)), 1bv32), $h0) && BV32_SGE(BV32_MUL(2bv32, $h0), BV32_ADD(BV32_ADD(BV32_MUL(5bv32, local_id_x$1), BV32_MUL(5bv32, $g1.0$1)), 3bv32)) && BV32_SGE(BV32_ADD(BV32_ADD($nj, BV32_MUL(2bv32, local_id_x$1)), BV32_MUL(2bv32, $g1.0$1)), $h0) && BV32_SLT(BV32_SUB(BV32_SUB($ni, $g5.0$1), 1bv32), 31bv32) ==> p57$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b28 ==> BV32_SGE(BV32_MUL(5bv32, $nj), BV32_ADD($h0, 6bv32)) && BV32_SGE($h0, 4bv32) && BV32_SLT($g1.0$2, BV32_SDIV(BV32_ADD(BV32_MUL(2bv32, $h0), 2bv32), 5bv32)) && BV32_SLT($g5.0$2, $ni) && BV32_SGE(BV32_ADD(BV32_ADD(BV32_MUL(3bv32, local_id_x$2), BV32_MUL(3bv32, $g1.0$2)), 1bv32), $h0) && BV32_SGE(BV32_MUL(2bv32, $h0), BV32_ADD(BV32_ADD(BV32_MUL(5bv32, local_id_x$2), BV32_MUL(5bv32, $g1.0$2)), 3bv32)) && BV32_SGE(BV32_ADD(BV32_ADD($nj, BV32_MUL(2bv32, local_id_x$2)), BV32_MUL(2bv32, $g1.0$2)), $h0) && BV32_SLT(BV32_SUB(BV32_SUB($ni, $g5.0$2), 1bv32), 31bv32) ==> p57$2;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b27 ==> !BV32_SGE(BV32_ADD(BV32_ADD(BV32_MUL(3bv32, v1$1), BV32_MUL(3bv32, $g1.0$1)), 1bv32), $h0) || !BV32_SGE(BV32_MUL(2bv32, $h0), BV32_ADD(BV32_ADD(BV32_MUL(5bv32, v1$1), BV32_MUL(5bv32, $g1.0$1)), 3bv32)) || !BV32_SGE(BV32_ADD(BV32_ADD($nj, BV32_MUL(2bv32, v1$1)), BV32_MUL(2bv32, $g1.0$1)), $h0) ==> !_READ_HAS_OCCURRED_$$kernel6.shared_A;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b26 ==> !BV32_SGE(BV32_ADD(BV32_ADD(BV32_MUL(3bv32, v1$1), BV32_MUL(3bv32, $g1.0$1)), 1bv32), $h0) || !BV32_SGE(BV32_MUL(2bv32, $h0), BV32_ADD(BV32_ADD(BV32_MUL(5bv32, v1$1), BV32_MUL(5bv32, $g1.0$1)), 3bv32)) || !BV32_SGE(BV32_ADD(BV32_ADD($nj, BV32_MUL(2bv32, v1$1)), BV32_MUL(2bv32, $g1.0$1)), $h0) ==> !_READ_HAS_OCCURRED_$$Q;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 1} _b25 ==> !BV32_SGE(BV32_ADD(BV32_ADD(BV32_MUL(3bv32, v1$1), BV32_MUL(3bv32, $g1.0$1)), 1bv32), $h0) || !BV32_SGE(BV32_MUL(2bv32, $h0), BV32_ADD(BV32_ADD(BV32_MUL(5bv32, v1$1), BV32_MUL(5bv32, $g1.0$1)), 3bv32)) || !BV32_SGE(BV32_ADD(BV32_ADD($nj, BV32_MUL(2bv32, v1$1)), BV32_MUL(2bv32, $g1.0$1)), $h0) ==> !p57$1;
    assert {:do_not_predicate} {:tag "conditionalLoopExecution"} {:thread 2} _b25 ==> !BV32_SGE(BV32_ADD(BV32_ADD(BV32_MUL(3bv32, v1$2), BV32_MUL(3bv32, $g1.0$2)), 1bv32), $h0) || !BV32_SGE(BV32_MUL(2bv32, $h0), BV32_ADD(BV32_ADD(BV32_MUL(5bv32, v1$2), BV32_MUL(5bv32, $g1.0$2)), 3bv32)) || !BV32_SGE(BV32_ADD(BV32_ADD($nj, BV32_MUL(2bv32, v1$2)), BV32_MUL(2bv32, $g1.0$2)), $h0) ==> !p57$2;
    assert {:tag "loopBound"} {:thread 1} p57$1 ==> _b24 ==> BV32_UGE($c2.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p57$2 ==> _b24 ==> BV32_UGE($c2.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p57$1 ==> _b23 ==> BV32_ULE($c2.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p57$2 ==> _b23 ==> BV32_ULE($c2.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p57$1 ==> _b22 ==> BV32_SGE($c2.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p57$2 ==> _b22 ==> BV32_SGE($c2.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p57$1 ==> _b21 ==> BV32_SLE($c2.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p57$2 ==> _b21 ==> BV32_SLE($c2.0$2, 0bv32);
