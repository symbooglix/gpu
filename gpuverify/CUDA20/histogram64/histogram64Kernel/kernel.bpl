...
implementation {:source_name "histogram64Kernel"} {:kernel} $_Z17histogram64KernelPjS_i($dataN: bv32)
{
  ...
  $10:
    ...
    assert {:block_sourceloc} {:sourceloc_num 22} p4$1 ==> true;
    ...
    call {:sourceloc} {:sourceloc_num 24} _LOG_READ_$$_ZZ17histogram64KernelPjS_iE6s_Hist(p5$1, BV32_ADD(BV32_MUL(local_id_x$1, 128bv32), $accumPos.0$1), $$_ZZ17histogram64KernelPjS_iE6s_Hist[1bv1][BV32_ADD(BV32_MUL(local_id_x$1, 128bv32), $accumPos.0$1)]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 24} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 24} _CHECK_READ_$$_ZZ17histogram64KernelPjS_iE6s_Hist(p5$2, BV32_ADD(BV32_MUL(local_id_x$2, 128bv32), $accumPos.0$2), $$_ZZ17histogram64KernelPjS_iE6s_Hist[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(BV32_MUL(local_id_x$2, 128bv32), $accumPos.0$2)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ17histogram64KernelPjS_iE6s_Hist"} true;
  ...
  $10.tail:
    assume !p4$1 && !p4$2;
    call {:sourceloc} {:sourceloc_num 29} _LOG_WRITE_$$d_Result(p3$1, BV32_ADD(BV32_MUL(group_id_x$1, 64bv32), local_id_x$1), $sum.0$1, $$d_Result[BV32_ADD(BV32_MUL(group_id_x$1, 64bv32), local_id_x$1)]);
    ...
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 29} _CHECK_WRITE_$$d_Result(p3$2, BV32_ADD(BV32_MUL(group_id_x$2, 64bv32), local_id_x$2), $sum.0$2);
