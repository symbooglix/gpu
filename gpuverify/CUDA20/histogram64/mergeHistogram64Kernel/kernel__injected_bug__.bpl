...
implementation {:source_name "mergeHistogram64Kernel"} {:kernel} $_Z22mergeHistogram64KernelPjS_j($blockN: bv32)
{
  ...
  $5:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b9 ==> _WRITE_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _READ_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data ==> _WATCHED_OFFSET == local_id_x$1;
    assert {:tag "nowrite"} _b7 ==> !_WRITE_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data;
    assert {:tag "noread"} _b6 ==> !_READ_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data;
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($stride.0, 32bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_UGE($stride.0, 32bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($stride.0, 32bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_ULE($stride.0, 32bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($stride.0, 32bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SGE($stride.0, 32bv32);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($stride.0, 32bv32);
    assert {:tag "loopBound"} {:thread 2} _b0 ==> BV32_SLE($stride.0, 32bv32);
  ...
  $falsebb0:
    ...
    call {:sourceloc} {:sourceloc_num 19} _LOG_READ_$$_ZZ22mergeHistogram64KernelPjS_jE4data(p5$1, 0bv32, $$_ZZ22mergeHistogram64KernelPjS_jE4data[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 19} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 19} _CHECK_READ_$$_ZZ22mergeHistogram64KernelPjS_jE4data(p5$2, 0bv32, $$_ZZ22mergeHistogram64KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    ...
    call {:sourceloc} {:sourceloc_num 20} _LOG_WRITE_$$d_Histogram(p5$1, group_id_x$1, v7$1, $$d_Histogram[group_id_x$1]);
    ...
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 20} _CHECK_WRITE_$$d_Histogram(p5$2, group_id_x$2, v7$2);
  ...
  __partitioned_block_$truebb0_2:
    call {:sourceloc_num 11} $bugle_barrier_duplicated_1(1bv1, 1bv1, p4$1, p4$2);
    call {:sourceloc} {:sourceloc_num 12} _LOG_READ_$$_ZZ22mergeHistogram64KernelPjS_jE4data(p4$1, BV32_ADD(local_id_x$1, $stride.0), $$_ZZ22mergeHistogram64KernelPjS_jE4data[1bv1][BV32_ADD(local_id_x$1, $stride.0)]);
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 12} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 12} _CHECK_READ_$$_ZZ22mergeHistogram64KernelPjS_jE4data(p4$2, BV32_ADD(local_id_x$2, $stride.0), $$_ZZ22mergeHistogram64KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(local_id_x$2, $stride.0)]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ22mergeHistogram64KernelPjS_jE4data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 13} _LOG_READ_$$_ZZ22mergeHistogram64KernelPjS_jE4data(p4$1, local_id_x$1, $$_ZZ22mergeHistogram64KernelPjS_jE4data[1bv1][local_id_x$1]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 13} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 13} _CHECK_READ_$$_ZZ22mergeHistogram64KernelPjS_jE4data(p4$2, local_id_x$2, $$_ZZ22mergeHistogram64KernelPjS_jE4data[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][local_id_x$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ22mergeHistogram64KernelPjS_jE4data"} true;
    ...
    call {:sourceloc} {:sourceloc_num 14} _LOG_WRITE_$$_ZZ22mergeHistogram64KernelPjS_jE4data(p4$1, local_id_x$1, BV32_ADD(v5$1, v4$1), $$_ZZ22mergeHistogram64KernelPjS_jE4data[1bv1][local_id_x$1]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 14} _CHECK_WRITE_$$_ZZ22mergeHistogram64KernelPjS_jE4data(p4$2, local_id_x$2, BV32_ADD(v5$2, v4$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$_ZZ22mergeHistogram64KernelPjS_jE4data"} true;
...
implementation {:inline 1} $bugle_barrier_duplicated_1($0: bv1, $1: bv1, _P$1: bool, _P$2: bool)
{
  ...
  anon0:
    assume _P$1 && $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data;
    assume _P$1 && $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data;
    assume _P$1 && $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$_ZZ22mergeHistogram64KernelPjS_jE4data;
    goto anon1;
  ...
  anon3:
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$1 && $1 != 0bv1 ==> !_READ_HAS_OCCURRED_$$d_Histogram;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$1 && $1 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$d_Histogram;
    assume group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 ==> _P$1 && $1 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$d_Histogram;
    goto anon4;
