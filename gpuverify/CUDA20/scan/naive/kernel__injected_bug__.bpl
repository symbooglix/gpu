...
implementation {:source_name "kernel"} {:kernel} $_Z6kernelPfS_i($n: bv32)
{
  ...
  $4:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _WRITE_HAS_OCCURRED_$$_ZZ6kernelPfS_iE4temp ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), BV32_ADD(BV32_MUL(0bv32, $n), local_id_x$1)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), BV32_ADD(BV32_MUL(0bv32, $n), local_id_x$1));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b7 ==> _READ_HAS_OCCURRED_$$_ZZ6kernelPfS_iE4temp ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), BV32_ADD(BV32_MUL(0bv32, $n), local_id_x$1)) || BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), BV32_ADD(BV32_MUL(0bv32, $n), local_id_x$1));
    assert {:tag "pow2NotZero"} _b6 ==> $offset.0 != 0bv32;
    assert {:tag "pow2"} _b5 ==> $offset.0 == 0bv32 || BV32_AND($offset.0, BV32_SUB($offset.0, 1bv32)) == 0bv32;
    ...
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_UGE($offset.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_UGE($offset.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($offset.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_ULE($offset.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($offset.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SGE($offset.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($offset.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SLE($offset.0, 1bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b0 ==> BV32_SLE(0bv32, $offset.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b0 ==> BV32_SLE(0bv32, $offset.0);
