...
implementation {:source_name "uniformAdd"} {:kernel} $_Z10uniformAddPfS_iii($n: bv32, $blockOffset: bv32, $baseIndex: bv32)
{
  ...
  __partitioned_block_$0_1:
    ...
    v2$1 := $$_ZZ10uniformAddPfS_iiiE3uni[1bv1][0bv32];
    v2$2 := $$_ZZ10uniformAddPfS_iiiE3uni[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32];
    call {:sourceloc} {:sourceloc_num 7} _LOG_READ_$$g_data(true, 0bv32, $$g_data[0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 7} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 7} _CHECK_READ_$$g_data(true, 0bv32, $$g_data[0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$g_data"} true;
    v3$1 := $$g_data[0bv32];
    v3$2 := $$g_data[0bv32];
    call {:sourceloc} {:sourceloc_num 8} _LOG_WRITE_$$g_data(true, 0bv32, FADD32(v3$1, v2$1), $$g_data[0bv32]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$g_data(true, 0bv32);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 8} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 8} _CHECK_WRITE_$$g_data(true, 0bv32, FADD32(v3$2, v2$2));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$g_data"} true;
    $$g_data[0bv32] := FADD32(v3$1, v2$1);
    $$g_data[0bv32] := FADD32(v3$2, v2$2);
    ...
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$_ZZ10uniformAddPfS_iiiE3uni"} true;
    v4$1 := $$_ZZ10uniformAddPfS_iiiE3uni[1bv1][0bv32];
    v4$2 := $$_ZZ10uniformAddPfS_iiiE3uni[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32];
    v5$1 := BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$1, BV32_SHL(group_size_x, 1bv32)), $baseIndex), local_id_x$1), group_size_x);
    v5$2 := BV32_ADD(BV32_ADD(BV32_ADD(BV32_MUL(group_id_x$2, BV32_SHL(group_size_x, 1bv32)), $baseIndex), local_id_x$2), group_size_x);
    call {:sourceloc} {:sourceloc_num 10} _LOG_READ_$$g_data(true, v5$1, $$g_data[v5$1]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 10} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 10} _CHECK_READ_$$g_data(true, v5$2, $$g_data[v5$2]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$g_data"} true;
    v6$1 := $$g_data[v5$1];
    v6$2 := $$g_data[v5$2];
    call {:sourceloc} {:sourceloc_num 11} _LOG_WRITE_$$g_data(true, v5$1, FADD32(v6$1, FMUL32(SI32_TO_FP32(BV1_ZEXT32((if BV32_ULT(BV32_ADD(local_id_x$1, group_size_x), $n) then 1bv1 else 0bv1))), v4$1)), $$g_data[v5$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$g_data(true, v5$2);
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 11} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 11} _CHECK_WRITE_$$g_data(true, v5$2, FADD32(v6$2, FMUL32(SI32_TO_FP32(BV1_ZEXT32((if BV32_ULT(BV32_ADD(local_id_x$2, group_size_x), $n) then 1bv1 else 0bv1))), v4$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$g_data"} true;
    $$g_data[v5$1] := FADD32(v6$1, FMUL32(SI32_TO_FP32(BV1_ZEXT32((if BV32_ULT(BV32_ADD(local_id_x$1, group_size_x), $n) then 1bv1 else 0bv1))), v4$1));
    $$g_data[v5$2] := FADD32(v6$2, FMUL32(SI32_TO_FP32(BV1_ZEXT32((if BV32_ULT(BV32_ADD(local_id_x$2, group_size_x), $n) then 1bv1 else 0bv1))), v4$2));
    return;
}
