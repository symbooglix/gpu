...
implementation {:source_name "readLocalMemory"} {:kernel} $readLocalMemory($size: bv32)
{
  ...
  $1:
    ...
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b5 ==> BV32_SLT($j.0$1, BV32_SDIV(4096bv32, group_size_x)) ==> p0$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b5 ==> BV32_SLT($j.0$2, BV32_SDIV(4096bv32, group_size_x)) ==> p0$2;
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b4 ==> BV32_UGE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b4 ==> BV32_UGE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b3 ==> BV32_ULE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b3 ==> BV32_ULE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b2 ==> BV32_SGE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b2 ==> BV32_SGE($j.0$2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b1 ==> BV32_SLE($j.0$1, 0bv32);
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b1 ==> BV32_SLE($j.0$2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} p0$1 ==> _b0 ==> BV32_SLE(0bv32, $j.0$1);
    assert {:tag "guardNonNeg"} {:thread 2} p0$2 ==> _b0 ==> BV32_SLE(0bv32, $j.0$2);
  ...
  $7:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$readLocalMemory.lbuf ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$readLocalMemory.lbuf ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 1} _b11 ==> BV32_SLT($j.1$1, BV32_SDIV(4096bv32, group_size_x)) ==> p5$1;
    assert {:do_not_predicate} {:tag "conditionsImplyingEnabledness"} {:thread 2} _b11 ==> BV32_SLT($j.1$2, BV32_SDIV(4096bv32, group_size_x)) ==> p5$2;
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b10 ==> BV32_UGE($j.1$1, $j.0$1);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b10 ==> BV32_UGE($j.1$2, $j.0$2);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b9 ==> BV32_ULE($j.1$1, $j.0$1);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b9 ==> BV32_ULE($j.1$2, $j.0$2);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b8 ==> BV32_SGE($j.1$1, $j.0$1);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b8 ==> BV32_SGE($j.1$2, $j.0$2);
    assert {:tag "loopBound"} {:thread 1} p5$1 ==> _b7 ==> BV32_SLE($j.1$1, $j.0$1);
    assert {:tag "loopBound"} {:thread 2} p5$2 ==> _b7 ==> BV32_SLE($j.1$2, $j.0$2);
    assert {:tag "guardNonNeg"} {:thread 1} p5$1 ==> _b6 ==> BV32_SLE(0bv32, $j.1$1);
    assert {:tag "guardNonNeg"} {:thread 2} p5$2 ==> _b6 ==> BV32_SLE(0bv32, $j.1$2);
  ...
  $11:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$readLocalMemory.lbuf ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$readLocalMemory.lbuf ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b16 ==> BV32_UGE($j.2, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b16 ==> BV32_UGE($j.2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b15 ==> BV32_ULE($j.2, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b15 ==> BV32_ULE($j.2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b14 ==> BV32_SGE($j.2, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b14 ==> BV32_SGE($j.2, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_SLE($j.2, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b13 ==> BV32_SLE($j.2, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b12 ==> BV32_SLE(0bv32, $j.2);
    assert {:tag "guardNonNeg"} {:thread 2} _b12 ==> BV32_SLE(0bv32, $j.2);
