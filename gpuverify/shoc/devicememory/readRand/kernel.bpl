...
procedure {:source_name "readRand"} {:kernel} $readRand($n: bv32, $samp: bv32, $w: bv32, $h: bv32);
...
implementation {:source_name "readRand"} {:kernel} $readRand($n: bv32, $samp: bv32, $w: bv32, $h: bv32)
{
  var $ridx.0$1: bv64;
  var $ridx.0$2: bv64;
  var $sum.0$1: bv32;
  ...
  $0:
    ...
    $ridx.0$1, $sum.0$1, $i.0 := v1$1 ++ v0$1, 0bv32, 0bv32;
    $ridx.0$2, $sum.0$2 := v1$2 ++ v0$2, 0bv32;
  ...
  $truebb:
    assume {:partition} v3 && v3;
    v4$1 := BV32_SLT($ridx.0$1[32:0], 0bv32);
    v4$2 := BV32_SLT($ridx.0$2[32:0], 0bv32);
    ...
    v5$1 := (if p1$1 then BV32_SGE($ridx.0$1[32:0], 32768bv32) else v5$1);
    v5$2 := (if p1$2 then BV32_SGE($ridx.0$2[32:0], 32768bv32) else v5$2);
    ...
    $1$1 := (if p2$1 then $ridx.0$1[32:0] else $1$1);
    $1$2 := (if p2$2 then $ridx.0$2[32:0] else $1$2);
    ...
    v6$1 := BV32_SLT($ridx.0$1[64:32], 0bv32);
    v6$2 := BV32_SLT($ridx.0$2[64:32], 0bv32);
    ...
    v7$1 := (if p5$1 then BV32_SGE($ridx.0$1[64:32], 32768bv32) else v7$1);
    v7$2 := (if p5$2 then BV32_SGE($ridx.0$2[64:32], 32768bv32) else v7$2);
    ...
    $3$1 := (if p6$1 then $ridx.0$1[64:32] else $3$1);
    $3$2 := (if p6$2 then $ridx.0$2[64:32] else $3$2);
    ...
    havoc v22$1, v22$2;
    havoc v23$1, v23$2;
    v24$1 := $ridx.0$1[64:32];
    v24$2 := $ridx.0$2[64:32];
    $ridx.0$1, $sum.0$1, $i.0 := BV32_AND(BV32_ADD(BV32_MUL(v24$1, 5bv32), 11bv32), BV32_SUB($h, 1bv32)) ++ BV32_AND(BV32_ADD(BV32_MUL($ridx.0$1[32:0], 3bv32), 29bv32), BV32_SUB($w, 1bv32)), FADD32($sum.0$1, v11$1 ++ v10$1 ++ v9$1 ++ v8$1), BV32_ADD($i.0, 1bv32);
    $ridx.0$2, $sum.0$2 := BV32_AND(BV32_ADD(BV32_MUL(v24$2, 5bv32), 11bv32), BV32_SUB($h, 1bv32)) ++ BV32_AND(BV32_ADD(BV32_MUL($ridx.0$2[32:0], 3bv32), 29bv32), BV32_SUB($w, 1bv32)), FADD32($sum.0$2, v11$2 ++ v10$2 ++ v9$2 ++ v8$2);
