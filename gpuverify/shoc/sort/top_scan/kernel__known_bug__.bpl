...
procedure {:source_name "top_scan"} {:kernel} $top_scan($n: bv32);
  ...
  modifies $$top_scan.s_seed, $$lmem, _WRITE_HAS_OCCURRED_$$top_scan.s_seed, _WRITE_READ_BENIGN_FLAG_$$top_scan.s_seed, _WRITE_READ_BENIGN_FLAG_$$top_scan.s_seed, $$isums, _TRACKING, _READ_HAS_OCCURRED_$$isums, _WRITE_HAS_OCCURRED_$$lmem, _WRITE_READ_BENIGN_FLAG_$$lmem, _WRITE_READ_BENIGN_FLAG_$$lmem, _TRACKING, _READ_HAS_OCCURRED_$$lmem, _READ_HAS_OCCURRED_$$top_scan.s_seed, _WRITE_HAS_OCCURRED_$$isums, _WRITE_READ_BENIGN_FLAG_$$isums, _WRITE_READ_BENIGN_FLAG_$$isums, _TRACKING, _TRACKING, _TRACKING;
...
implementation {:source_name "top_scan"} {:kernel} $top_scan($n: bv32)
{
  ...
  $3:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b17 ==> _READ_HAS_OCCURRED_$$lmem ==> _WATCHED_OFFSET == BV32_SUB(BV32_ADD(local_id_x$1, group_size_x), 1bv32) || _WATCHED_OFFSET == BV32_ADD(local_id_x$1, group_size_x);
    assert {:tag "nowrite"} _b16 ==> !_WRITE_HAS_OCCURRED_$$lmem;
    assert {:tag "noread"} _b15 ==> !_READ_HAS_OCCURRED_$$lmem;
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b14 ==> _WRITE_HAS_OCCURRED_$$isums ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), BV32_ADD(BV32_MUL(0bv32, $n), local_id_x$1));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b13 ==> _READ_HAS_OCCURRED_$$isums ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, $n), 1bv32), BV32_ADD(BV32_MUL(0bv32, $n), local_id_x$1));
    assert {:tag "nowrite"} _b12 ==> !_WRITE_HAS_OCCURRED_$$isums;
    assert {:tag "noread"} _b11 ==> !_READ_HAS_OCCURRED_$$isums;
    assert {:tag "pow2NotZero"} _b10 ==> $i.i.0 != 0bv32;
    assert {:tag "pow2"} _b9 ==> $i.i.0 == 0bv32 || BV32_AND($i.i.0, BV32_SUB($i.i.0, 1bv32)) == 0bv32;
  ...
  $7:
    ...
    assert {:tag "pow2NotZero"} _b24 ==> $i.i.0 != 0bv32;
    assert {:tag "pow2"} _b23 ==> $i.i.0 == 0bv32 || BV32_AND($i.i.0, BV32_SUB($i.i.0, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$top_scan.s_seed ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$top_scan.s_seed ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$top_scan.s_seed ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$lmem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$lmem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$lmem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_UGE($i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b8 ==> BV32_UGE($i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_ULE($i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_ULE($i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SGE($i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_SGE($i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b5 ==> BV32_SLE($i.i.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b5 ==> BV32_SLE($i.i.0, 1bv32);
  ...
  __partitioned_block_$falsebb2_0:
    ...
    call {:sourceloc} {:sourceloc_num 24} _LOG_READ_$$top_scan.s_seed(p5$1, 0bv32, $$top_scan.s_seed[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_6"} {:captureState "check_state_6"} {:sourceloc} {:sourceloc_num 24} true;
    call {:check_id "check_state_6"} {:sourceloc} {:sourceloc_num 24} _CHECK_READ_$$top_scan.s_seed(p5$2, 0bv32, $$top_scan.s_seed[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    ...
    call {:sourceloc} {:sourceloc_num 28} _LOG_READ_$$top_scan.s_seed(p7$1, 0bv32, $$top_scan.s_seed[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_4"} {:captureState "check_state_4"} {:sourceloc} {:sourceloc_num 28} true;
    call {:check_id "check_state_4"} {:sourceloc} {:sourceloc_num 28} _CHECK_READ_$$top_scan.s_seed(p7$2, 0bv32, $$top_scan.s_seed[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$top_scan.s_seed"} true;
    ...
    call {:sourceloc} {:sourceloc_num 29} _LOG_WRITE_$$top_scan.s_seed(p7$1, 0bv32, BV32_ADD(v13$1, BV32_ADD(v9$1, $val.0$1)), $$top_scan.s_seed[1bv1][0bv32]);
    ...
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 29} _CHECK_WRITE_$$top_scan.s_seed(p7$2, 0bv32, BV32_ADD(v13$2, BV32_ADD(v9$2, $val.0$2)));
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$top_scan.s_seed"} true;
  ...
  __partitioned_block_$falsebb2_1:
    call {:sourceloc_num 31} $bugle_barrier_duplicated_2(1bv1, 0bv1);
  ...
  __partitioned_block_$truebb2_1:
    call {:sourceloc_num 17} $bugle_barrier_duplicated_3(1bv1, 0bv1);
  ...
  __partitioned_block_$truebb2_2:
    call {:sourceloc_num 20} $bugle_barrier_duplicated_4(1bv1, 0bv1);
