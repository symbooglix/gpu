...
implementation {:source_name "gr_base"} {:kernel} $gr_base($TCONV: bv32, $PCONV: bv32)
{
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b9 ==> _WRITE_HAS_OCCURRED_$$C ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 13824bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 13824bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 13824bv32), BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)));
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b8 ==> _READ_HAS_OCCURRED_$$C ==> BV32_AND(BV32_SUB(BV32_MUL(1bv32, 13824bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(1bv32, 13824bv32), 1bv32), BV32_ADD(BV32_MUL(0bv32, 13824bv32), BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1)));
    assert {:tag "accessUpperBoundBlock"} _b7 ==> _WRITE_HAS_OCCURRED_$$C ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(group_size_x, BV32_ADD(group_id_x$1, 1bv32)), local_id_x$1));
    assert {:tag "accessLowerBoundBlock"} _b6 ==> _WRITE_HAS_OCCURRED_$$C ==> BV32_SLE(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), _WATCHED_OFFSET);
    assert {:tag "accessUpperBoundBlock"} _b5 ==> _READ_HAS_OCCURRED_$$C ==> BV32_SLT(_WATCHED_OFFSET, BV32_ADD(BV32_MUL(group_size_x, BV32_ADD(group_id_x$1, 1bv32)), local_id_x$1));
    assert {:tag "accessLowerBoundBlock"} _b4 ==> _READ_HAS_OCCURRED_$$C ==> BV32_SLE(BV32_ADD(BV32_MUL(group_size_x, group_id_x$1), local_id_x$1), _WATCHED_OFFSET);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_UGE($k.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_UGE($k.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_ULE($k.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_ULE($k.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SGE($k.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SGE($k.0, 1bv32);
    assert {:tag "loopBound"} {:thread 1} _b0 ==> BV32_SLE($k.0, 1bv32);
    assert {:tag "loopBound"} {:thread 2} _b0 ==> BV32_SLE($k.0, 1bv32);
