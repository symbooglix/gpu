...
axiom {:array_info "$$fft1D_512.reversed8"} {:elem_width 32} {:source_name "fft1D_512.reversed8"} {:source_elem_width 32} {:source_dimensions "8"} true;

var {:source_name "smem"} {:group_shared} $$fft1D_512.smem: [bv1][bv32]bv32;

axiom {:array_info "$$fft1D_512.smem"} {:group_shared} {:elem_width 32} {:source_name "smem"} {:source_elem_width 32} {:source_dimensions "576"} true;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*"} _READ_HAS_OCCURRED_$$fft1D_512.smem: bool;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem: bool;

var {:race_checking} {:group_shared} {:elem_width 32} {:source_elem_width 32} {:source_dimensions "*"} _ATOMIC_HAS_OCCURRED_$$fft1D_512.smem: bool;
...
procedure {:source_name "fft1D_512"} {:kernel} $fft1D_512();
  requires $$fft1D_512.reversed8$0bv32$1 == 0bv32;
  requires $$fft1D_512.reversed8$0bv32$2 == 0bv32;
  requires $$fft1D_512.reversed8$1bv32$1 == 4bv32;
  requires $$fft1D_512.reversed8$1bv32$2 == 4bv32;
  requires $$fft1D_512.reversed8$2bv32$1 == 2bv32;
  requires $$fft1D_512.reversed8$2bv32$2 == 2bv32;
  requires $$fft1D_512.reversed8$3bv32$1 == 6bv32;
  requires $$fft1D_512.reversed8$3bv32$2 == 6bv32;
  requires $$fft1D_512.reversed8$4bv32$1 == 1bv32;
  requires $$fft1D_512.reversed8$4bv32$2 == 1bv32;
  requires $$fft1D_512.reversed8$5bv32$1 == 5bv32;
  requires $$fft1D_512.reversed8$5bv32$2 == 5bv32;
  requires $$fft1D_512.reversed8$6bv32$1 == 3bv32;
  requires $$fft1D_512.reversed8$6bv32$2 == 3bv32;
  requires $$fft1D_512.reversed8$7bv32$1 == 7bv32;
  requires $$fft1D_512.reversed8$7bv32$2 == 7bv32;
  ...
  requires !_READ_HAS_OCCURRED_$$fft1D_512.smem && !_WRITE_HAS_OCCURRED_$$fft1D_512.smem && !_ATOMIC_HAS_OCCURRED_$$fft1D_512.smem;
  ...
  modifies $$fft1D_512.smem, $$work, _TRACKING, _TRACKING, _TRACKING, _TRACKING, _TRACKING, _TRACKING, _TRACKING, _WRITE_HAS_OCCURRED_$$work, _WRITE_READ_BENIGN_FLAG_$$work, _WRITE_READ_BENIGN_FLAG_$$work, _READ_HAS_OCCURRED_$$fft1D_512.smem, _WRITE_HAS_OCCURRED_$$fft1D_512.smem, _WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem, _WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem, _READ_HAS_OCCURRED_$$work;



implementation {:source_name "fft1D_512"} {:kernel} $fft1D_512()
{
  var $i.i.0: bv32;
  var $j.0: bv32;
  var $i.i53.0: bv32;
  ...
  $1:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b52 ==> _READ_HAS_OCCURRED_$$work ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 64bv32), 2bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 64bv32), 2bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_MUL(0bv32, 64bv32), 2bv32), BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, 512bv32), local_id_x$1), 2bv32))) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 64bv32), 2bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 64bv32), 2bv32), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(0bv32, 64bv32), 2bv32), BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, 512bv32), local_id_x$1), 2bv32)), 1bv32));
    assert {:tag "accessUpperBoundBlock"} _b51 ==> _READ_HAS_OCCURRED_$$work ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), 512bv32), local_id_x$1), 2bv32));
    assert {:tag "accessLowerBoundBlock"} _b50 ==> _READ_HAS_OCCURRED_$$work ==> BV32_SLE(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, 512bv32), local_id_x$1), 2bv32), _WATCHED_OFFSET);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b4 ==> BV32_UGE($i.i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b4 ==> BV32_UGE($i.i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b3 ==> BV32_ULE($i.i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b3 ==> BV32_ULE($i.i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b2 ==> BV32_SGE($i.i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b2 ==> BV32_SGE($i.i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b1 ==> BV32_SLE($i.i.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b1 ==> BV32_SLE($i.i.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b0 ==> BV32_SLE(0bv32, $i.i.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b0 ==> BV32_SLE(0bv32, $i.i.0);
  ...
  $falsebb:
    ...
    v32$1 := $$data$1[11bv32];
    v32$2 := $$data$2[11bv32];
    $$data$1[10bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v31$1, 1065353216bv32), FSUB32(2147483648bv32, FMUL32(v32$1, 3212836864bv32))));
    $$data$2[10bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v31$2, 1065353216bv32), FSUB32(2147483648bv32, FMUL32(v32$2, 3212836864bv32))));
    $$data$1[11bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v31$1, 3212836864bv32), FMUL32(v32$1, 1065353216bv32)));
    $$data$2[11bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v31$2, 3212836864bv32), FMUL32(v32$2, 1065353216bv32)));
    v33$1 := $$data$1[12bv32];
    v33$2 := $$data$2[12bv32];
    v34$1 := $$data$1[13bv32];
    v34$2 := $$data$2[13bv32];
    $$data$1[12bv32] := FADD32(FMUL32(v33$1, 0bv32), FSUB32(2147483648bv32, FMUL32(v34$1, 3212836864bv32)));
    $$data$2[12bv32] := FADD32(FMUL32(v33$2, 0bv32), FSUB32(2147483648bv32, FMUL32(v34$2, 3212836864bv32)));
    $$data$1[13bv32] := FADD32(FMUL32(v33$1, 3212836864bv32), FMUL32(v34$1, 0bv32));
    $$data$2[13bv32] := FADD32(FMUL32(v33$2, 3212836864bv32), FMUL32(v34$2, 0bv32));
    v35$1 := $$data$1[14bv32];
    v35$2 := $$data$2[14bv32];
    v36$1 := $$data$1[15bv32];
    v36$2 := $$data$2[15bv32];
    $$data$1[14bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v35$1, 3212836864bv32), FSUB32(2147483648bv32, FMUL32(v36$1, 3212836864bv32))));
    $$data$2[14bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v35$2, 3212836864bv32), FSUB32(2147483648bv32, FMUL32(v36$2, 3212836864bv32))));
    $$data$1[15bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v35$1, 3212836864bv32), FMUL32(v36$1, 3212836864bv32)));
    $$data$2[15bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v35$2, 3212836864bv32), FMUL32(v36$2, 3212836864bv32)));
    v37$1 := $$data$1[0bv32];
    v37$2 := $$data$2[0bv32];
    v38$1 := $$data$1[1bv32];
    v38$2 := $$data$2[1bv32];
    ...
    v50$1 := $$data$1[7bv32];
    v50$2 := $$data$2[7bv32];
    $$data$1[6bv32] := FADD32(FMUL32(v49$1, 0bv32), FSUB32(2147483648bv32, FMUL32(v50$1, 3212836864bv32)));
    $$data$2[6bv32] := FADD32(FMUL32(v49$2, 0bv32), FSUB32(2147483648bv32, FMUL32(v50$2, 3212836864bv32)));
    $$data$1[7bv32] := FADD32(FMUL32(v49$1, 3212836864bv32), FMUL32(v50$1, 0bv32));
    $$data$2[7bv32] := FADD32(FMUL32(v49$2, 3212836864bv32), FMUL32(v50$2, 0bv32));
    v51$1 := $$data$1[0bv32];
    v51$2 := $$data$2[0bv32];
    v52$1 := $$data$1[1bv32];
    v52$2 := $$data$2[1bv32];
    ...
    v76$1 := $$data$1[15bv32];
    v76$2 := $$data$2[15bv32];
    $$data$1[14bv32] := FADD32(FMUL32(v75$1, 0bv32), FSUB32(2147483648bv32, FMUL32(v76$1, 3212836864bv32)));
    $$data$2[14bv32] := FADD32(FMUL32(v75$2, 0bv32), FSUB32(2147483648bv32, FMUL32(v76$2, 3212836864bv32)));
    $$data$1[15bv32] := FADD32(FMUL32(v75$1, 3212836864bv32), FMUL32(v76$1, 0bv32));
    $$data$2[15bv32] := FADD32(FMUL32(v75$2, 3212836864bv32), FMUL32(v76$2, 0bv32));
    v77$1 := $$data$1[8bv32];
    v77$2 := $$data$2[8bv32];
    v78$1 := $$data$1[9bv32];
    v78$2 := $$data$2[9bv32];
    ...
    v89$1 := $$fft1D_512.reversed8$0bv32$1;
    v89$2 := $$fft1D_512.reversed8$0bv32$2;
    $$reversed8$1[0bv32] := v89$1;
    $$reversed8$2[0bv32] := v89$2;
    v90$1 := $$fft1D_512.reversed8$1bv32$1;
    v90$2 := $$fft1D_512.reversed8$1bv32$2;
    $$reversed8$1[1bv32] := v90$1;
    $$reversed8$2[1bv32] := v90$2;
    v91$1 := $$fft1D_512.reversed8$2bv32$1;
    v91$2 := $$fft1D_512.reversed8$2bv32$2;
    $$reversed8$1[2bv32] := v91$1;
    $$reversed8$2[2bv32] := v91$2;
    v92$1 := $$fft1D_512.reversed8$3bv32$1;
    v92$2 := $$fft1D_512.reversed8$3bv32$2;
    $$reversed8$1[3bv32] := v92$1;
    $$reversed8$2[3bv32] := v92$2;
    v93$1 := $$fft1D_512.reversed8$4bv32$1;
    v93$2 := $$fft1D_512.reversed8$4bv32$2;
    $$reversed8$1[4bv32] := v93$1;
    $$reversed8$2[4bv32] := v93$2;
    v94$1 := $$fft1D_512.reversed8$5bv32$1;
    v94$2 := $$fft1D_512.reversed8$5bv32$2;
    $$reversed8$1[5bv32] := v94$1;
    $$reversed8$2[5bv32] := v94$2;
    v95$1 := $$fft1D_512.reversed8$6bv32$1;
    v95$2 := $$fft1D_512.reversed8$6bv32$2;
    $$reversed8$1[6bv32] := v95$1;
    $$reversed8$2[6bv32] := v95$2;
    v96$1 := $$fft1D_512.reversed8$7bv32$1;
    v96$2 := $$fft1D_512.reversed8$7bv32$2;
  ...
  $7:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_UGE($i.i53.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b9 ==> BV32_UGE($i.i53.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($i.i53.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b8 ==> BV32_ULE($i.i53.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($i.i53.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_SGE($i.i53.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($i.i53.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_SLE($i.i53.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b5 ==> BV32_SLE(0bv32, $i.i53.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b5 ==> BV32_SLE(0bv32, $i.i53.0);
  ...
  $9:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b14 ==> BV32_UGE($i.i50.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b14 ==> BV32_UGE($i.i50.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b13 ==> BV32_ULE($i.i50.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b13 ==> BV32_ULE($i.i50.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b12 ==> BV32_SGE($i.i50.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b12 ==> BV32_SGE($i.i50.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b11 ==> BV32_SLE($i.i50.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b11 ==> BV32_SLE($i.i50.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b10 ==> BV32_SLE(0bv32, $i.i50.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b10 ==> BV32_SLE(0bv32, $i.i50.0);
  ...
  $11:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b19 ==> BV32_UGE($i.i48.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b19 ==> BV32_UGE($i.i48.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b18 ==> BV32_ULE($i.i48.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b18 ==> BV32_ULE($i.i48.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b17 ==> BV32_SGE($i.i48.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b17 ==> BV32_SGE($i.i48.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b16 ==> BV32_SLE($i.i48.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b16 ==> BV32_SLE($i.i48.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b15 ==> BV32_SLE(0bv32, $i.i48.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b15 ==> BV32_SLE(0bv32, $i.i48.0);
  ...
  $13:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b24 ==> BV32_UGE($i.i45.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b24 ==> BV32_UGE($i.i45.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b23 ==> BV32_ULE($i.i45.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b23 ==> BV32_ULE($i.i45.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b22 ==> BV32_SGE($i.i45.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b22 ==> BV32_SGE($i.i45.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b21 ==> BV32_SLE($i.i45.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b21 ==> BV32_SLE($i.i45.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b20 ==> BV32_SLE(0bv32, $i.i45.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b20 ==> BV32_SLE(0bv32, $i.i45.0);
  ...
  __partitioned_block_$falsebb4_1:
    ...
    $$data$1[10bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v164$1, 1065353216bv32), FSUB32(2147483648bv32, FMUL32(v165$1, 3212836864bv32))));
    $$data$2[10bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v164$2, 1065353216bv32), FSUB32(2147483648bv32, FMUL32(v165$2, 3212836864bv32))));
    $$data$1[11bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v164$1, 3212836864bv32), FMUL32(v165$1, 1065353216bv32)));
    $$data$2[11bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v164$2, 3212836864bv32), FMUL32(v165$2, 1065353216bv32)));
    v166$1 := $$data$1[12bv32];
    v166$2 := $$data$2[12bv32];
    v167$1 := $$data$1[13bv32];
    v167$2 := $$data$2[13bv32];
    $$data$1[12bv32] := FADD32(FMUL32(v166$1, 0bv32), FSUB32(2147483648bv32, FMUL32(v167$1, 3212836864bv32)));
    $$data$2[12bv32] := FADD32(FMUL32(v166$2, 0bv32), FSUB32(2147483648bv32, FMUL32(v167$2, 3212836864bv32)));
    $$data$1[13bv32] := FADD32(FMUL32(v166$1, 3212836864bv32), FMUL32(v167$1, 0bv32));
    $$data$2[13bv32] := FADD32(FMUL32(v166$2, 3212836864bv32), FMUL32(v167$2, 0bv32));
    v168$1 := $$data$1[14bv32];
    v168$2 := $$data$2[14bv32];
    v169$1 := $$data$1[15bv32];
    v169$2 := $$data$2[15bv32];
    $$data$1[14bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v168$1, 3212836864bv32), FSUB32(2147483648bv32, FMUL32(v169$1, 3212836864bv32))));
    $$data$2[14bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v168$2, 3212836864bv32), FSUB32(2147483648bv32, FMUL32(v169$2, 3212836864bv32))));
    $$data$1[15bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v168$1, 3212836864bv32), FMUL32(v169$1, 3212836864bv32)));
    $$data$2[15bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v168$2, 3212836864bv32), FMUL32(v169$2, 3212836864bv32)));
    v170$1 := $$data$1[0bv32];
    v170$2 := $$data$2[0bv32];
    v171$1 := $$data$1[1bv32];
    v171$2 := $$data$2[1bv32];
    ...
    v183$1 := $$data$1[7bv32];
    v183$2 := $$data$2[7bv32];
    $$data$1[6bv32] := FADD32(FMUL32(v182$1, 0bv32), FSUB32(2147483648bv32, FMUL32(v183$1, 3212836864bv32)));
    $$data$2[6bv32] := FADD32(FMUL32(v182$2, 0bv32), FSUB32(2147483648bv32, FMUL32(v183$2, 3212836864bv32)));
    $$data$1[7bv32] := FADD32(FMUL32(v182$1, 3212836864bv32), FMUL32(v183$1, 0bv32));
    $$data$2[7bv32] := FADD32(FMUL32(v182$2, 3212836864bv32), FMUL32(v183$2, 0bv32));
    v184$1 := $$data$1[0bv32];
    v184$2 := $$data$2[0bv32];
    v185$1 := $$data$1[1bv32];
    v185$2 := $$data$2[1bv32];
    ...
    $$data$1[14bv32] := FADD32(FMUL32(v208$1, 0bv32), FSUB32(2147483648bv32, FMUL32(v209$1, 3212836864bv32)));
    $$data$2[14bv32] := FADD32(FMUL32(v208$2, 0bv32), FSUB32(2147483648bv32, FMUL32(v209$2, 3212836864bv32)));
    $$data$1[15bv32] := FADD32(FMUL32(v208$1, 3212836864bv32), FMUL32(v209$1, 0bv32));
    $$data$2[15bv32] := FADD32(FMUL32(v208$2, 3212836864bv32), FMUL32(v209$2, 0bv32));
    v210$1 := $$data$1[8bv32];
    v210$2 := $$data$2[8bv32];
    v211$1 := $$data$1[9bv32];
    v211$2 := $$data$2[9bv32];
  ...
  $19:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b29 ==> BV32_UGE($i.i44.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b29 ==> BV32_UGE($i.i44.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b28 ==> BV32_ULE($i.i44.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b28 ==> BV32_ULE($i.i44.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b27 ==> BV32_SGE($i.i44.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b27 ==> BV32_SGE($i.i44.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b26 ==> BV32_SLE($i.i44.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b26 ==> BV32_SLE($i.i44.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b25 ==> BV32_SLE(0bv32, $i.i44.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b25 ==> BV32_SLE(0bv32, $i.i44.0);
  ...
  $21:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b34 ==> BV32_UGE($i.i42.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b34 ==> BV32_UGE($i.i42.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b33 ==> BV32_ULE($i.i42.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b33 ==> BV32_ULE($i.i42.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b32 ==> BV32_SGE($i.i42.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b32 ==> BV32_SGE($i.i42.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b31 ==> BV32_SLE($i.i42.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b31 ==> BV32_SLE($i.i42.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b30 ==> BV32_SLE(0bv32, $i.i42.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b30 ==> BV32_SLE(0bv32, $i.i42.0);
  ...
  $23:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b39 ==> BV32_UGE($i.i41.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b39 ==> BV32_UGE($i.i41.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b38 ==> BV32_ULE($i.i41.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b38 ==> BV32_ULE($i.i41.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b37 ==> BV32_SGE($i.i41.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b37 ==> BV32_SGE($i.i41.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b36 ==> BV32_SLE($i.i41.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b36 ==> BV32_SLE($i.i41.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b35 ==> BV32_SLE(0bv32, $i.i41.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b35 ==> BV32_SLE(0bv32, $i.i41.0);
  ...
  $25:
    ...
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b44 ==> BV32_UGE($i.i39.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b44 ==> BV32_UGE($i.i39.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b43 ==> BV32_ULE($i.i39.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b43 ==> BV32_ULE($i.i39.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b42 ==> BV32_SGE($i.i39.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b42 ==> BV32_SGE($i.i39.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b41 ==> BV32_SLE($i.i39.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b41 ==> BV32_SLE($i.i39.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b40 ==> BV32_SLE(0bv32, $i.i39.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b40 ==> BV32_SLE(0bv32, $i.i39.0);
  ...
  $falsebb9:
    ...
    $$data$1[10bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v297$1, 1065353216bv32), FSUB32(2147483648bv32, FMUL32(v298$1, 3212836864bv32))));
    $$data$2[10bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v297$2, 1065353216bv32), FSUB32(2147483648bv32, FMUL32(v298$2, 3212836864bv32))));
    $$data$1[11bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v297$1, 3212836864bv32), FMUL32(v298$1, 1065353216bv32)));
    $$data$2[11bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v297$2, 3212836864bv32), FMUL32(v298$2, 1065353216bv32)));
    v299$1 := $$data$1[12bv32];
    v299$2 := $$data$2[12bv32];
    v300$1 := $$data$1[13bv32];
    v300$2 := $$data$2[13bv32];
    $$data$1[12bv32] := FADD32(FMUL32(v299$1, 0bv32), FSUB32(2147483648bv32, FMUL32(v300$1, 3212836864bv32)));
    $$data$2[12bv32] := FADD32(FMUL32(v299$2, 0bv32), FSUB32(2147483648bv32, FMUL32(v300$2, 3212836864bv32)));
    $$data$1[13bv32] := FADD32(FMUL32(v299$1, 3212836864bv32), FMUL32(v300$1, 0bv32));
    $$data$2[13bv32] := FADD32(FMUL32(v299$2, 3212836864bv32), FMUL32(v300$2, 0bv32));
    v301$1 := $$data$1[14bv32];
    v301$2 := $$data$2[14bv32];
    v302$1 := $$data$1[15bv32];
    v302$2 := $$data$2[15bv32];
    $$data$1[14bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v301$1, 3212836864bv32), FSUB32(2147483648bv32, FMUL32(v302$1, 3212836864bv32))));
    $$data$2[14bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v301$2, 3212836864bv32), FSUB32(2147483648bv32, FMUL32(v302$2, 3212836864bv32))));
    $$data$1[15bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v301$1, 3212836864bv32), FMUL32(v302$1, 3212836864bv32)));
    $$data$2[15bv32] := FMUL32(1060439283bv32, FADD32(FMUL32(v301$2, 3212836864bv32), FMUL32(v302$2, 3212836864bv32)));
    v303$1 := $$data$1[0bv32];
    v303$2 := $$data$2[0bv32];
    v304$1 := $$data$1[1bv32];
    v304$2 := $$data$2[1bv32];
    ...
    v316$1 := $$data$1[7bv32];
    v316$2 := $$data$2[7bv32];
    $$data$1[6bv32] := FADD32(FMUL32(v315$1, 0bv32), FSUB32(2147483648bv32, FMUL32(v316$1, 3212836864bv32)));
    $$data$2[6bv32] := FADD32(FMUL32(v315$2, 0bv32), FSUB32(2147483648bv32, FMUL32(v316$2, 3212836864bv32)));
    $$data$1[7bv32] := FADD32(FMUL32(v315$1, 3212836864bv32), FMUL32(v316$1, 0bv32));
    $$data$2[7bv32] := FADD32(FMUL32(v315$2, 3212836864bv32), FMUL32(v316$2, 0bv32));
    v317$1 := $$data$1[0bv32];
    v317$2 := $$data$2[0bv32];
    v318$1 := $$data$1[1bv32];
    v318$2 := $$data$2[1bv32];
    ...
    $$data$1[14bv32] := FADD32(FMUL32(v341$1, 0bv32), FSUB32(2147483648bv32, FMUL32(v342$1, 3212836864bv32)));
    $$data$2[14bv32] := FADD32(FMUL32(v341$2, 0bv32), FSUB32(2147483648bv32, FMUL32(v342$2, 3212836864bv32)));
    $$data$1[15bv32] := FADD32(FMUL32(v341$1, 3212836864bv32), FMUL32(v342$1, 0bv32));
    $$data$2[15bv32] := FADD32(FMUL32(v341$2, 3212836864bv32), FMUL32(v342$2, 0bv32));
    v343$1 := $$data$1[8bv32];
    v343$2 := $$data$2[8bv32];
    v344$1 := $$data$1[9bv32];
    v344$2 := $$data$2[9bv32];
    ...
    v355$1 := $$globalStores8.reversed$0bv32$1;
    v355$2 := $$globalStores8.reversed$0bv32$2;
    $$reversed.i$1[0bv32] := v355$1;
    $$reversed.i$2[0bv32] := v355$2;
    v356$1 := $$globalStores8.reversed$1bv32$1;
    v356$2 := $$globalStores8.reversed$1bv32$2;
    $$reversed.i$1[1bv32] := v356$1;
    $$reversed.i$2[1bv32] := v356$2;
    v357$1 := $$globalStores8.reversed$2bv32$1;
    v357$2 := $$globalStores8.reversed$2bv32$2;
    $$reversed.i$1[2bv32] := v357$1;
    $$reversed.i$2[2bv32] := v357$2;
    v358$1 := $$globalStores8.reversed$3bv32$1;
    v358$2 := $$globalStores8.reversed$3bv32$2;
    $$reversed.i$1[3bv32] := v358$1;
    $$reversed.i$2[3bv32] := v358$2;
    v359$1 := $$globalStores8.reversed$4bv32$1;
    v359$2 := $$globalStores8.reversed$4bv32$2;
    $$reversed.i$1[4bv32] := v359$1;
    $$reversed.i$2[4bv32] := v359$2;
    v360$1 := $$globalStores8.reversed$5bv32$1;
    v360$2 := $$globalStores8.reversed$5bv32$2;
    $$reversed.i$1[5bv32] := v360$1;
    $$reversed.i$2[5bv32] := v360$2;
    v361$1 := $$globalStores8.reversed$6bv32$1;
    v361$2 := $$globalStores8.reversed$6bv32$2;
    $$reversed.i$1[6bv32] := v361$1;
    $$reversed.i$2[6bv32] := v361$2;
    v362$1 := $$globalStores8.reversed$7bv32$1;
    v362$2 := $$globalStores8.reversed$7bv32$2;
    $$reversed.i$1[7bv32] := v362$1;
    $$reversed.i$2[7bv32] := v362$2;
    $i.i38.0 := 0bv32;
  ...
  $27:
    ...
    assert {:tag "accessedOffsetsSatisfyPredicates"} _b55 ==> _WRITE_HAS_OCCURRED_$$work ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 64bv32), 2bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 64bv32), 2bv32), 1bv32), BV32_ADD(BV32_MUL(BV32_MUL(0bv32, 64bv32), 2bv32), BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, 512bv32), local_id_x$1), 2bv32))) || BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 64bv32), 2bv32), 1bv32), _WATCHED_OFFSET) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(1bv32, 64bv32), 2bv32), 1bv32), BV32_ADD(BV32_ADD(BV32_MUL(BV32_MUL(0bv32, 64bv32), 2bv32), BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, 512bv32), local_id_x$1), 2bv32)), 1bv32));
    assert {:tag "accessUpperBoundBlock"} _b54 ==> _WRITE_HAS_OCCURRED_$$work ==> BV32_SLT(_WATCHED_OFFSET, BV32_MUL(BV32_ADD(BV32_MUL(BV32_ADD(group_id_x$1, 1bv32), 512bv32), local_id_x$1), 2bv32));
    assert {:tag "accessLowerBoundBlock"} _b53 ==> _WRITE_HAS_OCCURRED_$$work ==> BV32_SLE(BV32_MUL(BV32_ADD(BV32_MUL(group_id_x$1, 512bv32), local_id_x$1), 2bv32), _WATCHED_OFFSET);
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$fft1D_512.smem ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b49 ==> BV32_UGE($i.i38.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b49 ==> BV32_UGE($i.i38.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b48 ==> BV32_ULE($i.i38.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b48 ==> BV32_ULE($i.i38.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b47 ==> BV32_SGE($i.i38.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b47 ==> BV32_SGE($i.i38.0, 0bv32);
    assert {:tag "loopBound"} {:thread 1} _b46 ==> BV32_SLE($i.i38.0, 0bv32);
    assert {:tag "loopBound"} {:thread 2} _b46 ==> BV32_SLE($i.i38.0, 0bv32);
    assert {:tag "guardNonNeg"} {:thread 1} _b45 ==> BV32_SLE(0bv32, $i.i38.0);
    assert {:tag "guardNonNeg"} {:thread 2} _b45 ==> BV32_SLE(0bv32, $i.i38.0);
    assert {:block_sourceloc} {:sourceloc_num 625} true;
    v363 := BV32_SLT($i.i38.0, 8bv32);
    goto $truebb10, $falsebb10;

  $falsebb10:
    assume {:partition} !v363 && !v363;
    return;

  $truebb10:
    assume {:partition} v363 && v363;
    v364$1 := $$reversed.i$1[$i.i38.0];
    v364$2 := $$reversed.i$2[$i.i38.0];
    v365$1 := $$data$1[BV32_MUL(v364$1, 2bv32)];
    v365$2 := $$data$2[BV32_MUL(v364$2, 2bv32)];
    v366$1 := $$data$1[BV32_ADD(BV32_MUL(v364$1, 2bv32), 1bv32)];
    v366$2 := $$data$2[BV32_ADD(BV32_MUL(v364$2, 2bv32), 1bv32)];
    call {:sourceloc} {:sourceloc_num 630} _LOG_WRITE_$$work(true, BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)), v365$1, $$work[BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$work(true, BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)));
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 630} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 630} _CHECK_WRITE_$$work(true, BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)), v365$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$work"} true;
    $$work[BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32))] := v365$1;
    $$work[BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32))] := v365$2;
    call {:sourceloc} {:sourceloc_num 631} _LOG_WRITE_$$work(true, BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)), 1bv32), v366$1, $$work[BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)), 1bv32)]);
    ...
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 631} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 631} _CHECK_WRITE_$$work(true, BV32_ADD(BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)), 1bv32), v366$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$work"} true;
    $$work[BV32_ADD(BV32_ADD(BV32_MUL(v1$1, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)), 1bv32)] := v366$1;
    $$work[BV32_ADD(BV32_ADD(BV32_MUL(v1$2, 2bv32), BV32_MUL(BV32_MUL($i.i38.0, 64bv32), 2bv32)), 1bv32)] := v366$2;
  ...
  $truebb9:
    assume {:partition} v269 && v269;
    call {:sourceloc} {:sourceloc_num 463} _LOG_READ_$$fft1D_512.smem(true, BV32_ADD(v268$1, BV32_MUL($i.i39.0, 8bv32)), $$fft1D_512.smem[1bv1][BV32_ADD(v268$1, BV32_MUL($i.i39.0, 8bv32))]);
    assume {:do_not_predicate} {:check_id "check_state_2"} {:captureState "check_state_2"} {:sourceloc} {:sourceloc_num 463} true;
    call {:check_id "check_state_2"} {:sourceloc} {:sourceloc_num 463} _CHECK_READ_$$fft1D_512.smem(true, BV32_ADD(v268$2, BV32_MUL($i.i39.0, 8bv32)), $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v268$2, BV32_MUL($i.i39.0, 8bv32))]);
  ...
  $truebb8:
    ...
    call {:sourceloc} {:sourceloc_num 458} _LOG_WRITE_$$fft1D_512.smem(true, BV32_ADD(v255$1, BV32_MUL($i.i41.0, 72bv32)), v267$1, $$fft1D_512.smem[1bv1][BV32_ADD(v255$1, BV32_MUL($i.i41.0, 72bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem(true, BV32_ADD(v255$2, BV32_MUL($i.i41.0, 72bv32)));
    assume {:do_not_predicate} {:check_id "check_state_3"} {:captureState "check_state_3"} {:sourceloc} {:sourceloc_num 458} true;
    call {:check_id "check_state_3"} {:sourceloc} {:sourceloc_num 458} _CHECK_WRITE_$$fft1D_512.smem(true, BV32_ADD(v255$2, BV32_MUL($i.i41.0, 72bv32)), v267$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$fft1D_512.smem"} true;
    $$fft1D_512.smem[1bv1][BV32_ADD(v255$1, BV32_MUL($i.i41.0, 72bv32))] := v267$1;
    $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v255$2, BV32_MUL($i.i41.0, 72bv32))] := v267$2;
  ...
  $truebb7:
    ...
    v252$1 := $$fft1D_512.smem[1bv1][BV32_ADD(v250$1, BV32_MUL($i.i42.0, 8bv32))];
    v252$2 := $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v250$2, BV32_MUL($i.i42.0, 8bv32))];
  ...
  $truebb6:
    ...
    call {:sourceloc} {:sourceloc_num 425} _LOG_WRITE_$$fft1D_512.smem(true, BV32_ADD(v237$1, BV32_MUL($i.i44.0, 72bv32)), v248$1, $$fft1D_512.smem[1bv1][BV32_ADD(v237$1, BV32_MUL($i.i44.0, 72bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem(true, BV32_ADD(v237$2, BV32_MUL($i.i44.0, 72bv32)));
    assume {:do_not_predicate} {:check_id "check_state_5"} {:captureState "check_state_5"} {:sourceloc} {:sourceloc_num 425} true;
    call {:check_id "check_state_5"} {:sourceloc} {:sourceloc_num 425} _CHECK_WRITE_$$fft1D_512.smem(true, BV32_ADD(v237$2, BV32_MUL($i.i44.0, 72bv32)), v248$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$fft1D_512.smem"} true;
    $$fft1D_512.smem[1bv1][BV32_ADD(v237$1, BV32_MUL($i.i44.0, 72bv32))] := v248$1;
    $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v237$2, BV32_MUL($i.i44.0, 72bv32))] := v248$2;
  ...
  $truebb5:
    ...
    v234$1 := FP64_CONV32(FMUL64(FDIV64(FMUL64(13842132293034192152bv64, SI32_TO_FP64(v233$1)), 4634204016564240384bv64), SI32_TO_FP64(v2$1)));
    v234$2 := FP64_CONV32(FMUL64(FDIV64(FMUL64(13842132293034192152bv64, SI32_TO_FP64(v233$2)), 4634204016564240384bv64), SI32_TO_FP64(v2$2)));
  ...
  $truebb4:
    ...
    v137$1 := $$fft1D_512.smem[1bv1][BV32_ADD(v135$1, BV32_MUL($i.i45.0, 8bv32))];
    v137$2 := $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v135$2, BV32_MUL($i.i45.0, 8bv32))];
  ...
  $truebb3:
    ...
    call {:sourceloc} {:sourceloc_num 227} _LOG_WRITE_$$fft1D_512.smem(true, BV32_ADD(v122$1, BV32_MUL($i.i48.0, 66bv32)), v134$1, $$fft1D_512.smem[1bv1][BV32_ADD(v122$1, BV32_MUL($i.i48.0, 66bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem(true, BV32_ADD(v122$2, BV32_MUL($i.i48.0, 66bv32)));
    assume {:do_not_predicate} {:check_id "check_state_7"} {:captureState "check_state_7"} {:sourceloc} {:sourceloc_num 227} true;
    call {:check_id "check_state_7"} {:sourceloc} {:sourceloc_num 227} _CHECK_WRITE_$$fft1D_512.smem(true, BV32_ADD(v122$2, BV32_MUL($i.i48.0, 66bv32)), v134$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$fft1D_512.smem"} true;
    $$fft1D_512.smem[1bv1][BV32_ADD(v122$1, BV32_MUL($i.i48.0, 66bv32))] := v134$1;
    $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v122$2, BV32_MUL($i.i48.0, 66bv32))] := v134$2;
  ...
  $truebb2:
    ...
    v119$1 := $$fft1D_512.smem[1bv1][BV32_ADD(v117$1, BV32_MUL($i.i50.0, 8bv32))];
    v119$2 := $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v117$2, BV32_MUL($i.i50.0, 8bv32))];
  ...
  $truebb1:
    ...
    call {:sourceloc} {:sourceloc_num 194} _LOG_WRITE_$$fft1D_512.smem(true, BV32_ADD(v104$1, BV32_MUL($i.i53.0, 66bv32)), v115$1, $$fft1D_512.smem[1bv1][BV32_ADD(v104$1, BV32_MUL($i.i53.0, 66bv32))]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem(true, BV32_ADD(v104$2, BV32_MUL($i.i53.0, 66bv32)));
    assume {:do_not_predicate} {:check_id "check_state_9"} {:captureState "check_state_9"} {:sourceloc} {:sourceloc_num 194} true;
    call {:check_id "check_state_9"} {:sourceloc} {:sourceloc_num 194} _CHECK_WRITE_$$fft1D_512.smem(true, BV32_ADD(v104$2, BV32_MUL($i.i53.0, 66bv32)), v115$2);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$fft1D_512.smem"} true;
    $$fft1D_512.smem[1bv1][BV32_ADD(v104$1, BV32_MUL($i.i53.0, 66bv32))] := v115$1;
    $$fft1D_512.smem[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][BV32_ADD(v104$2, BV32_MUL($i.i53.0, 66bv32))] := v115$2;
  ...
  $truebb0:
    ...
    v101$1 := FP64_CONV32(FMUL64(FDIV64(FMUL64(13842132293034192152bv64, SI32_TO_FP64(v100$1)), 4647714815446351872bv64), SI32_TO_FP64(v0$1)));
    v101$2 := FP64_CONV32(FMUL64(FDIV64(FMUL64(13842132293034192152bv64, SI32_TO_FP64(v100$2)), 4647714815446351872bv64), SI32_TO_FP64(v0$2)));
...
procedure {:inline 1} {:safe_barrier} {:source_name "bugle_barrier"} {:barrier} $bugle_barrier_duplicated_0($0: bv1, $1: bv1);
  requires $0 == 1bv1;
  requires $1 == 0bv1;
  modifies $$fft1D_512.smem, $$work, _TRACKING;
...
var $$fft1D_512.reversed8$0bv32$1: bv32;

var $$fft1D_512.reversed8$0bv32$2: bv32;

var $$fft1D_512.reversed8$1bv32$1: bv32;

var $$fft1D_512.reversed8$1bv32$2: bv32;

var $$fft1D_512.reversed8$2bv32$1: bv32;

var $$fft1D_512.reversed8$2bv32$2: bv32;

var $$fft1D_512.reversed8$3bv32$1: bv32;

var $$fft1D_512.reversed8$3bv32$2: bv32;

var $$fft1D_512.reversed8$4bv32$1: bv32;

var $$fft1D_512.reversed8$4bv32$2: bv32;

var $$fft1D_512.reversed8$5bv32$1: bv32;

var $$fft1D_512.reversed8$5bv32$2: bv32;

var $$fft1D_512.reversed8$6bv32$1: bv32;

var $$fft1D_512.reversed8$6bv32$2: bv32;

var $$fft1D_512.reversed8$7bv32$1: bv32;

var $$fft1D_512.reversed8$7bv32$2: bv32;
...
const _WATCHED_VALUE_$$fft1D_512.smem: bv32;

procedure {:inline 1} _LOG_READ_$$fft1D_512.smem(_P: bool, _offset: bv32, _value: bv32);
  modifies _READ_HAS_OCCURRED_$$fft1D_512.smem;



implementation {:inline 1} _LOG_READ_$$fft1D_512.smem(_P: bool, _offset: bv32, _value: bv32)
{

  log_access_entry:
    _READ_HAS_OCCURRED_$$fft1D_512.smem := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$fft1D_512.smem == _value then true else _READ_HAS_OCCURRED_$$fft1D_512.smem);
    return;
}



procedure _CHECK_READ_$$fft1D_512.smem(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "smem"} {:array "$$fft1D_512.smem"} {:race} {:write_read} !(_P && _WRITE_HAS_OCCURRED_$$fft1D_512.smem && _WATCHED_OFFSET == _offset && _WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "smem"} {:array "$$fft1D_512.smem"} {:race} {:atomic_read} !(_P && _ATOMIC_HAS_OCCURRED_$$fft1D_512.smem && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);



var _WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem: bool;

procedure {:inline 1} _LOG_WRITE_$$fft1D_512.smem(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32);
  modifies _WRITE_HAS_OCCURRED_$$fft1D_512.smem, _WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem;



implementation {:inline 1} _LOG_WRITE_$$fft1D_512.smem(_P: bool, _offset: bv32, _value: bv32, _value_old: bv32)
{

  log_access_entry:
    _WRITE_HAS_OCCURRED_$$fft1D_512.smem := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$fft1D_512.smem == _value then true else _WRITE_HAS_OCCURRED_$$fft1D_512.smem);
    _WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$fft1D_512.smem == _value then _value != _value_old else _WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem);
    return;
}



procedure _CHECK_WRITE_$$fft1D_512.smem(_P: bool, _offset: bv32, _value: bv32);
  requires {:source_name "smem"} {:array "$$fft1D_512.smem"} {:race} {:write_write} !(_P && _WRITE_HAS_OCCURRED_$$fft1D_512.smem && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$fft1D_512.smem != _value && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "smem"} {:array "$$fft1D_512.smem"} {:race} {:read_write} !(_P && _READ_HAS_OCCURRED_$$fft1D_512.smem && _WATCHED_OFFSET == _offset && _WATCHED_VALUE_$$fft1D_512.smem != _value && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "smem"} {:array "$$fft1D_512.smem"} {:race} {:atomic_write} !(_P && _ATOMIC_HAS_OCCURRED_$$fft1D_512.smem && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);



procedure {:inline 1} _LOG_ATOMIC_$$fft1D_512.smem(_P: bool, _offset: bv32);
  modifies _ATOMIC_HAS_OCCURRED_$$fft1D_512.smem;



implementation {:inline 1} _LOG_ATOMIC_$$fft1D_512.smem(_P: bool, _offset: bv32)
{

  log_access_entry:
    _ATOMIC_HAS_OCCURRED_$$fft1D_512.smem := (if _P && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 && _TRACKING && _WATCHED_OFFSET == _offset then true else _ATOMIC_HAS_OCCURRED_$$fft1D_512.smem);
    return;
}



procedure _CHECK_ATOMIC_$$fft1D_512.smem(_P: bool, _offset: bv32);
  requires {:source_name "smem"} {:array "$$fft1D_512.smem"} {:race} {:write_atomic} !(_P && _WRITE_HAS_OCCURRED_$$fft1D_512.smem && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);
  requires {:source_name "smem"} {:array "$$fft1D_512.smem"} {:race} {:read_atomic} !(_P && _READ_HAS_OCCURRED_$$fft1D_512.smem && _WATCHED_OFFSET == _offset && group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2);



procedure {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem(_P: bool, _offset: bv32);
  modifies _WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem;



implementation {:inline 1} _UPDATE_WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem(_P: bool, _offset: bv32)
{

  _UPDATE_BENIGN_FLAG:
    _WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem := (if _P && _WRITE_HAS_OCCURRED_$$fft1D_512.smem && _WATCHED_OFFSET == _offset then false else _WRITE_READ_BENIGN_FLAG_$$fft1D_512.smem);
    return;
}
...
implementation {:inline 1} $bugle_barrier_duplicated_0($0: bv1, $1: bv1)
{
  ...
  anon0:
    assume $0 != 0bv1 ==> !_READ_HAS_OCCURRED_$$fft1D_512.smem;
    assume $0 != 0bv1 ==> !_WRITE_HAS_OCCURRED_$$fft1D_512.smem;
    assume $0 != 0bv1 ==> !_ATOMIC_HAS_OCCURRED_$$fft1D_512.smem;
    goto anon1;
