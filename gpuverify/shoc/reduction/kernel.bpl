...
implementation {:source_name "reduce"} {:kernel} $reduce($n: bv32)
{
  ...
  $0:
    ...
    v0$2 := local_id_x$2;
    v1 := group_size_x;
    call {:sourceloc} {:sourceloc_num 1} _LOG_WRITE_$$sdata(true, v0$1, 0bv32, $$sdata[1bv1][v0$1]);
    call _UPDATE_WRITE_READ_BENIGN_FLAG_$$sdata(true, v0$2);
    assume {:do_not_predicate} {:check_id "check_state_0"} {:captureState "check_state_0"} {:sourceloc} {:sourceloc_num 1} true;
    call {:check_id "check_state_0"} {:sourceloc} {:sourceloc_num 1} _CHECK_WRITE_$$sdata(true, v0$2, 0bv32);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_WRITE_$$sdata"} true;
    $$sdata[1bv1][v0$1] := 0bv32;
    $$sdata[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][v0$2] := 0bv32;
    $i.0$1 := BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2bv32)), v0$1);
    $i.0$2 := BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2bv32)), v0$2);
    p0$1 := false;
    p0$2 := false;
    p0$1 := true;
    p0$2 := true;
  ...
  $1:
    ...
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b4 ==> BV32_UGE($i.0$1, BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2bv32)), v0$1));
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b4 ==> BV32_UGE($i.0$2, BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2bv32)), v0$2));
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b3 ==> BV32_ULE($i.0$1, BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2bv32)), v0$1));
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b3 ==> BV32_ULE($i.0$2, BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2bv32)), v0$2));
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b2 ==> BV32_SGE($i.0$1, BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2bv32)), v0$1));
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b2 ==> BV32_SGE($i.0$2, BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2bv32)), v0$2));
    assert {:tag "loopBound"} {:thread 1} p0$1 ==> _b1 ==> BV32_SLE($i.0$1, BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2bv32)), v0$1));
    assert {:tag "loopBound"} {:thread 2} p0$2 ==> _b1 ==> BV32_SLE($i.0$2, BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2bv32)), v0$2));
    assert {:tag "loopCounterIsStrided"} {:thread 1} p0$1 ==> _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x), 1bv32), $i.0$1) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$1, BV32_MUL(group_size_x, 2bv32)), local_id_x$1));
    assert {:tag "loopCounterIsStrided"} {:thread 2} p0$2 ==> _b0 ==> BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x), 1bv32), $i.0$2) == BV32_AND(BV32_SUB(BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x), 1bv32), BV32_ADD(BV32_MUL(group_id_x$2, BV32_MUL(group_size_x, 2bv32)), local_id_x$2));
    ...
    $i.0$1 := (if p1$1 then BV32_ADD($i.0$1, BV32_MUL(BV32_MUL(group_size_x, 2bv32), num_groups_x)) else $i.0$1);
  ...
  $4:
    ...
    assert {:tag "pow2NotZero"} _b13 ==> $s.0 != 0bv32;
    assert {:tag "pow2"} _b12 ==> $s.0 == 0bv32 || BV32_AND($s.0, BV32_SUB($s.0, 1bv32)) == 0bv32;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _ATOMIC_HAS_OCCURRED_$$sdata ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _WRITE_HAS_OCCURRED_$$sdata ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "groupSharedArraysDisjointAcrossGroups"} _READ_HAS_OCCURRED_$$sdata ==> group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2;
    assert {:tag "loopBound"} {:thread 1} _b9 ==> BV32_UGE($s.0, BV32_UDIV(v1, 2bv32));
    assert {:tag "loopBound"} {:thread 2} _b9 ==> BV32_UGE($s.0, BV32_UDIV(v1, 2bv32));
    assert {:tag "loopBound"} {:thread 1} _b8 ==> BV32_ULE($s.0, BV32_UDIV(v1, 2bv32));
    assert {:tag "loopBound"} {:thread 2} _b8 ==> BV32_ULE($s.0, BV32_UDIV(v1, 2bv32));
    assert {:tag "loopBound"} {:thread 1} _b7 ==> BV32_SGE($s.0, BV32_UDIV(v1, 2bv32));
    assert {:tag "loopBound"} {:thread 2} _b7 ==> BV32_SGE($s.0, BV32_UDIV(v1, 2bv32));
    assert {:tag "loopBound"} {:thread 1} _b6 ==> BV32_SLE($s.0, BV32_UDIV(v1, 2bv32));
    assert {:tag "loopBound"} {:thread 2} _b6 ==> BV32_SLE($s.0, BV32_UDIV(v1, 2bv32));
  ...
  $falsebb0:
    ...
    call {:sourceloc} {:sourceloc_num 21} _LOG_READ_$$sdata(p5$1, 0bv32, $$sdata[1bv1][0bv32]);
    assume {:do_not_predicate} {:check_id "check_state_1"} {:captureState "check_state_1"} {:sourceloc} {:sourceloc_num 21} true;
    call {:check_id "check_state_1"} {:sourceloc} {:sourceloc_num 21} _CHECK_READ_$$sdata(p5$2, 0bv32, $$sdata[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32]);
    assume {:captureState "call_return_state_0"} {:procedureName "_CHECK_READ_$$sdata"} true;
    v11$1 := (if p5$1 then $$sdata[1bv1][0bv32] else v11$1);
    v11$2 := (if p5$2 then $$sdata[(if group_id_x$1 == group_id_x$2 && group_id_y$1 == group_id_y$2 && group_id_z$1 == group_id_z$2 then 1bv1 else 0bv1)][0bv32] else v11$2);
